...
VALUES (
  ...
  '{"label":"快乐马1.0","group":"阿里云百炼","recommended":false,"visible":true,"pipeline":"video","supportedModes":["image_to_video","reference_image_to_video"],"providerDocUrl":"https://help.aliyun.com/zh/model-studio/happyhorse-reference-to-video-api-reference","parameterDisplayLanguage":"zh-CN"}'::jsonb,
  'active',
  23,
