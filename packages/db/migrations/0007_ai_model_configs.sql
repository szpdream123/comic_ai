...
(
  ...
  '{"prompt":{"type":"string","maxLength":4000},"aspectRatio":{"enum":["1:1","16:9","9:16"]},"quality":{"enum":["standard","hd","2K"]},"count":{"type":"integer","minimum":1,"maximum":4}}'::jsonb,
  '{"quality":"2K","count":1,"aspectRatio":"9:16"}'::jsonb,
  '{"baseURL":"https://code.shoestravel.xin","endpoint":"/v1/images/generations","apiKeyEnv":"GPT_IMAGE2_API_KEY","resultFormat":"b64_json","requestFormat":"openai_images","timeoutMs":120000}'::jsonb,
  ...
  '{"label":"GPT Image 2","group":"OpenAI","recommended":true,"visible":true,"pipeline":"G"}'::jsonb,
  'active',
  10,
