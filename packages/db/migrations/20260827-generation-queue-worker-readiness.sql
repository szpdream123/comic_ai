ALTER TABLE generation_queue_worker_leases
  ADD COLUMN IF NOT EXISTS worker_ready_at timestamp with time zone;
...
BEGIN
  ...
  LOOP
    ...
    SET owner_id = EXCLUDED.owner_id,
        ...
        worker_ready_at = CASE
          WHEN generation_queue_worker_leases.owner_id = EXCLUDED.owner_id
            THEN generation_queue_worker_leases.worker_ready_at
          ELSE NULL
        END
