...
export const criticalApiRouteAuthRegistrations = [
  ...
  { id: "home-recommendations.cover-media.read", method: "GET", path: "/api/home-recommendations/covers/{storageObjectId}/media", policy: "public" },
  ...
  { id: "moneyprinter.text-models", method: "GET", path: "/api/integrations/moneyprinter/text-models", policy: "signed-webhook" },
  { id: "moneyprinter.text-completions", method: "POST", path: "/api/integrations/moneyprinter/text-completions", policy: "signed-webhook" },
  { id: "moneyprinter.video-generations", method: "POST", path: "/api/integrations/moneyprinter/video-generations", policy: "signed-webhook" },
  { id: "moneyprinter.image-generations", method: "POST", path: "/api/integrations/moneyprinter/image-generations", policy: "signed-webhook" },
  { id: "moneyprinter.video-task", method: "GET", path: "/api/integrations/moneyprinter/video-generations/{taskId}", policy: "signed-webhook" },
  { id: "moneyprinter.image-task", method: "GET", path: "/api/integrations/moneyprinter/image-generations/{taskId}", policy: "signed-webhook" },
  { id: "creator.asset-version-thumbnail", method: "GET", path: "/api/creator/assets/versions/{versionId}/thumbnail", policy: "user" },
  ...
  { id: "creator.skill-categories.list", method: "GET", path: "/api/creator/skill-categories", policy: "user" },
  { id: "creator.skills.catalog", method: "GET", path: "/api/creator/skills", policy: "user" },
  ...
  { id: "creator.skills.files.attach", method: "POST", path: "/api/creator/skills/{skillId}/files", policy: "user" },
...
const adminApiRouteAuthRegistrations = inventoryRegistrations("admin", [
  ...
  ["GET", "/api/admin/video-batch/cookie"],
  ["GET", "/api/admin/video-batch/media"],
  ["PATCH", "/api/admin/video-batch/cookie"],
  ...
  ["PATCH", "/api/admin/skill-categories"],
  ["DELETE", "/api/admin/skill-categories"],
  ...
  ["GET", "/api/admin/geo/monitoring"],
  ["POST", "/api/admin/geo/monitoring/manual"],
  ["POST", "/api/admin/geo/monitoring/official-api"],
  ...
  ["GET", "/api/admin/geo/content/{contentItemId}"],
  ["POST", "/api/admin/geo/generate"],
  ["POST", "/api/admin/geo/preview"],
  ["POST", "/api/admin/geo/assets/uploads"],
  ["POST", "/api/admin/geo/content/{contentItemId}/submit-review"],
  ["POST", "/api/admin/geo/content/{contentItemId}/publish"],
  ["POST", "/api/admin/geo/content/{contentItemId}/rollback"],
  ["POST", "/api/admin/geo/content/{contentItemId}/archive"],
  ["GET", "/api/admin/geo/settings"],
  ["PATCH", "/api/admin/geo/settings"],
  ["GET", "/api/admin/home-recommendations"],
  ["PATCH", "/api/admin/home-recommendations/background"],
  ["POST", "/api/admin/home-recommendations/background/upload"],
  ["POST", "/api/admin/home-recommendations/videos/upload"],
  ["POST", "/api/admin/home-recommendations/covers/upload"],
  ["POST", "/api/admin/home-recommendations/categories"],
  ["PATCH", "/api/admin/home-recommendations/categories/{categoryId}"],
  ["DELETE", "/api/admin/home-recommendations/categories/{categoryId}"],
  ["POST", "/api/admin/home-recommendations/videos"],
  ["PATCH", "/api/admin/home-recommendations/videos/{videoId}"],
  ["DELETE", "/api/admin/home-recommendations/videos/{videoId}"],
  ...
  ["GET", "/api/admin/resources/retention/summary"],
  ["POST", "/api/admin/resources/retention/run"],
...
const userApiRouteAuthRegistrations = inventoryRegistrations("user", [
  ...
  ["GET", "/api/toolbox/watermark-removal/model"],
  ["GET", "/api/toolbox/watermark-removal/ocr/det"],
  ["GET", "/api/toolbox/watermark-removal/ocr/rec"],
  ["GET", "/api/toolbox/watermark-removal/ocr/dict"],
  ["GET", "/api/free-generation/agent-models"],
  ["GET", "/api/free-generation/conversations"],
  ["POST", "/api/free-generation/conversations"],
  ["PATCH", "/api/free-generation/conversations"],
  ["DELETE", "/api/free-generation/conversations"],
  ["GET", "/api/free-generation/conversations/{conversationId}/messages"],
  ["POST", "/api/free-generation/conversations/{conversationId}/messages"],
  ["GET", "/api/free-generation/conversations/{conversationId}/file-grants"],
  ["POST", "/api/free-generation/conversations/{conversationId}/file-grants"],
  ["DELETE", "/api/free-generation/conversations/{conversationId}/file-grants/{grantId}"],
  ["GET", "/api/free-generation/agent-tasks/{taskId}/events"],
  ["POST", "/api/free-generation/agent-tasks/{taskId}/pause"],
  ["POST", "/api/free-generation/agent-tasks/{taskId}/resume"],
  ["POST", "/api/free-generation/agent-tasks/{taskId}/stop"],
  ["POST", "/api/free-generation/agent-tasks/{taskId}/replan"],
  ["POST", "/api/free-generation/agent-tasks/{taskId}/interject"],
  ["POST", "/api/free-generation/agent-tasks/{taskId}/approve"],
  ["POST", "/api/free-generation/agent-tasks/{taskId}/skip"],
  ["PATCH", "/api/creator/canvases/{canvasProjectId}/positions"],
  ...
  ["POST", "/api/canvas/{canvasProjectId}/video-export"],
  ...
  ["POST", "/api/canvas/{canvasProjectId}/assistant/chat/completions"],
  ["POST", "/api/canvas/{canvasProjectId}/assistant/images/generations"],
  ["POST", "/api/canvas/{canvasProjectId}/assistant/videos/generations"],
  ["GET", "/api/canvas/{canvasProjectId}/assistant/tasks/{taskId}"],
...
export const apiRouteAuthInventoryCoverage = {
  explicitMethodPath: { discovered: 207, uncovered: 0 },
