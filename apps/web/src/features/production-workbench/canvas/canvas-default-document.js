export const CANVAS_NODE_SIZES = {
  ...
  "ai-shotlist": { width: 720, height: 380 },
...
export function createDefaultCanvasDocument(input = {}) {
  ...
  return {
    ...
    viewport: { x: 0, y: 0, zoom: 1, snapEnabled: false, showBackgroundGrid: false, interactionMode: "default" },
    nodes: [],
    edges: [],
    createdAt: now,
    updatedAt: now,
