...
export function ProceduralMannequin({ bodyType, color = "#4F8EF7", rigState }: ProceduralMannequinProps) {
  ...
  const leftHandRotation = getRotationFromControls(controls, "leftHand", preset.bodyType);
  const rightHandRotation = getRotationFromControls(controls, "rightHand", preset.bodyType);
  ...
  const leftFootRotation = getRotationFromControls(controls, "leftFoot", preset.bodyType);
  const rightFootRotation = getRotationFromControls(controls, "rightFoot", preset.bodyType);
  ...
  return (
    <group name={`procedural-${preset.bodyType}`} rotation={bodyRotation} scale={preset.defaultScale}>
      <group name="pose-torso" rotation={torsoRotation}>
        <Torso
        ...
        <group name="pose-leftShoulder" position={[-p.shoulderWidth, armOriginY, 0]} rotation={leftShoulderRotation}>
          <Segment
            color={color}
          ...
          />
          <group name="pose-leftElbow" position={[0, elbowY, 0]} rotation={leftElbowRotation}>
            ...
            <group name="pose-leftHand" position={[0, handY, 0.02]} rotation={leftHandRotation}>
              <Hand color={color} position={[0, 0, 0]} radius={p.handRadius} scale={p.handScale} side="left" />
            </group>
          </group>
        </group>

        <group name="pose-rightShoulder" position={[p.shoulderWidth, armOriginY, 0]} rotation={rightShoulderRotation}>
          <Segment
            color={color}
            length={p.upperArmLength}
            position={[0, -(p.upperArmLength * 0.5 + p.upperArmRadius), 0]}
            radius={p.upperArmRadius}
          />
          <group name="pose-rightElbow" position={[0, elbowY, 0]} rotation={rightElbowRotation}>
            <Joint color={color} position={[0, 0, 0]} radius={p.elbowRadius} scale={jointScale} />
            <Segment
              color={color}
              length={p.forearmLength}
            ...
            />
            <Joint color={color} position={[0, wristY, 0]} radius={p.wristRadius} scale={jointScale} />
            <group name="pose-rightHand" position={[0, handY, 0.02]} rotation={rightHandRotation}>
              <Hand color={color} position={[0, 0, 0]} radius={p.handRadius} scale={p.handScale} side="right" />
            </group>
          </group>
        </group>
      </group>
      ...
      <group name="pose-leftHip" position={[-p.legSpread, legOriginY, 0]} rotation={leftHipRotation}>
        <Segment
          color={color}
        ...
        />
        <group name="pose-leftKnee" position={[0, kneeY, 0]} rotation={leftKneeRotation}>
          ...
          <group name="pose-leftFoot" position={[0, footY, p.footRadius * 0.74]} rotation={leftFootRotation}>
            <Foot color={color} length={p.footLength} position={[0, 0, 0]} radius={p.footRadius} scale={p.footScale} side="left" />
          </group>
        </group>
      </group>

      <group name="pose-rightHip" position={[p.legSpread, legOriginY, 0]} rotation={rightHipRotation}>
        <Segment
          color={color}
          length={p.thighLength}
          position={[0, -(p.thighLength * 0.5 + p.thighRadius), 0]}
          radius={p.thighRadius}
        />
        <group name="pose-rightKnee" position={[0, kneeY, 0]} rotation={rightKneeRotation}>
          <Joint color={color} position={[0, 0, 0]} radius={p.kneeRadius} scale={jointScale} />
          <Segment
            color={color}
            length={p.calfLength}
          ...
          />
          <Joint color={color} position={[0, ankleY, 0]} radius={p.ankleRadius} scale={jointScale} />
          <group name="pose-rightFoot" position={[0, footY, p.footRadius * 0.74]} rotation={rightFootRotation}>
            <Foot color={color} length={p.footLength} position={[0, 0, 0]} radius={p.footRadius} scale={p.footScale} side="right" />
          </group>
        </group>
      </group>
    </group>
