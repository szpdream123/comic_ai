...
export const CANVAS_TOOL_PRESETS = Object.freeze([
  ...
  Object.freeze({
    ...
    category: "image",
    categoryLabel: "图像生成",
    description: "输入角色设定，并行生成同一角色的正面、侧面和背面视图。",
    tags: Object.freeze(["角色", "三视图", "正侧背"]),
    nodeCount: 4,
    nodes: Object.freeze([
      Object.freeze({ kind: "workflow", type: "script-node", offsetX: 0, offsetY: 310, data: { title: "角色设定" } }),
      Object.freeze({ kind: "image", offsetX: 420, offsetY: 0, data: { prompt: "同一角色，正面全身视图，纯色背景" } }),
      Object.freeze({ kind: "image", offsetX: 420, offsetY: 440, data: { prompt: "同一角色，侧面全身视图，纯色背景" } }),
      Object.freeze({ kind: "image", offsetX: 420, offsetY: 880, data: { prompt: "同一角色，背面全身视图，纯色背景" } }),
    ]),
    connections: Object.freeze([[0, 1], [0, 2], [0, 3]]),
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    category: "audio",
    categoryLabel: "音频生成",
    description: "从脚本文本生成音频，再以音频驱动视频生成。",
    tags: Object.freeze(["音频", "视频", "音频生视频"]),
    nodeCount: 3,
    nodes: Object.freeze([
      Object.freeze({ kind: "workflow", type: "script-node", offsetX: 0, offsetY: 45 }),
      Object.freeze({ kind: "workflow", type: "audio-node", offsetX: 410, offsetY: 20 }),
      Object.freeze({ kind: "video", offsetX: 830, offsetY: 0 }),
    ]),
    connections: Object.freeze([[0, 1], [1, 2]]),
  }),
  Object.freeze({
