...
function xt(e, t, n, r, i) {
	...
	switch (i) {
		...
		case "ZYZ":
			...
			break;
		default: U("MathUtils: .setQuaternionFromProperEuler() encountered an unknown order: " + i);
	}
}
function St(e, t) {
	...
	setFromEuler(e, t = !0) {
		...
		switch (a) {
			...
			case "XZY":
				this._x = d * l * u - c * f * p, this._y = c * f * u - d * l * p, this._z = c * l * p + d * f * u, this._w = c * l * u + d * f * p;
				break;
			default: U("Quaternion: .setFromEuler() encountered an unknown order: " + a);
		}
...
}, Et = /* @__PURE__ */ new q(), Dt = /* @__PURE__ */ new Tt(), J = class e {
	static {
...
}, Ot = /* @__PURE__ */ new J(), kt = /* @__PURE__ */ new J().set(.4123908, .3575843, .1804808, .212639, .7151687, .0721923, .0193308, .1191948, .9505322), At = /* @__PURE__ */ new J().set(3.2409699, -1.5373832, -.4986108, -.9692436, 1.8759675, .0415551, .0556301, -.203977, 1.0569715);
function jt() {
	let e = {
		enabled: !0,
		workingColorSpace: Pe,
		spaces: {},
		convert: function(e, t, n) {
			return this.enabled === !1 || t === n || !t || !n ? e : (this.spaces[t].transfer === "srgb" && (e.r = Mt(e.r), e.g = Mt(e.g), e.b = Mt(e.b)), this.spaces[t].primaries !== this.spaces[n].primaries && (e.applyMatrix3(this.spaces[t].toXYZ), e.applyMatrix3(this.spaces[n].fromXYZ)), this.spaces[n].transfer === "srgb" && (e.r = Nt(e.r), e.g = Nt(e.g), e.b = Nt(e.b)), e);
		},
		...
		getTransfer: function(e) {
			return e === "" ? Fe : this.spaces[e].transfer;
		},
...
var Pt, Ft = class {
	static getDataURL(e, t = "image/png") {
		...
		if (e instanceof HTMLCanvasElement) n = e;
			...
			Pt === void 0 && (Pt = Ue("canvas")), Pt.width = e.width, Pt.height = e.height;
			let t = Pt.getContext("2d");
			e instanceof ImageData ? t.putImageData(e, 0, 0) : t.drawImage(e, 0, 0, e.width, e.height), n = Pt;
		}
	...
	static sRGBToLinear(e) {
		if (typeof HTMLImageElement < "u" && e instanceof HTMLImageElement || typeof HTMLCanvasElement < "u" && e instanceof HTMLCanvasElement || typeof ImageBitmap < "u" && e instanceof ImageBitmap) {
			...
			for (let e = 0; e < i.length; e++) i[e] = Mt(i[e] / 255) * 255;
			return n.putImageData(r, 0, 0), t;
		} else if (e.data) {
			let t = e.data.slice(0);
			for (let e = 0; e < t.length; e++) t instanceof Uint8Array || t instanceof Uint8ClampedArray ? t[e] = Math.floor(Mt(t[e] / 255) * 255) : t[e] = Mt(t[e]);
			return {
				data: t,
				width: e.width,
				height: e.height
	...
	constructor(e = null) {
		this.isSource = !0, Object.defineProperty(this, "id", { value: It++ }), this.uuid = rt(), this.data = e, this.dataReady = !0, this.version = 0;
	}
	getSize(e) {
		let t = this.data;
	...
	toJSON(e) {
		...
		if (r !== null) {
			...
			if (Array.isArray(r)) {
				e = [];
				for (let t = 0, n = r.length; t < n; t++) r[t].isDataTexture ? e.push(Rt(r[t].image)) : e.push(Rt(r[t]));
			} else e = Rt(r);
			n.url = e;
		}
...
function Rt(e) {
	return typeof HTMLImageElement < "u" && e instanceof HTMLImageElement || typeof HTMLCanvasElement < "u" && e instanceof HTMLCanvasElement || typeof ImageBitmap < "u" && e instanceof ImageBitmap ? Ft.getDataURL(e) : e.data ? {
...
Vt.DEFAULT_IMAGE = null, Vt.DEFAULT_MAPPING = 300, Vt.DEFAULT_ANISOTROPY = 1;
var Ht = class e {
	static {
	...
	*[Symbol.iterator]() {
	...
	copy(e) {
		...
		for (let t = 0, n = e.textures.length; t < n; t++) {
			...
			this.textures[t].source = new Lt(n);
		}
	...
	extractRotation(e) {
		...
		let t = this.elements, n = e.elements, r = 1 / Jt.setFromMatrixColumn(e, 0).length(), i = 1 / Jt.setFromMatrixColumn(e, 1).length(), a = 1 / Jt.setFromMatrixColumn(e, 2).length();
	...
	makeRotationFromQuaternion(e) {
		return this.compose(Xt, e, Zt);
	}
	lookAt(e, t, n) {
		let r = this.elements;
		return en.subVectors(e, t), en.lengthSq() === 0 && (en.z = 1), en.normalize(), Qt.crossVectors(n, en), Qt.lengthSq() === 0 && (Math.abs(n.z) === 1 ? en.x += 1e-4 : en.z += 1e-4, en.normalize(), Qt.crossVectors(n, en)), Qt.normalize(), $t.crossVectors(en, Qt), r[0] = Qt.x, r[4] = $t.x, r[8] = en.x, r[1] = Qt.y, r[5] = $t.y, r[9] = en.y, r[2] = Qt.z, r[6] = $t.z, r[10] = en.z, this;
	}
	multiply(e) {
		return this.multiplyMatrices(this, e);
	}
	...
	multiplyMatrices(e, t) {
		let n = e.elements, r = t.elements, i = this.elements, a = n[0], o = n[4], s = n[8], c = n[12], l = n[1], u = n[5], d = n[9], f = n[13], p = n[2], m = n[6], h = n[10], g = n[14], _ = n[3], v = n[7], y = n[11], b = n[15], x = r[0], S = r[4], C = r[8], w = r[12], T = r[1], E = r[5], D = r[9], O = r[13], k = r[2], A = r[6], ee = r[10], j = r[14], M = r[3], te = r[7], N = r[11], P = r[15];
		return i[0] = a * x + o * T + s * k + c * M, i[4] = a * S + o * E + s * A + c * te, i[8] = a * C + o * D + s * ee + c * N, i[12] = a * w + o * O + s * j + c * P, i[1] = l * x + u * T + d * k + f * M, i[5] = l * S + u * E + d * A + f * te, i[9] = l * C + u * D + d * ee + f * N, i[13] = l * w + u * O + d * j + f * P, i[2] = p * x + m * T + h * k + g * M, i[6] = p * S + m * E + h * A + g * te, i[10] = p * C + m * D + h * ee + g * N, i[14] = p * w + m * O + h * j + g * P, i[3] = _ * x + v * T + y * k + b * M, i[7] = _ * S + v * E + y * A + b * te, i[11] = _ * C + v * D + y * ee + b * N, i[15] = _ * w + v * O + y * j + b * P, this;
	}
	multiplyScalar(e) {
		let t = this.elements;
	...
	decompose(e, t, n) {
		...
		let a = Jt.set(r[0], r[1], r[2]).length(), o = Jt.set(r[4], r[5], r[6]).length(), s = Jt.set(r[8], r[9], r[10]).length();
		i < 0 && (a = -a), Yt.copy(this);
		let c = 1 / a, l = 1 / o, u = 1 / s;
		return Yt.elements[0] *= c, Yt.elements[1] *= c, Yt.elements[2] *= c, Yt.elements[4] *= l, Yt.elements[5] *= l, Yt.elements[6] *= l, Yt.elements[8] *= u, Yt.elements[9] *= u, Yt.elements[10] *= u, t.setFromRotationMatrix(Yt), n.x = a, n.y = o, n.z = s, this;
	}
...
}, Jt = /* @__PURE__ */ new q(), Yt = /* @__PURE__ */ new qt(), Xt = /* @__PURE__ */ new q(0, 0, 0), Zt = /* @__PURE__ */ new q(1, 1, 1), Qt = /* @__PURE__ */ new q(), $t = /* @__PURE__ */ new q(), en = /* @__PURE__ */ new q(), tn = /* @__PURE__ */ new qt(), nn = /* @__PURE__ */ new Tt(), rn = class e {
	...
	setFromRotationMatrix(e, t = this._order, n = !0) {
		...
		switch (t) {
			...
			case "XZY":
				...
				break;
			default: U("Euler: .setFromRotationMatrix() encountered an unknown order: " + t);
		}
...
var an = class {
...
}, on = 0, sn = /* @__PURE__ */ new q(), cn = /* @__PURE__ */ new Tt(), ln = /* @__PURE__ */ new qt(), un = /* @__PURE__ */ new q(), dn = /* @__PURE__ */ new q(), fn = /* @__PURE__ */ new q(), pn = /* @__PURE__ */ new Tt(), mn = /* @__PURE__ */ new q(1, 0, 0), hn = /* @__PURE__ */ new q(0, 1, 0), gn = /* @__PURE__ */ new q(0, 0, 1), _n = { type: "added" }, vn = { type: "removed" }, yn = {
	type: "childadded",
	child: null
}, bn = {
	type: "childremoved",
	child: null
}, xn = class e extends Qe {
	constructor() {
		super(), this.isObject3D = !0, Object.defineProperty(this, "id", { value: on++ }), this.uuid = rt(), this.name = "", this.type = "Object3D", this.parent = null, this.children = [], this.up = e.DEFAULT_UP.clone();
		let t = new q(), n = new rn(), r = new Tt(), i = new q(1, 1, 1);
		function a() {
			r.setFromEuler(n, !1);
		}
		function o() {
		...
		}), this.matrix = new qt(), this.matrixWorld = new qt(), this.matrixAutoUpdate = e.DEFAULT_MATRIX_AUTO_UPDATE, this.matrixWorldAutoUpdate = e.DEFAULT_MATRIX_WORLD_AUTO_UPDATE, this.matrixWorldNeedsUpdate = !1, this.layers = new an(), this.visible = !0, this.castShadow = !1, this.receiveShadow = !1, this.frustumCulled = !0, this.renderOrder = 0, this.animations = [], this.customDepthMaterial = void 0, this.customDistanceMaterial = void 0, this.static = !1, this.userData = {}, this.pivot = null;
	}
	onBeforeShadow() {}
	onAfterShadow() {}
	onBeforeRender() {}
	...
	lookAt(e, t, n) {
		...
		let r = this.parent;
		this.updateWorldMatrix(!0, !1), dn.setFromMatrixPosition(this.matrixWorld), this.isCamera || this.isLight ? ln.lookAt(dn, un, this.up) : ln.lookAt(un, dn, this.up), this.quaternion.setFromRotationMatrix(ln), r && (ln.extractRotation(r.matrixWorld), cn.setFromRotationMatrix(ln), this.quaternion.premultiply(cn.invert()));
	}
	add(e) {
		...
		return e === this ? (W("Object3D.add: object can't be added as a child of itself.", e), this) : (e && e.isObject3D ? (e.removeFromParent(), e.parent = this, this.children.push(e), e.dispatchEvent(_n), yn.child = e, this.dispatchEvent(yn), yn.child = null) : W("Object3D.add: object not an instance of THREE.Object3D.", e), this);
	}
	remove(e) {
		if (arguments.length > 1) {
		...
		return t !== -1 && (e.parent = null, this.children.splice(t, 1), e.dispatchEvent(vn), bn.child = e, this.dispatchEvent(bn), bn.child = null), this;
	}
	removeFromParent() {
		let e = this.parent;
	...
	attach(e) {
		return this.updateWorldMatrix(!0, !1), ln.copy(this.matrixWorld).invert(), e.parent !== null && (e.parent.updateWorldMatrix(!0, !1), ln.multiply(e.parent.matrixWorld)), e.applyMatrix4(ln), e.removeFromParent(), e.parent = this, this.children.push(e), e.updateWorldMatrix(!1, !0), e.dispatchEvent(_n), yn.child = e, this.dispatchEvent(yn), yn.child = null, this;
	}
	getObjectById(e) {
	...
	getWorldQuaternion(e) {
		return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(dn, e, fn), e;
	}
	getWorldScale(e) {
		return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(dn, pn, e), e;
	}
	getWorldDirection(e) {
...
xn.DEFAULT_UP = /* @__PURE__ */ new q(0, 1, 0), xn.DEFAULT_MATRIX_AUTO_UPDATE = !0, xn.DEFAULT_MATRIX_WORLD_AUTO_UPDATE = !0;
var Sn = class extends xn {
	constructor() {
		super(), this.isGroup = !0, this.type = "Group";
	}
}, Cn = { type: "move" }, wn = class {
	constructor() {
	...
	getTargetRaySpace() {
		return this._targetRay === null && (this._targetRay = new Sn(), this._targetRay.matrixAutoUpdate = !1, this._targetRay.visible = !1, this._targetRay.hasLinearVelocity = !1, this._targetRay.linearVelocity = new q(), this._targetRay.hasAngularVelocity = !1, this._targetRay.angularVelocity = new q()), this._targetRay;
	}
	getGripSpace() {
		return this._grip === null && (this._grip = new Sn(), this._grip.matrixAutoUpdate = !1, this._grip.visible = !1, this._grip.hasLinearVelocity = !1, this._grip.linearVelocity = new q(), this._grip.hasAngularVelocity = !1, this._grip.angularVelocity = new q(), this._grip.eventsEnabled = !1), this._grip;
	}
	dispatchEvent(e) {
	...
	update(e, t, n) {
		...
		if (e && t.session.visibilityState !== "visible-blurred") {
			...
			o !== null && (r = t.getPose(e.targetRaySpace, n), r === null && i !== null && (r = i), r !== null && (o.matrix.fromArray(r.transform.matrix), o.matrix.decompose(o.position, o.rotation, o.scale), o.matrixWorldNeedsUpdate = !0, r.linearVelocity ? (o.hasLinearVelocity = !0, o.linearVelocity.copy(r.linearVelocity)) : o.hasLinearVelocity = !1, r.angularVelocity ? (o.hasAngularVelocity = !0, o.angularVelocity.copy(r.angularVelocity)) : o.hasAngularVelocity = !1, this.dispatchEvent(Cn)));
		}
...
var X = class {
	...
	setHSL(e, t, n, r = Y.workingColorSpace) {
		if (e = it(e, 1), t = G(t, 0, 1), n = G(n, 0, 1), t === 0) this.r = this.g = this.b = n;
		else {
			let r = n <= .5 ? n * (1 + t) : n + t - n * t, i = 2 * n - r;
			this.r = On(i, r, e + 1 / 3), this.g = On(i, r, e), this.b = On(i, r, e - 1 / 3);
		}
		...
		if (r = /^(\w+)\(([^\)]*)\)/.exec(e)) {
			...
			switch (a) {
				...
				case "hsla":
					...
					break;
				default: U("Color: Unknown color model " + e);
			}
	...
	getHex(e = Ne) {
		return Y.workingToColorSpace(kn.copy(this), e), Math.round(G(kn.r * 255, 0, 255)) * 65536 + Math.round(G(kn.g * 255, 0, 255)) * 256 + Math.round(G(kn.b * 255, 0, 255));
	}
	getHexString(e = Ne) {
		return ("000000" + this.getHex(e).toString(16)).slice(-6);
	}
	getHSL(e, t = Y.workingColorSpace) {
		Y.workingToColorSpace(kn.copy(this), t);
		let n = kn.r, r = kn.g, i = kn.b, a = Math.max(n, r, i), o = Math.min(n, r, i), s, c, l = (o + a) / 2;
		if (o === a) s = 0, c = 0;
		else {
			let e = a - o;
	...
	getRGB(e, t = Y.workingColorSpace) {
		return Y.workingToColorSpace(kn.copy(this), t), e.r = kn.r, e.g = kn.g, e.b = kn.b, e;
	}
	getStyle(e = Ne) {
		Y.workingToColorSpace(kn.copy(this), e);
		let t = kn.r, n = kn.g, r = kn.b;
	...
	lerpHSL(e, t) {
		this.getHSL(En), e.getHSL(Dn);
		let n = st(En.h, Dn.h, t), r = st(En.s, Dn.s, t), i = st(En.l, Dn.l, t);
...
var An = class e {
...
}, Mn = /* @__PURE__ */ new q(), Nn = /* @__PURE__ */ new q(), Pn = /* @__PURE__ */ new q(), Fn = /* @__PURE__ */ new q(), In = /* @__PURE__ */ new q(), Ln = /* @__PURE__ */ new q(), Rn = /* @__PURE__ */ new q(), zn = /* @__PURE__ */ new q(), Bn = /* @__PURE__ */ new q(), Vn = /* @__PURE__ */ new q(), Hn = /* @__PURE__ */ new Ht(), Un = /* @__PURE__ */ new Ht(), Wn = /* @__PURE__ */ new Ht(), Gn = class e {
	...
	static getBarycoord(e, t, n, r, i) {
		...
		let a = Mn.dot(Mn), o = Mn.dot(Nn), s = Mn.dot(Pn), c = Nn.dot(Nn), l = Nn.dot(Pn), u = a * c - o * o;
		if (u === 0) return i.set(0, 0, 0), null;
		let d = 1 / u, f = (c * s - o * l) * d, p = (a * l - o * s) * d;
		return i.set(1 - f - p, p, f);
	}
	static containsPoint(e, t, n, r) {
		return this.getBarycoord(e, t, n, r, Fn) === null ? !1 : Fn.x >= 0 && Fn.y >= 0 && Fn.x + Fn.y <= 1;
	}
	static getInterpolation(e, t, n, r, i, a, o, s) {
		return this.getBarycoord(e, t, n, r, Fn) === null ? (s.x = 0, s.y = 0, "z" in s && (s.z = 0), "w" in s && (s.w = 0), null) : (s.setScalar(0), s.addScaledVector(i, Fn.x), s.addScaledVector(a, Fn.y), s.addScaledVector(o, Fn.z), s);
	}
	static getInterpolatedAttribute(e, t, n, r, i, a) {
		return Hn.setScalar(0), Un.setScalar(0), Wn.setScalar(0), Hn.fromBufferAttribute(e, t), Un.fromBufferAttribute(e, n), Wn.fromBufferAttribute(e, r), a.setScalar(0), a.addScaledVector(Hn, i.x), a.addScaledVector(Un, i.y), a.addScaledVector(Wn, i.z), a;
	}
	...
	getArea() {
		return Mn.subVectors(this.c, this.b), Nn.subVectors(this.a, this.b), Mn.cross(Nn).length() * .5;
	}
	getMidpoint(e) {
	...
	setFromCenterAndSize(e, t) {
		let n = Jn.copy(t).multiplyScalar(.5);
	...
	expandByObject(e, t = !1) {
		...
		if (n !== void 0) {
			...
			if (t === !0 && r !== void 0 && e.isInstancedMesh !== !0) for (let t = 0, n = r.count; t < n; t++) e.isMesh === !0 ? e.getVertexPosition(t, Jn) : Jn.fromBufferAttribute(r, t), Jn.applyMatrix4(e.matrixWorld), this.expandByPoint(Jn);
			else e.boundingBox === void 0 ? (n.boundingBox === null && n.computeBoundingBox(), Yn.copy(n.boundingBox)) : (e.boundingBox === null && e.computeBoundingBox(), Yn.copy(e.boundingBox)), Yn.applyMatrix4(e.matrixWorld), this.union(Yn);
		}
		let r = e.children;
	...
	intersectsTriangle(e) {
		...
		this.getCenter(nr), rr.subVectors(this.max, nr), Xn.subVectors(e.a, nr), Zn.subVectors(e.b, nr), Qn.subVectors(e.c, nr), $n.subVectors(Zn, Xn), er.subVectors(Qn, Zn), tr.subVectors(Xn, Qn);
		let t = [
			0,
			-$n.z,
			$n.y,
		...
		return !or(t, Xn, Zn, Qn, rr) || (t = [
			...
			0,
			1
		], !or(t, Xn, Zn, Qn, rr)) ? !1 : (ir.crossVectors($n, er), t = [
			ir.x,
			ir.y,
			ir.z
		], or(t, Xn, Zn, Qn, rr));
	...
	getBoundingSphere(e) {
		return this.isEmpty() ? e.makeEmpty() : (this.getCenter(e.center), e.radius = this.getSize(Jn).length() * .5), e;
	}
	intersect(e) {
	...
	/* @__PURE__ */ new q(),
	/* @__PURE__ */ new q()
], Jn = /* @__PURE__ */ new q(), Yn = /* @__PURE__ */ new Kn(), Xn = /* @__PURE__ */ new q(), Zn = /* @__PURE__ */ new q(), Qn = /* @__PURE__ */ new q(), $n = /* @__PURE__ */ new q(), er = /* @__PURE__ */ new q(), tr = /* @__PURE__ */ new q(), nr = /* @__PURE__ */ new q(), rr = /* @__PURE__ */ new q(), ir = /* @__PURE__ */ new q(), ar = /* @__PURE__ */ new q();
function or(e, t, n, r, i) {
	for (let a = 0, o = e.length - 3; a <= o; a += 3) {
		ar.fromArray(e, a);
		let o = i.x * Math.abs(ar.x) + i.y * Math.abs(ar.y) + i.z * Math.abs(ar.z), s = t.dot(ar), c = n.dot(ar), l = r.dot(ar);
		if (Math.max(-Math.max(s, c, l), Math.min(s, c, l)) > o) return !1;
	}
	return !0;
}
var sr = /* @__PURE__ */ new q(), cr = /* @__PURE__ */ new K(), lr = 0, ur = class extends Qe {
	constructor(e, t, n = !1) {
		if (super(), Array.isArray(e)) throw TypeError("THREE.BufferAttribute: array should be a Typed Array.");
		this.isBufferAttribute = !0, Object.defineProperty(this, "id", { value: lr++ }), this.name = "", this.array = e, this.itemSize = t, this.count = e === void 0 ? 0 : e.length / t, this.normalized = n, this.usage = Re, this.updateRanges = [], this.gpuType = h, this.version = 0;
	}
	onUploadCallback() {}
	set needsUpdate(e) {
		e === !0 && this.version++;
	...
	applyMatrix3(e) {
		if (this.itemSize === 2) for (let t = 0, n = this.count; t < n; t++) cr.fromBufferAttribute(this, t), cr.applyMatrix3(e), this.setXY(t, cr.x, cr.y);
		else if (this.itemSize === 3) for (let t = 0, n = this.count; t < n; t++) sr.fromBufferAttribute(this, t), sr.applyMatrix3(e), this.setXYZ(t, sr.x, sr.y, sr.z);
		return this;
	}
	applyMatrix4(e) {
		for (let t = 0, n = this.count; t < n; t++) sr.fromBufferAttribute(this, t), sr.applyMatrix4(e), this.setXYZ(t, sr.x, sr.y, sr.z);
		return this;
	}
	applyNormalMatrix(e) {
	...
	setXYZW(e, t, n, r, i) {
		return e *= this.itemSize, this.normalized && (t = Ct(t, this.array), n = Ct(n, this.array), r = Ct(r, this.array), i = Ct(i, this.array)), this.array[e + 0] = t, this.array[e + 1] = n, this.array[e + 2] = r, this.array[e + 3] = i, this;
	}
	onUpload(e) {
...
}, pr = /* @__PURE__ */ new Kn(), mr = /* @__PURE__ */ new q(), hr = /* @__PURE__ */ new q(), gr = class {
	...
	setFromPoints(e, t) {
		let n = this.center;
		t === void 0 ? pr.setFromPoints(e).getCenter(n) : n.copy(t);
		let r = 0;
	...
	expandByPoint(e) {
		...
		if (t > this.radius * this.radius) {
			...
			this.center.addScaledVector(mr, n / e), this.radius += n;
		}
		return this;
	}
	union(e) {
		return e.isEmpty() ? this : this.isEmpty() ? (this.copy(e), this) : (this.center.equals(e.center) === !0 ? this.radius = Math.max(this.radius, e.radius) : (hr.subVectors(e.center, this.center).setLength(e.radius), this.expandByPoint(mr.copy(e.center).add(hr)), this.expandByPoint(mr.copy(e.center).sub(hr))), this);
	}
	equals(e) {
...
}, _r = 0, vr = /* @__PURE__ */ new qt(), yr = /* @__PURE__ */ new xn(), br = /* @__PURE__ */ new q(), xr = /* @__PURE__ */ new Kn(), Sr = /* @__PURE__ */ new Kn(), Cr = /* @__PURE__ */ new q(), wr = class e extends Qe {
	constructor() {
		super(), this.isBufferGeometry = !0, Object.defineProperty(this, "id", { value: _r++ }), this.uuid = rt(), this.name = "", this.type = "BufferGeometry", this.index = null, this.indirect = null, this.indirectOffset = 0, this.attributes = {}, this.morphAttributes = {}, this.morphTargetsRelative = !1, this.groups = [], this.boundingBox = null, this.boundingSphere = null, this.drawRange = {
			start: 0,
			count: Infinity
		}, this.userData = {};
	}
	...
	setIndex(e) {
		return Array.isArray(e) ? this.index = new (Ve(e) ? fr : dr)(e, 1) : this.index = e, this;
	}
	setIndirect(e, t = 0) {
	...
	translate(e, t, n) {
		return vr.makeTranslation(e, t, n), this.applyMatrix4(vr), this;
	}
	scale(e, t, n) {
		return vr.makeScale(e, t, n), this.applyMatrix4(vr), this;
	}
	lookAt(e) {
	...
	computeBoundingBox() {
		...
		if (e && e.isGLBufferAttribute) {
			W("BufferGeometry.computeBoundingBox(): GLBufferAttribute requires a manual bounding box.", this), this.boundingBox.set(new q(-Infinity, -Infinity, -Infinity), new q(Infinity, Infinity, Infinity));
			return;
		}
		if (e !== void 0) {
			if (this.boundingBox.setFromBufferAttribute(e), t) for (let e = 0, n = t.length; e < n; e++) {
				let n = t[e];
				xr.setFromBufferAttribute(n), this.morphTargetsRelative ? (Cr.addVectors(this.boundingBox.min, xr.min), this.boundingBox.expandByPoint(Cr), Cr.addVectors(this.boundingBox.max, xr.max), this.boundingBox.expandByPoint(Cr)) : (this.boundingBox.expandByPoint(xr.min), this.boundingBox.expandByPoint(xr.max));
			}
	...
	computeBoundingSphere() {
		...
		let e = this.attributes.position, t = this.morphAttributes.position;
		if (e && e.isGLBufferAttribute) {
			W("BufferGeometry.computeBoundingSphere(): GLBufferAttribute requires a manual bounding sphere.", this), this.boundingSphere.set(new q(), Infinity);
			return;
		}
		if (e) {
			let n = this.boundingSphere.center;
			if (xr.setFromBufferAttribute(e), t) for (let e = 0, n = t.length; e < n; e++) {
				let n = t[e];
				Sr.setFromBufferAttribute(n), this.morphTargetsRelative ? (Cr.addVectors(xr.min, Sr.min), xr.expandByPoint(Cr), Cr.addVectors(xr.max, Sr.max), xr.expandByPoint(Cr)) : (xr.expandByPoint(Sr.min), xr.expandByPoint(Sr.max));
			}
			xr.getCenter(n);
			let r = 0;
			for (let t = 0, i = e.count; t < i; t++) Cr.fromBufferAttribute(e, t), r = Math.max(r, n.distanceToSquared(Cr));
			if (t) for (let i = 0, a = t.length; i < a; i++) {
				let a = t[i], o = this.morphTargetsRelative;
				for (let t = 0, i = a.count; t < i; t++) Cr.fromBufferAttribute(a, t), o && (br.fromBufferAttribute(e, t), Cr.add(br)), r = Math.max(r, n.distanceToSquared(Cr));
			}
	...
	computeTangents() {
		...
		this.hasAttribute("tangent") === !1 && this.setAttribute("tangent", new ur(new Float32Array(4 * n.count), 4));
	...
	computeVertexNormals() {
		...
		if (t !== void 0) {
			...
			if (n === void 0) n = new ur(new Float32Array(t.count * 3), 3), this.setAttribute("normal", n);
	...
	normalizeNormals() {
		...
		for (let t = 0, n = e.count; t < n; t++) Cr.fromBufferAttribute(e, t), Cr.normalize(), e.setXYZ(t, Cr.x, Cr.y, Cr.z);
	}
	toNonIndexed() {
		function t(e, t) {
...
}, Tr = 0, Er = class extends Qe {
	constructor() {
		super(), this.isMaterial = !0, Object.defineProperty(this, "id", { value: Tr++ }), this.uuid = rt(), this.name = "", this.type = "Material", this.blending = 1, this.side = 0, this.vertexColors = !1, this.opacity = 1, this.transparent = !1, this.alphaHash = !1, this.blendSrc = 204, this.blendDst = 205, this.blendEquation = 100, this.blendSrcAlpha = null, this.blendDstAlpha = null, this.blendEquationAlpha = null, this.blendColor = new X(0, 0, 0), this.blendAlpha = 0, this.depthFunc = 3, this.depthTest = !0, this.depthWrite = !0, this.stencilWriteMask = 255, this.stencilFunc = 519, this.stencilRef = 0, this.stencilFuncMask = 255, this.stencilFail = Le, this.stencilZFail = Le, this.stencilZPass = Le, this.stencilWrite = !1, this.clippingPlanes = null, this.clipIntersection = !1, this.clipShadows = !1, this.shadowSide = null, this.colorWrite = !0, this.precision = null, this.polygonOffset = !1, this.polygonOffsetFactor = 0, this.polygonOffsetUnits = 0, this.dithering = !1, this.alphaToCoverage = !1, this.premultipliedAlpha = !1, this.forceSinglePass = !1, this.allowOverride = !0, this.visible = !0, this.toneMapped = !0, this.userData = {}, this.version = 0, this._alphaTest = 0;
	}
	get alphaTest() {
...
}, Dr = /* @__PURE__ */ new q(), Or = /* @__PURE__ */ new q(), kr = /* @__PURE__ */ new q(), Ar = /* @__PURE__ */ new q(), jr = /* @__PURE__ */ new q(), Mr = /* @__PURE__ */ new q(), Nr = /* @__PURE__ */ new q(), Pr = class {
...
}, Ir = /* @__PURE__ */ new qt(), Lr = /* @__PURE__ */ new Pr(), Rr = /* @__PURE__ */ new gr(), zr = /* @__PURE__ */ new q(), Br = /* @__PURE__ */ new q(), Vr = /* @__PURE__ */ new q(), Hr = /* @__PURE__ */ new q(), Ur = /* @__PURE__ */ new q(), Wr = /* @__PURE__ */ new q(), Gr = /* @__PURE__ */ new q(), Kr = /* @__PURE__ */ new q(), qr = class extends xn {
...
function Yr(e, t, n, r, i, a, o, s, c, l) {
	...
	if (u) {
		let e = new q();
		Gn.getBarycoord(Gr, Br, Vr, Hr, e), i && (u.uv = Gn.getInterpolatedAttribute(i, s, c, l, e, new K())), a && (u.uv1 = Gn.getInterpolatedAttribute(a, s, c, l, e, new K())), o && (u.normal = Gn.getInterpolatedAttribute(o, s, c, l, e, new q()), u.normal.dot(r.direction) > 0 && u.normal.multiplyScalar(-1));
		let t = {
			a: s,
			b: c,
			c: l,
		...
		Gn.getNormal(Br, Vr, Hr, t.normal), u.face = t, u.barycoord = e;
	}
	return u;
}
var Xr = class extends Vt {
...
}, Qr = /* @__PURE__ */ new qt(), $r = /* @__PURE__ */ new qt(), ei = [], ti = /* @__PURE__ */ new Kn(), ni = /* @__PURE__ */ new qt(), ri = /* @__PURE__ */ new qr(), ii = /* @__PURE__ */ new gr(), ai = class extends qr {
	constructor(e, t, n) {
		super(e, t), this.isInstancedMesh = !0, this.instanceMatrix = new Zr(new Float32Array(n * 16), 16), this.previousInstanceMatrix = null, this.instanceColor = null, this.morphTexture = null, this.count = n, this.boundingBox = null, this.boundingSphere = null;
	...
	computeBoundingBox() {
		...
		for (let n = 0; n < t; n++) this.getMatrixAt(n, Qr), ti.copy(e.boundingBox).applyMatrix4(Qr), this.boundingBox.union(ti);
	}
	computeBoundingSphere() {
		let e = this.geometry, t = this.count;
		this.boundingSphere === null && (this.boundingSphere = new gr()), e.boundingSphere === null && e.computeBoundingSphere(), this.boundingSphere.makeEmpty();
		for (let n = 0; n < t; n++) this.getMatrixAt(n, Qr), ii.copy(e.boundingSphere).applyMatrix4(Qr), this.boundingSphere.union(ii);
	}
	copy(e, t) {
	...
	raycast(e, t) {
		...
		if (ri.geometry = this.geometry, ri.material = this.material, ri.material !== void 0 && (this.boundingSphere === null && this.computeBoundingSphere(), ii.copy(this.boundingSphere), ii.applyMatrix4(n), e.ray.intersectsSphere(ii) !== !1)) for (let i = 0; i < r; i++) {
			this.getMatrixAt(i, Qr), $r.multiplyMatrices(n, Qr), ri.matrixWorld = $r, ri.raycast(e, ei);
			for (let e = 0, n = ei.length; e < n; e++) {
				let n = ei[e];
	...
	setColorAt(e, t) {
		return this.instanceColor === null && (this.instanceColor = new Zr(new Float32Array(this.instanceMatrix.count * 3).fill(1), 3)), t.toArray(this.instanceColor.array, e * 3), this;
	}
	setMatrixAt(e, t) {
	...
	setMorphAt(e, t) {
		...
		this.morphTexture === null && (this.morphTexture = new Xr(new Float32Array(r * this.count), r, this.count, D, h));
...
}, oi = /* @__PURE__ */ new q(), si = /* @__PURE__ */ new q(), ci = /* @__PURE__ */ new J(), li = class {
...
}, ui = /* @__PURE__ */ new gr(), di = /* @__PURE__ */ new K(.5, .5), fi = /* @__PURE__ */ new q(), pi = class {
	...
	copy(e) {
		return super.copy(e), this.source = new Lt(Object.assign({}, e.image)), this.compareFunction = e.compareFunction, this;
	}
	toJSON(e) {
		let t = super.toJSON(e);
	...
	constructor(e = 1, t = 32, n = 0, r = Math.PI * 2) {
		...
		this.setIndex(i), this.setAttribute("position", new Z(a, 3)), this.setAttribute("normal", new Z(o, 3)), this.setAttribute("uv", new Z(s, 2));
	}
	copy(e) {
		return super.copy(e), this.parameters = Object.assign({}, e.parameters), this;
	}
...
var Ti = /* @__PURE__ */ new q(), Ei = /* @__PURE__ */ new q(), Di = /* @__PURE__ */ new wi(), Oi = /* @__PURE__ */ new wi(), ki = /* @__PURE__ */ new wi(), Ai = class extends xi {
	...
	getPoint(e, t = new q()) {
		...
		let c, l;
		this.closed || o > 0 ? c = r[(o - 1) % i] : (Ei.subVectors(r[0], r[1]).add(r[0]), c = Ei);
		let u = r[o % i], d = r[(o + 1) % i];
		if (this.closed || o + 2 < i ? l = r[(o + 2) % i] : (Ti.subVectors(r[i - 1], r[i - 2]).add(r[i - 1]), l = Ti), this.curveType === "centripetal" || this.curveType === "chordal") {
			let e = this.curveType === "chordal" ? .5 : .25, t = c.distanceToSquared(u) ** +e, n = u.distanceToSquared(d) ** +e, r = d.distanceToSquared(l) ** +e;
			n < 1e-4 && (n = 1), t < 1e-4 && (t = n), r < 1e-4 && (r = n), Di.initNonuniformCatmullRom(c.x, u.x, d.x, l.x, t, n, r), Oi.initNonuniformCatmullRom(c.y, u.y, d.y, l.y, t, n, r), ki.initNonuniformCatmullRom(c.z, u.z, d.z, l.z, t, n, r);
		} else this.curveType === "catmullrom" && (Di.initCatmullRom(c.x, u.x, d.x, l.x, this.tension), Oi.initCatmullRom(c.y, u.y, d.y, l.y, this.tension), ki.initCatmullRom(c.z, u.z, d.z, l.z, this.tension));
		return n.set(Di.calc(s), Oi.calc(s), ki.calc(s)), n;
	}
	copy(e) {
...
function Bi(e, t, n, r, i) {
	return Ii(e, t) + Li(e, n) + Ri(e, r) + zi(e, i);
}
var Vi = class extends xi {
	...
	getPoint(e, t = new K()) {
		...
		return n.set(Bi(e, r.x, i.x, a.x, o.x), Bi(e, r.y, i.y, a.y, o.y)), n;
	}
	copy(e) {
	...
	getPoint(e, t = new q()) {
		let n = t, r = this.v0, i = this.v1, a = this.v2, o = this.v3;
		return n.set(Bi(e, r.x, i.x, a.x, o.x), Bi(e, r.y, i.y, a.y, o.y), Bi(e, r.z, i.z, a.z, o.z)), n;
	}
	copy(e) {
		return super.copy(e), this.v0.copy(e.v0), this.v1.copy(e.v1), this.v2.copy(e.v2), this.v3.copy(e.v3), this;
	}
	...
	getPoint(e, t = new K()) {
		...
		return n.set(Fi(e, r.x, i.x, a.x), Fi(e, r.y, i.y, a.y)), n;
	}
	copy(e) {
	...
	getPoint(e, t = new q()) {
		let n = t, r = this.v0, i = this.v1, a = this.v2;
		return n.set(Fi(e, r.x, i.x, a.x), Fi(e, r.y, i.y, a.y), Fi(e, r.z, i.z, a.z)), n;
	}
	copy(e) {
		return super.copy(e), this.v0.copy(e.v0), this.v1.copy(e.v1), this.v2.copy(e.v2), this;
	}
	...
	getPoint(e, t = new K()) {
		...
		return n.set(ji(o, s.x, c.x, l.x, u.x), ji(o, s.y, c.y, l.y, u.y)), n;
	}
	copy(e) {
		super.copy(e), this.points = [];
		for (let t = 0, n = e.points.length; t < n; t++) {
	...
	fromJSON(e) {
		...
		for (let t = 0, n = e.curves.length; t < n; t++) {
			let n = e.curves[t];
			this.curves.push(new Ji[n.type]().fromJSON(n));
		}
		return this;
	}
}, Xi = class extends Yi {
	...
	lineTo(e, t) {
		let n = new Ui(this.currentPoint.clone(), new K(e, t));
		return this.curves.push(n), this.currentPoint.set(e, t), this;
	}
	quadraticCurveTo(e, t, n, r) {
		let i = new Gi(this.currentPoint.clone(), new K(e, t), new K(n, r));
		return this.curves.push(i), this.currentPoint.set(n, r), this;
	}
	bezierCurveTo(e, t, n, r, i, a) {
		let o = new Vi(this.currentPoint.clone(), new K(e, t), new K(n, r), new K(i, a));
		return this.curves.push(o), this.currentPoint.set(i, a), this;
	}
	splineThru(e) {
		let t = new qi([this.currentPoint.clone()].concat(e));
...
function Qi(e, t, n = 2) {
	let r = t && t.length, i = r ? t[0] * n : e.length, a = $i(e, 0, i, n, !0), o = [];
...
function $i(e, t, n, r, i) {
	let a;
	if (i === Aa(e, t, n, r) > 0) for (let i = t; i < n; i += r) a = Da(i / r | 0, e[i], e[i + 1], a);
	else for (let i = n - r; i >= t; i -= r) a = Da(i / r | 0, e[i], e[i + 1], a);
	return a && ya(a, a.next) && (Oa(a), a = a.next), a;
}
function ea(e, t) {
	if (!e) return e;
	t ||= e;
	let n = e, r;
	do
		if (r = !1, !n.steiner && (ya(n, n.next) || va(n.prev, n, n.next) === 0)) {
			if (Oa(n), n = t = n.prev, n === n.next) break;
			r = !0;
		} else n = n.next;
	while (r || n !== t);
	return t;
...
function ta(e, t, n, r, i, a, o) {
	...
	for (; e.prev !== e.next;) {
		...
		if (a ? ra(e, r, i, a) : na(e)) {
			t.push(c.i, e.i, l.i), Oa(e), e = l.next, s = l.next;
			continue;
		}
		if (e = l, e === s) {
			o ? o === 1 ? (e = ia(ea(e), t), ta(e, t, n, r, i, a, 2)) : o === 2 && aa(e, t, n, r, i, a) : ta(ea(e), t, n, r, i, a, 1);
			break;
		}
	}
}
...
function ra(e, t, n, r) {
	...
	if (va(i, a, o) >= 0) return !1;
	let s = i.x, c = a.x, l = o.x, u = i.y, d = a.y, f = o.y, p = Math.min(s, c, l), m = Math.min(u, d, f), h = Math.max(s, c, l), g = Math.max(u, d, f), _ = pa(p, m, t, n, r), v = pa(h, g, t, n, r), y = e.prevZ, b = e.nextZ;
	for (; y && y.z >= _ && b && b.z <= v;) {
		if (y.x >= p && y.x <= h && y.y >= m && y.y <= g && y !== i && y !== o && ga(s, u, c, d, l, f, y.x, y.y) && va(y.prev, y, y.next) >= 0 || (y = y.prevZ, b.x >= p && b.x <= h && b.y >= m && b.y <= g && b !== i && b !== o && ga(s, u, c, d, l, f, b.x, b.y) && va(b.prev, b, b.next) >= 0)) return !1;
		b = b.nextZ;
	}
	for (; y && y.z >= _;) {
		if (y.x >= p && y.x <= h && y.y >= m && y.y <= g && y !== i && y !== o && ga(s, u, c, d, l, f, y.x, y.y) && va(y.prev, y, y.next) >= 0) return !1;
		y = y.prevZ;
	}
	for (; b && b.z <= v;) {
		if (b.x >= p && b.x <= h && b.y >= m && b.y <= g && b !== i && b !== o && ga(s, u, c, d, l, f, b.x, b.y) && va(b.prev, b, b.next) >= 0) return !1;
		b = b.nextZ;
	}
	return !0;
}
function ia(e, t) {
	...
	do {
		...
		!ya(r, i) && ba(r, n, n.next, i) && wa(r, i) && wa(i, r) && (t.push(r.i, n.i, i.i), Oa(n), Oa(n.next), n = e = i), n = n.next;
	} while (n !== e);
	return ea(n);
}
function aa(e, t, n, r, i, a) {
	...
	do {
		...
		for (; e !== o.prev;) {
			if (o.i !== e.i && _a(o, e)) {
				let s = Ea(o, e);
				o = ea(o, o.next), s = ea(s, s.next), ta(o, t, n, r, i, a, 0), ta(s, t, n, r, i, a, 0);
				return;
			}
			e = e.next;
		}
...
function oa(e, t, n, r) {
	...
	for (let n = 0, a = t.length; n < a; n++) {
		let o = $i(e, t[n] * r, n < a - 1 ? t[n + 1] * r : e.length, r, !1);
		o === o.next && (o.steiner = !0), i.push(ma(o));
	}
	i.sort(sa);
	for (let e = 0; e < i.length; e++) n = ca(i[e], n);
	return n;
}
function sa(e, t) {
	let n = e.x - t.x;
...
function ca(e, t) {
	...
	if (!n) return t;
	let r = Ea(n, e);
	return ea(r, r.next), ea(n, n.next);
}
function la(e, t) {
	let n = t, r = e.x, i = e.y, a = -Infinity, o;
	if (ya(e, n)) return n;
	do {
		if (ya(e, n.next)) return n.next;
	...
	n = o;
	do {
		if (r >= n.x && n.x >= c && r !== n.x && ha(i < l ? r : a, i, c, l, i < l ? a : r, i, n.x, n.y)) {
			let t = Math.abs(i - n.y) / (r - n.x);
			wa(n, e) && (t < u || t === u && (n.x > o.x || n.x === o.x && ua(o, n))) && (o = n, u = t);
		}
		n = n.next;
	} while (n !== s);
	return o;
...
function da(e, t, n, r) {
	let i = e;
	do
		i.z === 0 && (i.z = pa(i.x, i.y, t, n, r)), i.prevZ = i.prev, i.nextZ = i.next, i = i.next;
	while (i !== e);
	i.prevZ.nextZ = null, i.prevZ = null, fa(i);
}
function fa(e) {
	let t, n = 1;
	do {
...
function ga(e, t, n, r, i, a, o, s) {
	return !(e === o && t === s) && ha(e, t, n, r, i, a, o, s);
}
function _a(e, t) {
	return e.next.i !== t.i && e.prev.i !== t.i && !Ca(e, t) && (wa(e, t) && wa(t, e) && Ta(e, t) && (va(e.prev, e, t.prev) || va(e, t.prev, t)) || ya(e, t) && va(e.prev, e, e.next) > 0 && va(t.prev, t, t.next) > 0);
}
function va(e, t, n) {
...
function ba(e, t, n, r) {
	let i = Sa(va(e, t, n)), a = Sa(va(e, t, r)), o = Sa(va(n, r, e)), s = Sa(va(n, r, t));
	return !!(i !== a && o !== s || i === 0 && xa(e, n, t) || a === 0 && xa(e, r, t) || o === 0 && xa(n, e, r) || s === 0 && xa(n, t, r));
}
function xa(e, t, n) {
...
function Ca(e, t) {
	let n = e;
	do {
		if (n.i !== e.i && n.next.i !== e.i && n.i !== t.i && n.next.i !== t.i && ba(n, n.next, e, t)) return !0;
		n = n.next;
	} while (n !== e);
	return !1;
}
...
function Ea(e, t) {
	let n = ka(e.i, e.x, e.y), r = ka(t.i, t.x, t.y), i = e.next, a = t.prev;
...
var ja = class {
	...
	static triangulateShape(e, t) {
		...
		let a = e.length;
		t.forEach(Na);
		for (let e = 0; e < t.length; e++) r.push(a), a += t[e].length, Pa(n, t[e]);
		let o = ja.triangulate(n, r);
...
var Fa = class e extends wr {
	constructor(e = new Zi([
		new K(.5, .5),
		new K(-.5, .5),
		new K(-.5, -.5),
		new K(.5, -.5)
		...
		this.setAttribute("position", new Z(r, 3)), this.setAttribute("uv", new Z(i, 2)), this.computeVertexNormals();
		function a(e) {
			let a = [], o = t.curveSegments === void 0 ? 12 : t.curveSegments, s = t.steps === void 0 ? 1 : t.steps, c = t.depth === void 0 ? 1 : t.depth, l = t.bevelEnabled === void 0 ? !0 : t.bevelEnabled, u = t.bevelThickness === void 0 ? .2 : t.bevelThickness, d = t.bevelSize === void 0 ? u - .1 : t.bevelSize, f = t.bevelOffset === void 0 ? 0 : t.bevelOffset, p = t.bevelSegments === void 0 ? 3 : t.bevelSegments, m = t.extrudePath, h = t.UVGenerator === void 0 ? Ia : t.UVGenerator, g, _ = !1, v, y, b, x;
			if (m) {
				g = m.getSpacedPoints(s), _ = !0, l = !1;
				let e = m.isCatmullRomCurve3 ? m.closed : !1;
				v = m.computeFrenetFrames(s, e), y = new q(), b = new q(), x = new q();
			}
			l || (p = 0, u = 0, d = 0, f = 0);
			...
			if (!Ma.isClockWise(C)) {
				...
				for (let e = 0, t = w.length; e < t; e++) {
					let t = w[e];
					Ma.isClockWise(t) && (w[e] = t.reverse());
				}
			}
			function T(e) {
				let t = e[0];
			...
			function O(e, t, n) {
				return t || W("ExtrudeGeometry: vec does not exist"), e.clone().addScaledVector(t, n);
			}
			let k = C.length;
			function A(e, t, n) {
			...
			if (p === 0) N = Ma.triangulateShape(D, w);
				...
				N = Ma.triangulateShape(e, t);
			}
			let P = N.length, ne = d + f;
			for (let e = 0; e < k; e++) {
				let t = l ? O(C[e], te[e], ne) : C[e];
	...
	static fromJSON(t, n) {
		...
		return i !== void 0 && (t.options.extrudePath = new Ji[i.type]().fromJSON(i)), new e(r, t.options);
	}
}, Ia = {
...
var Ra = class e extends wr {
	...
	constructor(e = .5, t = 1, n = 32, r = 1, i = 0, a = Math.PI * 2) {
		...
		this.setIndex(o), this.setAttribute("position", new Z(s, 3)), this.setAttribute("normal", new Z(c, 3)), this.setAttribute("uv", new Z(l, 2));
	}
	copy(e) {
		return super.copy(e), this.parameters = Object.assign({}, e.parameters), this;
	}
	...
	constructor(e = new Zi([
		...
		this.setIndex(n), this.setAttribute("position", new Z(r, 3)), this.setAttribute("normal", new Z(i, 3)), this.setAttribute("uv", new Z(a, 2));
		function c(e) {
			let o = r.length / 3, c = e.extractPoints(t), l = c.shape, u = c.holes;
			Ma.isClockWise(l) === !1 && (l = l.reverse());
			for (let e = 0, t = u.length; e < t; e++) {
				let t = u[e];
				Ma.isClockWise(t) === !0 && (u[e] = t.reverse());
			}
			let d = Ma.triangulateShape(l, u);
			for (let e = 0, t = u.length; e < t; e++) {
				let t = u[e];
				l = l.concat(t);
			}
...
function Wa(e) {
	...
	for (let n in e) {
		...
		for (let r in e[n]) {
			let i = e[n][r];
			if (Ka(i)) i.isRenderTargetTexture ? (U("UniformsUtils: Textures of render targets cannot be cloned via cloneUniforms() or mergeUniforms()."), t[n][r] = null) : t[n][r] = i.clone();
			else if (Array.isArray(i)) if (Ka(i[0])) {
				let e = [];
...
var Ya = {
	...
	constructor(e) {
		super(), this.isShaderMaterial = !0, this.type = "ShaderMaterial", this.defines = {}, this.uniforms = {}, this.uniformsGroups = [], this.vertexShader = Xa, this.fragmentShader = Za, this.linewidth = 1, this.wireframe = !1, this.wireframeLinewidth = 1, this.fog = !1, this.lights = !1, this.clipping = !1, this.forceSinglePass = !0, this.extensions = {
			clipCullDistance: !1,
			multiDraw: !1
	...
	constructor(e) {
		super(), this.isMeshDepthMaterial = !0, this.type = "MeshDepthMaterial", this.depthPacking = Me, this.map = null, this.alphaMap = null, this.displacementMap = null, this.displacementScale = 1, this.displacementBias = 0, this.wireframe = !1, this.wireframeLinewidth = 1, this.setValues(e);
	}
	copy(e) {
...
var oo = class {
	...
	getInterpolation() {
		switch (this.createInterpolant) {
			...
			case this.InterpolantFactoryMethodLinear: return ke;
			case this.InterpolantFactoryMethodSmooth: return B;
			case this.InterpolantFactoryMethodBezier: return Ae;
		}
	}
	getValueSize() {
	...
	validate() {
		...
		if (r !== void 0 && He(r)) for (let t = 0, n = r.length; t !== n; ++t) {
			let n = r[t];
			if (isNaN(n)) {
...
fo.prototype.ValueTypeName = "", fo.prototype.TimeBufferType = Float32Array, fo.prototype.ValueBufferType = Float32Array, fo.prototype.DefaultInterpolation = ke;
var po = class extends fo {
	constructor(e, t, n) {
		super(e, t, n);
	}
};
po.prototype.ValueTypeName = "bool", po.prototype.ValueBufferType = Array, po.prototype.DefaultInterpolation = z, po.prototype.InterpolantFactoryMethodLinear = void 0, po.prototype.InterpolantFactoryMethodSmooth = void 0;
...
vo.prototype.ValueTypeName = "string", vo.prototype.ValueBufferType = Array, vo.prototype.DefaultInterpolation = z, vo.prototype.InterpolantFactoryMethodLinear = void 0, vo.prototype.InterpolantFactoryMethodSmooth = void 0;
...
var bo = {
	...
	files: {},
	add: function(e, t) {
		this.enabled !== !1 && (xo(e) || (this.files[e] = t));
	},
	get: function(e) {
		if (this.enabled !== !1 && !xo(e)) return this.files[e];
	},
	remove: function(e) {
		delete this.files[e];
	},
...
var So = /* @__PURE__ */ new class {
	...
	constructor(e) {
		this.manager = e === void 0 ? So : e, this.crossOrigin = "anonymous", this.withCredentials = !1, this.path = "", this.resourcePath = "", this.requestHeader = {}, typeof __THREE_DEVTOOLS__ < "u" && __THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe", { detail: this }));
	}
	load() {}
	loadAsync(e, t) {
		let n = this;
...
var wo = /* @__PURE__ */ new WeakMap(), To = class extends Co {
	constructor(e) {
		super(e);
	}
	load(e, t, n, r) {
		this.path !== void 0 && (e = this.path + e), e = this.manager.resolveURL(e);
		let i = this, a = bo.get(`image:${e}`);
		if (a !== void 0) {
		...
		function s() {
			...
			wo.delete(this), i.manager.itemEnd(e);
		}
		function c(t) {
			l(), r && r(t), bo.remove(`image:${e}`);
			let n = wo.get(this) || [];
			for (let e = 0; e < n.length; e++) {
				let r = n[e];
				r.onError && r.onError(t);
			}
			wo.delete(this), i.manager.itemError(e), i.manager.itemEnd(e);
		}
		function l() {
			o.removeEventListener("load", s, !1), o.removeEventListener("error", c, !1);
		}
		return o.addEventListener("load", s, !1), o.addEventListener("error", c, !1), e.slice(0, 5) !== "data:" && this.crossOrigin !== void 0 && (o.crossOrigin = this.crossOrigin), bo.add(`image:${e}`, o), i.manager.itemStart(e), o.src = e, o;
	}
}, Eo = class extends Co {
	constructor(e) {
		super(e);
	...
	load(e, t, n, r) {
		let i = new Vt(), a = new To(this.manager);
	...
	constructor(e, t, n) {
		super(e, n), this.isHemisphereLight = !0, this.type = "HemisphereLight", this.position.copy(xn.DEFAULT_UP), this.updateMatrix(), this.groundColor = new X(t);
	}
	copy(e, t) {
...
}, ko = /* @__PURE__ */ new qt(), Ao = /* @__PURE__ */ new q(), jo = /* @__PURE__ */ new q(), Mo = class {
	constructor(e) {
		this.camera = e, this.intensity = 1, this.bias = 0, this.biasNode = null, this.normalBias = 0, this.radius = 1, this.blurSamples = 8, this.mapSize = new K(512, 512), this.mapType = l, this.map = null, this.mapPass = null, this.matrix = new qt(), this.autoUpdate = !0, this.needsUpdate = !1, this._frustum = new pi(), this._frameExtents = new K(1, 1), this._viewportCount = 1, this._viewports = [new Ht(0, 0, 1, 1)];
	}
	getViewportCount() {
	...
	updateMatrices(e) {
		...
		Ao.setFromMatrixPosition(e.matrixWorld), t.position.copy(Ao), jo.setFromMatrixPosition(e.target.matrixWorld), t.lookAt(jo), t.updateMatrixWorld(), ko.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse), this._frustum.setFromProjectionMatrix(ko, t.coordinateSystem, t.reversedDepth), t.coordinateSystem === 2001 || t.reversedDepth ? n.set(.5, 0, 0, .5, 0, .5, 0, .5, 0, 0, 1, 0, 0, 0, 0, 1) : n.set(.5, 0, 0, .5, 0, .5, 0, .5, 0, 0, .5, .5, 0, 0, 0, 1), n.multiply(ko);
	}
	getViewport(e) {
...
}, No = /* @__PURE__ */ new q(), Po = /* @__PURE__ */ new Tt(), Fo = /* @__PURE__ */ new q(), Io = class extends xn {
	constructor() {
		super(), this.isCamera = !0, this.type = "Camera", this.matrixWorldInverse = new qt(), this.projectionMatrix = new qt(), this.projectionMatrixInverse = new qt(), this.coordinateSystem = Be, this._reversedDepth = !1;
	}
	get reversedDepth() {
	...
	updateMatrixWorld(e) {
		super.updateMatrixWorld(e), this.matrixWorld.decompose(No, Po, Fo), Fo.x === 1 && Fo.y === 1 && Fo.z === 1 ? this.matrixWorldInverse.copy(this.matrixWorld).invert() : this.matrixWorldInverse.compose(No, Po, Fo.set(1, 1, 1)).invert();
	}
	updateWorldMatrix(e, t) {
		super.updateWorldMatrix(e, t), this.matrixWorld.decompose(No, Po, Fo), Fo.x === 1 && Fo.y === 1 && Fo.z === 1 ? this.matrixWorldInverse.copy(this.matrixWorld).invert() : this.matrixWorldInverse.compose(No, Po, Fo.set(1, 1, 1)).invert();
	}
	clone() {
		return new this.constructor().copy(this);
	}
}, Lo = /* @__PURE__ */ new q(), Ro = /* @__PURE__ */ new K(), zo = /* @__PURE__ */ new K(), Bo = class extends Io {
	...
	getFocalLength() {
		let e = Math.tan(tt * .5 * this.fov);
		return .5 * this.getFilmHeight() / e;
	}
	getEffectiveFOV() {
		return nt * 2 * Math.atan(Math.tan(tt * .5 * this.fov) / this.zoom);
	}
	getFilmWidth() {
	...
	getViewBounds(e, t, n) {
		Lo.set(-1, -1, .5).applyMatrix4(this.projectionMatrixInverse), t.set(Lo.x, Lo.y).multiplyScalar(-e / Lo.z), Lo.set(1, 1, .5).applyMatrix4(this.projectionMatrixInverse), n.set(Lo.x, Lo.y).multiplyScalar(-e / Lo.z);
	}
	getViewSize(e, t) {
		return this.getViewBounds(e, Ro, zo), t.subVectors(zo, Ro);
	}
	...
	updateProjectionMatrix() {
		let e = this.near, t = e * Math.tan(tt * .5 * this.fov) / this.zoom, n = 2 * t, r = this.aspect * n, i = -.5 * r, a = this.view;
	...
	constructor() {
		super(new Bo(90, 1, .5, 500)), this.isPointLightShadow = !0;
	}
}, Ho = class extends Do {
	...
	constructor(e, t) {
		super(e, t), this.isDirectionalLight = !0, this.type = "DirectionalLight", this.position.copy(xn.DEFAULT_UP), this.updateMatrix(), this.target = new xn(), this.shadow = new Wo();
	}
	dispose() {
		super.dispose(), this.shadow.dispose();
	}
...
}, qo = -90, Jo = 1, Yo = class extends xn {
	constructor(e, t, n) {
		super(), this.type = "CubeCamera", this.renderTarget = n, this.coordinateSystem = null, this.activeMipmapLevel = 0;
		let r = new Bo(qo, Jo, e, t);
		r.layers = this.layers, this.add(r);
		let i = new Bo(qo, Jo, e, t);
		i.layers = this.layers, this.add(i);
		let a = new Bo(qo, Jo, e, t);
		a.layers = this.layers, this.add(a);
		let o = new Bo(qo, Jo, e, t);
		o.layers = this.layers, this.add(o);
		let s = new Bo(qo, Jo, e, t);
		s.layers = this.layers, this.add(s);
		let c = new Bo(qo, Jo, e, t);
	...
	connect(e) {
		this._document = e, e.hidden !== void 0 && (this._pageVisibilityHandler = Qo.bind(this), e.addEventListener("visibilitychange", this._pageVisibilityHandler, !1));
	}
	disconnect() {
...
var $o = "\\[\\]\\.:\\/", es = /* @__PURE__ */ RegExp("[\\[\\]\\.:\\/]", "g"), ts = "[^\\[\\]\\.:\\/]", ns = "[^" + $o.replace("\\.", "") + "]", rs = /* @__PURE__ */ "((?:WC+[\\/:])*)".replace("WC", ts), is = /* @__PURE__ */ "(WCOD+)?".replace("WCOD", ns), as = /* @__PURE__ */ "(?:\\.(WC+)(?:\\[(.+)\\])?)?".replace("WC", ts), os = /* @__PURE__ */ "\\.(WC+)(?:\\[(.+)\\])?".replace("WC", ts), ss = RegExp("^" + rs + is + as + os + "$"), cs = [
	"material",
	"materials",
	"bones",
	"map"
...
var ds = class e {
...
}, fs = /* @__PURE__ */ new qt(), ps = class {
	constructor(e, t, n = 0, r = Infinity) {
		this.ray = new Pr(e, t), this.near = n, this.far = r, this.camera = null, this.layers = new an(), this.params = {
			Mesh: {},
			Line: { threshold: 1 },
			LOD: {},
			Points: { threshold: 1 },
	...
	setFromCamera(e, t) {
		t.isPerspectiveCamera ? (this.ray.origin.setFromMatrixPosition(t.matrixWorld), this.ray.direction.set(e.x, e.y, .5).unproject(t).sub(this.ray.origin).normalize(), this.camera = t) : t.isOrthographicCamera ? (this.ray.origin.set(e.x, e.y, (t.near + t.far) / (t.near - t.far)).unproject(t), this.ray.direction.set(0, 0, -1).transformDirection(t.matrixWorld), this.camera = t) : W("Raycaster: Unsupported camera type: " + t.type);
	}
	setFromXRController(e) {
		return fs.identity().extractRotation(e.matrixWorld), this.ray.origin.setFromMatrixPosition(e.matrixWorld), this.ray.direction.set(0, 0, -1).applyMatrix4(fs), this;
	}
	intersectObject(e, t = !0, n = []) {
		return hs(e, this, n, t), n.sort(ms), n;
	}
...
function hs(e, t, n, r) {
	...
	if (e.layers.test(t.layers) && e.raycast(t, n) === !1 && (i = !1), i === !0 && r === !0) {
		let r = e.children;
		for (let e = 0, i = r.length; e < i; e++) hs(r[e], t, n, !0);
	}
}
(class e {
	static {
...
function gs(e, t, n, r) {
	...
	switch (n) {
		...
		case te:
		case N: return Math.floor((e + 3) / 4) * Math.floor((t + 3) / 4) * 16;
		case ne:
		case ie: return Math.max(e, 16) * Math.max(t, 8) / 4;
		case P:
		...
		case le: return Math.floor((e + 3) / 4) * Math.floor((t + 3) / 4) * 16;
		case ue: return Math.floor((e + 4) / 5) * Math.floor((t + 3) / 4) * 16;
		case de: return Math.floor((e + 4) / 5) * Math.floor((t + 4) / 5) * 16;
		case fe: return Math.floor((e + 5) / 6) * Math.floor((t + 4) / 5) * 16;
		case pe: return Math.floor((e + 5) / 6) * Math.floor((t + 5) / 6) * 16;
		case me: return Math.floor((e + 7) / 8) * Math.floor((t + 4) / 5) * 16;
		case he: return Math.floor((e + 7) / 8) * Math.floor((t + 5) / 6) * 16;
		case ge: return Math.floor((e + 7) / 8) * Math.floor((t + 7) / 8) * 16;
		case _e: return Math.floor((e + 9) / 10) * Math.floor((t + 4) / 5) * 16;
		case ve: return Math.floor((e + 9) / 10) * Math.floor((t + 5) / 6) * 16;
		case ye: return Math.floor((e + 9) / 10) * Math.floor((t + 7) / 8) * 16;
		case be: return Math.floor((e + 9) / 10) * Math.floor((t + 9) / 10) * 16;
		case xe: return Math.floor((e + 11) / 12) * Math.floor((t + 9) / 10) * 16;
		case Se: return Math.floor((e + 11) / 12) * Math.floor((t + 11) / 12) * 16;
		case Ce:
		case we:
		case Te: return Math.ceil(e / 4) * Math.ceil(t / 4) * 16;
		case Ee:
		case De: return Math.ceil(e / 4) * Math.ceil(t / 4) * 8;
		case R:
...
typeof __THREE_DEVTOOLS__ < "u" && __THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register", { detail: { revision: "184" } })), typeof window < "u" && (window.__THREE__ ? U("WARNING: Multiple instances of Three.js being imported.") : window.__THREE__ = "184");
//#endregion
...
var Q = {
	...
	points: {
		uniforms: /* @__PURE__ */ Ga([$.points, $.fog]),
	...
	depth: {
		uniforms: /* @__PURE__ */ Ga([$.common, $.displacementmap]),
	...
	sprite: {
		uniforms: /* @__PURE__ */ Ga([$.sprite, $.fog]),
...
bs.physical = {
	uniforms: /* @__PURE__ */ Ga([bs.standard.uniforms, {
		clearcoat: { value: 0 },
...
var xs = {
	...
	b: 0,
	g: 0
}, Ss = /* @__PURE__ */ new qt(), Cs = /* @__PURE__ */ new J();
...
function ws(e, t, n, r, i, a) {
	...
	function h(t, n) {
		let i = p(n);
		i && (i.isCubeTexture || i.mapping === 306) ? (l === void 0 && (l = new qr(new vi(1, 1, 1), new Qa({
			name: "BackgroundCubeMaterial",
			uniforms: Wa(bs.backgroundCube.uniforms),
		...
		} }), r.update(l)), l.material.uniforms.envMap.value = i, l.material.uniforms.backgroundBlurriness.value = n.backgroundBlurriness, l.material.uniforms.backgroundIntensity.value = n.backgroundIntensity, l.material.uniforms.backgroundRotation.value.setFromMatrix4(Ss.makeRotationFromEuler(n.backgroundRotation)).transpose(), i.isCubeTexture && i.isRenderTargetTexture === !1 && l.material.uniforms.backgroundRotation.value.premultiply(Cs), l.material.toneMapped = Y.getTransfer(i.colorSpace) !== Ie, (u !== i || d !== i.version || f !== e.toneMapping) && (l.material.needsUpdate = !0, u = i, d = i.version, f = e.toneMapping), l.layers.enableAll(), t.unshift(l, l.geometry, l.material, 0, 0, null)) : i && i.isTexture && (c === void 0 && (c = new qr(new Ra(2, 2), new Qa({
			name: "BackgroundMaterial",
			uniforms: Wa(bs.background.uniforms),
	...
	function g(t, r) {
		t.getRGB(xs, Ja(e)), n.buffers.color.setClear(xs.r, xs.g, xs.b, r, a);
	}
	function _() {
...
function Os(e) {
	let t = this, n = null, r = 0, i = !1, a = !1, o = new li(), s = new J(), c = {
		value: null,
		needsUpdate: !1
	};
...
var ks = 4, As = [
	...
	.526,
	.582
], js = 20, Ms = 256, Ns = /* @__PURE__ */ new Uo(), Ps = /* @__PURE__ */ new X(), Fs = null, Is = 0, Ls = 0, Rs = !1, zs = /* @__PURE__ */ new q(), Bs = class {
	constructor(e) {
		this._renderer = e, this._pingPongRenderTarget = null, this._lodMax = 0, this._cubeSize = 0, this._sizeLods = [], this._sigmas = [], this._lodMeshes = [], this._backgroundBox = null, this._cubemapMaterial = null, this._equirectMaterial = null, this._blurMaterial = null, this._ggxMaterial = null;
	}
	fromScene(e, t = 0, n = .1, r = 100, i = {}) {
		let { size: a = 256, position: o = zs } = i;
		Fs = this._renderer.getRenderTarget(), Is = this._renderer.getActiveCubeFace(), Ls = this._renderer.getActiveMipmapLevel(), Rs = this._renderer.xr.enabled, this._renderer.xr.enabled = !1, this._setSize(a);
	...
	_cleanup(e) {
		this._renderer.setRenderTarget(Fs, Is, Ls), this._renderer.xr.enabled = Rs, e.scissorTest = !1, Us(e, 0, 0, e.width, e.height);
	}
	_fromTexture(e, t) {
		e.mapping === 301 || e.mapping === 302 ? this._setSize(e.image.length === 0 ? 16 : e.image[0].width || e.image[0].image.width) : this._setSize(e.image.width / 4), Fs = this._renderer.getRenderTarget(), Is = this._renderer.getActiveCubeFace(), Ls = this._renderer.getActiveMipmapLevel(), Rs = this._renderer.xr.enabled, this._renderer.xr.enabled = !1;
	...
	_allocateTargets() {
		...
		if (this._pingPongRenderTarget === null || this._pingPongRenderTarget.width !== e || this._pingPongRenderTarget.height !== t) {
			this._pingPongRenderTarget !== null && this._dispose(), this._pingPongRenderTarget = Hs(e, t, n);
			let { _lodMax: r } = this;
			({lodMeshes: this._lodMeshes, sizeLods: this._sizeLods, sigmas: this._sigmas} = Vs(r)), this._blurMaterial = Gs(r, e, t), this._ggxMaterial = Ws(r, e, t);
		}
		return r;
	}
	_compileMaterial(e) {
		let t = new qr(new wr(), e);
		this._renderer.compile(t, Ns);
	}
	_sceneToCubeUV(e, t, n, r, i) {
		let a = new Bo(90, 1, t, n), o = [
			1,
			-1,
			1,
			1,
		...
		c.getClearColor(Ps), c.toneMapping = 0, c.autoClear = !1, c.state.buffers.depth.getReversed() && (c.setRenderTarget(r), c.clearDepth(), c.setRenderTarget(null)), this._backgroundBox === null && (this._backgroundBox = new qr(new vi(), new Fr({
	...
	_textureToCubeUV(e, t) {
		...
		r ? (this._cubemapMaterial === null && (this._cubemapMaterial = qs()), this._cubemapMaterial.uniforms.flipEnvMap.value = e.isRenderTargetTexture === !1 ? -1 : 1) : this._equirectMaterial === null && (this._equirectMaterial = Ks());
		let i = r ? this._cubemapMaterial : this._equirectMaterial, a = this._lodMeshes[0];
		a.material = i;
		let o = i.uniforms;
		o.envMap.value = e;
		let s = this._cubeSize;
		Us(t, 0, 0, 3 * s, 2 * s), n.setRenderTarget(t), n.render(a, Ns);
	}
	_applyPMREM(e) {
	...
	_applyGGXFilter(e, t, n) {
		...
		o.material = a;
		let s = a.uniforms, c = n / (this._lodMeshes.length - 1), l = t / (this._lodMeshes.length - 1), u = Math.sqrt(c * c - l * l) * (0 + c * 1.25), { _lodMax: d } = this, f = this._sizeLods[n], p = 3 * f * (n > d - ks ? n - d + ks : 0), m = 4 * (this._cubeSize - f);
		s.envMap.value = e.texture, s.roughness.value = u, s.mipInt.value = d - t, Us(i, p, m, 3 * f, 2 * f), r.setRenderTarget(i), r.render(o, Ns), s.envMap.value = i.texture, s.roughness.value = 0, s.mipInt.value = d - n, Us(e, p, m, 3 * f, 2 * f), r.setRenderTarget(e), r.render(o, Ns);
	}
	_blur(e, t, n, r, i) {
	...
	_halfBlur(e, t, n, r, i, a, o) {
		...
		l.material = c;
		let u = c.uniforms, d = this._sizeLods[n] - 1, f = isFinite(i) ? Math.PI / (2 * d) : 2 * Math.PI / (2 * js - 1), p = i / f, m = isFinite(i) ? 1 + Math.floor(3 * p) : js;
		m > js && U(`sigmaRadians, ${i}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${js}`);
		let h = [], g = 0;
		for (let e = 0; e < js; ++e) {
		...
		Us(t, 3 * v * (r > _ - ks ? r - _ + ks : 0), 4 * (this._cubeSize - v), 3 * v, 2 * v), s.setRenderTarget(t), s.render(l, Ns);
	}
};
function Vs(e) {
	let t = [], n = [], r = [], i = e, a = e - ks + 1 + As.length;
	for (let o = 0; o < a; o++) {
		let a = 2 ** i;
		t.push(a);
		let s = 1 / a;
		o > e - ks ? s = As[o - e + ks - 1] : o === 0 && (s = 0), n.push(s);
		...
		let h = new wr();
		h.setAttribute("position", new ur(f, 3)), h.setAttribute("uv", new ur(p, 2)), h.setAttribute("faceIndex", new ur(m, 1)), r.push(new qr(h, null)), i > ks && i--;
	}
	return {
		lodMeshes: r,
		sizeLods: t,
...
function Gs(e, t, n) {
	let r = new Float32Array(js), i = new q(0, 1, 0);
	return new Qa({
...
var Ys = class extends Wt {
	...
	fromEquirectangularTexture(e, t) {
		...
		}, r = new vi(5, 5, 5), i = new Qa({
			name: "CubemapFromEquirect",
			uniforms: Wa(n.uniforms),
		...
		let a = new qr(r, i), s = t.minFilter;
		return t.minFilter === 1008 && (t.minFilter = o), new Yo(1, 10, this).update(e, a), t.minFilter = s, a.geometry.dispose(), a.material.dispose(), this;
	}
	clear(e, t = !0, n = !0, r = !0) {
	...
	function o(t) {
		if (t && t.isTexture) {
			...
			if (a || o) {
				...
				if (t.isRenderTargetTexture && t.pmremVersion !== s) return r === null && (r = new Bs(e)), i = a ? r.fromEquirectangular(t, i) : r.fromCubemap(t, i), i.texture.pmremVersion = t.pmremVersion, n.set(t, i), i.texture;
				if (i !== void 0) return i.texture;
				{
					let s = t.image;
					return a && s && s.height > 0 || o && s && c(s) ? (r === null && (r = new Bs(e)), i = a ? r.fromEquirectangular(t) : r.fromCubemap(t), i.texture.pmremVersion = t.pmremVersion, n.set(t, i), t.addEventListener("dispose", u), i.texture) : null;
				}
			}
		}
		return t;
...
function tc(e, t, n) {
	let r = /* @__PURE__ */ new WeakMap(), i = new Ht();
	function a(a, o, s) {
		...
		if (d === void 0 || d.count !== u) {
			...
			let g = new Float32Array(p * m * 4 * u), _ = new Gt(g, p, m, u);
...
function ic(e, t, n, r, i) {
	...
	let c = new $a({
		...
		depthTest: !1,
		depthWrite: !1
	}), l = new qr(s, c), u = new Uo(-1, 1, 1, -1, 0, 1), d = null, f = null, p = !1, m, h = null, _ = [], v = !1;
...
var ac = /* @__PURE__ */ new Vt(), oc = /* @__PURE__ */ new hi(1, 1), sc = /* @__PURE__ */ new Gt(), cc = /* @__PURE__ */ new Kt(), lc = /* @__PURE__ */ new mi(), uc = [], dc = [], fc = new Float32Array(16), pc = new Float32Array(9), mc = new Float32Array(4);
function hc(e, t, n) {
	let r = e[0];
	if (r <= 0 || r > 0) return e;
	let i = t * n, a = uc[i];
...
function vc(e, t) {
	let n = dc[t];
	n === void 0 && (n = new Int32Array(t), dc[t] = n);
...
function bc(e, t) {
	...
	if (t.x !== void 0) (n[0] !== t.x || n[1] !== t.y) && (e.uniform2f(this.addr, t.x, t.y), n[0] = t.x, n[1] = t.y);
		...
		if (gc(n, t)) return;
		e.uniform2fv(this.addr, t), _c(n, t);
	}
}
function xc(e, t) {
	let n = this.cache;
	if (t.x !== void 0) (n[0] !== t.x || n[1] !== t.y || n[2] !== t.z) && (e.uniform3f(this.addr, t.x, t.y, t.z), n[0] = t.x, n[1] = t.y, n[2] = t.z);
		...
		if (gc(n, t)) return;
		e.uniform3fv(this.addr, t), _c(n, t);
	}
}
function Sc(e, t) {
	let n = this.cache;
	if (t.x !== void 0) (n[0] !== t.x || n[1] !== t.y || n[2] !== t.z || n[3] !== t.w) && (e.uniform4f(this.addr, t.x, t.y, t.z, t.w), n[0] = t.x, n[1] = t.y, n[2] = t.z, n[3] = t.w);
		...
		if (gc(n, t)) return;
		e.uniform4fv(this.addr, t), _c(n, t);
	}
}
function Cc(e, t) {
	...
	if (r === void 0) {
		if (gc(n, t)) return;
		e.uniformMatrix2fv(this.addr, !1, t), _c(n, t);
	} else {
		if (gc(n, r)) return;
		mc.set(r), e.uniformMatrix2fv(this.addr, !1, mc), _c(n, r);
	}
}
function wc(e, t) {
	let n = this.cache, r = t.elements;
	if (r === void 0) {
		if (gc(n, t)) return;
		e.uniformMatrix3fv(this.addr, !1, t), _c(n, t);
	} else {
		if (gc(n, r)) return;
		pc.set(r), e.uniformMatrix3fv(this.addr, !1, pc), _c(n, r);
	}
}
function Tc(e, t) {
	let n = this.cache, r = t.elements;
	if (r === void 0) {
		if (gc(n, t)) return;
		e.uniformMatrix4fv(this.addr, !1, t), _c(n, t);
	} else {
		if (gc(n, r)) return;
		fc.set(r), e.uniformMatrix4fv(this.addr, !1, fc), _c(n, r);
	}
}
function Ec(e, t) {
	let n = this.cache;
...
function Dc(e, t) {
	...
	if (t.x !== void 0) (n[0] !== t.x || n[1] !== t.y) && (e.uniform2i(this.addr, t.x, t.y), n[0] = t.x, n[1] = t.y);
		...
		if (gc(n, t)) return;
		e.uniform2iv(this.addr, t), _c(n, t);
	}
}
function Oc(e, t) {
	let n = this.cache;
	if (t.x !== void 0) (n[0] !== t.x || n[1] !== t.y || n[2] !== t.z) && (e.uniform3i(this.addr, t.x, t.y, t.z), n[0] = t.x, n[1] = t.y, n[2] = t.z);
		...
		if (gc(n, t)) return;
		e.uniform3iv(this.addr, t), _c(n, t);
	}
}
function kc(e, t) {
	let n = this.cache;
	if (t.x !== void 0) (n[0] !== t.x || n[1] !== t.y || n[2] !== t.z || n[3] !== t.w) && (e.uniform4i(this.addr, t.x, t.y, t.z, t.w), n[0] = t.x, n[1] = t.y, n[2] = t.z, n[3] = t.w);
		...
		if (gc(n, t)) return;
		e.uniform4iv(this.addr, t), _c(n, t);
	}
}
function Ac(e, t) {
	let n = this.cache;
...
function jc(e, t) {
	...
	if (t.x !== void 0) (n[0] !== t.x || n[1] !== t.y) && (e.uniform2ui(this.addr, t.x, t.y), n[0] = t.x, n[1] = t.y);
		...
		if (gc(n, t)) return;
		e.uniform2uiv(this.addr, t), _c(n, t);
	}
}
function Mc(e, t) {
	let n = this.cache;
	if (t.x !== void 0) (n[0] !== t.x || n[1] !== t.y || n[2] !== t.z) && (e.uniform3ui(this.addr, t.x, t.y, t.z), n[0] = t.x, n[1] = t.y, n[2] = t.z);
		...
		if (gc(n, t)) return;
		e.uniform3uiv(this.addr, t), _c(n, t);
	}
}
function Nc(e, t) {
	let n = this.cache;
	if (t.x !== void 0) (n[0] !== t.x || n[1] !== t.y || n[2] !== t.z || n[3] !== t.w) && (e.uniform4ui(this.addr, t.x, t.y, t.z, t.w), n[0] = t.x, n[1] = t.y, n[2] = t.z, n[3] = t.w);
		...
		if (gc(n, t)) return;
		e.uniform4uiv(this.addr, t), _c(n, t);
	}
}
function Pc(e, t, n) {
	...
	let a;
	this.type === e.SAMPLER_2D_SHADOW ? (oc.compareFunction = n.isReversedDepthBuffer() ? 518 : 515, a = oc) : a = ac, n.setTexture2D(t || a, i);
}
function Fc(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTexture3D(t || cc, i);
}
function Ic(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTextureCube(t || lc, i);
}
function Lc(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTexture2DArray(t || sc, i);
}
function Rc(e) {
	switch (e) {
		case 5126: return yc;
		case 35664: return bc;
		case 35665: return xc;
		case 35666: return Sc;
		case 35674: return Cc;
		case 35675: return wc;
		case 35676: return Tc;
		case 5124:
		case 35670: return Ec;
		case 35667:
		case 35671: return Dc;
		case 35668:
		case 35672: return Oc;
		case 35669:
		case 35673: return kc;
		case 5125: return Ac;
		case 36294: return jc;
		case 36295: return Mc;
		case 36296: return Nc;
		case 35678:
		case 36198:
		case 36298:
		case 36306:
		...
		case 36300:
		case 36308:
		case 36293: return Ic;
		case 36289:
		case 36303:
		case 36311:
		case 36292: return Lc;
	}
}
function zc(e, t) {
...
function Bc(e, t) {
	let n = hc(t, this.size, 2);
	e.uniform2fv(this.addr, n);
}
function Vc(e, t) {
	let n = hc(t, this.size, 3);
	e.uniform3fv(this.addr, n);
}
function Hc(e, t) {
	let n = hc(t, this.size, 4);
...
function Wc(e, t) {
	let n = hc(t, this.size, 9);
	e.uniformMatrix3fv(this.addr, !1, n);
}
function Gc(e, t) {
	let n = hc(t, this.size, 16);
...
function el(e, t, n) {
	let r = this.cache, i = t.length, a = vc(n, i);
	gc(r, a) || (e.uniform1iv(this.addr, a), _c(r, a));
	let o;
	o = this.type === e.SAMPLER_2D_SHADOW ? oc : ac;
	for (let e = 0; e !== i; ++e) n.setTexture2D(t[e] || o, a[e]);
}
function tl(e, t, n) {
	let r = this.cache, i = t.length, a = vc(n, i);
	gc(r, a) || (e.uniform1iv(this.addr, a), _c(r, a));
	for (let e = 0; e !== i; ++e) n.setTexture3D(t[e] || cc, a[e]);
}
function nl(e, t, n) {
	let r = this.cache, i = t.length, a = vc(n, i);
	gc(r, a) || (e.uniform1iv(this.addr, a), _c(r, a));
	for (let e = 0; e !== i; ++e) n.setTextureCube(t[e] || lc, a[e]);
}
function rl(e, t, n) {
	let r = this.cache, i = t.length, a = vc(n, i);
	gc(r, a) || (e.uniform1iv(this.addr, a), _c(r, a));
	for (let e = 0; e !== i; ++e) n.setTexture2DArray(t[e] || sc, a[e]);
}
function il(e) {
	switch (e) {
		case 5126: return zc;
		case 35664: return Bc;
		case 35665: return Vc;
		case 35666: return Hc;
		case 35674: return Uc;
		case 35675: return Wc;
		case 35676: return Gc;
		case 5124:
		case 35670: return Kc;
		case 35667:
		case 35671: return qc;
		case 35668:
		case 35672: return Jc;
		case 35669:
		case 35673: return Yc;
		case 5125: return Xc;
		case 36294: return Zc;
		case 36295: return Qc;
		case 36296: return $c;
		case 35678:
		case 36198:
		case 36298:
...
var al = class {
	...
	constructor(e, t, n) {
		this.id = e, this.addr = n, this.cache = [], this.type = t.type, this.size = t.size, this.setValue = il(t.type);
	}
}, sl = class {
	constructor(e) {
...
function ul(e, t, n) {
	...
	for (cl.lastIndex = 0;;) {
		let a = cl.exec(r), o = cl.lastIndex, s = a[1], c = a[2] === "]", l = a[3];
		if (c && (s |= 0), l === void 0 || l === "[" && o + 2 === i) {
			ll(n, l === void 0 ? new al(s, e, t) : new ol(s, e, t));
			break;
		} else {
			let e = n.map[s];
			e === void 0 && (e = new sl(s), ll(n, e)), n = e;
		}
	}
}
var dl = class {
	constructor(e, t) {
		...
		for (let r = 0; r < n; ++r) {
			...
			ul(n, e.getUniformLocation(t, n.name), this);
		}
		let r = [], i = [];
...
var gl = /* @__PURE__ */ new J();
function _l(e) {
	Y._getMatrix(gl, Y.workingColorSpace, e);
	let t = `mat3( ${gl.elements.map((e) => e.toFixed(4))} )`;
	switch (Y.getTransfer(e)) {
		case Fe: return [t, "LinearTransferOETF"];
		case Ie: return [t, "sRGBTransferOETF"];
		default: return U("WebGLProgram: Unsupported color space: ", e), [t, "LinearTransferOETF"];
	}
}
function vl(e, t, n) {
...
var Sl = /* @__PURE__ */ new q();
function Cl() {
	return Y.getLuminanceCoefficients(Sl), [
		"float luminance( const in vec3 rgb ) {",
		`	const vec3 weights = vec3( ${Sl.x.toFixed(4)}, ${Sl.y.toFixed(4)}, ${Sl.z.toFixed(4)} );`,
...
var Al = /^[ \t]*#include +<([\w\d./]+)>/gm;
function jl(e) {
	return e.replace(Al, Nl);
}
...
function Nl(e, t) {
	...
	if (n === void 0) {
		let e = Ml.get(t);
		if (e !== void 0) n = Q[e], U("WebGLRenderer: Shader chunk \"%s\" has been deprecated. Use \"%s\" instead.", t, e);
...
function zl(e) {
	return Rl[e.shadowMapType] || "SHADOWMAP_TYPE_BASIC";
}
var Bl = {
...
function Vl(e) {
	return e.envMap === !1 ? "ENVMAP_TYPE_CUBE" : Bl[e.envMapMode] || "ENVMAP_TYPE_CUBE";
}
var Hl = { 302: "ENVMAP_MODE_REFRACTION" };
function Ul(e) {
	return e.envMap === !1 ? "ENVMAP_MODE_REFLECTION" : Hl[e.envMapMode] || "ENVMAP_MODE_REFLECTION";
}
var Wl = {
...
function Gl(e) {
	return e.envMap === !1 ? "ENVMAP_BLENDING_NONE" : Wl[e.combine] || "ENVMAP_BLENDING_NONE";
}
function Kl(e) {
...
function ql(e, t, n, r) {
	let i = e.getContext(), a = n.defines, o = n.vertexShader, s = n.fragmentShader, c = zl(n), l = Vl(n), u = Ul(n), d = Gl(n), f = Kl(n), p = wl(n), m = Tl(a), h = i.createProgram(), g, _, v = n.glslVersion ? "#version " + n.glslVersion + "\n" : "";
	...
	let y = v + g + o, b = v + _ + s, x = fl(i, i.VERTEX_SHADER, y), S = fl(i, i.FRAGMENT_SHADER, b);
	...
	function C(t) {
		if (e.debug.checkShaderErrors) {
			...
			if (i.getProgramParameter(h, i.LINK_STATUS) === !1) if (l = !1, typeof e.debug.onShaderError == "function") e.debug.onShaderError(i, h, x, S);
				...
				let e = vl(i, x, "vertex"), n = vl(i, S, "fragment");
				W("THREE.WebGLProgram: Shader Error " + i.getError() + " - VALIDATE_STATUS " + i.getProgramParameter(h, i.VALIDATE_STATUS) + "\n\nMaterial Name: " + t.name + "\nMaterial Type: " + t.type + "\n\nProgram Info Log: " + o + "\n" + e + "\n" + n);
			}
		...
		i.deleteShader(x), i.deleteShader(S), w = new dl(i, h), T = El(i, h);
	}
	let w;
	...
	return this.isReady = function() {
		return E === !1 && (E = i.getProgramParameter(h, pl)), E;
	}, this.destroy = function() {
		r.releaseStatesOfProgram(this), i.deleteProgram(h), this.program = void 0;
	}, this.type = n.shaderType, this.name = n.shaderName, this.id = ml++, this.cacheKey = t, this.usedTimes = 1, this.program = h, this.vertexShader = x, this.fragmentShader = S, this;
}
var Jl = 0, Yl = class {
	constructor() {
	...
	_getShaderStage(e) {
		...
		return n === void 0 && (n = new Xl(e), t.set(e, n)), n;
	}
}, Xl = class {
	constructor(e) {
		this.id = Jl++, this.code = e, this.usedTimes = 0;
	}
};
function Zl(e) {
...
function Ql(e, t, n, r, i, a) {
	let o = new an(), s = new Yl(), c = /* @__PURE__ */ new Set(), l = [], u = /* @__PURE__ */ new Map(), d = r.logarithmicDepthBuffer, f = r.precision, p = {
	...
	function h(i, o, l, u, h, g) {
		...
		let Ae = {
			...
			packedNormalMap: F && i.normalMapType === 0 && Zl(i.normalMap.format),
			metalnessMap: I,
			roughnessMap: L,
			anisotropy: ce,
			anisotropyMap: me,
			...
			toneMapping: B,
			decodeVideoTexture: N && i.map.isVideoTexture === !0 && Y.getTransfer(i.map.colorSpace) === "srgb",
			decodeVideoTextureEmissive: se && i.emissiveMap.isVideoTexture === !0 && Y.getTransfer(i.emissiveMap.colorSpace) === "srgb",
	...
	function y(e) {
		...
		if (t) {
			let e = bs[t];
			n = Ya.clone(e.uniforms);
		} else n = e.uniforms;
		return n;
	}
	function b(t, n) {
		let r = u.get(n);
		return r === void 0 ? (r = new ql(e, n, t, i), l.push(r), u.set(n, r)) : ++r.usedTimes, r;
	}
	function x(e) {
		if (--e.usedTimes === 0) {
			let t = l.indexOf(e);
...
function nu() {
	...
	function u(e, t) {
		n.length > 1 && n.sort(e || eu), r.length > 1 && r.sort(t || tu), i.length > 1 && i.sort(t || tu);
	}
	function d() {
...
function ru() {
	...
	function t(t, n) {
		let r = e.get(t), i;
		return r === void 0 ? (i = new nu(), e.set(t, [i])) : n >= r.length ? (i = new nu(), r.push(i)) : i = r[n], i;
	}
	function n() {
		e = /* @__PURE__ */ new WeakMap();
	}
...
function uu(e) {
	...
	function n(n, r = 0) {
		let i = t.get(n), a;
		return i === void 0 ? (a = new lu(e), t.set(n, [a])) : r >= i.length ? (a = new lu(e), i.push(a)) : a = i[r], a;
	}
	function r() {
...
var du = "void main() {\n	gl_Position = vec4( position, 1.0 );\n}", fu = "uniform sampler2D shadow_pass;\nuniform vec2 resolution;\nuniform float radius;\nvoid main() {\n	const float samples = float( VSM_SAMPLES );\n	float mean = 0.0;\n	float squared_mean = 0.0;\n	float uvStride = samples <= 1.0 ? 0.0 : 2.0 / ( samples - 1.0 );\n	float uvStart = samples <= 1.0 ? 0.0 : - 1.0;\n	for ( float i = 0.0; i < samples; i ++ ) {\n		float uvOffset = uvStart + i * uvStride;\n		#ifdef HORIZONTAL_PASS\n			vec2 distribution = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( uvOffset, 0.0 ) * radius ) / resolution ).rg;\n			mean += distribution.x;\n			squared_mean += distribution.y * distribution.y + distribution.x * distribution.x;\n		#else\n			float depth = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( 0.0, uvOffset ) * radius ) / resolution ).r;\n			mean += depth;\n			squared_mean += depth * depth;\n		#endif\n	}\n	mean = mean / samples;\n	squared_mean = squared_mean / samples;\n	float std_dev = sqrt( max( 0.0, squared_mean - mean * mean ) );\n	gl_FragColor = vec4( mean, std_dev, 0.0, 1.0 );\n}", pu = [
	...
	/* @__PURE__ */ new q(0, -1, 0),
	/* @__PURE__ */ new q(0, -1, 0)
], hu = /* @__PURE__ */ new qt(), gu = /* @__PURE__ */ new q(), _u = /* @__PURE__ */ new q();
function vu(e, t, n) {
	let i = new pi(), a = new K(), s = new K(), c = new Ht(), l = new ro(), u = new io(), d = {}, f = n.maxTextureSize, p = {
		0: 1,
		1: 0,
		2: 2
	}, _ = new Qa({
	...
	let y = new wr();
	y.setAttribute("position", new ur(new Float32Array([
		-1,
		-1,
		.5,
		3,
	...
	let b = new qr(y, _), x = this;
	this.enabled = !1, this.autoUpdate = !0, this.needsUpdate = !1, this.type = 1;
	let S = this.type;
	this.render = function(t, n, l) {
		if (x.enabled === !1 || x.autoUpdate === !1 && x.needsUpdate === !1 || t.length === 0) return;
		this.type === 2 && (U("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."), this.type = 1);
		...
		for (let u = 0, d = t.length; u < d; u++) {
			...
			if (p === void 0) {
				U("WebGLShadowMap:", d, "has no shadow.");
				continue;
			}
			...
			if (p.camera._reversedDepth = b, p.map === null || v === !0) {
				if (p.map !== null && (p.map.depthTexture !== null && (p.map.depthTexture.dispose(), p.map.depthTexture = null), p.map.dispose()), this.type === 3) {
					...
					p.map = new Wt(a.x, a.y, {
						...
						magFilter: o,
						generateMipmaps: !1
					}), p.map.texture.name = d.name + ".shadowMap", p.map.depthTexture = new hi(a.x, a.y, h), p.map.depthTexture.name = d.name + ".shadowMapDepth", p.map.depthTexture.format = T, p.map.depthTexture.compareFunction = null, p.map.depthTexture.minFilter = r, p.map.depthTexture.magFilter = r;
				} else d.isPointLight ? (p.map = new Ys(a.x), p.map.depthTexture = new gi(a.x, m)) : (p.map = new Wt(a.x, a.y), p.map.depthTexture = new hi(a.x, a.y, m)), p.map.depthTexture.name = d.name + ".shadowMap", p.map.depthTexture.format = T, this.type === 1 ? (p.map.depthTexture.compareFunction = b ? 518 : 515, p.map.depthTexture.minFilter = o, p.map.depthTexture.magFilter = o) : (p.map.depthTexture.compareFunction = null, p.map.depthTexture.minFilter = r, p.map.depthTexture.magFilter = r);
	...
	function C(n, r) {
		let i = t.update(b);
		_.defines.VSM_SAMPLES !== n.blurSamples && (_.defines.VSM_SAMPLES = n.blurSamples, v.defines.VSM_SAMPLES = n.blurSamples, _.needsUpdate = !0, v.needsUpdate = !0), n.mapPass === null && (n.mapPass = new Wt(a.x, a.y, {
			format: k,
			type: g
...
function yu(e, t) {
	function n() {
		let t = !1, n = new Ht(), r = null, i = new Ht(0, 0, 0, 0);
		return {
			setMask: function(n) {
	...
	let a = new n(), o = new r(), s = new i(), c = /* @__PURE__ */ new WeakMap(), l = /* @__PURE__ */ new WeakMap(), u = {}, d = {}, f = {}, p = /* @__PURE__ */ new WeakMap(), m = [], h = null, g = !1, _ = null, v = null, y = null, b = null, x = null, S = null, C = null, w = new X(0, 0, 0), T = 0, E = !1, D = null, O = null, k = null, A = null, ee = null, j = e.getParameter(e.MAX_COMBINED_TEXTURE_IMAGE_UNITS), M = !1, te = 0, N = e.getParameter(e.VERSION);
	N.indexOf("WebGL") === -1 ? N.indexOf("OpenGL ES") !== -1 && (te = parseFloat(/^OpenGL ES (\d)/.exec(N)[1]), M = te >= 2) : (te = parseFloat(/^WebGL (\d)/.exec(N)[1]), M = te >= 1);
	let P = null, ne = {}, re = e.getParameter(e.SCISSOR_BOX), ie = e.getParameter(e.VIEWPORT), ae = new Ht().fromArray(re), F = new Ht().fromArray(ie);
	function oe(t, n, r, i) {
	...
	function ve(t, n, r) {
		t ? (I(e.POLYGON_OFFSET_FILL), (A !== n || ee !== r) && (A = n, ee = r, o.getReversed() && (n = -n), e.polygonOffset(n, r))) : L(e.POLYGON_OFFSET_FILL);
	}
	function ye(t) {
...
function bu(l, u, d, f, p, m, h) {
	let g = u.has("WEBGL_multisampled_render_to_texture") ? u.get("WEBGL_multisampled_render_to_texture") : null, _ = typeof navigator > "u" ? !1 : /OculusBrowser/g.test(navigator.userAgent), v = new K(), y = /* @__PURE__ */ new WeakMap(), b = /* @__PURE__ */ new Set(), x, S = /* @__PURE__ */ new WeakMap(), C = !1;
	try {
	...
	function A(e, t, n, r, i, a = !1) {
		if (e !== null) {
			...
			U("WebGLRenderer: Attempt to use non-existing WebGL internal format '" + e + "'");
		}
		let o;
		r && (o = u.get("EXT_texture_norm16"), o || U("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));
		let s = t;
	...
	function M(e) {
		let t = e.target;
		t.removeEventListener("dispose", M), N(t), t.isVideoTexture && y.delete(t), t.isHTMLTexture && b.delete(t);
	}
	function te(e) {
		let t = e.target;
		t.removeEventListener("dispose", te), ne(t);
	}
	function N(e) {
		let t = f.get(e);
	...
	function oe() {
		let e = re;
		return e >= p.maxTextures && U("WebGLTextures: Trying to use " + e + " texture units while this GPU supports only " + p.maxTextures), re += 1, e;
	}
	function se(e) {
		let t = [];
	...
	function I(e, t) {
		...
		if (e.isVideoTexture && ke(e), e.isRenderTargetTexture === !1 && e.isExternalTexture !== !0 && e.version > 0 && n.__version !== e.version) {
			let r = e.image;
			if (r === null) U("WebGLRenderer: Texture marked for update but no image data found.");
			else if (r.complete === !1) U("WebGLRenderer: Texture marked for update but image is incomplete");
			else {
				_e(n, e, t);
				return;
			}
	...
	function pe(e, t) {
		if (t.type === 1015 && u.has("OES_texture_float_linear") === !1 && (t.magFilter === 1006 || t.magFilter === 1007 || t.magFilter === 1005 || t.magFilter === 1008 || t.minFilter === 1006 || t.minFilter === 1007 || t.minFilter === 1005 || t.minFilter === 1008) && U("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."), l.texParameteri(e, l.TEXTURE_WRAP_S, ue[t.wrapS]), l.texParameteri(e, l.TEXTURE_WRAP_T, ue[t.wrapT]), (e === l.TEXTURE_3D || e === l.TEXTURE_2D_ARRAY) && l.texParameteri(e, l.TEXTURE_WRAP_R, ue[t.wrapR]), l.texParameteri(e, l.TEXTURE_MAG_FILTER, de[t.magFilter]), l.texParameteri(e, l.TEXTURE_MIN_FILTER, de[t.minFilter]), t.compareFunction && (l.texParameteri(e, l.TEXTURE_COMPARE_MODE, l.COMPARE_REF_TO_TEXTURE), l.texParameteri(e, l.TEXTURE_COMPARE_FUNC, fe[t.compareFunction])), u.has("EXT_texture_filter_anisotropic") === !0) {
	...
	function _e(e, t, n) {
		...
		if (a.version !== o.__version || i === !0) {
			if (d.activeTexture(l.TEXTURE0 + n), !(typeof ImageBitmap < "u" && t.image instanceof ImageBitmap)) {
				let e = Y.getPrimaries(Y.workingColorSpace), n = t.colorSpace === "" ? null : Y.getPrimaries(t.colorSpace), r = t.colorSpace === "" || e === n ? l.NONE : l.BROWSER_DEFAULT_WEBGL;
			...
			if (t.isDepthTexture) u = ee(t.format === E, t.type), _ && (g ? d.texStorage2D(l.TEXTURE_2D, 1, u, e.width, e.height) : d.texImage2D(l.TEXTURE_2D, 0, u, e.width, e.height, 0, s, c, null));
				...
				t.generateMipmaps = !1;
			} else g ? (_ && d.texStorage2D(l.TEXTURE_2D, y, u, e.width, e.height), v && ge(t, e, s, c)) : d.texImage2D(l.TEXTURE_2D, 0, u, e.width, e.height, 0, s, c, e.data);
				...
				for (let n = 0, r = h.length; n < r; n++) if (f = h[n], t.format !== 1023) if (s !== null) if (g) {
					if (v) if (t.layerUpdates.size > 0) {
						let e = gs(f.width, f.height, t.format, t.type);
				...
				if (_ && d.texStorage3D(l.TEXTURE_2D_ARRAY, y, u, e.width, e.height, e.depth), v) if (t.layerUpdates.size > 0) {
					let n = gs(e.width, e.height, t.format, t.type);
					for (let r of t.layerUpdates) {
	...
	function ve(e, t, n) {
		...
		if (i.version !== a.__version || r === !0) {
			...
			let e = Y.getPrimaries(Y.workingColorSpace), o = t.colorSpace === "" ? null : Y.getPrimaries(t.colorSpace), s = t.colorSpace === "" || e === o ? l.NONE : l.BROWSER_DEFAULT_WEBGL;
			...
			for (let e = 0; e < 6; e++) !c && !u ? f[e] = T(t.image[e], !0, p.maxCubemapSize) : f[e] = u ? t.image[e].image : t.image[e], f[e] = B(t, f[e]);
	...
	function ye(e, t, n, r, i, a) {
		...
		d.bindFramebuffer(l.FRAMEBUFFER, e), z(t) ? g.framebufferTexture2DMultisampleEXT(l.FRAMEBUFFER, r, i, p.__webglTexture, 0, Oe(t)) : (i === l.TEXTURE_2D || i >= l.TEXTURE_CUBE_MAP_POSITIVE_X && i <= l.TEXTURE_CUBE_MAP_NEGATIVE_Z) && l.framebufferTexture2D(l.FRAMEBUFFER, r, i, p.__webglTexture, a), d.bindFramebuffer(l.FRAMEBUFFER, null);
	}
	function be(e, t, n) {
		if (l.bindRenderbuffer(l.RENDERBUFFER, e), t.depthBuffer) {
			...
			z(t) ? g.renderbufferStorageMultisampleEXT(l.RENDERBUFFER, Oe(t), a, t.width, t.height) : n ? l.renderbufferStorageMultisample(l.RENDERBUFFER, Oe(t), a, t.width, t.height) : l.renderbufferStorage(l.RENDERBUFFER, a, t.width, t.height), l.framebufferRenderbuffer(l.FRAMEBUFFER, o, l.RENDERBUFFER, e);
		} else {
			let e = t.textures;
			for (let r = 0; r < e.length; r++) {
				let i = e[r], a = m.convert(i.format, i.colorSpace), o = m.convert(i.type), s = A(i.internalFormat, a, o, i.normalized, i.colorSpace);
				z(t) ? g.renderbufferStorageMultisampleEXT(l.RENDERBUFFER, Oe(t), s, t.width, t.height) : n ? l.renderbufferStorageMultisample(l.RENDERBUFFER, Oe(t), s, t.width, t.height) : l.renderbufferStorage(l.RENDERBUFFER, s, t.width, t.height);
			}
		}
	...
	function xe(e, t, n) {
		...
		if (i.__renderTarget = t, (!i.__webglTexture || t.depthTexture.image.width !== t.width || t.depthTexture.image.height !== t.height) && (t.depthTexture.image.width = t.width, t.depthTexture.image.height = t.height, t.depthTexture.needsUpdate = !0), r) {
			if (i.__webglInit === void 0 && (i.__webglInit = !0, t.depthTexture.addEventListener("dispose", M)), i.__webglTexture === void 0) {
				i.__webglTexture = l.createTexture(), d.bindTexture(l.TEXTURE_CUBE_MAP, i.__webglTexture), pe(l.TEXTURE_CUBE_MAP, t.depthTexture);
		...
		let a = i.__webglTexture, o = Oe(t), s = r ? l.TEXTURE_CUBE_MAP_POSITIVE_X + n : l.TEXTURE_2D, c = t.depthTexture.format === 1027 ? l.DEPTH_STENCIL_ATTACHMENT : l.DEPTH_ATTACHMENT;
		if (t.depthTexture.format === 1026) z(t) ? g.framebufferTexture2DMultisampleEXT(l.FRAMEBUFFER, c, s, a, 0, o) : l.framebufferTexture2D(l.FRAMEBUFFER, c, s, a, 0);
		else if (t.depthTexture.format === 1027) z(t) ? g.framebufferTexture2DMultisampleEXT(l.FRAMEBUFFER, c, s, a, 0, o) : l.framebufferTexture2D(l.FRAMEBUFFER, c, s, a, 0);
	...
	function Se(e) {
		...
		if (e.depthTexture && !t.__autoAllocateDepthBuffer) if (n) for (let n = 0; n < 6; n++) xe(t.__webglFramebuffer[n], e, n);
		else {
			...
			for (let n = 0; n < 6; n++) if (d.bindFramebuffer(l.FRAMEBUFFER, t.__webglFramebuffer[n]), t.__webglDepthbuffer[n] === void 0) t.__webglDepthbuffer[n] = l.createRenderbuffer(), be(t.__webglDepthbuffer[n], e, !1);
			else {
			...
			let n = e.texture.mipmaps;
			if (n && n.length > 0 ? d.bindFramebuffer(l.FRAMEBUFFER, t.__webglFramebuffer[0]) : d.bindFramebuffer(l.FRAMEBUFFER, t.__webglFramebuffer), t.__webglDepthbuffer === void 0) t.__webglDepthbuffer = l.createRenderbuffer(), be(t.__webglDepthbuffer, e, !1);
			else {
	...
	function Ce(e, t, n) {
		let r = f.get(e);
		t !== void 0 && ye(r.__webglFramebuffer, e, e.texture, l.COLOR_ATTACHMENT0, l.TEXTURE_2D, 0), n !== void 0 && Se(e);
	}
	function we(e) {
		...
		if (o || (r.__webglTexture === void 0 && (r.__webglTexture = l.createTexture()), r.__version = t.version, h.memory.textures++), a) {
			...
			if (e.samples > 0 && z(e) === !1) {
				...
				for (let t = 0; t < i.length; t++) {
					...
					let a = m.convert(r.format, r.colorSpace), o = m.convert(r.type), s = A(r.internalFormat, a, o, r.normalized, r.colorSpace, e.isXRRenderTarget === !0), c = Oe(e);
				...
				l.bindRenderbuffer(l.RENDERBUFFER, null), e.depthBuffer && (n.__webglDepthRenderbuffer = l.createRenderbuffer(), be(n.__webglDepthRenderbuffer, e, !0)), d.bindFramebuffer(l.FRAMEBUFFER, null);
			}
		}
		if (a) {
			d.bindTexture(l.TEXTURE_CUBE_MAP, r.__webglTexture), pe(l.TEXTURE_CUBE_MAP, t);
			for (let r = 0; r < 6; r++) if (t.mipmaps && t.mipmaps.length > 0) for (let i = 0; i < t.mipmaps.length; i++) ye(n.__webglFramebuffer[r][i], e, t, l.COLOR_ATTACHMENT0, l.TEXTURE_CUBE_MAP_POSITIVE_X + r, i);
			else ye(n.__webglFramebuffer[r], e, t, l.COLOR_ATTACHMENT0, l.TEXTURE_CUBE_MAP_POSITIVE_X + r, 0);
			D(t) && O(l.TEXTURE_CUBE_MAP), d.unbindTexture();
		} else if (o) {
			for (let t = 0, r = i.length; t < r; t++) {
				let r = i[t], a = f.get(r), o = l.TEXTURE_2D;
				(e.isWebGL3DRenderTarget || e.isWebGLArrayRenderTarget) && (o = e.isWebGL3DRenderTarget ? l.TEXTURE_3D : l.TEXTURE_2D_ARRAY), d.bindTexture(o, a.__webglTexture), pe(o, r), ye(n.__webglFramebuffer, e, r, l.COLOR_ATTACHMENT0 + t, o, 0), D(r) && O(o);
			}
			d.unbindTexture();
		} else {
			let i = l.TEXTURE_2D;
			if ((e.isWebGL3DRenderTarget || e.isWebGLArrayRenderTarget) && (i = e.isWebGL3DRenderTarget ? l.TEXTURE_3D : l.TEXTURE_2D_ARRAY), d.bindTexture(i, r.__webglTexture), pe(i, t), t.mipmaps && t.mipmaps.length > 0) for (let r = 0; r < t.mipmaps.length; r++) ye(n.__webglFramebuffer[r], e, t, l.COLOR_ATTACHMENT0, i, r);
			else ye(n.__webglFramebuffer, e, t, l.COLOR_ATTACHMENT0, i, 0);
		...
		if (e.samples > 0) {
			if (z(e) === !1) {
				...
				for (let c = 0; c < t.length; c++) {
					...
					l.blitFramebuffer(0, 0, n, r, 0, 0, n, r, i, l.NEAREST), _ === !0 && (Ee.length = 0, De.length = 0, Ee.push(l.COLOR_ATTACHMENT0 + c), e.depthBuffer && e.resolveDepthBuffer === !1 && (Ee.push(a), De.push(a), l.invalidateFramebuffer(l.DRAW_FRAMEBUFFER, De)), l.invalidateFramebuffer(l.READ_FRAMEBUFFER, Ee));
				}
	...
	function B(e, t) {
		...
		return e.isCompressedTexture === !0 || e.isVideoTexture === !0 || n !== "srgb-linear" && n !== "" && (Y.getTransfer(n) === "srgb" ? (r !== 1023 || i !== 1009) && U("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType.") : W("WebGLTextures: Unsupported texture color space:", n)), t;
	}
	function Ae(e) {
	...
	this.allocateTextureUnit = oe, this.resetTextureUnits = ie, this.getTextureUnits = ae, this.setTextureUnits = F, this.setTexture2D = I, this.setTexture2DArray = L, this.setTexture3D = ce, this.setTextureCube = le, this.rebindTextures = Ce, this.setupRenderTarget = we, this.updateRenderTargetMipmap = Te, this.updateMultisampleRenderTarget = R, this.setupDepthRenderbuffer = Se, this.setupFrameBufferTexture = ye, this.useMultisampledRTT = z, this.isReversedDepthBuffer = function() {
...
var Su = "\nvoid main() {\n\n	gl_Position = vec4( position, 1.0 );\n\n}", Cu = "\nuniform sampler2DArray depthColor;\nuniform float depthWidth;\nuniform float depthHeight;\n\nvoid main() {\n\n	vec2 coord = vec2( gl_FragCoord.x / depthWidth, gl_FragCoord.y / depthHeight );\n\n	if ( coord.x >= 1.0 ) {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x - 1.0, coord.y, 1 ) ).r;\n\n	} else {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;\n\n	}\n\n}", wu = class {
	...
	getMesh(e) {
		if (this.texture !== null && this.mesh === null) {
			...
			this.mesh = new qr(new Ra(20, 20), n);
		}
		return this.mesh;
	}
	reset() {
	...
	constructor(e, t) {
		super();
		let n = this, r = null, i = 1, a = null, o = "local-floor", s = 1, c = null, u = null, d = null, f = null, p = null, h = null, g = typeof XRWebGLBinding < "u", _ = new wu(), v = {}, b = t.getContextAttributes(), x = null, S = null, C = [], D = [], O = new K(), k = null, A = new Bo();
		A.viewport = new Ht();
		let ee = new Bo();
		ee.viewport = new Ht();
		let j = [A, ee], M = new Xo(), te = null, N = null;
		this.cameraAutoUpdate = !0, this.enabled = !1, this.isPresenting = !1, this.getController = function(e) {
			let t = C[e];
			return t === void 0 && (t = new wn(), C[e] = t), t.getTargetRaySpace();
		}, this.getControllerGrip = function(e) {
			let t = C[e];
			return t === void 0 && (t = new wn(), C[e] = t), t.getGripSpace();
		}, this.getHand = function(e) {
			let t = C[e];
			return t === void 0 && (t = new wn(), C[e] = t), t.getHandSpace();
		};
		function P(e) {
		...
		function ne() {
			...
			te = null, N = null, _.reset();
			for (let e in v) delete v[e];
			e.setRenderTarget(x), p = null, f = null, d = null, r = null, S = null, ce.stop(), n.isPresenting = !1, e.setPixelRatio(k), e.setSize(O.width, O.height, !1), n.dispatchEvent({ type: "sessionend" });
		}
		this.setFramebufferScaleFactor = function(e) {
			...
			if (r = u, r !== null) {
				if (x = e.getRenderTarget(), r.addEventListener("select", P), r.addEventListener("selectstart", P), r.addEventListener("selectend", P), r.addEventListener("squeeze", P), r.addEventListener("squeezestart", P), r.addEventListener("squeezeend", P), r.addEventListener("end", ne), r.addEventListener("inputsourceschange", re), b.xrCompatible !== !0 && await t.makeXRCompatible(), k = e.getPixelRatio(), e.getSize(O), g && "createProjectionLayer" in XRWebGLBinding.prototype) {
					...
					d = this.getBinding(), f = d.createProjectionLayer(s), r.updateRenderState({ layers: [f] }), e.setPixelRatio(1), e.setSize(f.textureWidth, f.textureHeight, !1), S = new Wt(f.textureWidth, f.textureHeight, {
						format: w,
						type: l,
					...
					p = new XRWebGLLayer(r, t, n), r.updateRenderState({ baseLayer: p }), e.setPixelRatio(1), e.setSize(p.framebufferWidth, p.framebufferHeight, !1), S = new Wt(p.framebufferWidth, p.framebufferHeight, {
						format: w,
						type: l,
						colorSpace: e.outputColorSpace,
						stencilBuffer: b.stencil,
		...
		this.updateCamera = function(e) {
			...
			_.texture !== null && (_.depthNear > 0 && (t = _.depthNear), _.depthFar > 0 && (n = _.depthFar)), M.near = ee.near = A.near = t, M.far = ee.far = A.far = n, (te !== M.near || N !== M.far) && (r.updateRenderState({
				depthNear: M.near,
				depthFar: M.far
			}), te = M.near, N = M.far), M.layers.mask = e.layers.mask | 6, A.layers.mask = M.layers.mask & -5, ee.layers.mask = M.layers.mask & -3;
			let i = e.parent, a = M.cameras;
			oe(M, i);
			for (let e = 0; e < a.length; e++) oe(a[e], i);
			a.length === 2 ? F(M, A, ee) : M.projectionMatrix.copy(A.projectionMatrix), se(e, M, i);
		};
		function se(e, t, n) {
			n === null ? e.matrix.copy(t.matrixWorld) : (e.matrix.copy(n.matrixWorld), e.matrix.invert(), e.matrix.multiply(t.matrixWorld)), e.matrix.decompose(e.position, e.quaternion, e.scale), e.updateMatrixWorld(!0), e.projectionMatrix.copy(t.projectionMatrix), e.projectionMatrixInverse.copy(t.projectionMatrixInverse), e.isPerspectiveCamera && (e.fov = nt * 2 * Math.atan(1 / e.projectionMatrix.elements[5]), e.zoom = 1);
		}
		...
		let ce = new vs();
		ce.setAnimationLoop(L), this.setAnimationLoop = function(e) {
			I = e;
		}, this.dispose = function() {};
	}
}, Eu = /* @__PURE__ */ new qt(), Du = /* @__PURE__ */ new J();
Du.set(-1, 0, 0, 0, 1, 0, 0, 0, 1);
function Ou(e, t) {
	function n(e, t) {
		e.matrixAutoUpdate === !0 && e.updateMatrix(), t.value.copy(e.matrix);
	}
	function r(t, n) {
		n.color.getRGB(t.fogColor.value, Ja(e)), n.isFog ? (t.fogNear.value = n.near, t.fogFar.value = n.far) : n.isFogExp2 && (t.fogDensity.value = n.density);
	}
	function i(e, t, n, r, i) {
	...
	function a(e, r) {
		...
		a && (e.envMap.value = a, e.envMapRotation.value.setFromMatrix4(Eu.makeRotationFromEuler(o)).transpose(), a.isCubeTexture && a.isRenderTargetTexture === !1 && e.envMapRotation.value.premultiply(Du), e.reflectivity.value = r.reflectivity, e.ior.value = r.ior, e.refractionRatio.value = r.refractionRatio), r.lightMap && (e.lightMap.value = r.lightMap, e.lightMapIntensity.value = r.lightMapIntensity, n(r.lightMap, e.lightMapTransform)), r.aoMap && (e.aoMap.value = r.aoMap, e.aoMapIntensity.value = r.aoMapIntensity, n(r.aoMap, e.aoMapTransform));
	}
	function o(e, t) {
...
function Mu() {
	return ju === null && (ju = new Xr(Au, 16, 16, k, g), ju.name = "DFG_LUT", ju.minFilter = o, ju.magFilter = o, ju.wrapS = t, ju.wrapT = t, ju.generateMipmaps = !1, ju.needsUpdate = !0), ju;
}
var Nu = class {
	constructor(e = {}) {
		let { canvas: t = We(), context: n = null, depth: r = !0, stencil: i = !1, alpha: a = !1, antialias: o = !1, premultipliedAlpha: s = !0, preserveDrawingBuffer: u = !1, powerPreference: d = "default", failIfMajorPerformanceCaveat: p = !1, reversedDepthBuffer: h = !1, outputBufferType: b = l } = e;
		...
		let S = b, C = new Set([
			...
			_,
			v
		]), T = new Uint32Array(4), E = new Int32Array(4), D = new q(), k = null, j = null, M = [], te = [], N = null;
		this.domElement = t, this.debug = {
			checkShaderErrors: !0,
			onShaderError: null
		}, this.autoClear = !0, this.autoClearColor = !0, this.autoClearDepth = !0, this.autoClearStencil = !0, this.sortObjects = !0, this.clippingPlanes = [], this.localClippingEnabled = !1, this.toneMapping = 0, this.toneMappingExposure = 1, this.transmissionResolutionScale = 1;
		let P = this, ne = !1, re = null;
		this._outputColorSpace = Ne;
		let ie = 0, ae = 0, F = null, oe = -1, se = null, I = new Ht(), L = new Ht(), ce = null, le = new X(0), ue = 0, de = t.width, fe = t.height, pe = 1, me = null, he = null, ge = new Ht(0, 0, de, fe), _e = new Ht(0, 0, de, fe), ve = !1, ye = new pi(), be = !1, xe = !1, Se = new qt(), Ce = new q(), we = new Ht(), Te = {
			background: null,
			fog: null,
			environment: null,
		...
		try {
			...
			if ("setAttribute" in t && t.setAttribute("data-engine", "three.js r184"), t.addEventListener("webglcontextlost", tt, !1), t.addEventListener("webglcontextrestored", nt, !1), t.addEventListener("webglcontextcreationerror", rt, !1), R === null) {
				let t = "webgl2";
		...
		let z, ke, B, Ae, V, H, je, Me, Pe, Fe, Ie, Le, Re, ze, Ve, He, Ue, Ge, Ke, Je, Ye, Ze, Qe;
		function $e() {
			z = new Zs(R), z.init(), Ye = new xu(R, z), ke = new Ds(R, z, e, Ye), B = new yu(R, z), ke.reversedDepthBuffer && h && B.buffers.depth.setReversed(!0), Ae = new ec(R), V = new $l(), H = new bu(R, z, B, V, ke, Ye, Ae), je = new Xs(P), Me = new ys(R), Ze = new Ts(R, Me), Pe = new Qs(R, Me, Ae, Ze), Fe = new nc(R, Pe, Me, Ze, Ae), Ge = new tc(R, ke, H), Ve = new Os(V), Ie = new Ql(P, je, z, ke, Ze, Ve), Le = new Ou(P, V), Re = new ru(), ze = new uu(z), Ue = new ws(P, je, B, Fe, x, s), He = new vu(P, Fe, ke), Qe = new ku(R, Ae, ke, B), Ke = new Es(R, z, Ae), Je = new $s(R, z, Ae), Ae.programs = Ie.programs, P.capabilities = ke, P.extensions = z, P.properties = V, P.renderLists = Re, P.shadowMap = He, P.state = B, P.info = Ae;
		}
		$e(), S !== 1009 && (N = new ic(S, t.width, t.height, r, i));
		let et = new Tu(P, R);
		this.xr = et, this.getContext = function() {
			...
			let e = z.get("WEBGL_lose_context");
			e && e.loseContext();
			...
			de = e, fe = n, t.width = Math.floor(e * pe), t.height = Math.floor(n * pe), r === !0 && (t.style.width = e + "px", t.style.height = n + "px"), N !== null && N.setSize(t.width, t.height), this.setViewport(0, 0, e, n);
			...
			if (S === 1009) {
				W("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");
				return;
			}
			if (e) {
				for (let t = 0; t < e.length; t++) if (e[t].isOutputPass === !0) {
					U("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");
					break;
				}
			}
			N.setEffects(e || []);
			...
			e.isVector4 ? ge.set(e.x, e.y, e.z, e.w) : ge.set(e, t, n, r), B.viewport(I.copy(ge).multiplyScalar(pe).round());
		}, this.getScissor = function(e) {
			return e.copy(_e);
		}, this.setScissor = function(e, t, n, r) {
			e.isVector4 ? _e.set(e.x, e.y, e.z, e.w) : _e.set(e, t, n, r), B.scissor(L.copy(_e).multiplyScalar(pe).round());
		}, this.getScissorTest = function() {
			return ve;
		}, this.setScissorTest = function(e) {
			B.setScissorTest(ve = e);
			...
			if (e) {
				...
				if (e) {
					let e = F.texture.type, t = w.has(e), n = Ue.getClearColor(), r = Ue.getClearAlpha(), i = n.r, a = n.g, o = n.b;
		...
		function tt(e) {
			e.preventDefault(), qe("WebGLRenderer: Context Lost."), ne = !0;
		}
		function nt() {
			qe("WebGLRenderer: Context Restored."), ne = !1;
			let e = Ae.autoReset, t = He.enabled, n = He.autoUpdate, r = He.needsUpdate, i = He.type;
			$e(), Ae.autoReset = e, He.enabled = t, He.autoUpdate = n, He.needsUpdate = r, He.type = i;
		}
		function rt(e) {
		...
		function G(e) {
			let t = e.target;
			t.removeEventListener("dispose", G), it(t);
		}
		function it(e) {
			at(e), V.remove(e);
		}
		function at(e) {
			let t = V.get(e).programs;
		...
		this.renderBufferDirect = function(e, t, n, r, i, a) {
			...
			Ze.setup(i, r, s, n, c);
			let h, g = Ke;
			if (c !== null && (h = Me.get(c), g = Je, g.setIndex(h)), i.isMesh) r.wireframe === !0 ? (B.setLineWidth(r.wireframeLinewidth * De()), g.setMode(R.LINES)) : g.setMode(R.TRIANGLES);
			else if (i.isLine) {
				let e = r.linewidth;
				e === void 0 && (e = 1), B.setLineWidth(e * De()), i.isLineSegments ? g.setMode(R.LINES) : i.isLineLoop ? g.setMode(R.LINE_LOOP) : g.setMode(R.LINE_STRIP);
			} else i.isPoints ? g.setMode(R.POINTS) : i.isSprite && g.setMode(R.TRIANGLES);
			if (i.isBatchedMesh) if (z.get("WEBGL_multi_draw")) g.renderMultiDraw(i._multiDrawStarts, i._multiDrawCounts, i._multiDrawCount);
			else {
				let e = i._multiDrawStarts, t = i._multiDrawCounts, n = i._multiDrawCount, a = c ? Me.get(c).bytesPerElement : 1, o = V.get(r).currentProgram.getUniforms();
		...
		this.compile = function(e, t, n = null) {
			n === null && (n = e), j = ze.get(n), j.init(t), te.push(j), n.traverseVisible(function(e) {
			...
			return new Promise((t) => {
				...
				z.get("KHR_parallel_shader_compile") === null ? setTimeout(n, 10) : n();
			});
		};
		let st = null;
		function ct(e) {
		...
		dt.setAnimationLoop(ct), typeof self < "u" && dt.setContext(self), this.setAnimationLoop = function(e) {
			st = e, et.setAnimationLoop(e), e === null ? dt.stop() : dt.start();
		}, et.addEventListener("sessionstart", lt), et.addEventListener("sessionend", ut), this.render = function(e, t) {
			...
			let n = et.enabled === !0 && et.isPresenting === !0, r = N !== null && (F === null || n) && N.begin(P, F);
			if (e.matrixWorldAutoUpdate === !0 && e.updateMatrixWorld(), t.parent === null && t.matrixWorldAutoUpdate === !0 && t.updateMatrixWorld(), et.enabled === !0 && et.isPresenting === !0 && (N === null || N.isCompositing() === !1) && (et.cameraAutoUpdate === !0 && et.updateCamera(t), t = et.getCamera()), e.isScene === !0 && e.onBeforeRender(P, e, t, F), j = ze.get(e, te.length), j.init(t), j.state.textureUnits = H.getTextureUnits(), te.push(j), Se.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse), ye.setFromProjectionMatrix(Se, Be, t.reversedDepth), xe = this.localClippingEnabled, be = Ve.init(this.clippingPlanes, xe), k = Re.get(e, M.length), k.init(), M.push(k), et.enabled === !0 && et.isPresenting === !0) {
				let e = P.xr.getDepthSensingMesh();
				e !== null && ft(e, t, -Infinity, P.sortObjects);
			}
			ft(e, t, 0, P.sortObjects), k.finish(), P.sortObjects === !0 && k.sort(me, he), Ee = et.enabled === !1 || et.isPresenting === !1 || et.hasDepthSensing() === !1, Ee && Ue.addToRenderList(k, e), this.info.render.frame++, be === !0 && Ve.beginShadows();
			let i = j.state.shadowsArray;
			if (He.render(i, e, t), be === !0 && Ve.endShadows(), this.info.autoReset === !0 && this.info.reset(), (r && N.hasRenderPass()) === !1) {
			...
			if (e.layers.test(t.layers)) {
				if (e.isGroup) n = e.renderOrder;
					...
					if (!e.frustumCulled || ye.intersectsSprite(e)) {
						...
						i.visible && k.push(e, t, i, n, we.z, null);
					}
					...
					if (r && (e.boundingSphere === void 0 ? (t.boundingSphere === null && t.computeBoundingSphere(), we.copy(t.boundingSphere.center)) : (e.boundingSphere === null && e.computeBoundingSphere(), we.copy(e.boundingSphere.center)), we.applyMatrix4(e.matrixWorld).applyMatrix4(Se)), Array.isArray(i)) {
						...
						for (let a = 0, o = r.length; a < o; a++) {
							...
							s && s.visible && k.push(e, t, s, n, we.z, o);
						}
					} else i.visible && k.push(e, t, i, n, we.z, null);
				}
			}
			let i = e.children;
		...
		function pt(e, t, n, r) {
			...
			j.setupLightsView(n), be === !0 && Ve.setGlobalState(P.clippingPlanes, n), r && B.viewport(I.copy(r)), i.length > 0 && ht(i, t, n), a.length > 0 && ht(a, t, n), o.length > 0 && ht(o, t, n), B.buffers.depth.setTest(!0), B.buffers.depth.setMask(!0), B.buffers.color.setMask(!0), B.setPolygonOffset(!1);
		}
		function mt(e, t, n, r) {
			if ((n.isScene === !0 ? n.overrideMaterial : null) !== null) return;
			if (j.state.transmissionRenderTarget[r.id] === void 0) {
				let e = z.has("EXT_color_buffer_half_float") || z.has("EXT_color_buffer_float");
			...
			let a = j.state.transmissionRenderTarget[r.id], o = r.viewport || I;
			...
			P.setRenderTarget(a), P.getClearColor(le), ue = P.getClearAlpha(), ue < 1 && P.setClearColor(16777215, .5), P.clear(), Ee && Ue.render(n);
			let f = P.toneMapping;
			P.toneMapping = 0;
			let p = r.viewport;
			if (r.viewport !== void 0 && (r.viewport = void 0), j.setupLightsView(r), be === !0 && Ve.setGlobalState(P.clippingPlanes, r), ht(e, n, r), H.updateMultisampleRenderTarget(a), H.updateRenderTargetMipmap(a), z.has("WEBGL_multisampled_render_to_texture") === !1) {
				let e = !1;
				for (let i = 0, a = t.length; i < a; i++) {
				...
				e === !0 && (H.updateMultisampleRenderTarget(a), H.updateRenderTargetMipmap(a));
			}
			P.setRenderTarget(s, u, d), P.setClearColor(le, ue), p !== void 0 && (r.viewport = p), P.toneMapping = f;
		}
		function ht(e, t, n) {
		...
		function _t(e, t, n) {
			t.isScene !== !0 && (t = Te);
			let r = V.get(e), i = j.state.lights, a = j.state.shadowsArray, o = i.state.version, s = Ie.getParameters(e, i.state, a, t, n, j.state.lightProbeGridArray), c = Ie.getProgramCacheKey(s), l = r.programs;
		...
		function xt(e, t, n, r, i) {
			t.isScene !== !0 && (t = Te), H.resetTextureUnits();
			let a = t.fog, o = r.isMeshStandardMaterial || r.isMeshLambertMaterial || r.isMeshPhongMaterial ? t.environment : null, s = F === null ? P.outputColorSpace : F.isXRRenderTarget === !0 ? F.texture.colorSpace : Y.workingColorSpace, c = r.isMeshStandardMaterial || r.isMeshLambertMaterial && !r.envMap || r.isMeshPhongMaterial && !r.envMap, l = je.get(r.envMap || o, c), u = r.vertexColors === !0 && !!n.attributes.color && n.attributes.color.itemSize === 4, d = !!n.attributes.tangent && (!!r.normalMap || r.anisotropy > 0), f = !!n.morphAttributes.position, p = !!n.morphAttributes.normal, m = !!n.morphAttributes.color, h = 0;
			r.toneMapped && (F === null || F.isXRRenderTarget === !0) && (h = P.toneMapping);
			let g = n.morphAttributes.position || n.morphAttributes.normal || n.morphAttributes.color, _ = g === void 0 ? 0 : g.length, v = V.get(r), y = j.state.lights;
			if (be === !0 && (xe === !0 || e !== se)) {
				let t = e === se && r.id === oe;
				Ve.setState(r, e, t);
			}
			...
			b === !0 && (x = _t(r, t, i), re && r.isNodeMaterial && re.onUpdateProgram(r, x, v));
			let S = !1, C = !1, w = !1, T = x.getUniforms(), E = v.uniforms;
			if (B.useProgram(x.program) && (S = !0, C = !0, w = !0), r.id !== oe && (oe = r.id, C = !0), v.needsLights) {
				let e = bt(j.state.lightProbeGridArray, i);
				v.lightProbeGrid !== e && (v.lightProbeGrid = e, C = !0);
			}
			if (S || se !== e) {
				B.buffers.depth.getReversed() && e.reversedDepth !== !0 && (e._reversedDepth = !0, e.updateProjectionMatrix()), T.setValue(R, "projectionMatrix", e.projectionMatrix), T.setValue(R, "viewMatrix", e.matrixWorldInverse);
				let t = T.map.cameraPosition;
				t !== void 0 && t.setValue(R, Ce.setFromMatrixPosition(e.matrixWorld)), ke.logarithmicDepthBuffer && T.setValue(R, "logDepthBufFC", 2 / (Math.log(e.far + 1) / Math.LN2)), (r.isMeshPhongMaterial || r.isMeshToonMaterial || r.isMeshLambertMaterial || r.isMeshBasicMaterial || r.isMeshStandardMaterial || r.isShaderMaterial) && T.setValue(R, "isOrthographic", e.isOrthographicCamera === !0), se !== e && (se = e, C = !0, w = !0);
			}
			if (v.needsLights && (y.state.directionalShadowMap.length > 0 && T.setValue(R, "directionalShadowMap", y.state.directionalShadowMap, H), y.state.spotShadowMap.length > 0 && T.setValue(R, "spotShadowMap", y.state.spotShadowMap, H), y.state.pointShadowMap.length > 0 && T.setValue(R, "pointShadowMap", y.state.pointShadowMap, H)), i.isSkinnedMesh) {
				T.setOptional(R, i, "bindMatrix"), T.setOptional(R, i, "bindMatrixInverse");
				let e = i.skeleton;
				e && (e.boneTexture === null && e.computeBoneTexture(), T.setValue(R, "boneTexture", e.boneTexture, H));
			}
			i.isBatchedMesh && (T.setOptional(R, i, "batchingTexture"), T.setValue(R, "batchingTexture", i._matricesTexture, H), T.setOptional(R, i, "batchingIdTexture"), T.setValue(R, "batchingIdTexture", i._indirectTexture, H), T.setOptional(R, i, "batchingColorTexture"), i._colorsTexture !== null && T.setValue(R, "batchingColorTexture", i._colorsTexture, H));
			...
			if ((D.position !== void 0 || D.normal !== void 0 || D.color !== void 0) && Ge.update(i, n, x), (C || v.receiveShadow !== i.receiveShadow) && (v.receiveShadow = i.receiveShadow, T.setValue(R, "receiveShadow", i.receiveShadow)), (r.isMeshStandardMaterial || r.isMeshLambertMaterial || r.isMeshPhongMaterial) && r.envMap === null && t.environment !== null && (E.envMapIntensity.value = t.environmentIntensity), E.dfgLUT !== void 0 && (E.dfgLUT.value = Mu()), C) {
				if (T.setValue(R, "toneMappingExposure", P.toneMappingExposure), v.needsLights && St(E, w), a && r.fog === !0 && Le.refreshFogUniforms(E, a), Le.refreshMaterialUniforms(E, r, pe, fe, j.state.transmissionRenderTarget[e.id]), v.needsLights && v.lightProbeGrid) {
				...
				dl.upload(R, vt(v), E, H);
			}
			if (r.isShaderMaterial && r.uniformsNeedUpdate === !0 && (dl.upload(R, vt(v), E, H), r.uniformsNeedUpdate = !1), r.isSpriteMaterial && T.setValue(R, "center", i.center), T.setValue(R, "modelViewMatrix", i.modelViewMatrix), T.setValue(R, "normalMatrix", i.normalMatrix), T.setValue(R, "modelMatrix", i.matrixWorld), r.uniformsGroups !== void 0) {
		...
		this.getActiveCubeFace = function() {
			...
			let r = V.get(e);
			r.__autoAllocateDepthBuffer = e.resolveDepthBuffer === !1, r.__autoAllocateDepthBuffer === !1 && (r.__useRenderToTexture = !1), V.get(e.texture).__webglTexture = t, V.get(e.depthTexture).__webglTexture = r.__autoAllocateDepthBuffer ? void 0 : n, r.__hasExternalTextures = !0;
		}, this.setRenderTargetFramebuffer = function(e, t) {
			let n = V.get(e);
			n.__webglFramebuffer = t, n.__useDefaultFramebuffer = t === void 0;
		};
		let wt = R.createFramebuffer();
		this.setRenderTarget = function(e, t = 0, n = 0) {
			...
			if (e) {
				...
				if (o.__useDefaultFramebuffer !== void 0) {
					B.bindFramebuffer(R.FRAMEBUFFER, o.__webglFramebuffer), I.copy(e.viewport), L.copy(e.scissor), ce = e.scissorTest, B.viewport(I), B.scissor(L), B.setScissorTest(ce), oe = -1;
					return;
				} else if (o.__webglFramebuffer === void 0) H.setupRenderTarget(e);
				else if (o.__hasExternalTextures) H.rebindTextures(e, V.get(e.texture).__webglTexture, V.get(e.depthTexture).__webglTexture);
				else if (e.depthBuffer) {
					let t = e.depthTexture;
					if (o.__boundDepthTexture !== t) {
						if (t !== null && V.has(t) && (e.width !== t.image.width || e.height !== t.image.height)) throw Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");
						H.setupDepthRenderbuffer(e);
					}
				}
				let s = e.texture;
				(s.isData3DTexture || s.isDataArrayTexture || s.isCompressedArrayTexture) && (a = !0);
				let c = V.get(e).__webglFramebuffer;
				e.isWebGLCubeRenderTarget ? (r = Array.isArray(c[t]) ? c[t][n] : c[t], i = !0) : r = e.samples > 0 && H.useMultisampledRTT(e) === !1 ? V.get(e).__webglMultisampledFramebuffer : Array.isArray(c) ? c[n] : c, I.copy(e.viewport), L.copy(e.scissor), ce = e.scissorTest;
			} else I.copy(ge).multiplyScalar(pe).floor(), L.copy(_e).multiplyScalar(pe).floor(), ce = ve;
			if (n !== 0 && (r = wt), B.bindFramebuffer(R.FRAMEBUFFER, r) && B.drawBuffers(e, r), B.viewport(I), B.scissor(L), B.setScissorTest(ce), i) {
				let r = V.get(e.texture);
				R.framebufferTexture2D(R.FRAMEBUFFER, R.COLOR_ATTACHMENT0, R.TEXTURE_CUBE_MAP_POSITIVE_X + t, r.__webglTexture, n);
			} else if (a) {
				let r = t;
				for (let t = 0; t < e.textures.length; t++) {
					let i = V.get(e.textures[t]);
					R.framebufferTextureLayer(R.FRAMEBUFFER, R.COLOR_ATTACHMENT0 + t, i.__webglTexture, n, r);
				}
			} else if (e !== null && n !== 0) {
				let t = V.get(e.texture);
			...
			if (e.isWebGLCubeRenderTarget && o !== void 0 && (c = c[o]), c) {
				B.bindFramebuffer(R.FRAMEBUFFER, c);
				try {
					let o = e.textures[s], c = o.format, l = o.type;
					if (e.textures.length > 1 && R.readBuffer(R.COLOR_ATTACHMENT0 + s), !ke.textureFormatReadable(c)) {
					...
					let e = F === null ? null : V.get(F).__webglFramebuffer;
					B.bindFramebuffer(R.FRAMEBUFFER, e);
				}
			}
			...
			if (e.isWebGLCubeRenderTarget && o !== void 0 && (c = c[o]), c) if (t >= 0 && t <= e.width - r && n >= 0 && n <= e.height - i) {
				...
				if (e.textures.length > 1 && R.readBuffer(R.COLOR_ATTACHMENT0 + s), !ke.textureFormatReadable(l)) throw Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");
				...
				let f = F === null ? null : V.get(F).__webglFramebuffer;
				B.bindFramebuffer(R.FRAMEBUFFER, f);
				let p = R.fenceSync(R.SYNC_GPU_COMMANDS_COMPLETE, 0);
				return R.flush(), await Xe(R, p, 4), R.bindBuffer(R.PIXEL_PACK_BUFFER, d), R.getBufferSubData(R.PIXEL_PACK_BUFFER, 0, a), R.deleteBuffer(d), R.deleteSync(p), a;
			...
			H.setTexture2D(e, 0), R.copyTexSubImage2D(R.TEXTURE_2D, n, 0, 0, o, s, i, a), B.unbindTexture();
		};
		let K = R.createFramebuffer(), Tt = R.createFramebuffer();
		this.copyTextureToTexture = function(e, t, n = null, r = null, i = 0, a = 0) {
			...
			t.isData3DTexture ? (H.setTexture3D(t, 0), v = R.TEXTURE_3D) : t.isDataArrayTexture || t.isCompressedArrayTexture ? (H.setTexture2DArray(t, 0), v = R.TEXTURE_2D_ARRAY) : (H.setTexture2D(t, 0), v = R.TEXTURE_2D), B.activeTexture(R.TEXTURE0), B.pixelStorei(R.UNPACK_FLIP_Y_WEBGL, t.flipY), B.pixelStorei(R.UNPACK_PREMULTIPLY_ALPHA_WEBGL, t.premultiplyAlpha), B.pixelStorei(R.UNPACK_ALIGNMENT, t.unpackAlignment);
			let y = B.getParameter(R.UNPACK_ROW_LENGTH), b = B.getParameter(R.UNPACK_IMAGE_HEIGHT), x = B.getParameter(R.UNPACK_SKIP_PIXELS), S = B.getParameter(R.UNPACK_SKIP_ROWS), C = B.getParameter(R.UNPACK_SKIP_IMAGES);
			B.pixelStorei(R.UNPACK_ROW_LENGTH, h.width), B.pixelStorei(R.UNPACK_IMAGE_HEIGHT, h.height), B.pixelStorei(R.UNPACK_SKIP_PIXELS, l), B.pixelStorei(R.UNPACK_SKIP_ROWS, u), B.pixelStorei(R.UNPACK_SKIP_IMAGES, d);
			let w = e.isDataArrayTexture || e.isData3DTexture, T = t.isDataArrayTexture || t.isData3DTexture;
			if (e.isDepthTexture) {
				let n = V.get(e), r = V.get(t), h = V.get(n.__renderTarget), g = V.get(r.__renderTarget);
				B.bindFramebuffer(R.READ_FRAMEBUFFER, h.__webglFramebuffer), B.bindFramebuffer(R.DRAW_FRAMEBUFFER, g.__webglFramebuffer);
				for (let n = 0; n < c; n++) w && (R.framebufferTextureLayer(R.READ_FRAMEBUFFER, R.COLOR_ATTACHMENT0, V.get(e).__webglTexture, i, d + n), R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER, R.COLOR_ATTACHMENT0, V.get(t).__webglTexture, a, m + n)), R.blitFramebuffer(l, u, o, s, f, p, o, s, R.DEPTH_BUFFER_BIT, R.NEAREST);
				B.bindFramebuffer(R.READ_FRAMEBUFFER, null), B.bindFramebuffer(R.DRAW_FRAMEBUFFER, null);
			} else if (i !== 0 || e.isRenderTargetTexture || V.has(e)) {
				let n = V.get(e), r = V.get(t);
				B.bindFramebuffer(R.READ_FRAMEBUFFER, K), B.bindFramebuffer(R.DRAW_FRAMEBUFFER, Tt);
			...
			B.pixelStorei(R.UNPACK_ROW_LENGTH, y), B.pixelStorei(R.UNPACK_IMAGE_HEIGHT, b), B.pixelStorei(R.UNPACK_SKIP_PIXELS, x), B.pixelStorei(R.UNPACK_SKIP_ROWS, S), B.pixelStorei(R.UNPACK_SKIP_IMAGES, C), a === 0 && t.generateMipmaps && R.generateMipmap(v), B.unbindTexture();
		}, this.initRenderTarget = function(e) {
			V.get(e).__webglFramebuffer === void 0 && H.setupRenderTarget(e);
		}, this.initTexture = function(e) {
			e.isCubeTexture ? H.setTextureCube(e, 0) : e.isData3DTexture ? H.setTexture3D(e, 0) : e.isDataArrayTexture || e.isCompressedArrayTexture ? H.setTexture2DArray(e, 0) : H.setTexture2D(e, 0), B.unbindTexture();
		}, this.resetState = function() {
			ie = 0, ae = 0, F = null, B.reset(), Ze.reset();
...
//#endregion
export { l as $, no as A, e as B, o as C, qt as D, wt as E, Bo as F, Zi as G, Ne as H, Ra as I, Vt as J, Ba as K, Ho as L, eo as M, xn as N, qr as O, Uo as P, ds as Q, w as R, ai as S, Er as T, jn as U, za as V, Qa as W, Zo as X, Eo as Y, Ua as Z, Fa as _, vi as a, Sn as b, yi as c, Xr as d, y as et, E as f, Qe as g, ze as h, Me as i, Wt as it, to as j, Fr as k, X as l, Go as m, Nu as n, q as nt, ur as o, hi as p, Ha as q, Ko as r, Ht as rt, wr as s, Bs as t, K as tt, bi as u, h as v, Pe as w, Oo as x, An as y, ps as z };
