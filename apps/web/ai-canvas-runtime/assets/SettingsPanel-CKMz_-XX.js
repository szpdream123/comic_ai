...
import { A as c, An as l, Hn as u, In as d, Jn as f, Ln as p, Pn as m, S as h, Un as g, Vn as _, Wn as v, Yn as y, b, er as x, hi as S, j as C, kt as w, t as T, x as E, xi as D } from "./useAppStore-BH-MdRLu.js";
import { a as O } from "./core-D3lATfku.js";
import { a as k, l as A, n as j, s as M } from "./dist-js-CiPmuq1Z.js";
import { r as N } from "./dist-js-Cjy7VdJu.js";
import { E as P, M as F, N as I, O as L, j as R, m as ee, w as z } from "./directorSceneSchema-D22Qlbpb.js";
import { k as B, ot as V, x as H } from "./fileService-BawXHbsK.js";
import { a as te, r as ne } from "./ViewportImage-txaOn4PW.js";
import { t as U } from "./ModalOverlay-B0YAfIbK.js";
import { $ as re, C as ie, Kt as W, Nt as G, Pt as ae, Q as oe, W as se, X as ce, qt as le, rt as ue } from "./useTooltipAutoPlacement-D1FArkVS.js";
import { n as K } from "./rasterImageDimensions-CX1VK2cM.js";
import { c as de } from "./pluginRuntime-DJdo3vtj.js";
import { a as fe, i as pe } from "./clipboardService-Dwr2bAlQ.js";
import { a as q, c as me, d as he, i as ge, l as _e, n as ve, o as J, r as Y, s as ye, t as be, u as xe } from "./modelProtocolImport-Ca13SibB.js";
import { o as Se, t as X } from "./ChatMarkdown-C0G_rnzS.js";
import { a as Ce, o as we, r as Te } from "./directorDeskRuntimeService-B4LM4Z12.js";
import { t as Ee } from "./directorDeskWindowService-Br8LJiHk.js";
import { o as De, t as Z } from "./mcpBridgeService-CbxGlISN.js";
import { a as Oe, n as ke, o as Ae, r as je, s as Me, t as Ne } from "./mcpSessionConfig-BMS8WEq6.js";
import { r as Pe, t as Fe } from "./directorBlenderRuntimeService-DVIWpkEc.js";
//#region src/styles/settings.css
var Q = /* @__PURE__ */ e(t(), 1), Ie = "ai-canvas/provider-connection", Le = 1, Re = Object.keys(S), ze = [
...
function He(e) {
	return JSON.stringify({
		...
		connection: {
			...
			baseUrl: e.baseUrl,
			chatApiProtocol: ue(e.chatApiProtocol),
...
function Ue(e) {
	...
	let t = Ve(e.id);
	if (!t) return null;
	let n = Re.includes(e.category) ? e.category : "text", r = {
		id: t,
		name: Ve(e.name) || t,
		category: n,
		provider: "",
	...
	i && (r.description = i.slice(0, 500)), typeof e.contextWindow == "number" && Number.isFinite(e.contextWindow) && (r.contextWindow = Math.max(0, Math.floor(e.contextWindow))), Array.isArray(e.inputModalities) && (r.inputModalities = e.inputModalities.filter((e) => e === "text" || e === "image")), Be(e.videoCapability) && (r.videoCapability = e.videoCapability), ze.includes(e.imageReferenceRequestMode) && (r.imageReferenceRequestMode = e.imageReferenceRequestMode);
	let a = e.executionProfile;
	return Be(a) && typeof a.preset == "string" && (a.preset === "custom" ? v(a.protocol).length === 0 && (r.executionProfile = {
		preset: "custom",
		protocol: a.protocol
	}) : r.executionProfile = { preset: a.preset }), r;
}
function We(e) {
	if (Array.isArray(e)) return e.map(Ue).filter((e) => e !== null);
}
function Ge(e) {
	let t;
	try {
	...
	if (!Be(t) || t.kind !== Ie) return null;
	let n = Be(t.connection) ? t.connection : null;
	if (!n) return null;
	let r = Ve(n.catalogId) || "custom-openai", i = re(n.chatApiProtocol) ? n.chatApiProtocol : "openai-compatible", a = Array.isArray(n.visibleModelCategories) ? Re.filter((e) => n.visibleModelCategories.includes(e)) : void 0;
	return {
		catalogId: r,
		config: {
			name: Ve(n.name) || "导入的连接",
			apiKey: "",
			baseUrl: he(Ve(n.baseUrl), i) || void 0,
			chatApiProtocol: i,
			catalogId: r,
			selectedModels: We(n.selectedModels),
			catalogModels: We(n.catalogModels),
			visibleModelCategories: a
		}
	};
}
//#endregion
...
async function Je(e, t, n) {
	...
	for (let t of i) {
		...
		let i = qe(await n.json().catch(() => null));
		if (a = {
			success: !1,
			error: i ? `HTTP ${n.status}: ${i}` : `HTTP ${n.status}`
		}, n.status === 401 || n.status === 403) return a;
	}
	return a;
}
...
async function Xe(e) {
	let t = await (await x("https://www.runninghub.cn/uc/openapi/accountStatus", {
		method: "POST",
...
async function Qe(e, t) {
	...
	} : (await O("assistant_web_search", { request: {
		provider: e,
		apiKey: t,
...
var $e = {
	apimart: (e, t) => Je(e, t || "https://api.apib.ai/v1"),
	volcengine: (e, t) => Je(e, t || "https://ark.cn-beijing.volces.com/api/v3"),
	"runninghub-model": Xe,
	grsai: Ze,
...
async function et(e, t, n, r) {
	...
	let i = $e[e];
	try {
		if (i) return await i(t, n);
		let a = q(e);
		if (a?.authType === "oauth") return {
			success: !1,
			unsupported: !0,
			error: `${a.name} 使用 OAuth 登录，无需验证密钥`
		};
		let o = n?.trim() || a?.defaultBaseUrl;
		return o ? a?.connectionTestPath ? await Ye(t, o, a.connectionTestPath, a.requestQuery) : await Je(t, o, r) : {
			success: !1,
			error: `未知厂商: ${e}`
		};
	} catch (e) {
...
var tt = n(), $ = r();
function nt({ isOpen: e, runtime: t, onClose: n, onOpenUrl: r, onCopy: a }) {
	let o = i(), s = t?.phase || "preparing", c = t?.verificationUrl || "", l = t?.userCode || "", u = s === "oauth_ready" || s === "polling", d = s === "preparing" || s === "starting";
	return (0, tt.createPortal)(/* @__PURE__ */ (0, $.jsx)(te, { children: e && /* @__PURE__ */ (0, $.jsx)(ne.div, {
		...
		onClick: n,
		children: /* @__PURE__ */ (0, $.jsxs)(ne.div, {
...
function ut(e, t, n = "openai-compatible") {
	let r = t.trim().replace(/\/+$/, ""), i = r ? `${r}/docs` : "【请在这里粘贴该中转站的文档或模型列表页面 HTTPS 链接（若上面的接口地址已填，这里可留空，我会自动尝试 /docs）】";
	return [
		"请帮我把这个「中转站 / 聚合 API」里的模型添加为自定义接口配置。",
		"",
		`目标连接名称：${e || "（未填，可自定义）"}`,
		`对话协议：${ce[n]}（provider_config_preview 的 chatApiProtocol 必须填写 ${n}）`,
		r ? `接口地址（Base URL）：${r} —— 所有模型都用这个真实接口地址，不要拿文档站域名当 Base URL。` : "接口地址（Base URL）：未填。请从文档 / 中转站地址确定真实 API 接口地址（不是文档站域名）；new-api / one-api 中转站的文档域名通常就是 API 域名。",
		"",
		"请这样操作：",
		...
		"5. 读完所选模型的接口页后必须立即调用 provider_config_preview 生成草稿，并传入上面指定的 chatApiProtocol，再调用 provider_config_apply 保存；不要只报告一遍字段就结束任务（同一 Base URL 与同一对话协议，单次最多 16 个，超出就分多次保存）。",
...
async function dt(e) {
	try {
		await import("./dist-js-BTabQsg0.js").then(({ open: t }) => t(e));
	} catch {
...
function ft({ editing: e, definition: t, isWebSearchProvider: n, connectionName: r, setConnectionName: a, chatApiProtocol: o, setChatApiProtocol: s, apiKey: c, setApiKey: l, baseUrl: u, setBaseUrl: d, workflowApiKey: f, setWorkflowApiKey: p, dreaminaLoggedIn: m, dreaminaLoading: h, onDreaminaLogin: g, duplicateConnectionName: _, catalogStatus: v, catalogMessage: y, missingCredentials: b, onReturnToPicker: x, onTestConnection: S }) {
	let C = i();
	return /* @__PURE__ */ (0, $.jsxs)("section", {
		...
		children: [
			/* @__PURE__ */ (0, $.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, $.jsxs)("div", { children: [/* @__PURE__ */ (0, $.jsx)("h4", { children: C("连接信息") }), /* @__PURE__ */ (0, $.jsx)("p", { children: t.description })] }), !e && !n && /* @__PURE__ */ (0, $.jsx)(W, {
					type: "button",
			...
			t.id === "custom-openai" && /* @__PURE__ */ (0, $.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, $.jsx)(K, {
					...
					width: "16"
				}), /* @__PURE__ */ (0, $.jsx)("span", { children: C("提示：每个中转站提供的模型和参数规则都不一样，从接口拉取下来的模型，不一定能直接拿来用。不同中转站对同一个模型的名字、传入图片、尺寸等参数往往不同，直接使用可能会报错。请先查看你所用中转站的官方文档，把对应的参数改成文档里的值。如果你不会改，可以这样做：直接把中转站的文档发给对话助手，或者开启智能体并接入 MCP，让助手照着文档帮你添加和配置。") })]
			}),
			t.id === "custom-openai" && /* @__PURE__ */ (0, $.jsxs)("label", {
				className: "provider-field",
				children: [/* @__PURE__ */ (0, $.jsx)("span", { children: C("连接名称") }), /* @__PURE__ */ (0, $.jsx)("input", {
					type: "text",
					value: r,
					placeholder: C("例如：团队模型网关"),
			...
			t.id === "custom-openai" && /* @__PURE__ */ (0, $.jsxs)("label", {
				className: "provider-field",
				children: [
					/* @__PURE__ */ (0, $.jsx)("span", { children: C("对话协议") }),
					/* @__PURE__ */ (0, $.jsx)("select", {
						className: "ui-select__control",
						value: o,
						onChange: (e) => s(e.target.value),
						children: Object.entries(ce).map(([e, t]) => /* @__PURE__ */ (0, $.jsx)("option", {
							value: e,
							children: C(t)
						}, e))
					}),
					/* @__PURE__ */ (0, $.jsx)("small", { children: C(o === "anthropic-compatible" ? "使用 Messages API、x-api-key 和 Anthropic 流式事件" : o === "gemini-native" ? "使用原生 generateContent、x-goog-api-key 和 Gemini 内容结构" : "使用 Chat Completions、Bearer Key 和 OpenAI SSE") })
				]
			}),
			t.authType === "oauth" ? /* @__PURE__ */ (0, $.jsxs)("div", {
				className: "provider-oauth-row",
				children: [
					/* @__PURE__ */ (0, $.jsx)("span", { className: `provider-connection-dot${m ? " is-online" : ""}` }),
					/* @__PURE__ */ (0, $.jsxs)("div", { children: [/* @__PURE__ */ (0, $.jsx)("strong", { children: C(m ? "即梦账号已登录" : "即梦账号未登录") }), /* @__PURE__ */ (0, $.jsx)("small", { children: C("模型调用使用桌面端 OAuth 登录态") })] }),
					/* @__PURE__ */ (0, $.jsx)(W, {
						type: "button",
						className: "provider-secondary-btn",
						disabled: h,
						onClick: g,
						children: C(h ? "处理中..." : m ? "重新登录" : "OAuth 登录")
					})
				]
			}) : /* @__PURE__ */ (0, $.jsxs)("div", {
				className: "provider-fields-grid",
				children: [t.credentials.map((e) => {
					let n = e.key === "apiKey" ? c : u, r = e.key === "baseUrl" && t.allowCustomBaseUrl === !1;
					return /* @__PURE__ */ (0, $.jsxs)("label", {
						...
						children: [/* @__PURE__ */ (0, $.jsxs)("span", { children: [e.label, e.required ? " *" : ""] }), /* @__PURE__ */ (0, $.jsx)("input", {
							...
							disabled: r,
							onChange: (t) => {
								e.key === "apiKey" ? l(t.target.value) : d(t.target.value);
							},
							onBlur: (t) => {
								e.key === "baseUrl" && d(he(t.target.value, o));
							}
						})]
					}, e.key);
				}), t.id === "runninghub-model" && /* @__PURE__ */ (0, $.jsxs)("label", {
					className: "provider-field",
					children: [/* @__PURE__ */ (0, $.jsx)("span", { children: C("消费级-会员 API Key") }), /* @__PURE__ */ (0, $.jsx)("input", {
						type: "password",
						value: f,
						placeholder: C("用于 RunningHub 工作流执行（可选）"),
						onChange: (e) => p(e.target.value)
					})]
				})]
			}),
			_ && /* @__PURE__ */ (0, $.jsxs)("div", {
				className: "provider-catalog-message is-warning",
				children: [/* @__PURE__ */ (0, $.jsx)(K, {
					icon: "mdi:content-duplicate",
					width: "14"
				}), /* @__PURE__ */ (0, $.jsx)("span", { children: C("已有连接「{name}」使用相同接口地址和对话协议。继续保存会新建第二条同网关连接；如果只是想加模型，建议回列表编辑「{name}」。", { name: _ }) })]
			}),
			(t.externalUrl || lt[t.id]) && /* @__PURE__ */ (0, $.jsxs)("button", {
				type: "button",
				className: "provider-external-link",
				onClick: () => void dt(t.externalUrl || lt[t.id]),
				children: [/* @__PURE__ */ (0, $.jsx)(K, {
					icon: "mdi:open-in-new",
					width: "13"
				}), t.id === "grsai" ? C("前往 API Key 页面") : C("前往厂商控制台")]
			}),
			t.authType !== "oauth" && /* @__PURE__ */ (0, $.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, $.jsxs)(W, {
					type: "button",
					className: "provider-secondary-btn",
					disabled: b || v === "loading",
					onClick: () => void S(),
					children: [/* @__PURE__ */ (0, $.jsx)(K, {
						icon: v === "loading" ? "mdi:loading" : "mdi:connection",
						className: v === "loading" ? "settings-spin" : void 0,
						width: "15"
					}), C(v === "loading" ? "验证中" : "验证连接")]
				}), n && y && /* @__PURE__ */ (0, $.jsxs)("div", {
					className: `provider-catalog-message is-${v} m-0 flex-1`,
					children: [/* @__PURE__ */ (0, $.jsx)(K, {
						icon: v === "error" ? "mdi:alert-circle-outline" : "mdi:information-outline",
						width: "14"
					}), /* @__PURE__ */ (0, $.jsx)("span", { children: y })]
				})]
			})
		]
	});
...
var mt = {
	...
	video: f("video"),
	audio: f("audio")
}, gt = "仅用于轮询请求：提交响应中解析出的任务 ID";
function _t(e) {
	return y(e) ?? "调用时替换为节点中的实际值";
}
function vt(e) {
	let t = {
		model: e.id,
...
function xt(e) {
	try {
		let t = JSON.parse(e), n = v(t);
		return n.length > 0 ? { error: n[0] } : { protocol: u(t) };
	} catch (e) {
...
function wt({ fieldId: e, label: t, value: n, kind: r = "object", rows: i = 4, onChange: a, onValidityChange: o }) {
	let [s, c] = (0, Q.useState)(() => St(n)), [l, u] = (0, Q.useState)(null), d = (t) => {
		c(t);
		try {
			let n = JSON.parse(t);
			if (r === "object" && !Ct(n)) throw Error("必须是 JSON 对象");
			u(null), o(e), a(n);
		} catch (t) {
...
function Et({ model: e, apiKey: t, baseUrl: n, onChange: r, onImageReferenceRequestModeChange: a, onValidityChange: o, onClose: s }) {
	let c = i(), f = e.executionProfile?.preset ?? "legacy", h = e.executionProfile?.preset === "custom" && e.executionProfile.protocol ? u(e.executionProfile.protocol) : d(e.category), [y, b] = (0, Q.useState)(f), [x, S] = (0, Q.useState)(h), [C, w] = (0, Q.useState)("form"), [T, E] = (0, Q.useState)(() => St(h)), [D, O] = (0, Q.useState)(null), [k, A] = (0, Q.useState)(0), [j, M] = (0, Q.useState)(() => St(vt(e))), [N, P] = (0, Q.useState)(() => St(yt())), F = (0, Q.useId)(), I = `${F}-error`, L = (0, Q.useId)(), R = `${L}-error`, ee = (0, Q.useId)(), z = `${ee}-help`, B = (0, Q.useRef)(/* @__PURE__ */ new Set()), [V, H] = (0, Q.useState)({ status: "idle" }), te = (0, Q.useRef)(null);
	(0, Q.useEffect)(() => () => te.current?.abort(), []);
	let ne = (e) => {
		S(e), E(St(e));
		let t = v(e);
		O(t[0] ?? null);
		let n = t.length === 0 && B.current.size === 0;
		o(n), n && r({
			preset: "custom",
			protocol: u(e)
		});
	}, U = (e) => {
		let t = structuredClone(x);
		e(t), ne(t);
	}, re = (e, t) => {
		t ? B.current.add(e) : B.current.delete(e);
		let n = v(x);
		O(n[0] ?? null), o(n.length === 0 && B.current.size === 0);
	}, ie = (e) => {
		E(e);
		let t = xt(e);
		O(t.error ?? null), o(!!t.protocol), t.protocol && (B.current.clear(), S(t.protocol), r({
			preset: "custom",
			protocol: t.protocol
		}));
	}, W = (e) => {
		B.current.clear(), O(null), E(St(x)), w(e), o(v(x).length === 0);
	}, ae = (e) => {
		if (b(e), O(null), B.current.clear(), e === "legacy") {
			o(!0), r(void 0);
			return;
		}
		if (e === "custom") {
			ne(y !== "legacy" && y !== "custom" ? p(y) : x);
			return;
		}
		let t = p(e);
		S(t), E(St(t)), o(!0), r({ preset: e });
	}, oe = (t) => {
		U((n) => {
		...
		e && (U((t) => {
			let n = Ct(t.submit.body) ? t.submit.body : {};
		...
		t && (U((n) => {
			let r = Ct(n.submit.body) ? n.submit.body : {};
	...
	}, J = x.auth ?? { type: "bearer" }, Y = x.poll, ye = x.response.result ?? {}, be = Y?.response, xe = be?.result, Se = {
		...m(),
		...Y?.retry
	}, X = (0, Q.useMemo)(() => {
		if (y !== "custom") return {};
		try {
			let e = JSON.parse(j);
			if (!Ct(e)) throw Error("示例变量必须是 JSON 对象");
			return { preview: _({
		...
		j,
		x
	]), Ce = x.mode === "async" || x.response.type === "json", we = (0, Q.useMemo)(() => {
		if (y !== "custom" || !Ce) return {};
		try {
			let e = JSON.parse(N);
			if (!Ct(e) && !Array.isArray(e)) throw Error("响应示例必须是 JSON 对象或数组");
			return { entries: g(x, e) };
		} catch (e) {
		...
		try {
			let t = JSON.parse(j);
			if (!Ct(t)) throw Error("示例变量必须是 JSON 对象");
			e = t;
		} catch (e) {
			H({
				status: "error",
		...
		try {
			...
			H({
				status: "success",
				message: [
					i.urls?.length ? c("返回 {count} 个结果地址", { count: i.urls.length }) : "",
					i.text ? c("返回文本 {count} 字", { count: i.text.length }) : "",
					i.taskId ? c("任务 ID {id}", { id: i.taskId }) : ""
				].filter(Boolean).join("，") || c("调用成功，但没有解析出结果"),
				detail: St(i)
			});
		} catch (e) {
			if (r.signal.aborted) return;
			H({
				status: "error",
				message: e instanceof Error ? e.message : c("试跑失败")
			});
		}
	}, Ee = () => {
		te.current?.abort(), te.current = null, H({ status: "idle" });
	}, De = pt(y, t, n), Z = De === "legacy-preset" ? c("「自动兼容」不走声明式协议，无法试跑") : De === "missing-base-url" ? c("先填写接口地址") : De === "missing-api-key" ? c("先填写 API Key") : "";
	return /* @__PURE__ */ (0, $.jsxs)("section", {
		className: "provider-protocol-editor is-small",
		"aria-label": c("{name} 调用协议", { name: e.name }),
		children: [
			/* @__PURE__ */ (0, $.jsxs)("div", {
				className: "provider-protocol-editor-head",
				children: [/* @__PURE__ */ (0, $.jsxs)("div", { children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("模型调用协议") }), /* @__PURE__ */ (0, $.jsx)("strong", { children: e.name })] }), /* @__PURE__ */ (0, $.jsx)(G, {
					ariaLabel: c("关闭协议设置"),
					onClick: s
				})]
			}),
			/* @__PURE__ */ (0, $.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, $.jsxs)("label", {
						...
						children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("协议预设") }), /* @__PURE__ */ (0, $.jsx)("select", {
							value: y,
							onChange: (e) => ae(e.target.value),
							children: bt(e.category).map((e) => /* @__PURE__ */ (0, $.jsx)("option", {
								value: e,
								children: c(mt[e])
							}, e))
						})]
					...
					e.category === "image" ? /* @__PURE__ */ (0, $.jsxs)("label", {
						className: "provider-protocol-field",
						children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("参考图请求") }), /* @__PURE__ */ (0, $.jsxs)("select", {
							value: e.imageReferenceRequestMode ?? "generation-json-image-urls",
							onChange: (e) => a(e.target.value),
							children: [
								/* @__PURE__ */ (0, $.jsx)("option", {
									value: "generation-json-image-urls",
									children: c("生成接口 JSON（image_urls）")
								}),
								/* @__PURE__ */ (0, $.jsx)("option", {
									value: "generation-json-image-data-urls",
									children: c("生成接口 JSON（image，data URL 数组）")
								}),
								/* @__PURE__ */ (0, $.jsx)("option", {
									value: "edits-multipart",
									children: c("编辑接口 Multipart（图片文件）")
								})
							]
						})]
					}) : null,
					y === "custom" ? /* @__PURE__ */ (0, $.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, $.jsx)("button", {
							type: "button",
							role: "tab",
							"aria-selected": C === "form",
							className: C === "form" ? "is-active" : "",
							onClick: () => W("form"),
							children: c("表单")
						}), /* @__PURE__ */ (0, $.jsx)("button", {
							type: "button",
							role: "tab",
							"aria-selected": C === "json",
							className: C === "json" ? "is-active" : "",
							onClick: () => W("json"),
							children: "JSON"
						})]
					}) : null
					...
					/* @__PURE__ */ (0, $.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, $.jsxs)("button", {
								...
								disabled: !!Z || V.status === "running",
								title: Z || void 0,
								onClick: () => void Te(),
								children: [/* @__PURE__ */ (0, $.jsx)(K, {
									icon: V.status === "running" ? "mdi:loading" : "mdi:play-circle-outline",
									className: V.status === "running" ? "settings-spin" : void 0,
									width: "14"
								}), V.status === "running" ? c("试跑中") : c("试跑")]
							}),
							V.status === "running" ? /* @__PURE__ */ (0, $.jsx)("button", {
								type: "button",
							...
							/* @__PURE__ */ (0, $.jsx)("small", {
								...
								children: Z || c("用上面的示例变量真发一次请求，会产生真实调用与计费")
							})
						]
					}),
					V.message ? /* @__PURE__ */ (0, $.jsxs)("div", {
						className: `provider-catalog-message is-${V.status === "error" ? "error" : "ready"} mt-2`,
						children: [/* @__PURE__ */ (0, $.jsx)(K, {
							icon: V.status === "error" ? "mdi:alert-circle-outline" : "mdi:check-circle-outline",
							width: "14"
						}), /* @__PURE__ */ (0, $.jsx)("span", {
							className: "break-all",
							children: V.message
			...
			y === "custom" && C === "form" ? /* @__PURE__ */ (0, $.jsxs)("div", {
				...
				children: [
						...
						children: [
							/* @__PURE__ */ (0, $.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, $.jsx)(K, {
									...
									width: "14"
								}), /* @__PURE__ */ (0, $.jsx)("span", { children: c("协议与鉴权") })]
							}),
							/* @__PURE__ */ (0, $.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, $.jsxs)("label", {
										className: "provider-protocol-field",
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("执行模式") }), /* @__PURE__ */ (0, $.jsxs)("select", {
											value: x.mode,
									...
									/* @__PURE__ */ (0, $.jsxs)("label", {
										className: "provider-protocol-field",
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("鉴权方式") }), /* @__PURE__ */ (0, $.jsxs)("select", {
											value: J.type,
									...
									J.type === "header" || J.type === "query" ? /* @__PURE__ */ (0, $.jsxs)("label", {
										className: "provider-protocol-field",
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: J.type === "header" ? c("Header 名称") : c("Query 名称") }), /* @__PURE__ */ (0, $.jsx)("input", {
											value: J.name ?? "",
											onChange: (e) => U((t) => {
												t.auth = {
													...J,
										...
										className: "provider-protocol-field",
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("密钥前缀") }), /* @__PURE__ */ (0, $.jsx)("input", {
											value: J.prefix ?? "",
							...
							e.category === "text" ? /* @__PURE__ */ (0, $.jsxs)("label", {
								...
								children: [/* @__PURE__ */ (0, $.jsx)("input", {
									type: "checkbox",
									checked: x.streamFormat === "openai-sse",
									onChange: (e) => U((t) => {
										e.target.checked ? t.streamFormat = "openai-sse" : delete t.streamFormat;
									})
								}), /* @__PURE__ */ (0, $.jsx)("span", { children: c("OpenAI SSE 对话兼容") })]
							}) : null
						]
					}),
					/* @__PURE__ */ (0, $.jsxs)("section", {
						...
						children: [
							/* @__PURE__ */ (0, $.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, $.jsx)(K, {
									...
									width: "14"
								}), /* @__PURE__ */ (0, $.jsx)("span", { children: c("提交请求") })]
							}),
							/* @__PURE__ */ (0, $.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, $.jsxs)("label", {
										className: "provider-protocol-field",
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("方法") }), /* @__PURE__ */ (0, $.jsxs)("select", {
											value: x.submit.method,
									...
									/* @__PURE__ */ (0, $.jsxs)("label", {
										className: "provider-protocol-field",
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("路径") }), /* @__PURE__ */ (0, $.jsx)("input", {
											value: x.submit.path,
									...
									/* @__PURE__ */ (0, $.jsxs)("label", {
										className: "provider-protocol-field",
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("路径基准") }), /* @__PURE__ */ (0, $.jsxs)("select", {
											value: x.submit.pathMode ?? "append",
							...
							/* @__PURE__ */ (0, $.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, $.jsxs)("label", {
										className: "provider-protocol-field",
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("请求体编码") }), /* @__PURE__ */ (0, $.jsxs)("select", {
											value: x.submit.bodyEncoding ?? "json",
									...
									e.category === "image" || e.category === "video" ? /* @__PURE__ */ (0, $.jsxs)("label", {
										...
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("插入尺寸字段") }), /* @__PURE__ */ (0, $.jsxs)("select", {
											value: "",
									...
									e.category === "image" && x.submit.bodyEncoding === "multipart" ? /* @__PURE__ */ (0, $.jsxs)("label", {
										className: "provider-protocol-field",
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("插入文件字段") }), /* @__PURE__ */ (0, $.jsxs)("select", {
											value: "",
									...
									e.category === "image" && x.submit.bodyEncoding !== "multipart" ? /* @__PURE__ */ (0, $.jsxs)("label", {
										className: "provider-protocol-field",
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("插入参考图字段") }), /* @__PURE__ */ (0, $.jsxs)("select", {
											value: "",
									...
									e.category === "video" && x.submit.bodyEncoding !== "multipart" ? /* @__PURE__ */ (0, $.jsxs)("label", {
										className: "provider-protocol-field",
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("插入参考素材字段") }), /* @__PURE__ */ (0, $.jsxs)("select", {
											value: "",
							...
							/* @__PURE__ */ (0, $.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, $.jsx)(wt, {
									fieldId: "submit-headers",
									label: c("请求头 JSON"),
									value: x.submit.headers,
									rows: 4,
									onValidityChange: re,
						...
						children: [
							/* @__PURE__ */ (0, $.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, $.jsx)(K, {
									icon: "mdi:code-json",
									width: "14"
								}), /* @__PURE__ */ (0, $.jsx)("span", { children: x.mode === "sync" ? c("返回值结构") : c("任务与返回值结构") })]
							}),
							x.mode === "sync" ? /* @__PURE__ */ (0, $.jsxs)($.Fragment, { children: [/* @__PURE__ */ (0, $.jsxs)("div", {
								className: "provider-protocol-grid is-three",
								children: [
									/* @__PURE__ */ (0, $.jsxs)("label", {
										className: "provider-protocol-field",
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("响应类型") }), /* @__PURE__ */ (0, $.jsxs)("select", {
											value: x.response.type,
									...
									x.response.type === "binary" ? /* @__PURE__ */ (0, $.jsxs)("label", {
										className: "provider-protocol-field",
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("备用 MIME 类型") }), /* @__PURE__ */ (0, $.jsx)("input", {
											value: ye.mimeType ?? "",
									...
									/* @__PURE__ */ (0, $.jsxs)("label", {
										className: "provider-protocol-field",
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("错误路径") }), /* @__PURE__ */ (0, $.jsx)("input", {
											value: x.response.errorPath ?? "",
											onChange: (e) => me({ errorPath: e.target.value || void 0 })
										})]
									})
								]
							}), x.response.type === "json" ? /* @__PURE__ */ (0, $.jsxs)("div", {
								className: "provider-protocol-grid is-three",
								children: [
									/* @__PURE__ */ (0, $.jsxs)("label", {
										className: "provider-protocol-field",
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("URL 结果路径") }), /* @__PURE__ */ (0, $.jsx)("input", {
											value: ye.urlPath ?? "",
									...
									/* @__PURE__ */ (0, $.jsxs)("label", {
										className: "provider-protocol-field",
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("文本结果路径") }), /* @__PURE__ */ (0, $.jsx)("input", {
											value: ye.textPath ?? "",
									...
									/* @__PURE__ */ (0, $.jsxs)("label", {
										className: "provider-protocol-field",
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("Base64 结果路径") }), /* @__PURE__ */ (0, $.jsx)("input", {
											value: ye.base64Path ?? "",
									...
									ye.base64Path ? /* @__PURE__ */ (0, $.jsxs)("label", {
										className: "provider-protocol-field",
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("Base64 MIME 类型") }), /* @__PURE__ */ (0, $.jsx)("input", {
											value: ye.mimeType ?? "",
											placeholder: e.category === "video" ? "video/mp4" : e.category === "audio" ? "audio/mpeg" : "image/png",
											onChange: (e) => he({ mimeType: e.target.value || void 0 })
										})]
								...
								/* @__PURE__ */ (0, $.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, $.jsxs)("label", {
											className: "provider-protocol-field",
											children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("任务 ID 路径") }), /* @__PURE__ */ (0, $.jsx)("input", {
												value: x.response.taskIdPath ?? "",
												onChange: (e) => me({ taskIdPath: e.target.value })
											})]
										}),
										/* @__PURE__ */ (0, $.jsxs)("label", {
											className: "provider-protocol-field",
											children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("轮询方法") }), /* @__PURE__ */ (0, $.jsxs)("select", {
												value: Y.method,
												onChange: (e) => q({ method: e.target.value }),
												children: [/* @__PURE__ */ (0, $.jsx)("option", {
													value: "GET",
													children: "GET"
												}), /* @__PURE__ */ (0, $.jsx)("option", {
										...
										/* @__PURE__ */ (0, $.jsxs)("label", {
											className: "provider-protocol-field",
											children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("轮询间隔 ms") }), /* @__PURE__ */ (0, $.jsx)("input", {
												type: "number",
												min: 1e3,
												max: 6e4,
												value: Y.intervalMs ?? 3e3,
												onChange: (e) => q({ intervalMs: Number(e.target.value) })
											})]
										}),
										/* @__PURE__ */ (0, $.jsxs)("label", {
											className: "provider-protocol-field",
											children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("轮询请求体编码") }), /* @__PURE__ */ (0, $.jsxs)("select", {
												value: Y.bodyEncoding ?? "json",
												onChange: (e) => q({ bodyEncoding: e.target.value }),
												children: [/* @__PURE__ */ (0, $.jsx)("option", {
													value: "json",
													children: "JSON"
												}), /* @__PURE__ */ (0, $.jsx)("option", {
								...
								/* @__PURE__ */ (0, $.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, $.jsxs)("label", {
										...
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("轮询路径") }), /* @__PURE__ */ (0, $.jsx)("input", {
											value: Y.path,
											onChange: (e) => q({ path: e.target.value })
										})]
									}), /* @__PURE__ */ (0, $.jsxs)("label", {
										className: "provider-protocol-field",
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("路径基准") }), /* @__PURE__ */ (0, $.jsxs)("select", {
											value: Y.pathMode ?? "append",
											onChange: (e) => q({ pathMode: e.target.value }),
											children: [/* @__PURE__ */ (0, $.jsx)("option", {
												value: "append",
												children: c("连接地址")
											}), /* @__PURE__ */ (0, $.jsx)("option", {
								...
								/* @__PURE__ */ (0, $.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, $.jsx)(wt, {
										...
										rows: 4,
										onValidityChange: re,
										onChange: (e) => q({ headers: e })
									}), /* @__PURE__ */ (0, $.jsx)(wt, {
										fieldId: "poll-query",
										label: c("轮询 Query JSON"),
										value: Y.query,
										rows: 4,
										onValidityChange: re,
										onChange: (e) => q({ query: e })
									})]
								}),
								/* @__PURE__ */ (0, $.jsx)(wt, {
									fieldId: "poll-body",
								...
								/* @__PURE__ */ (0, $.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, $.jsxs)("label", {
											className: "provider-protocol-field",
											children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("状态路径") }), /* @__PURE__ */ (0, $.jsx)("input", {
												value: be?.statusPath ?? "",
										...
										/* @__PURE__ */ (0, $.jsxs)("label", {
											className: "provider-protocol-field",
											children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("成功状态") }), /* @__PURE__ */ (0, $.jsx)("input", {
										...
										/* @__PURE__ */ (0, $.jsxs)("label", {
											className: "provider-protocol-field",
											children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("失败状态") }), /* @__PURE__ */ (0, $.jsx)("input", {
								...
								/* @__PURE__ */ (0, $.jsxs)("div", {
									...
									children: [
										...
										xe?.base64Path ? /* @__PURE__ */ (0, $.jsxs)("label", {
											className: "provider-protocol-field",
											children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("Base64 MIME 类型") }), /* @__PURE__ */ (0, $.jsx)("input", {
												value: xe.mimeType ?? "",
												placeholder: e.category === "video" ? "video/mp4" : e.category === "audio" ? "audio/mpeg" : "image/png",
								...
								/* @__PURE__ */ (0, $.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, $.jsxs)("label", {
										...
										className: "provider-protocol-field",
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("进度路径") }), /* @__PURE__ */ (0, $.jsx)("input", {
										...
										children: [
											/* @__PURE__ */ (0, $.jsxs)("div", {
												...
												children: [
													/* @__PURE__ */ (0, $.jsxs)("label", {
														className: "provider-protocol-field",
														children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("最大轮询次数") }), /* @__PURE__ */ (0, $.jsx)("input", {
															type: "number",
															min: 1,
															max: 1e4,
															value: Y.maxAttempts ?? "",
															onChange: (e) => q({ maxAttempts: Number.isFinite(e.target.valueAsNumber) ? e.target.valueAsNumber : void 0 })
														})]
													}),
													/* @__PURE__ */ (0, $.jsxs)("label", {
														className: "provider-protocol-field",
														children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("最长时长（秒）") }), /* @__PURE__ */ (0, $.jsx)("input", {
															type: "number",
															min: 1,
															max: 86400,
															value: Y.maxDurationMs === void 0 ? "" : Y.maxDurationMs / 1e3,
															onChange: (e) => q({ maxDurationMs: Number.isFinite(e.target.valueAsNumber) ? Math.round(e.target.valueAsNumber * 1e3) : void 0 })
														})]
													}),
													/* @__PURE__ */ (0, $.jsxs)("label", {
														className: "provider-protocol-field",
														children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("错误重试次数") }), /* @__PURE__ */ (0, $.jsx)("input", {
															type: "number",
															min: 0,
															max: 10,
															value: Se.maxRetries,
											...
											/* @__PURE__ */ (0, $.jsxs)("div", {
												...
												children: [
													/* @__PURE__ */ (0, $.jsxs)("label", {
														className: "provider-protocol-field",
														children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("退避策略") }), /* @__PURE__ */ (0, $.jsxs)("select", {
															value: Se.backoff,
													...
													/* @__PURE__ */ (0, $.jsxs)("label", {
														className: "provider-protocol-field",
														children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("最大重试间隔 ms") }), /* @__PURE__ */ (0, $.jsx)("input", {
															type: "number",
															min: 1e3,
															max: 3e5,
															value: Se.maxDelayMs,
													...
													/* @__PURE__ */ (0, $.jsxs)("label", {
														className: "provider-protocol-field",
														children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("重试 HTTP 状态码") }), /* @__PURE__ */ (0, $.jsx)("input", {
															value: Se.httpStatuses.join(", "),
											...
											/* @__PURE__ */ (0, $.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, $.jsxs)("label", {
													...
													children: [/* @__PURE__ */ (0, $.jsx)("input", {
														type: "checkbox",
														checked: Se.honorRetryAfter,
														onChange: (e) => ve({ honorRetryAfter: e.target.checked })
													}), /* @__PURE__ */ (0, $.jsx)("span", { children: c("遵循 Retry-After") })]
												}), /* @__PURE__ */ (0, $.jsxs)("label", {
													className: "provider-protocol-toggle",
													children: [/* @__PURE__ */ (0, $.jsx)("input", {
														type: "checkbox",
														checked: Se.retryNetworkErrors,
														onChange: (e) => ve({ retryNetworkErrors: e.target.checked })
													}), /* @__PURE__ */ (0, $.jsx)("span", { children: c("重试网络错误") })]
												})]
											})
										]
									})]
							...
							Ce ? /* @__PURE__ */ (0, $.jsxs)("details", {
								...
								open: !0,
								children: [/* @__PURE__ */ (0, $.jsx)("summary", { children: c("响应示例与路径校验") }), /* @__PURE__ */ (0, $.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, $.jsxs)("div", {
										...
										"aria-live": "polite",
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("路径解析结果") }), we.entries?.map((e) => /* @__PURE__ */ (0, $.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, $.jsxs)("div", { children: [/* @__PURE__ */ (0, $.jsx)("strong", { children: e.label }), /* @__PURE__ */ (0, $.jsx)("code", { children: e.path })] }), /* @__PURE__ */ (0, $.jsx)("code", {
												...
												children: e.matchCount > 0 ? e.values.join(" | ") : c("未匹配")
											})]
										}, e.id))]
									})]
								})]
					...
					/* @__PURE__ */ (0, $.jsxs)("details", {
						...
						children: [/* @__PURE__ */ (0, $.jsx)("summary", { children: c("可用变量") }), /* @__PURE__ */ (0, $.jsxs)("div", { children: [ht[e.category].map((e) => /* @__PURE__ */ (0, $.jsx)("code", {
							"data-tooltip": c(_t(e)),
							children: `{{${e}}}`
						}, e)), x.mode === "async" ? /* @__PURE__ */ (0, $.jsx)("code", {
							"data-tooltip": c(gt),
							...
							children: [/* @__PURE__ */ (0, $.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, $.jsx)("textarea", {
										...
										"aria-describedby": X.error ? I : void 0,
										onChange: (e) => M(e.target.value)
									}),
									X.error ? /* @__PURE__ */ (0, $.jsx)("small", {
										id: I,
										role: "alert",
								...
								children: [
									/* @__PURE__ */ (0, $.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, $.jsx)("span", {
											...
											children: X.preview?.method ?? "--"
										}), /* @__PURE__ */ (0, $.jsx)("code", {
											className: "min-w-0 break-all text-[12px] text-canvas-text",
											children: X.preview?.relativeUrl ?? c("请求路径不可用")
										})]
									}),
									/* @__PURE__ */ (0, $.jsxs)("div", {
										className: "provider-protocol-field min-w-0",
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("Header 预览") }), /* @__PURE__ */ (0, $.jsx)("pre", {
											...
											children: X.preview ? St(X.preview.headers) : "{}"
										})]
									}),
									/* @__PURE__ */ (0, $.jsxs)("div", {
										className: "provider-protocol-field min-w-0",
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: c("Body 预览") }), /* @__PURE__ */ (0, $.jsx)("pre", {
											...
											children: X.preview?.body === void 0 ? c("无请求体") : St(X.preview.body)
										})]
									})
								]
							})]
					...
					/* @__PURE__ */ (0, $.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, $.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, $.jsx)("strong", { children: c("可用变量") }),
								/* @__PURE__ */ (0, $.jsx)("span", { children: c("可放入 path、query、headers 或 body，调用时会替换为节点中的实际值") }),
								/* @__PURE__ */ (0, $.jsx)("span", { children: c("（鼠标在变量上悬浮可查看详细说明）") })
							]
						}), /* @__PURE__ */ (0, $.jsxs)("div", {
							className: "provider-protocol-json-variable-list",
							children: [ht[e.category].map((e) => /* @__PURE__ */ (0, $.jsx)("code", {
								"data-tooltip": c(_t(e)),
								children: `{{${e}}}`
							}, e)), x.mode === "async" ? /* @__PURE__ */ (0, $.jsx)("code", {
								"data-tooltip": c(gt),
						...
						children: [
							/* @__PURE__ */ (0, $.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, $.jsx)("strong", { children: c("配置说明") }),
									/* @__PURE__ */ (0, $.jsx)("span", { children: c("不确定如何填写时，可先在“表单”模式配置，再切回 JSON 查看结果") })
								]
							}),
							/* @__PURE__ */ (0, $.jsxs)("dl", { children: [
								...
								] }), /* @__PURE__ */ (0, $.jsx)("dd", { children: c("协议版本固定为 2；mode 使用 sync 同步返回或 async 异步轮询。") })] }),
								/* @__PURE__ */ (0, $.jsxs)("div", { children: [/* @__PURE__ */ (0, $.jsx)("dt", { children: /* @__PURE__ */ (0, $.jsx)("code", { children: "auth" }) }), /* @__PURE__ */ (0, $.jsx)("dd", { children: c("定义 API Key 的注入方式。只配置 type、name、prefix，不要把真实密钥写进 JSON。") })] }),
								/* @__PURE__ */ (0, $.jsxs)("div", { children: [/* @__PURE__ */ (0, $.jsx)("dt", { children: /* @__PURE__ */ (0, $.jsx)("code", { children: "submit" }) }), /* @__PURE__ */ (0, $.jsx)("dd", { children: c("首次请求规则，包括 method、path、query、headers、bodyEncoding 和 body。") })] }),
								/* @__PURE__ */ (0, $.jsxs)("div", { children: [/* @__PURE__ */ (0, $.jsx)("dt", { children: /* @__PURE__ */ (0, $.jsx)("code", { children: "response" }) }), /* @__PURE__ */ (0, $.jsx)("dd", { children: c("首次响应的解析规则。同步模式从 result 取结果；异步模式用 taskIdPath 取得任务 ID。") })] }),
								/* @__PURE__ */ (0, $.jsxs)("div", { children: [/* @__PURE__ */ (0, $.jsx)("dt", { children: /* @__PURE__ */ (0, $.jsx)("code", { children: "poll" }) }), /* @__PURE__ */ (0, $.jsx)("dd", { children: c("仅异步模式需要，定义查询请求、完成/失败状态、结果路径、查询间隔与重试策略。") })] }),
								/* @__PURE__ */ (0, $.jsxs)("div", { children: [/* @__PURE__ */ (0, $.jsx)("dt", { children: c("响应路径") }), /* @__PURE__ */ (0, $.jsx)("dd", { children: c("用点号读取嵌套字段，例如 data.0.url；用 data.*.url 读取数组内全部 URL。") })] })
							] }),
							x.mode === "async" ? /* @__PURE__ */ (0, $.jsx)("p", { children: c("异步流程先按 response.taskIdPath 取得任务 ID，再在 poll 中通过 {{submit.task_id}} 引用。") }) : null
						]
					})
				]
			}) : null,
...
function jt({ label: e, value: t, placeholder: n, onChange: r }) {
	return /* @__PURE__ */ (0, $.jsxs)("label", {
...
function Mt({ onApply: e, onClose: t }) {
	let n = i(), [r, a] = (0, Q.useState)(At), [o, s] = (0, Q.useState)(!1), [c, l] = (0, Q.useState)(null), [u, d] = (0, Q.useState)(null), [f, p] = (0, Q.useState)(!1), m = !!c?.baseUrl && !!c.modelId && !!c.category && !!c.protocol && (c.confidence !== "low" || f), h = (0, Q.useMemo)(() => {
			...
			c ? /* @__PURE__ */ (0, $.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, $.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, $.jsx)("span", {
							className: `rounded border px-1.5 py-0.5 text-[11px] ${kt[c.confidence]}`,
							children: n(Ot[c.confidence])
...
function Rt({ model: e, onChange: t, onClose: n }) {
	let [r, i] = (0, Q.useState)(""), [a, o] = (0, Q.useState)(""), [s, c] = (0, Q.useState)(""), [l, u] = (0, Q.useState)(""), d = Pt(e.videoCapability), f = d.durations?.length ? [...d.durations].sort((e, t) => e - t) : void 0, p = [...new Set([...it, ...d.ratios ?? []])], m = [...new Set([...at, ...d.resolutions ?? []])], h = [...new Set([...ot, ...d.frameRates ?? []])].sort((e, t) => e - t), g = [...new Set([...st, ...f ?? []])].sort((e, t) => e - t), _ = d.inputConstraints ?? {}, v = Math.min(ct, Math.max(1, d.minDuration ?? Math.min(...d.durations ?? [1]))), y = Math.max(v, Math.min(ct, d.maxDuration ?? Math.max(...d.durations ?? [15]))), b = (e) => t(Pt(e)), x = (e) => b({
		...d,
		inputConstraints: e
	}), S = (e, t, n) => {
		let r = d[e] ?? [];
		...
		b({
			...d,
			frameRates: n,
			defaultFrameRate: Ft(d.defaultFrameRate, n)
		});
	}, T = (e) => {
		let t = f ?? [];
		if (t.includes(e) && t.length === 1) return;
		...
		b({
			...
			defaultDuration: Ft(d.defaultDuration, n)
		});
							...
							children: [
								/* @__PURE__ */ (0, $.jsxs)("label", {
									...
									children: [/* @__PURE__ */ (0, $.jsx)("span", { children: "提示词最少字符" }), /* @__PURE__ */ (0, $.jsx)("input", {
										...
										onChange: (e) => x({
											..._,
											promptMinCharacters: Lt(e.target.value, { integer: !0 })
										})
									})]
								}),
								/* @__PURE__ */ (0, $.jsxs)("label", {
									...
									children: [/* @__PURE__ */ (0, $.jsx)("span", { children: "Base64 解码后总上限（MiB）" }), /* @__PURE__ */ (0, $.jsx)("input", {
										...
										onChange: (e) => x({
											..._,
											maxBase64DecodedBytes: Lt(e.target.value, {
												integer: !0,
												scale: 1024 * 1024
											})
										})
										...
										onChange: (e) => x({
											...
											referenceVideo: {
												...
												width: {
													...
													min: Lt(e.target.value, { integer: !0 })
												}
											}
										})
									})]
...
function zt({ definition: e, models: t, filteredModels: n, selectedModels: r, selectedIds: a, query: o, setQuery: s, category: c, setCategory: l, visibleModelCategories: u, catalogStatus: d, catalogMessage: f, missingCredentials: p, apiKey: m, baseUrl: h, setProtocolValid: g, protocolImportOpen: _, setProtocolImportOpen: v, protocolImportSnapshot: y, protocolModel: b, videoCapabilityModel: x, setProtocolModelId: C, setVideoCapabilityModelId: w, categoryEditModelId: T, setCategoryEditModelId: E, manualModelId: D, setManualModelId: O, manualModelName: k, setManualModelName: A, manualCategory: j, setManualCategory: M, onToggleModel: N, onToggleVisibleModels: P, onToggleVisibleCategory: F, onToggleAllVisibleCategories: I, onAddManualModel: L, onUpdateModelCategory: R, onUpdateModelContextWindow: ee, onUpdateModelDescription: z, onUpdateModelVisionCapability: B, onUpdateModelProtocol: V, onUpdateVideoCapability: H, onUpdateImageReferenceRequestMode: te, onCloseProtocolEditor: ne, onApplyProtocolImport: U, onUndoProtocolImport: re, onFetchModels: ie }) {
	...
	return /* @__PURE__ */ (0, $.jsxs)("section", {
		...
		children: [
			...
			e.id === "custom-openai" && _ ? /* @__PURE__ */ (0, $.jsx)(Mt, {
				onApply: U,
				onClose: () => v(!1)
			}) : null,
			/* @__PURE__ */ (0, $.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, $.jsxs)("span", {
					...
					children: [/* @__PURE__ */ (0, $.jsx)("button", {
						type: "button",
						"aria-pressed": u.size === rt.length,
						className: `provider-category-choice is-all h-6 rounded px-2 text-[9px] ${u.size === rt.length ? "is-active" : ""}`,
						onClick: I,
						children: G("全部")
					}), rt.map((e) => /* @__PURE__ */ (0, $.jsx)("button", {
						type: "button",
			...
			t.length > 0 && /* @__PURE__ */ (0, $.jsxs)($.Fragment, { children: [
								...
								children: [
									...
									t.category === "text" ? /* @__PURE__ */ (0, $.jsxs)($.Fragment, { children: [/* @__PURE__ */ (0, $.jsxs)("label", {
										...
										children: [/* @__PURE__ */ (0, $.jsx)("input", {
											...
											onChange: (e) => B(t.id, e.target.checked)
									...
									/* @__PURE__ */ (0, $.jsxs)("label", {
										...
										children: [/* @__PURE__ */ (0, $.jsx)("span", { children: "Agent 选型说明" }), /* @__PURE__ */ (0, $.jsx)("textarea", {
											...
											onChange: (e) => z(t.id, e.target.value)
										})]
									})
								]
							}) : null
				...
				e.id === "custom-openai" && x && x.category === "video" && a.has(x.id) ? /* @__PURE__ */ (0, $.jsx)(Rt, {
					model: x,
					onChange: (e) => H(x.id, e),
					onClose: () => w(null)
				}, x.id) : null,
				e.id === "custom-openai" && b && a.has(b.id) ? /* @__PURE__ */ (0, $.jsx)(Et, {
					model: b,
					apiKey: m.trim(),
					baseUrl: he(h) || e.defaultBaseUrl || "",
					onChange: (e) => V(b.id, e),
					onImageReferenceRequestModeChange: (e) => te(b.id, e),
					onValidityChange: g,
					onClose: ne
				}, b.id) : null
			] }),
				...
				children: /* @__PURE__ */ (0, $.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, $.jsx)("select", {
							value: j,
							onChange: (e) => M(e.target.value),
							children: rt.map((e) => /* @__PURE__ */ (0, $.jsx)("option", {
								value: e,
								children: S[e]
							}, e))
						}),
...
function Bt({ definitions: e, providerConfigs: t, currentDefinition: n, onChoose: r }) {
	let a = i();
	return /* @__PURE__ */ (0, $.jsxs)("section", {
		className: "provider-model-section",
		children: [/* @__PURE__ */ (0, $.jsx)("div", {
...
function Vt({ isOpen: e, connectionId: t, initialConfig: n, providerConfigs: r, connectedProviderIds: a, fallbackModels: o, dreaminaLoggedIn: s, dreaminaLoading: c, runninghubWorkflowApiKey: l = "", onDreaminaLogin: u, onClose: d, onSave: f }) {
	let p = i(), m = !!t && !!n, h = n?.catalogId || t || "", g = q(h, n), _ = n?.selectedModels || [], v = n?.catalogModels || [], y = g && o[g.id] || [], [b, x] = (0, Q.useState)(h), [S, C] = (0, Q.useState)(n?.name || g?.name || ""), [w, E] = (0, Q.useState)(() => ue(n?.chatApiProtocol)), [D, O] = (0, Q.useState)(n?.apiKey || ""), [k, A] = (0, Q.useState)(n?.baseUrl || g?.defaultBaseUrl || ""), [j, M] = (0, Q.useState)(l), [N, P] = (0, Q.useState)(Nt(Nt(y, v), _)), [F, I] = (0, Q.useState)(() => new Set(_.map((e) => e.id))), [L, R] = (0, Q.useState)(_.length > 0 || y.length > 0 ? "ready" : "idle"), [ee, z] = (0, Q.useState)(v.length > 0 ? p("已加载本地缓存 {count} 个模型", { count: v.length }) : ""), [B, V] = (0, Q.useState)(""), [H, te] = (0, Q.useState)("all"), [ne, re] = (0, Q.useState)(() => new Set(n?.visibleModelCategories ?? rt)), [ie, ae] = (0, Q.useState)(""), [oe, se] = (0, Q.useState)(""), [ce, le] = (0, Q.useState)("text"), [de, fe] = (0, Q.useState)(null), [pe, me] = (0, Q.useState)(null), [_e, be] = (0, Q.useState)(!0), [xe, X] = (0, Q.useState)(!1), [Ce, we] = (0, Q.useState)(null), [Te, Ee] = (0, Q.useState)(null), De = (0, Q.useRef)(null), Z = q(b), Oe = J(), ke = ye(), Ae = Z?.kind === "web-search", je = ke.some((e) => !!r[e.id]?.apiKey?.trim());
	(0, Q.useEffect)(() => () => De.current?.abort(), []);
	let Me = Oe.filter((e) => e.kind === "web-search" ? e.id === "tavily" && (!je || Ae) : e.id === "custom-openai" || e.id === h || !a.includes(e.id)), Ne = (0, Q.useMemo)(() => {
		let e = B.trim().toLowerCase();
		return N.filter((t) => (H === "all" || t.category === H) && (!e || t.name.toLowerCase().includes(e) || t.id.toLowerCase().includes(e)));
	}, [
		H,
		N,
		B
	]), Pe = (0, Q.useMemo)(() => N.filter((e) => F.has(e.id)), [N, F]), Fe = (0, Q.useMemo)(() => N.find((e) => e.id === pe), [N, pe]), Ie = (0, Q.useMemo)(() => N.find((e) => e.id === de), [N, de]), Le = (0, Q.useMemo)(() => {
		if (m || Z?.id !== "custom-openai") return "";
		let e = he(k, w);
		return e && Object.values(r).find((t) => t.catalogId === "custom-openai" && ue(t.chatApiProtocol) === w && he(t.baseUrl, w) === e)?.name?.trim() || "";
	}, [
		k,
		w,
		Z,
		m,
		r
	]), Re = (0, Q.useMemo)(() => Z ? Z.authType === "oauth" ? !s : D.trim() ? Z.credentials.some((e) => e.required && e.key === "baseUrl" && !k.trim()) : !0 : !0, [
		D,
		k,
		Z,
		s
		...
		x(e.id), C(t?.name || e.name), E(ue(t?.chatApiProtocol)), O(t?.apiKey || ""), A(t?.baseUrl || e.defaultBaseUrl || ""), M("");
		let n = o[e.id] || [];
		P(n), I(/* @__PURE__ */ new Set()), R(n.length > 0 ? "ready" : "idle"), z(""), V(""), te("all"), re(new Set(rt)), ae(""), se(""), le("text"), fe(null), me(null), be(!0), X(!1), we(null), Ee(null);
	}, Be = (e) => {
		let t = he(k, w);
		if (!(!e || !t || e === t)) return A(e), e;
	}, Ve = async () => {
		if (!Z || Re) return;
		De.current?.abort();
		let e = new AbortController();
		De.current = e, R("loading"), z("");
		try {
			if (Z.id === "runninghub-model") {
				let e = await et("runninghub-model", D.trim());
			...
			P((e) => Nt(e, t.models)), R(t.warning ? "warning" : "ready");
			let n = Be(t.resolvedBaseUrl);
			z(t.warning || (n ? p("已获取 {count} 个模型，接口地址已更正为 {url}", {
				count: t.models.length,
				url: n
			}) : p("已获取 {count} 个模型", { count: t.models.length })));
		} catch (e) {
			if (e instanceof DOMException && e.name === "AbortError") return;
			R("error"), z(e instanceof Error ? e.message : p("模型列表拉取失败"));
		}
	}, He = async () => {
		let e = T.getState();
		e.chatPanelDetached && await Se(), e.openChatWithDraft(ut(S.trim(), he(k, w), w));
	}, Ue = async () => {
		if (!Z || Re) return;
		R("loading"), z(p("正在验证 {name} 连接...", { name: Z.name }));
		let e = await et(Z.id, D.trim(), k.trim() || void 0, w);
		if (e.success) {
			let t = Be(e.baseUrl);
			R("ready"), z([
		...
		R(e.unsupported ? "warning" : "error"), z(e.error || p("{name} 连接验证失败", { name: Z.name }));
	}, We = () => {
		me(null), be(!0);
	}, Ge = (e) => {
		F.has(e) && pe === e && We(), F.has(e) && de === e && fe(null), I((t) => {
			let n = new Set(t);
			return n.has(e) ? n.delete(e) : n.add(e), n;
		});
	}, Ke = () => {
		let e = Ne.length > 0 && Ne.every((e) => F.has(e.id));
		e && pe && Ne.some((e) => e.id === pe) && We(), e && de && Ne.some((e) => e.id === de) && fe(null), I((t) => {
			let n = new Set(t);
			for (let t of Ne) e ? n.delete(t.id) : n.add(t.id);
			return n;
		});
	}, qe = (e) => {
		re((t) => {
		...
		re((e) => e.size === rt.length ? /* @__PURE__ */ new Set() : new Set(rt));
	}, Ye = () => {
		let e = ie.trim();
		if (!e || !Z) return;
		let n = {
		...
		P((e) => Nt(e, [n])), I((t) => new Set(t).add(e)), ae(""), se("");
	}, Xe = (e, t) => {
		P((n) => n.map((n) => n.id === e ? {
			...n,
			category: t,
		...
		} : n)), t !== "video" && de === e && fe(null), re((e) => new Set(e).add(t)), Ee(null);
	}, Ze = (e, t) => {
		...
		we({
			baseUrl: k,
			models: structuredClone(N),
			selectedIds: new Set(F),
			visibleModelCategories: new Set(ne),
			category: H,
			protocolModelId: pe,
			protocolValid: _e,
			catalogStatus: L,
		...
		A(e.baseUrl), P((e) => e.find((e) => e.id === n) ? e.map((e) => e.id === n ? {
			...e,
			category: r.category,
			executionProfile: r.executionProfile,
			categoryManual: !0
		} : e) : [...e, r]), I((e) => new Set(e).add(n)), re((e) => new Set(e).add(r.category)), te("all"), me(n), be(!0), R("ready"), z(p("已从接口文档导入模型 {id}，保存前可继续检查调用协议", { id: n })), X(!1);
	}, st = () => {
		Ce && (A(Ce.baseUrl), P(Ce.models), I(Ce.selectedIds), re(Ce.visibleModelCategories), te(Ce.category), me(Ce.protocolModelId), be(Ce.protocolValid), R(Ce.catalogStatus), z(Ce.catalogMessage), we(null), X(!1));
	}, ct = () => {
		X(!1), we(null), d();
	}, lt = () => {
		X(!1), we(null), x("");
	}, dt = async () => {
		if (!Z || Re || !Ae && Pe.length === 0 || !_e) return;
		try {
			It(Pe);
		} catch (e) {
			R("error"), z(e instanceof Error ? e.message : p("视频能力配置无效"));
			return;
		}
		let e = Ae ? Z.id : t || Y(Z.id), n = Ae ? {} : {
			selectedModels: Pe.map((t) => ({
				...t,
				provider: e
			})),
			catalogModels: ve(N, F).map((t) => ({
				...t,
				provider: e
			})),
			visibleModelCategories: rt.filter((e) => ne.has(e)),
			catalogUpdatedAt: Date.now()
		};
		await f(e, {
			name: S.trim() || Z.name,
			apiKey: Z.authType === "oauth" ? "" : D.trim(),
			baseUrl: he(k, w) || void 0,
			catalogId: Z.id,
			...Z.id === "custom-openai" ? { chatApiProtocol: w } : {},
			...n
		}, Z.id === "runninghub-model" ? { runninghubWorkflowApiKey: j.trim() } : void 0);
	};
	return (0, tt.createPortal)(/* @__PURE__ */ (0, $.jsxs)(U, {
		isOpen: e,
		onClose: ct,
		...
		children: [/* @__PURE__ */ (0, $.jsxs)("header", {
			...
			}), /* @__PURE__ */ (0, $.jsx)("h3", { children: Ae ? p("联网搜索") : Z ? Z.name : p("选择 API 厂商") })] }), /* @__PURE__ */ (0, $.jsxs)("div", {
				className: "flex items-center gap-2",
			...
			children: [
				/* @__PURE__ */ (0, $.jsx)(ft, {
					editing: m,
					definition: Z,
					isWebSearchProvider: Ae,
					connectionName: S,
					setConnectionName: C,
					chatApiProtocol: w,
					setChatApiProtocol: E,
					apiKey: D,
					setApiKey: O,
					baseUrl: k,
					setBaseUrl: A,
					...
					dreaminaLoading: c,
					onDreaminaLogin: u,
					duplicateConnectionName: Le,
					catalogStatus: L,
					catalogMessage: ee,
					missingCredentials: Re,
					onReturnToPicker: lt,
					onTestConnection: Ue
				}),
				Ae && /* @__PURE__ */ (0, $.jsx)(Bt, {
					definitions: ke,
					providerConfigs: r,
					currentDefinition: Z,
					onChoose: ze
				}),
				!Ae && /* @__PURE__ */ (0, $.jsx)(zt, {
					definition: Z,
					models: N,
					filteredModels: Ne,
					selectedModels: Pe,
					...
					baseUrl: k,
					setProtocolValid: be,
					protocolImportOpen: xe,
					setProtocolImportOpen: X,
					protocolImportSnapshot: Ce,
					protocolModel: Fe,
					videoCapabilityModel: Ie,
					setProtocolModelId: me,
					setVideoCapabilityModelId: fe,
					categoryEditModelId: Te,
					setCategoryEditModelId: Ee,
					manualModelId: ie,
					setManualModelId: ae,
					manualModelName: oe,
					setManualModelName: se,
					manualCategory: ce,
					setManualCategory: le,
					onToggleModel: Ge,
					onToggleVisibleModels: Ke,
					onToggleVisibleCategory: qe,
					onToggleAllVisibleCategories: Je,
					onAddManualModel: Ye,
					onUpdateModelCategory: Xe,
					onUpdateModelContextWindow: Ze,
					onUpdateModelDescription: Qe,
					onUpdateModelVisionCapability: $e,
					onUpdateModelProtocol: nt,
					onUpdateVideoCapability: it,
					onUpdateImageReferenceRequestMode: at,
					onCloseProtocolEditor: We,
					onApplyProtocolImport: ot,
					onUndoProtocolImport: st,
					onFetchModels: Ve
				})
			]
		}), /* @__PURE__ */ (0, $.jsxs)("footer", {
			className: "provider-dialog-footer",
			children: [/* @__PURE__ */ (0, $.jsx)("span", { children: Ae ? `当前使用 ${Z.name}` : Pe.length > 0 ? p("将启用 {count} 个模型", { count: Pe.length }) : p("至少选择一个模型") }), /* @__PURE__ */ (0, $.jsxs)("div", { children: [/* @__PURE__ */ (0, $.jsx)(W, {
				type: "button",
				className: "provider-secondary-btn",
				onClick: ct,
				children: p("取消")
			...
			children: /* @__PURE__ */ (0, $.jsx)("div", {
				className: "provider-picker-grid",
				children: Me.map((e) => /* @__PURE__ */ (0, $.jsxs)("button", {
					type: "button",
...
function Gt({ onClose: e }) {
	let t = i(), { config: n, updateConfig: r, setProviderConfig: a, saveProviderConfig: o, removeProviderConfig: s, saveConfig: c, pendingApiKeyConnectionId: l, setPendingApiKeyConnectionId: u } = T(le((e) => ({
		config: e.config,
		...
		open: !1,
		revision: 0
	}), [p, m] = (0, Q.useState)(), [h, g] = (0, Q.useState)({}), _ = (0, Q.useRef)(/* @__PURE__ */ new Set()), v = (0, Q.useRef)(!0), [y, b] = (0, Q.useState)(!0), [x, S] = (0, Q.useState)(!1), [C, w] = (0, Q.useState)(() => t("首次登录时会自动准备即梦组件")), [E, D] = (0, Q.useState)(!1), [k, A] = (0, Q.useState)(null), j = (0, Q.useRef)(!1), M = n.dreaminaAuth, N = _e(n), P = (0, Q.useMemo)(() => {
		let e = {};
		for (let t of J()) t.models && (e[t.id] = t.models.map((e) => ({ ...e })));
		for (let t of ae) {
		...
		for (let [t, r] of Object.entries(n.providers)) {
			...
			let n = q(t, r);
			n && (n.kind === "web-search" && t !== N || Ke(r, n.authType) && e.push({
				id: t,
				config: r
			}));
		}
		...
		n.providers,
		M?.loggedIn
	]), I = (0, Q.useMemo)(() => F.map((e) => q(e.id, e.config)?.id || e.id), [F]), L = l && n.providers[l] ? l : null, R = d.open || !!L, ee = L ?? d.connectionId, z = L ? `pending-${L}` : d.revision, B = ee ? F.find((e) => e.id === ee)?.config : void 0, H = (0, Q.useCallback)(async (e, t) => O(e, t), []);
	(0, Q.useEffect)(() => {
		let e = !1;
		return V().then((t) => {
			e || b(t);
		...
		for (let [t, r] of Object.entries(n.providers)) {
			...
			let i = r.selectedModels?.filter((e) => me(n, e.id)), a = r.catalogModels?.filter((e) => me(n, e.id));
		...
		for (let e of F) {
			...
			}), et(t.id, e.config.apiKey.trim(), e.config.baseUrl).then((t) => {
				let n = t.balance;
	...
	let te = (0, Q.useCallback)((e) => {
		A(e), e.message && w(e.message), !(e.phase !== "success" && !e.loggedIn) && (r({ dreaminaAuth: {
			loggedIn: !0,
			username: e.username || t("即梦用户"),
			credit: e.credit || void 0,
			loginTs: Date.now()
		} }), !j.current && (j.current = !0, T.getState().showToast(t("即梦登录成功")), setTimeout(() => D(!1), 800)));
	}, [t, r]), ne = (0, Q.useCallback)(async (e = !1) => {
		if (!Wt()) {
			w(t("OAuth 登录仅在桌面应用中可用")), T.getState().showToast(t("OAuth 登录仅在桌面应用中可用"), "error");
			return;
		}
		j.current = !1, S(!0), A(null), D(!0);
		try {
			A(await H("dreamina_login_start", { force: e }));
		} catch (e) {
			w(typeof e == "string" ? e : e?.message || t("启动登录失败"));
		} finally {
			S(!1);
		}
	}, [t, H]), U = (0, Q.useCallback)(async () => {
		S(!0);
		try {
			Wt() && await H("dreamina_logout");
		} catch {}
		r({ dreaminaAuth: void 0 }), A(null), w(t("已退出登录")), S(!1);
	}, [
		t,
		H,
		r
	]), re = (0, Q.useCallback)(async (e) => {
		try {
			await import("./dist-js-BTabQsg0.js").then(({ open: t }) => t(e));
		} catch {
			window.open(e, "_blank", "noopener,noreferrer");
		}
	}, []), ie = (0, Q.useCallback)((e, n) => {
		navigator.clipboard?.writeText(e).catch(() => {}), T.getState().showToast(t("已复制{label}", { label: n }));
	}, [t]);
	(0, Q.useEffect)(() => {
		if (!E || !Wt()) return;
		let e, t = !1;
		import("./event-BlmvLUFr.js").then((e) => e.i).then(({ listen: e }) => e("dreamina-login-runtime", (e) => te(e.payload))).then((n) => {
			t ? n() : e = n;
		}).catch(() => {});
		let n = setInterval(async () => {
			try {
				te(await H("dreamina_login_runtime"));
			} catch {}
		}, 1500);
		return () => {
		...
		!Wt() || !M?.loggedIn || H("dreamina_status").then((e) => {
			e.loggedIn && (A(e), w(t("即梦已登录")), r({ dreaminaAuth: {
				loggedIn: !0,
				username: e.username || t("即梦用户"),
				credit: e.credit || void 0,
	...
	let G = async (e) => {
		...
		if (!r) return;
		let i = await pe(He(r));
		T.getState().showToast(t(i ? "连接配置已复制（不含 API Key）" : "复制失败"), i ? "success" : "error");
	}, oe = async () => {
		let e = Ge(await fe());
		if (!e) {
			T.getState().showToast(t("剪贴板里没有可导入的连接配置"), "error");
			return;
		}
		let r = q(e.catalogId);
		if (!r || r.authType === "oauth") {
			T.getState().showToast(t("该连接类型不支持导入"), "error");
			return;
		}
		let i = Y(e.catalogId);
		if (n.providers[i]) {
			T.getState().showToast(t("已存在 {name} 连接，请先删除后再导入", { name: r.name }), "error");
			return;
		}
		...
		}), await c(), T.getState().showToast(t("已导入连接，请补填 API Key")), u(i);
	}, se = () => {
		u(null), f((e) => ({
			open: !0,
			connectionId: void 0,
		...
		}) : i && n.providers.runninghub && await s("runninghub"), await c(), ue();
	}, he = async (e) => {
		let t = n.providers[e], i = q(e, t);
		if (e === "dreamina" && await U(), i?.kind === "web-search") {
			for (let e of ye()) await s(e.id);
			...
			/* @__PURE__ */ (0, $.jsxs)("div", {
				...
				children: [!y && /* @__PURE__ */ (0, $.jsxs)("p", {
					...
					children: F.map((e) => {
						...
						if (!r) return null;
						let i = e.config.selectedModels?.length, a = Ut(e.config, r.defaultBaseUrl), o = r.id === "dreamina", s = r.id === "runninghub-model", c = r.kind === "web-search", l = r.authType !== "oauth" && !e.config.apiKey.trim(), u = s && !!e.config.apiKey.trim(), d = s && !!n.providers.runninghub?.apiKey.trim(), f = Number(u) + Number(d), g = c ? t("联网搜索") : r.id === "custom-openai" && e.config.name.trim() || r.name, _ = o ? t("OAuth 已连接") : s ? t("{count}/2 密钥已配置", { count: f }) : t(l ? "待填写 API Key" : "已连接");
						return /* @__PURE__ */ (0, $.jsxs)("div", {
...
async function Yt(e) {
	...
	let n = I(t, ".trash");
	try {
		if (!await j(n)) return null;
		let t = await Kt(n), r = t.reduce((e, t) => e + t.size, 0);
		return {
			projectId: e.id,
			projectName: e.name,
			trashDir: n,
...
async function Xt(e, t) {
	if (!F()) return [];
	let n = await R(e.id);
	return n ? (await Kt(n)).filter((e) => !t.has(e.path)).map((t) => ({
		path: t.path,
		name: t.name,
		size: t.size,
		projectId: e.id,
...
async function en(e) {
	if (F()) try {
		...
		for (let n of t) {
			let t = I(e, n.name);
			try {
				n.isFile ? await M(t) : n.isDirectory && (await tn(t), await M(t));
			} catch {}
		}
		await M(e).catch(() => {});
	} catch {}
...
async function tn(e) {
	try {
		...
		for (let n of t) {
			let t = I(e, n.name);
			n.isDirectory && await tn(t), await M(t).catch(() => {});
		}
	} catch {}
}
async function nn(e) {
...
function ln(e, t, n, r, i, a, o, s) {
	...
	if (u <= 0) return "";
	let d = +(u > 180), f = Math.PI / 180 * u, p = Math.min(o, (r - n) / 2, n * f / 2), m = p / r * (180 / Math.PI), h = p / n * (180 / Math.PI), g = cn(e, t, r, c + m), _ = cn(e, t, r, l - m), v = cn(e, t, r, l), y = cn(e, t, r - p, l), b = cn(e, t, n + p, l), x = cn(e, t, n, l), S = cn(e, t, n, l - h), C = cn(e, t, n, c + h), w = cn(e, t, n, c), T = cn(e, t, n + p, c), E = cn(e, t, r - p, c), D = cn(e, t, r, c);
	return [
		`M ${g.x} ${g.y}`,
		`A ${r} ${r} 0 ${d} 1 ${_.x} ${_.y}`,
		`Q ${v.x} ${v.y} ${y.x} ${y.y}`,
...
function un({ segments: e, total: t, size: n = 160 }) {
	...
	return /* @__PURE__ */ (0, $.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, $.jsx)("div", {
			...
			children: [p.map((e, t) => /* @__PURE__ */ (0, $.jsx)("path", {
				d: ln(a, o, s, c, e.start, e.start + e.sweep, l, 2),
				fill: e.color,
				onMouseEnter: () => d(t),
				onMouseLeave: () => d(null),
				style: {
		...
		children: [/* @__PURE__ */ (0, $.jsx)("div", {
			...
			children: r.map((e, n) => {
				...
				return /* @__PURE__ */ (0, $.jsx)("div", {
					...
					title: `${t(e.label)}: ${C(e.value)} (${e.pct.toFixed(1)}%)`
				}, n);
			})
		}), /* @__PURE__ */ (0, $.jsx)("div", {
...
function fn() {
	let e = i(), { projects: t, nodes: n, showToast: r } = T(le((e) => ({
		projects: e.projects,
		currentProjectId: e.currentProjectId,
		nodes: e.nodes,
		showToast: e.showToast
	}))), [a, o] = (0, Q.useState)(!1), [s, l] = (0, Q.useState)(null), [u, d] = (0, Q.useState)(null), [f, p] = (0, Q.useState)("overview"), [m, h] = (0, Q.useState)(/* @__PURE__ */ new Set()), g = (0, Q.useRef)(!1), _ = (0, Q.useCallback)(async () => {
		o(!0);
		try {
			c().then(d);
			let i = await $t(t, Qt(n), []);
			l(i), g.current = !0;
			let a = C(i.totalSize), o = C(i.reclaimableSize), s = i.trashes.length + i.orphans.length + i.duplicates.length + i.offlineFolders.length;
	...
	(0, Q.useEffect)(() => (g.current || _(), () => {
		g.current = !1;
	}), []);
	let v = (0, Q.useCallback)(async (t) => {
		h((e) => new Set(e).add(t.trashDir));
		try {
			await en(t.trashDir), r(e("已清空「{name}」的回收站缓存", { name: t.projectName })), g.current = !1, await _();
		} catch {
			r(e("清理失败"), "error");
		} finally {
			h((e) => {
		...
		_,
		e
	]), y = (0, Q.useCallback)(async (t) => {
		h((e) => new Set(e).add(t.path));
		try {
			await nn(t.path) ? (r(e("已删除：{name}", { name: t.name })), g.current = !1, await _()) : r(e("删除失败"), "error");
		} catch {
			r(e("删除失败"), "error");
		} finally {
			h((e) => {
		...
		h((e) => new Set(e).add(t.path));
		try {
			await rn(t.path) ? (r(e("已删除：{name}", { name: t.name })), g.current = !1, await _()) : r(e("删除失败"), "error");
		} catch {
			r(e("删除失败"), "error");
		} finally {
			h((e) => {
		...
		if (s) {
			for (let e of s.trashes) await en(e.trashDir);
			r(e("已清空所有回收站缓存")), g.current = !1, await _();
		}
	}, [
		s,
		r,
		...
		if (!s) return;
		let t = 0;
		for (let e of s.orphans) await nn(e.path) && t++;
		r(e("已删除 {count} 个孤儿文件", { count: t })), g.current = !1, await _();
	}, [
		s,
		r,
		_,
	...
	return /* @__PURE__ */ (0, $.jsxs)("div", {
		...
		children: [
			...
			u && u.quota > 0 && (() => {
				let t = Math.min(1, u.ratio), n = t >= .85;
				return /* @__PURE__ */ (0, $.jsxs)("div", {
				...
				children: [
						...
						children: /* @__PURE__ */ (0, $.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, $.jsx)(un, {
								...
								children: [
									...
									w.issueSections.length > 0 && /* @__PURE__ */ (0, $.jsx)("div", {
										className: "flex flex-wrap gap-1.5",
										children: w.issueSections.map((e) => /* @__PURE__ */ (0, $.jsxs)("button", {
											type: "button",
											onClick: () => p(e.id),
					...
					/* @__PURE__ */ (0, $.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, $.jsx)("h4", {
							...
							children: e("各项目占用空间")
						}), /* @__PURE__ */ (0, $.jsx)(dn, { items: w.projectBars })]
					}),
					/* @__PURE__ */ (0, $.jsx)("div", {
							...
							children: [/* @__PURE__ */ (0, $.jsxs)("div", {
								...
								children: [Object.entries(t.categories).map(([t, n]) => /* @__PURE__ */ (0, $.jsxs)("span", {
									...
									children: [
										/* @__PURE__ */ (0, $.jsx)("span", {
											className: "w-1.5 h-1.5 rounded-full",
											style: { backgroundColor: an[t] || "#94a3b8" }
										}),
										e(t),
										" ",
										n.count,
					...
					f === "orphans" && /* @__PURE__ */ (0, $.jsx)("div", {
						...
						children: s.orphans.length === 0 ? /* @__PURE__ */ (0, $.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, $.jsx)("span", { children: e("共 {count} 个孤儿文件，可释放 {size}", {
								count: s.orphans.length,
								size: C(s.orphans.reduce((e, t) => e + t.size, 0))
							}) }), /* @__PURE__ */ (0, $.jsx)(W, {
								type: "button",
...
function mn() {
	let e = i(), t = T((e) => e.showToast), n = Ce(), [r, a] = (0, Q.useState)(null), [o, s] = (0, Q.useState)(n), [c, l] = (0, Q.useState)(!1), [u, d] = (0, Q.useState)(!1);
	(0, Q.useEffect)(() => {
		if (!n) return;
		let e = !0;
		return Te().then((t) => {
	...
	let f = async () => {
		l(!0);
		try {
			await Ee(), a(await we()), d(!1), t(e("已删除 3D 导演台本地资源"), "success");
		} catch (e) {
		...
		children: [/* @__PURE__ */ (0, $.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, $.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, $.jsx)("p", {
					...
					children: r?.installed ? e("占用 {size}", { size: pn(r.installedBytes) }) : e("创建或打开导演台节点时可下载")
				})]
...
function _n(e) {
	return e === "streamable-http" ? gn : hn;
}
//#endregion
//#region src/components/settings/McpControlSettings.tsx
var vn = typeof window < "u" && "__TAURI__" in window;
function yn() {
	let e = i(), { config: t, updateConfig: n, saveConfig: r } = T(le((e) => ({
		config: e.config,
		updateConfig: e.updateConfig,
		saveConfig: e.saveConfig
	...
	let v = (0, Q.useMemo)(() => a && s ? Ne(a, s) : null, [a, s]), y = (e) => {
		n(e), r();
	}, b = async () => {
		u(!0), f(""), m(!1);
		try {
	...
	}, O = Oe(t.mcpPort), k = je(t.mcpTransport), A = a !== null && O !== void 0 && O !== a.port, j = a !== null && k !== a.transport, M = _n(k);
	return vn ? /* @__PURE__ */ (0, $.jsxs)("div", {
		className: "space-y-4",
		children: [
			/* @__PURE__ */ (0, $.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, $.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, $.jsx)("input", {
							...
							onBlur: (t) => {
								let n = t.target.value.trim(), r = n ? Oe(n) : void 0;
								if (n && r === void 0) {
...
function Sn({ activeTab: e, onSelect: t }) {
	...
	return /* @__PURE__ */ (0, $.jsx)("nav", {
		...
		children: bn.map(({ id: r, label: i }) => /* @__PURE__ */ (0, $.jsxs)(W, {
			...
			children: [/* @__PURE__ */ (0, $.jsx)(xn, { tab: r }), n(i)]
		}, r))
	});
}
//#endregion
//#region src/components/settings/ShortcutSettings.tsx
var Cn = typeof navigator < "u" && /Macintosh|Mac OS X/.test(navigator.userAgent);
function wn() {
	let e = Cn ? "⌘" : "Ctrl", t = Cn ? "⌃" : "Ctrl", n = Cn ? "⌥" : "Alt", r = Cn ? "⇧" : "Shift", i = Cn ? "⌫ Delete" : "Delete / Backspace";
	return [
		{
			action: "保存画布",
			key: `${e} + S`
...
function Tn() {
	...
	return /* @__PURE__ */ (0, $.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, $.jsx)("p", {
			...
			children: e("键盘快捷键配置")
		}), wn().map(({ action: t, key: n }) => /* @__PURE__ */ (0, $.jsxs)("div", {
...
var En = "text-xs bg-canvas-surface border border-canvas-border rounded-md px-2.5 py-1.5 text-canvas-text placeholder-canvas-text-muted focus:outline-none focus:border-indigo-500 transition-colors", Dn = "__default__", On = 15e3, kn = 250;
function An({ availability: e, label: t }) {
	return /* @__PURE__ */ (0, $.jsx)("span", {
		...
		"aria-label": t,
		role: "status",
		children: /* @__PURE__ */ (0, $.jsx)("span", { className: `h-2.5 w-2.5 rounded-full ring-2 shadow-sm ${e === "available" ? "bg-emerald-400 ring-emerald-400/25" : e === "unavailable" ? "bg-red-400 ring-red-400/25" : "bg-amber-400 ring-amber-400/25 animate-pulse"}` })
	});
}
function jn() {
	let { config: e, updateConfig: t, saveConfig: n, workflows: r, setSettingsOpen: a, setWorkflowPanelOpen: o, showToast: s } = T(le((e) => ({
		config: e.config,
		updateConfig: e.updateConfig,
		saveConfig: e.saveConfig,
		...
		showToast: e.showToast
	}))), c = i(), [l, u] = (0, Q.useState)(!1), [d, f] = (0, Q.useState)(!1), [p, m] = (0, Q.useState)("idle"), [h, g] = (0, Q.useState)({}), _ = e.comfyUIPath, v = (0, Q.useMemo)(() => e.comfyServers ?? [], [e.comfyServers]);
	(0, Q.useEffect)(() => {
		let t = new AbortController(), n, r = [{
			key: Dn,
			url: e.comfyUIUrl?.trim() || "http://127.0.0.1:8188"
		}, ...v.map((e) => ({
			key: e.id,
			url: e.url.trim()
		}))], i = async (e) => {
			e && g((e) => ({
				...e,
				...Object.fromEntries(r.map(({ key: e, url: t }) => [e, {
					url: t,
					availability: "checking"
				}]))
			})), await Promise.all(r.map(async ({ key: e, url: n }) => {
				let r = await w(n, { signal: t.signal });
				t.signal.aborted || g((t) => t[e]?.url === n ? {
					...t,
					[e]: {
						url: n,
						availability: r ? "available" : "unavailable"
					}
				} : t);
			})), t.signal.aborted || (n = window.setTimeout(() => void i(!1), On));
		}, a = window.setTimeout(() => void i(!0), kn);
		return () => {
			t.abort(), window.clearTimeout(a), n !== void 0 && window.clearTimeout(n);
		};
	}, [e.comfyUIUrl, v]);
	let y = (e) => c(e === "available" ? "ComfyUI 服务已就绪" : e === "unavailable" ? "服务未就绪，请查看弹出的终端窗口中的日志" : "正在等待 ComfyUI 服务就绪，首次启动可能需要几分钟时间…"), b = (e, t) => {
		let n = h[e];
		return n?.url === t ? n.availability : "checking";
	}, x = async () => {
		let t = e.comfyUIUrl?.trim() || "http://127.0.0.1:8188";
		f(!0);
		try {
			await O("open_comfyui_window", { comfyUrl: t });
		} catch (e) {
		...
		u(!0), m("starting");
		try {
			await O("launch_comfyui", { comfyPath: t });
			...
			m(i ? "ready" : "failed"), i && await x(), s(c(i ? "ComfyUI 服务已就绪" : "ComfyUI 进程已启动，但等待服务就绪超时，请查看终端窗口日志"), i ? "success" : "error");
		} catch (e) {
		...
		name: c("服务端 {index}", { index: v.length + 1 }),
		url: ""
	}]), k = (e, t) => E(v.map((n) => n.id === e ? {
		...n,
		...t
	} : n)), A = (e) => E(v.filter((t) => t.id !== e));
	return /* @__PURE__ */ (0, $.jsxs)("div", {
		className: "space-y-4",
		children: [
			/* @__PURE__ */ (0, $.jsxs)("div", { children: [/* @__PURE__ */ (0, $.jsx)("h3", {
				...
				children: [
					...
					/* @__PURE__ */ (0, $.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, $.jsx)("div", {
							className: `flex-1 min-w-0 text-[11px] leading-4 break-all bg-canvas-surface rounded-md px-2.5 py-1 border border-canvas-border ${_ ? "text-canvas-text-secondary font-mono select-all" : "text-canvas-text-muted italic"}`,
							children: _ || c("未设置")
						}), /* @__PURE__ */ (0, $.jsx)(W, {
							type: "button",
							className: "settings-save-btn self-stretch shrink-0 text-xs",
							onClick: S,
							children: c(_ ? "更换" : "选择文件夹")
						})]
					}),
					/* @__PURE__ */ (0, $.jsx)("p", {
				...
				children: [
					...
					/* @__PURE__ */ (0, $.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, $.jsx)("input", {
							...
							availability: b(Dn, e.comfyUIUrl?.trim() || "http://127.0.0.1:8188"),
							label: y(b(Dn, e.comfyUIUrl?.trim() || "http://127.0.0.1:8188"))
						})]
					}),
					/* @__PURE__ */ (0, $.jsx)("p", {
						className: "text-[11px] text-canvas-text-muted mt-2",
					...
					/* @__PURE__ */ (0, $.jsxs)("div", {
						...
						}), v.length === 0 ? /* @__PURE__ */ (0, $.jsx)("p", {
							className: "text-[11px] text-canvas-text-muted",
							children: c("图片与视频分开部署时，在这里添加另一台服务端，再到「工作流管理」里把工作流绑定过去")
						}) : /* @__PURE__ */ (0, $.jsxs)("div", {
							className: "space-y-2",
							children: [v.map((e) => /* @__PURE__ */ (0, $.jsxs)("div", {
								className: "flex items-center gap-2",
								children: [
									/* @__PURE__ */ (0, $.jsx)("input", {
										type: "text",
										className: `${En} w-28 shrink-0`,
										placeholder: c("服务端名称"),
										defaultValue: e.name,
										onBlur: (t) => void k(e.id, { name: t.target.value.trim() })
									}),
									/* @__PURE__ */ (0, $.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, $.jsx)("input", {
											...
											defaultValue: e.url,
											onBlur: (t) => void k(e.id, { url: t.target.value.trim() })
										}), /* @__PURE__ */ (0, $.jsx)(An, {
											availability: b(e.id, e.url.trim()),
											label: y(b(e.id, e.url.trim()))
										})]
									}),
									/* @__PURE__ */ (0, $.jsx)("button", {
										type: "button",
...
function Nn({ active: e }) {
	let t = i(), { config: n, updateConfig: r, saveConfig: a, currentProjectId: o } = T(le((e) => ({
		config: e.config,
		updateConfig: e.updateConfig,
		saveConfig: e.saveConfig,
		currentProjectId: e.currentProjectId
	...
	(0, Q.useEffect)(() => {
		...
		return n(), window.addEventListener(ee, n), () => {
			t = !0, window.removeEventListener(ee, n);
		};
	}, [e, o]), (0, Q.useEffect)(() => {
		if (!e) return;
		let t = !1;
			...
			children: [
				/* @__PURE__ */ (0, $.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, $.jsx)("div", {
						...
						className: "flex items-center gap-2",
						children: [/* @__PURE__ */ (0, $.jsx)("div", {
							className: `flex-1 min-w-0 text-[11px] break-all rounded-md px-3 py-1.5 border border-canvas-border ${w ? "text-canvas-text-secondary font-mono leading-relaxed bg-canvas-surface select-all" : "text-canvas-text-muted bg-canvas-surface italic"}`,
							children: w || t("未设置（使用系统默认目录）")
						}), /* @__PURE__ */ (0, $.jsx)(W, {
							type: "button",
							className: "settings-save-btn shrink-0 text-xs",
							onClick: () => x(t("选择文件保存根目录"), (e) => ({ baseDataDir: e })),
							children: t(w ? "更换" : "选择文件夹")
						})]
					})]
				}),
				/* @__PURE__ */ (0, $.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, $.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, $.jsx)("div", {
							...
							children: _ ? t("检测中…") : h ? Mn(h) : t("未检测到唯一安装，请选择 blender.exe")
						}), /* @__PURE__ */ (0, $.jsx)(W, {
							type: "button",
							className: "settings-save-btn shrink-0 text-xs",
							disabled: _,
...
async function zn(e, t, n, r, i) {
	...
	try {
		...
		throw Error(`无法读取插件文件 ${n}，请确认文件存在并重新选择插件根目录`, { cause: e });
	}
	if (!o.isFile) throw Error(`插件文件 ${n} 不是普通文件`);
	let s = (e) => {
		if (i !== void 0 && e !== i) throw Error(`插件包资源 ${n} 字节数不匹配`);
		if (e > r) throw Error(`插件文件 ${n} 过大`);
	};
	s(o.size);
	let c = await e.readFile(a);
	return s(c.byteLength), c;
}
async function Bn(e, t, n, r) {
	let i = await zn(e, t, n, r);
	try {
		return new TextDecoder("utf-8", { fatal: !0 }).decode(i);
	} catch (e) {
		throw Error(`插件文件 ${n} 必须使用 UTF-8 编码`, { cause: e });
	}
}
async function Vn(e, t = !1) {
	let n = await import("./dist-js-CiPmuq1Z.js").then((e) => e.t), r = /* @__PURE__ */ new Set();
	for (let t of e) {
		let e = t.replace(/\\/g, "/").replace(/\/+$/, "");
		(await n.stat(t)).isDirectory ? (await n.readDir(t)).some((e) => e.name === "manifest.json") && r.add(`${e}/manifest.json`) : e.endsWith("/manifest.json") && r.add(e);
	}
	if (r.size === 0) {
		if (!t) return null;
		throw Error("所选文件夹根目录缺少 manifest.json，请选择插件根目录");
	}
	if (r.size !== 1) throw Error("请一次只选择一个插件根目录");
	let i = Array.from(r)[0].slice(0, -13), a = await Bn(n, i, "manifest.json", Fn), o = await Bn(n, i, h(a).entry, In), s = E(a, o), c = s.ui ? await Bn(n, i, s.ui.entry, Ln) : void 0, l = [];
	for (let e of s.resources ?? []) {
		let t = await zn(n, i, e.path, e.bytes, e.bytes);
		l.push({
			id: e.id,
			bytes: Array.from(t)
		});
...
//#endregion
//#region src/services/plugins/pluginMarketplace.ts
var Hn = "https://raw.githubusercontent.com/Tenney95/AI-Canvas-tauri/master/public/plugin-marketplace.json", Un = "/plugin-marketplace.json", Wn = 900 * 1e3, Gn = 15e3, Kn = 128 * 1024, qn = 256 * 1024, Jn = 64 * 1024, Yn = 512 * 1024, Xn = 100, Zn = /^v?(\d+\.\d+\.\d+)$/, Qn = /* @__PURE__ */ new Map();
function $n(e, t) {
...
async function nr(e, t, n, r) {
	let i = new AbortController(), a = setTimeout(() => i.abort(), Gn);
	try {
		let a = await e(t, {
			signal: i.signal,
...
async function rr(e, t, n) {
	let r = new AbortController(), i = setTimeout(() => r.abort(), Gn);
	try {
...
function ir(e) {
	if (new Blob([e]).size > Kn) throw Error("插件市场索引过大");
	let t;
	try {
		t = JSON.parse(e);
	} catch {
	...
	if (!Array.isArray(n.plugins) || n.plugins.length > Xn) throw Error(`插件市场索引最多允许 ${Xn} 个插件`);
...
async function sr(e, t = {}) {
	let n = t.fetcher ?? fetch, r = er(e), i = Qn.get(r);
	if (!t.force && i && i.expiresAt > Date.now()) return i.plugin;
	let [a, o] = tr(r), s = await nr(n, `https://api.github.com/repos/${a}/${o}/releases/latest`, qn, "application/vnd.github+json"), c = $n(JSON.parse(s), "GitHub Release"), l = typeof c.tag_name == "string" ? c.tag_name : "", u = Zn.exec(l);
	if (!u) throw Error("最新 GitHub Release 标签必须使用 vX.Y.Z");
	if (c.draft === !0 || c.prerelease === !0) throw Error("不能安装草稿或预发布版本");
	let d = `https://raw.githubusercontent.com/${a}/${o}/${l}`, f = await nr(n, `${d}/manifest.json`, Jn), p = await nr(n, `${d}/${h(f).entry}`, Yn), m = E(f, p);
	...
	let g = m.ui ? await nr(n, `${d}/${m.ui.entry}`, 2 * 1024 * 1024) : void 0, _ = await Promise.all((m.resources ?? []).map(async (e) => ({
		id: e.id,
		bytes: Array.from(await rr(n, `${d}/${e.path}`, e.bytes))
	}))), v = {
		repository: r,
		releaseTag: l,
...
async function cr(e) {
	let t;
	try {
		return ir(await nr(e, Hn, Kn));
	} catch (e) {
		t = e;
	}
	try {
		return ir(await nr(e, Un, Kn));
	} catch {
		throw t;
	}
}
async function lr(e = [], t = {}) {
	let n = t.fetcher ?? fetch, r = await cr(n), i = new Map(r.map((e) => [e.repository, e.featured]));
	for (let t of e) {
		let e = er(t);
		i.has(e) || i.set(e, !1);
	}
...
}, null, 2), hr = "def uppercase_output(input_value):\n    output = str(input_value[\"node\"][\"data\"].get(\"output\", \"\"))\n    return {\n        \"data\": {\"output\": output.upper()},\n        \"message\": \"已使用本机 Python 转换输出\",\n    }\n\ndefine_plugin({\"tools\": {\"python-uppercase-output\": uppercase_output}})\n", gr = "AI-Canvas-插件开发规范.md", _r = 256, vr = new Set([
	".git",
	".hg",
	".svn"
]);
function yr(e) {
	return vr.has(e.trim().toLocaleLowerCase());
}
async function br({ tauri: e, openNativeDirectory: t, openBrowserDirectory: n, installFromPaths: r }) {
	if (!e) {
		n();
		return;
	}
	let i = await t(), a = Array.isArray(i) ? i[0] : i;
	typeof a == "string" && a.trim() && await r([a]);
}
var xr = {
...
function Sr(e) {
	return e.permissions.map((e) => xr[e] ?? e).join("；");
}
function Cr(e, t) {
...
async function kr(e) {
	...
	for (;;) {
		...
		if (n.push(...e), n.length > _r) throw Error("插件文件夹包含的文件过多");
	}
}
async function Ar(e, t, n) {
	if (yr(e.name)) return;
	if (n.length >= _r) throw Error("插件文件夹包含的文件过多");
	let r = `${t}${e.name}`;
	if (Dr(e)) {
...
function Pr() {
	let e = (0, Q.useRef)(null), t = T((e) => e.installedPlugins), n = T((e) => e.installPluginBundle), r = T((e) => e.setPluginEnabled), i = T((e) => e.deletePlugin), a = T((e) => e.showToast), [o, s] = (0, Q.useState)(!1), [c, l] = (0, Q.useState)(!1), [u, d] = (0, Q.useState)(!1), [f, p] = (0, Q.useState)([]), [m, g] = (0, Q.useState)(!0), [_, v] = (0, Q.useState)(""), [y, b] = (0, Q.useState)(""), [x, S] = (0, Q.useState)(""), [C, w] = (0, Q.useState)(""), [E, O] = (0, Q.useState)(null), [k, A] = (0, Q.useState)(!1), j = (0, Q.useMemo)(() => t.flatMap((e) => e.manifest.repository ? [e.manifest.repository] : []), [t]), M = (0, Q.useCallback)(async (e = !1) => {
		g(!0), v("");
		try {
			p(await lr(j, { force: e }));
		} catch (e) {
			v(e instanceof Error ? e.message : "插件市场加载失败");
		} finally {
			g(!1);
		}
	...
	let P = (0, Q.useMemo)(() => {
		let e = y.trim().toLocaleLowerCase();
		...
		if (!(!e.trim() || C)) {
			w(e);
			try {
				let i = r?.status === "ready" ? r : await sr(e, { force: !0 }), a = t.some((e) => e.id === i.manifest.id) ? "更新" : "安装", o = await Tr(i.manifest, i.source, a, i.repository);
				if (!o) return;
		...
		try {
			if (F()) {
				await H(new TextEncoder().encode("# AI Canvas 插件开发规范\n\n> 适用宿主版本：AI Canvas `0.9.2`；Plugin API v1<br>\n> 最后更新：2026-09-03；插件入口：设置 → 插件 → 导入插件文件夹 / 插件市场\n\n本文档说明如何为 AI Canvas 编写用户插件。当前只有一套 Plugin API v1：节点工具、自定义节点、宿主管理的模型调用、节点/连线/包资源句柄、主窗口隔离弹窗，以及由用户明确授权的可信 Python 运行时都属于同一份首版契约，不存在旧版本兼容分支。\n\n## 1. 当前能力范围\n\nPlugin API v1 支持：\n\n- 在节点右键菜单中注册一个或多个工具；\n- 在文本、图片、视频、音频和全景节点的上方工具栏中注册按钮；\n- 由宿主根据 Manifest 渲染统一操作弹窗，或在同一主窗口 Modal 内挂载隔离的插件 UI；\n- 指定每个工具适用的节点类型；\n- 读取 Manifest 中声明的节点顶层字段；\n- 返回 JSON 数据更新当前节点；\n- 返回 JSON 数据创建派生节点；\n- 在独立 QuickJS 沙箱中执行同步 JavaScript。\n- 通过本机 Python 3 和当前环境已安装的包执行可信 `main.py` 插件；\n- 通过 `contributes.nodes` 注册带字段和输入输出端口的自定义节点；\n- 向自定义节点与节点工具提供当前可调用模型的安全目录，并由宿主代为调用模型；\n- 在操作弹窗中提供模型下拉，并通过 `model.generate` 把参考图与提示词一起交给多模态模型；\n- 通过调用级不透明 `resourceId` 读取当前节点文件、直接输入连线文件和 Manifest 声明的包资源；\n- 通过宿主在项目目录创建新的文本输出，不向插件暴露真实路径；\n- 从符合发布规范的 GitHub Release 安装插件，并检查稳定版更新。\n\nJavaScript 沙箱当前暂不支持：\n\n- 自定义设置面板或任意挂入宿主 DOM 的 HTML/React；\n- 任意网络请求、任意路径文件访问、目录遍历、删除、系统命令或 Tauri API；\n- `import`、`require`、第三方 npm 包或多个 JavaScript 文件；\n- Promise、`async` 工具或后台任务；\n- 获取真实本地路径、跨项目文件、非直接连线文件或修改受保护的资产字段；\n- 构造新的远程媒体 URL 交给宿主加载；远程媒体只能从真实媒体输入或本轮宿主媒体模型结果中原样传递。\n\n## 2. 插件目录结构\n\n每个插件是一个独立文件夹。JavaScript 与 Python 插件分别使用以下结构：\n\n```text\nmy-plugin/\n├── manifest.json\n├── main.js\n├── ui.js                    # 仅声明 manifest.ui 时需要\n└── resources/               # 仅放 manifest.resources 声明的包资源\n    └── template.txt\n\nmy-python-plugin/\n├── manifest.json\n└── main.py\n```\n\n- 文件名区分大小写；\n- `manifest.json` 和入口文件必须位于同一级目录；\n- 文件夹中必须且只能有一个 `manifest.json`；\n- JavaScript 入口固定为 `main.js`；可信 Python 插件固定为 `main.py`；\n- `ui.entry` 和 `resources[].path` 必须是插件目录内的安全相对路径并通过字节数与 SHA-256 校验；\n- 未在 Manifest 中声明的其他文件不会被插件运行时加载。\n\n## 3. 最小可运行示例\n\n下面的插件会为文本节点增加“输出转大写”右键工具和工具栏按钮。由于工具声明了 `dialog`，两个入口都会在主窗口中打开同一个操作弹窗。\n\n### manifest.json\n\n```json\n{\n  \"apiVersion\": 1,\n  \"id\": \"com.example.uppercase\",\n  \"name\": \"文本大写工具\",\n  \"version\": \"1.0.0\",\n  \"author\": \"Your Name\",\n  \"description\": \"把文本节点的输出内容转换为大写\",\n  \"category\": \"content\",\n  \"keywords\": [\"文本\", \"格式化\"],\n  \"entry\": \"main.js\",\n  \"permissions\": [\"node.read\", \"node.write\"],\n  \"contributes\": {\n    \"nodeTools\": [\n      {\n        \"id\": \"uppercase-output\",\n        \"title\": \"输出转大写\",\n        \"description\": \"把当前节点的 output 转换为大写\",\n        \"placements\": [\"node-context-menu\", \"node-toolbar\"],\n        \"icon\": \"lucide:case-upper\",\n        \"dialog\": {\n          \"title\": \"输出转大写\",\n          \"description\": \"可选填写前缀；确认后插件会处理当前节点输出。\",\n          \"submitLabel\": \"转换\",\n          \"fields\": [\n            {\n              \"id\": \"prefix\",\n              \"label\": \"结果前缀\",\n              \"type\": \"text\",\n              \"placeholder\": \"例如：标题：\"\n            }\n          ]\n        },\n        \"nodeTypes\": [\"ai-text\", \"source-text\"],\n        \"inputFields\": [\"output\"],\n        \"output\": {\n          \"mode\": \"update-current\",\n          \"fields\": [\"output\"]\n        }\n      }\n    ]\n  }\n}\n```\n\n### main.js\n\n```javascript\ndefinePlugin({\n  tools: {\n    \"uppercase-output\": (input) => ({\n      data: {\n        output: String(input.parameters.prefix || \"\")\n          + String(input.node.data.output || \"\").toUpperCase()\n      },\n      message: \"已将节点输出转换为大写\"\n    })\n  }\n});\n```\n\n安装后，在画布中选择 `ai-text` 或 `source-text` 节点，节点上方工具栏会显示插件图标；右键菜单中也会出现“输出转大写”。\n\n## 4. Manifest 顶层字段\n\n| 字段 | 类型 | 必填 | 规则 |\n|---|---|---:|---|\n| `apiVersion` | number | 是 | 固定为 `1` |\n| `runtime` | string | 否 | `javascript`（默认）或 `python` |\n| `id` | string | 是 | 插件唯一 ID，建议使用反向域名；仅允许小写字母、数字、点、下划线和短横线，最长 128 字符 |\n| `name` | string | 是 | 用户可见名称，最长 80 字符 |\n| `version` | string | 是 | 插件版本，最长 32 字符；建议使用语义化版本，如 `1.2.0` |\n| `author` | string | 否 | 作者名称，最长 80 字符 |\n| `description` | string | 否 | 插件用途说明，最长 240 字符 |\n| `repository` | string | GitHub 发布必填 | GitHub HTTPS 仓库地址，格式为 `https://github.com/作者/仓库` |\n| `homepage` | string | 否 | 插件主页，必须使用 HTTPS |\n| `license` | string | 否 | 开源许可证标识，如 `MIT`、`Apache-2.0` |\n| `category` | string | 是 | 插件分类，见下表 |\n| `keywords` | string[] | 否 | 1–12 个关键词，每项最长 128 字符 |\n| `entry` | string | 是 | JavaScript 固定为 `main.js`；Python 固定为 `main.py` |\n| `permissions` | string[] | 是 | 插件权限，见权限章节 |\n| `contributes.nodeTools` | object[] | 条件必填 | 插件贡献的节点工具，最多 64 个 |\n| `resources` | object[] | 否 | 当前 revision 随包安装的不可变资源，最多 64 项、合计 64 MiB |\n| `ui` | object | 否 | 自定义 UI bundle、SHA-256 与导出映射；使用时必须声明 `ui.custom` |\n| `contributes.nodes` | object[] | 条件必填 | 自定义节点，最多 32 个；两类贡献至少填写一种 |\n\n### category 可选值\n\n| 值 | 含义 |\n|---|---|\n| `content` | 文本、提示词、结构化内容处理 |\n| `media` | 图片、视频、音频相关的元数据处理 |\n| `workflow` | 工作流内容或参数处理 |\n| `utility` | 不属于以上分类的通用工具 |\n\n分类用于向用户说明插件用途，不会自动授予额外权限。\n\n## 5. 节点工具声明\n\n`contributes.nodeTools` 中的每一项表示一个节点工具。同一个工具可以同时出现在右键菜单和节点工具栏。\n\n| 字段 | 类型 | 必填 | 规则 |\n|---|---|---:|---|\n| `id` | string | 是 | 工具在当前插件内的唯一 ID，最长 64 字符；仅允许小写字母、数字、点、下划线和短横线 |\n| `title` | string | 是 | 菜单、工具提示和弹窗中的工具名称，最长 80 字符 |\n| `description` | string | 否 | 工具用途说明，最长 240 字符 |\n| `placements` | string[] | 是 | 可填写 `node-context-menu`、`node-toolbar`，也可同时填写两者 |\n| `icon` | string | 工具栏入口必填 | Iconify 图标名，例如 `lucide:wand-sparkles`；不接受 URL、SVG 或 HTML |\n| `dialog` | object | 工具栏入口必填 | 点击后由宿主渲染声明式表单，或在主窗口 Modal 中挂载隔离自定义 UI |\n| `nodeTypes` | string[] | 是 | 工具适用的节点类型 |\n| `inputFields` | string[] | 是 | 允许传给插件的节点数据顶层字段，数量为 1–64 个 |\n| `output` | object | 是 | 工具的写入方式和允许输出的字段 |\n\nManifest 中的工具 ID 必须与 `main.js` 的 `tools` 键完全一致。\n\n### placements 与交互方式\n\n| 值 | 出现位置 | 点击行为 |\n|---|---|---|\n| `node-context-menu` | 节点右键菜单 | 声明 `dialog` 时打开同一个主窗口弹窗；未声明时立即执行，`input.parameters` 为空对象 |\n| `node-toolbar` | 匹配节点的上方工具栏 | 打开 Manifest 声明的宿主弹窗，用户确认后执行 |\n\n同一工具从工具栏或右键菜单触发时复用同一个弹窗。只要声明了 `dialog`，即使没有必填字段也会打开它；完全不需要 UI 的一键工具可以省略 `dialog`，插件需自行处理空的 `input.parameters`。\n\n工具栏按钮会自动追加到现有节点工具栏，不进入用户的内置工具栏排序配置。按钮提示格式为“工具标题 · 插件名称”。目前实际提供上方工具栏的节点族包括文本、图片、视频、音频和全景；对应的源节点复用同一工具栏，但仍按 `nodeTypes` 精确匹配。\n\n### icon 规则\n\n工具栏入口必须提供 `icon`。它必须是 Iconify 的 `集合:图标名` 格式，只能使用小写字母、数字和短横线，例如：\n\n```json\n\"icon\": \"lucide:wand-sparkles\"\n```\n\n插件不能传入远程图标 URL、SVG 字符串、HTML 或本地文件路径。\n\n### dialog 规则\n\n`node-toolbar` 工具必须声明 `dialog`：\n\n```json\n\"dialog\": {\n  \"title\": \"整理文本\",\n  \"description\": \"选择处理方式并填写附加说明。\",\n  \"submitLabel\": \"开始处理\",\n  \"fields\": [\n    {\n      \"id\": \"instruction\",\n      \"label\": \"附加说明\",\n      \"type\": \"textarea\",\n      \"placeholder\": \"请输入要求\",\n      \"required\": true\n    },\n    {\n      \"id\": \"tone\",\n      \"label\": \"语气\",\n      \"type\": \"select\",\n      \"defaultValue\": \"brief\",\n      \"options\": [\n        { \"label\": \"简洁\", \"value\": \"brief\" },\n        { \"label\": \"详细\", \"value\": \"detailed\" }\n      ]\n    }\n  ]\n}\n```\n\n`dialog` 支持以下字段：\n\n| 字段 | 类型 | 必填 | 规则 |\n|---|---|---:|---|\n| `title` | string | 否 | 弹窗标题，缺省使用工具 `title` |\n| `description` | string | 否 | 弹窗说明，缺省使用工具 `description` |\n| `submitLabel` | string | 否 | 确认按钮文字，缺省为“执行” |\n| `fields` | object[] | 是 | 0–16 个表单字段；空数组表示仅确认后执行 |\n\n表单字段支持 `text`、`textarea`、`number`、`select` 和 `boolean`。每项可声明 `id`、`label`、`type`、`description`、`placeholder`、`required` 与 `defaultValue`；`select` 还必须声明 1–32 个 `{ \"label\", \"value\" }` 选项。字段 `id` 在当前弹窗中必须唯一，只能使用字母开头的字母、数字和下划线组合。\n\nAPI v1 还支持 `model` 类型，用于让用户在弹窗里选择模型：\n\n| 类型 | 说明 | 额外字段 |\n|---|---|---|\n| `model` | 渲染当前已配置且可调用的模型下拉。插件只拿到用户选择的模型 ID，拿不到 API Key、接口地址或任何厂商凭据 | 可选 `modelCategories`：`text`、`image`、`video`、`audio` 的数组，缺省表示不限分类 |\n\n```json\n{\n  \"id\": \"model\",\n  \"label\": \"分析模型\",\n  \"type\": \"model\",\n  \"modelCategories\": [\"text\"],\n  \"required\": true\n}\n```\n\n`model` 字段要求插件声明 `models.read`；`modelCategories` 只能用在 `model` 字段上。模型下拉只列出已配置凭据的模型，未配置的厂商不会出现。\n\n### 支持的 nodeTypes\n\n| 节点类型 | 用途 |\n|---|---|\n| `ai-text` | AI 文本节点 |\n| `ai-image` | AI 图片节点 |\n| `ai-video` | AI 视频节点 |\n| `ai-audio` | AI 音频节点 |\n| `ai-animation` | AI 动画节点 |\n| `ai-panorama` | AI 全景节点 |\n| `ai-markdown` | Markdown 节点 |\n| `ai-storyboard` | 宫格分镜节点 |\n| `ai-shotlist` | 分镜表节点 |\n| `ai-director` | 导演台节点 |\n| `source-image` | 图片源节点 |\n| `source-video` | 视频源节点 |\n| `source-audio` | 音频源节点 |\n| `source-text` | 文本源节点 |\n| `canvas-note` | 画布笔记 |\n| `comment` | 评论节点 |\n\n一个工具可以同时声明多个节点类型：\n\n```json\n\"nodeTypes\": [\"ai-text\", \"source-text\", \"ai-markdown\"]\n```\n\n## 6. 输入数据\n\n工具函数接收一个 `input` 对象：\n\n```typescript\ninterface PluginInput {\n  projectId: string;\n  iteration: number;\n  parameters: Record<string, JsonValue>;\n  node: {\n    id: string;\n    type: string;\n    data: Record<string, JsonValue>;\n  };\n  models: PluginModelSummary[];\n  effectResult?: PluginNodeHostEffectResult;\n}\n```\n\n`input.parameters` 来自宿主弹窗。工具栏按钮总会先打开弹窗；右键菜单是直接执行入口，通常该值为 `{}`，但工具声明了必填字段时宿主会先打开弹窗（见第 5 节）。插件应为可选参数提供缺省处理：\n\n```javascript\nconst prefix = String(input.parameters.prefix || \"\");\nconst confirmed = input.parameters.confirmed === true;\n```\n\n另外三个字段与宿主 effect 相关，详见「宿主 effect」：\n\n| 字段 | 含义 |\n|---|---|\n| `iteration` | 当前是第几轮调用，首次为 `0`；每完成一次宿主 effect 加一 |\n| `models` | 当前可调用模型目录，每项包含 `id`、`name`、`provider`、`category` 与 `inputModalities`，不含任何凭据；未声明 `models.read` 时为空数组 |\n| `effectResult` | 上一轮宿主 effect 的结果，`{ type, ok, value?, error? }`；首次调用时不存在 |\n\n```javascript\nconst models = input.models.filter((model) => model.category === \"text\");\nif (input.effectResult && !input.effectResult.ok) {\n  return { data: { output: `调用失败：${input.effectResult.error}` } };\n}\n```\n\n其中 `input.node.data` 只包含当前工具在 `inputFields` 中声明、并且可以安全转换为 JSON 的字段。例如：\n\n```json\n\"inputFields\": [\"label\", \"prompt\", \"output\"]\n```\n\n对应的插件代码：\n\n```javascript\nconst label = input.node.data.label;\nconst prompt = input.node.data.prompt;\nconst output = input.node.data.output;\n```\n\n常用节点字段包括：\n\n| 字段 | 常见类型 | 含义 |\n|---|---|---|\n| `label` | string | 节点名称 |\n| `prompt` | string | 提示词 |\n| `output` | string | 文本结果或媒体 URL |\n| `status` | string | `idle`、`loading`、`success` 或 `error` |\n| `model` | string | 当前模型 ID |\n| `provider` | string | 当前供应商 ID |\n| `workflowId` | string | 当前工作流 ID |\n| `workflowInputs` | object | 工作流输入映射 |\n| `imageUrl` | string | 图片展示 URL |\n| `videoUrl` | string | 视频展示 URL |\n| `audioUrl` | string | 音频展示 URL |\n| `thumbnailUrl` | string | 缩略图 URL |\n| `style` | string | 画风 ID |\n| `aspectRatio` | string | 宽高比 |\n| `imageWidth` / `imageHeight` | number | 图片尺寸 |\n| `videoWidth` / `videoHeight` | number | 视频尺寸 |\n| `note` | object | 画布笔记数据 |\n\n不同节点不一定拥有所有字段。插件必须处理字段不存在或值为空的情况。\n\n以下本地敏感字段禁止出现在 `inputFields` 中：\n\n- `filePath`\n- `relativePath`\n- `directorCaptureFilePaths`\n- `__proto__`\n- `constructor`\n- `prototype`\n\n## 7. main.js 注册规则\n\n入口文件必须且只能调用一次全局函数 `definePlugin`：\n\n```javascript\ndefinePlugin({\n  tools: {\n    \"tool-id\": (input) => {\n      return {\n        data: {\n          output: \"插件处理结果\"\n        },\n        message: \"可选的完成提示\"\n      };\n    }\n  }\n});\n```\n\n规则如下：\n\n- `tools` 的键是 Manifest 中声明的工具 ID；\n- 每个工具值必须是同步函数；\n- 工具必须返回可 JSON 序列化的普通对象；\n- 返回对象必须包含非空的 `data` 对象，或包含一个 `effect` 请求宿主代执行模型/资源能力；\n- `message` 可选，用于执行完成后的短提示，最长保留 240 字符；\n- 不要修改 `input`，应根据输入创建并返回新数据；\n- 不要返回函数、Symbol、循环引用、`undefined`、Promise 或其他不可 JSON 序列化的值。\n\n返回 `effect` 的多阶段写法见第 9 节「宿主 effect」；节点工具与自定义节点都可以使用，两者只是取模型 ID 的位置不同。\n\nPlugin API 的 JSON 值范围为：\n\n```typescript\ntype JsonValue =\n  | null\n  | boolean\n  | number\n  | string\n  | JsonValue[]\n  | { [key: string]: JsonValue };\n```\n\n### 7.1 main.py 注册规则\n\n可信 Python 插件同样使用 API v1，并显式声明运行时：\n\n```json\n{\n  \"apiVersion\": 1,\n  \"runtime\": \"python\",\n  \"entry\": \"main.py\"\n}\n```\n\n`main.py` 必须调用一次 `define_plugin`，工具函数接收与 JavaScript 相同的 JSON 输入并返回可 JSON 序列化的字典：\n\n```python\ndef uppercase(input_value):\n    output = str(input_value[\"node\"][\"data\"].get(\"output\", \"\"))\n    return {\n        \"data\": {\"output\": output.upper()},\n        \"message\": \"已转换输出\",\n    }\n\ndefine_plugin({\"tools\": {\"uppercase-output\": uppercase}})\n```\n\n宿主按顺序探测 macOS/Linux 的 `python3`、`python`，以及 Windows 的 `python`、`py -3`、`python3`。解释器必须是 Python 3。插件直接使用该环境的标准库和 site-packages；AI Canvas 不下载 Python、不创建虚拟环境，也不读取或自动执行 `requirements.txt`。\n\nPython 工具同样必须同步返回 JSON 数据；不接受 coroutine。每次调用使用一个独立子进程，默认最长运行 30 秒。源码通过标准输入传递，不拼接到 Shell 命令中。\n\n> **安全警告：** Python 插件不是沙箱。它以当前用户身份运行，可以绕过 Manifest 权限自行访问本机文件、网络和环境变量，也可以启动其他程序。Manifest 权限只约束 AI Canvas 代办的模型、资源和画布能力。只安装并启用你信任且已审查源码的 Python 插件。\n\n## 8. 输出规则\n\n### 更新当前节点\n\n使用 `update-current` 将结果合并到当前节点：\n\n```json\n\"output\": {\n  \"mode\": \"update-current\",\n  \"fields\": [\"label\", \"output\"]\n}\n```\n\n```javascript\ndefinePlugin({\n  tools: {\n    \"format-output\": (input) => ({\n      data: {\n        label: `${input.node.data.label}（已处理）`,\n        output: String(input.node.data.output || \"\").trim()\n      }\n    })\n  }\n});\n```\n\n### 创建派生节点\n\n使用 `create-node` 在源节点右侧创建新节点：\n\n```json\n\"output\": {\n  \"mode\": \"create-node\",\n  \"nodeType\": \"source-text\",\n  \"fields\": [\"label\", \"output\"]\n}\n```\n\n```javascript\ndefinePlugin({\n  tools: {\n    \"create-summary\": (input) => ({\n      data: {\n        label: \"内容摘要\",\n        output: String(input.node.data.output || \"\").slice(0, 120)\n      },\n      message: \"已创建摘要节点\"\n    })\n  }\n});\n```\n\n`nodeType` 仅对 `create-node` 有效；省略时沿用源节点类型。未返回 `label` 时，宿主会根据源节点和工具名称生成新节点名称。\n\n插件只能返回 `output.fields` 中预先声明的字段。如果返回未声明字段，整次执行会失败，不会进行部分写入。\n\nJavaScript 节点工具返回 `imageUrl`、`thumbnailUrl`、`videoUrl`、`audioUrl`、`sourceUrl` 或其他宿主媒体载体时，远程地址必须与本次输入中的真实媒体引用完全一致。插件不能拼接、改写查询参数或从普通文本、JSON、文件正文、弹窗参数中构造新的 `http/https` 媒体地址。插件同样不能猜测或自行返回 `asset:`、`file:`、`blob:` 等本地引用；只有宿主在本轮模型结果中发出的精确本地引用可以原样回传。普通文本节点的 `output` 仍可包含网页链接；只有会被宿主作为媒体加载的字段受此限制。\n\n`ai-markdown` 的 `output` 需要额外遵守同一规则：普通 Markdown 链接可以正常输出，但 `![说明](URL)` 图片会被宿主加载，因此其中的远程 URL 必须来自该 Markdown 节点原有的图片引用或其他受信媒体来源。\n\n以下字段属于宿主身份、本地资产或内部关联信息，禁止写入：\n\n- `type`\n- `displayId`\n- `filePath`\n- `relativePath`\n- `assetId`\n- `artifactId`\n- `role`\n- `dramaAssetId`\n- `dramaAssetKind`\n- `characterLibraryLinks`\n- `hiddenByCharacterLibrary`\n- `directorInstanceId`\n- `directorCaptureFilePaths`\n- `__proto__`\n- `constructor`\n- `prototype`\n\n## 9. 自定义节点与资源端口\n\n自定义节点由宿主统一渲染。Manifest 决定节点字段和端口，`main.js` / `main.py` 中与节点 `id` 同名的 `tools` 函数负责编排数据及宿主能力。\n\n```json\n{\n  \"apiVersion\": 1,\n  \"permissions\": [\n    \"node.read\",\n    \"node.write\",\n    \"models.read\",\n    \"models.invoke\",\n    \"files.connected.read\",\n    \"files.output.create\",\n    \"plugin.resources.read\"\n  ],\n  \"resources\": [{\n    \"id\": \"system-prompt\",\n    \"path\": \"resources/system-prompt.txt\",\n    \"integrity\": \"sha256-<64位十六进制摘要>\",\n    \"mediaType\": \"text/plain\",\n    \"bytes\": 128\n  }],\n  \"contributes\": {\n    \"nodeTools\": [],\n    \"nodes\": [{\n      \"id\": \"writer\",\n      \"title\": \"写作节点\",\n      \"description\": \"读取直接连入的资料并调用文本模型\",\n      \"icon\": \"lucide:sparkles\",\n      \"inputs\": [{\n        \"id\": \"source\",\n        \"label\": \"资料\",\n        \"type\": \"resource\",\n        \"multiple\": true,\n        \"accept\": [\"text/*\", \"application/json\"],\n        \"maxBytes\": 1048576\n      }],\n      \"outputs\": [{ \"id\": \"result\", \"label\": \"结果\", \"type\": \"text\" }],\n      \"fields\": [\n        { \"id\": \"prompt\", \"label\": \"提示词\", \"type\": \"textarea\", \"required\": true },\n        { \"id\": \"model\", \"label\": \"模型\", \"type\": \"model\", \"modelCategories\": [\"text\"] }\n      ],\n      \"resourceAccess\": { \"self\": true, \"incoming\": true, \"portIds\": [\"source\"] }\n    }]\n  }\n}\n```\n\n### 节点字段\n\n`fields` 最多 16 项，支持 `text`、`textarea`、`number`、`select`、`boolean` 和 `model`。`modelCategories` 可包含 `text`、`image`、`video`、`audio`；模型下拉只显示当前已配置且可调用的模型。文件不再作为表单字段保存，统一通过 `resourceAccess` 和 `input.resources` 获得短期句柄。\n\n### 输入输出端口\n\n`inputs`、`outputs` 各最多 16 项，端口类型支持 `text`、`image`、`video`、`audio`、`json` 和 `resource`。输入端口可声明 `required` 和 `multiple`；媒体与 `resource` 端口还可声明 MIME `accept` 与单文件 `maxBytes`。插件最终只能返回 Manifest 已声明的字段和输出端口。\n\n插件节点之间的连线按来源 `plugin-out-<outputId>` 和目标 `plugin-in-<inputId>` 精确路由。目标 Handle 缺失或未知时不会回退到第一个输入端口。显式插件端口要求来源插件、节点和端口仍属于当前活动 revision，且来源与目标端口类型完全一致；例如 `image` 不能直接连接到 `text`。来源插件被卸载、节点被移除、端口被改名或连线被替换时会立即失效，不会回退到其它输出端口。\n\n### 文件资源授权\n\n`resourceAccess` 默认不授予任何文件：\n\n- `self: true`：当前目标节点自身引用的项目文件；\n- `incoming: true`：当前节点的一跳直接输入连线所引用的项目文件；\n- `portIds`：仅自定义节点可用，把入边授权进一步限制到指定输入端口，且必须与 `incoming: true` 同时声明；\n- `resources[]`：插件包内不可变资源，按 ID、相对路径、字节数和 SHA-256 随完整 revision 登记。\n\n项目文件要求位于当前项目目录中，路径及父目录均不得是符号链接。宿主只把以下结构放进 `input.resources`，不提供绝对路径或项目相对路径：\n\n```json\n{\n  \"self\": [],\n  \"incoming\": [{\n    \"resourceId\": \"plugin-resource-<opaque>\",\n    \"origin\": \"connection\",\n    \"displayName\": \"frame.png\",\n    \"mediaType\": \"image/png\",\n    \"size\": 123456,\n    \"access\": \"read\",\n    \"source\": { \"nodeId\": \"source-node\", \"edgeId\": \"edge-1\", \"portId\": \"source\" }\n  }],\n  \"inputs\": { \"source\": [{\n    \"resourceId\": \"plugin-resource-<opaque>\",\n    \"origin\": \"connection\",\n    \"displayName\": \"frame.png\",\n    \"mediaType\": \"image/png\",\n    \"size\": 123456,\n    \"access\": \"read\",\n    \"source\": { \"nodeId\": \"source-node\", \"edgeId\": \"edge-1\", \"portId\": \"source\" }\n  }] },\n  \"package\": []\n}\n```\n\n`resourceId` 只在本次调用或 UI 会话内有效，并绑定插件 ID、入口源码摘要、完整 revision 摘要、项目、节点、画布 revision、连线和端口。读取前宿主会重新检查这些条件以及文件大小、修改时间和普通文件身份；任一变化都会撤销授权。\n\n当前单个 `image`、`video` 或 `audio` 输出端口应返回一个媒体 URL 字符串。JavaScript 插件可以原样返回真实远程媒体输入、本轮宿主发出的模型结果，或受支持的安全内联媒体；自行构造的 `asset:`、`file:`、`blob:` 和不安全 `data:` 引用会被拒绝。需要把本地图片交给模型时，应使用 `model.generate.resourceIds`，由宿主解析句柄；插件不会看到本地 URL。\n\n### 宿主 effect\n\n插件 JavaScript 仍是同步函数。需要异步模型或资源能力时返回一个 `effect`；宿主完成后**再次调用同一个函数**，并在 `input.effectResult` 中给出结果。单次节点、工具或自定义 UI 会话最多执行 4 个 effect。\n\n自定义节点与**节点工具**都可以使用 effect。区别只在于模型 ID 从哪里来：自定义节点读 `input.node.values`，节点工具读弹窗传来的 `input.parameters`。\n\n```js\ndefinePlugin({\n  tools: {\n    \"analyze-frames\": (input) => {\n      // 第一轮：请求宿主调用模型\n      if (!input.effectResult) {\n        return {\n          effect: {\n            type: \"model.generate\",\n            modelId: input.parameters.model,\n            prompt: \"请逐帧分析这些画面的景别、运镜与光线。\",\n            resourceIds: input.resources.incoming\n              .filter((resource) => resource.mediaType.startsWith(\"image/\"))\n              .map((resource) => resource.resourceId)\n          }\n        };\n      }\n      // 第二轮：effectResult 已就绪\n      if (!input.effectResult.ok) {\n        return { data: { output: `模型调用失败：${input.effectResult.error}` } };\n      }\n      return {\n        data: { output: input.effectResult.value.text },\n        message: \"分析完成\"\n      };\n    }\n  }\n});\n```\n\n`input.iteration` 表示当前是第几轮（首次为 `0`），可用于区分更多阶段。不需要多阶段的工具直接返回 `data` 即可，宿主不会再发起第二次调用。\n\n支持的 effect：\n\n| `type` | 权限 | 输入 | 返回值 |\n|---|---|---|---|\n| `model.generate` | `models.invoke` | `modelId`、`prompt`、可选受信远程 `imageUrls`、本次会话的 `resourceIds` 与 `parameters` | 文本为 `{text}`；媒体为 `{url}` |\n| `resource.readText` | `files.connected.read` 或 `plugin.resources.read` | 本次授权的 `resourceId`、可选 `maxBytes` | `{resource, content}`，最多读取 256 KiB UTF-8 文本 |\n| `resource.readRange` | `files.connected.read` 或 `plugin.resources.read` | `resourceId`、`offset`、`length` | `{resource, offset, bytes, base64}`，单次最多 256 KiB |\n| `resource.createText` | `files.output.create` | `content`、可选 `suggestedName` | 在当前项目目录创建新文本，返回 `{fileName, bytes}`；不显示路径且不覆盖上游文件 |\n\n宿主操作失败时不会中断整个工具，而是以 `{ ok: false, error }` 的形式回到 `effectResult`，由插件决定降级还是报错；权限不足、模型不在目录、模型请求异常都走这条路径。\n\n模型目录通过 `input.models` 提供，只包含 ID、名称、分类、用途和输入模态，不包含 API Key、接口地址或厂商凭据；未声明 `models.read` 时该数组为空。模型实际请求始终由宿主现有生成服务执行。\n\n**随模型一起提交的参考图**：远程参考仍可从真实媒体输入原样传递；本地节点或直接连线文件使用本次 `input.resources` 中的 `resourceId`，放进 `model.generate.resourceIds`。宿主会确认资源属于当前调用且 MIME 为图片，再在插件不可见的边界内解析为模型输入。\n\n`imageUrls` 的来源规则：\n\n| 运行时 | 规则 |\n|---|---|\n| JavaScript | 每一项必须已经存在于本次 `inputFields` 声明的媒体引用中，或是本轮宿主模型产生的结果。自行拼接的远程地址会被拒绝，整次运行失败 |\n| Python | 不做来源限制——可信 Python 本身已具备当前用户的联网能力，该校验没有沙箱意义 |\n\n宿主只把成功的图片、视频或音频模型返回 URL 加入本次运行的受信媒体来源集合；文本模型结果和资源正文不会获得该资格。来源集合与资源句柄都不会跨节点、跨 invocation 或跨 UI 会话持久化。\n\n### 主窗口自定义弹窗\n\n节点工具可以用 `dialog.ui` 引用 `manifest.ui.exports` 的逻辑键，用插件自定义视图替换声明式表单。宿主仍使用自己的 `ModalOverlay`、标题栏、关闭行为和主题容器；插件 bundle 只运行在 Modal 内部的 `<iframe sandbox=\"allow-scripts\">`，不会打开额外系统窗口，也拿不到主窗口 DOM、Store、Tauri IPC 或网络能力。\n\nPlugin API v1 只允许节点工具使用自定义 UI。`contributes.nodes` 的节点主体始终由宿主根据 `fields`、`inputs` 与 `outputs` 渲染，不接受 `nodes[].ui`；这样可以保持画布拖拽、缩放、主题、焦点和错误边界一致。\n\n```json\n{\n  \"permissions\": [\"node.read\", \"node.write\", \"ui.custom\"],\n  \"ui\": {\n    \"entry\": \"ui.js\",\n    \"integrity\": \"sha256-<ui.js 的 64 位十六进制摘要>\",\n    \"exports\": { \"toolDialog\": \"ToolDialog\" }\n  },\n  \"contributes\": {\n    \"nodeTools\": [{\n      \"id\": \"compose\",\n      \"title\": \"组合处理\",\n      \"placements\": [\"node-toolbar\", \"node-context-menu\"],\n      \"icon\": \"lucide:panels-top-left\",\n      \"dialog\": { \"fields\": [], \"ui\": \"toolDialog\" },\n      \"nodeTypes\": [\"ai-image\"],\n      \"inputFields\": [\"output\"],\n      \"output\": { \"mode\": \"update-current\", \"fields\": [\"output\"] }\n    }]\n  }\n}\n```\n\n`ui.js` 必须是自包含的 IIFE/UMD bundle。插件可以使用原生 DOM，也可以把 React、Vue 等框架打进自己的 bundle；宿主不会把主窗口的 React 实例交给插件。bundle 需要把挂载函数写入 `window.__AI_CANVAS_PLUGIN_HOST__.exports.ToolDialog`，签名固定为 `(root, props) => cleanup?`：\n\n```js\n(function () {\n  window.__AI_CANVAS_PLUGIN_HOST__.exports.ToolDialog = function mount(root, props) {\n    const button = document.createElement('button');\n    button.textContent = '执行';\n    button.onclick = () => void props.submit({ confirmed: true });\n    root.appendChild(button);\n    return () => button.remove();\n  };\n})();\n```\n\n挂载函数只能操作 iframe 内传入的 `root`。它收到的 `props` 只有：\n\n- `surface`（v1 固定为 `tool-dialog`）、`theme`、裁剪后的 `node`、安全模型目录和 `parameters`；\n- 本会话的不透明 `resources`；\n- `runEffect()`、`setParameters()`、`submit()`、`close()`、`toast()` 与 `busy`。\n\niframe 与宿主只通过 `window.postMessage` 交换带随机 `sessionId` 的有界 JSON。宿主同时绑定消息的 `event.source`、插件双摘要、项目、节点和画布 revision；伪造来源、更新插件、切换项目、修改画布或断开连线都会使会话失败关闭。UI 点击提交时沿用同一 invocation 的资源句柄和受信媒体集合，不会在提交瞬间换发一组不兼容的 ID。主窗口深浅主题会实时同步到 `theme` getter 与 iframe 的 `data-theme`，同时派发 `ai-canvas-theme-change` 事件；插件负责为两种主题提供可读配色。iframe 内按 `Esc` 也会请求宿主关闭当前 Modal。\n\n宿主启动自定义 UI 前还会确认该 iframe 没有获得 `window.__TAURI__`、`window.__TAURI_INTERNALS__` 或其它 Tauri 初始化标记；检测到即停止加载插件 bundle。这个 iframe 是能力隔离边界，不承诺独立进程或 CPU/内存隔离：死循环或过重渲染仍可能影响主窗口响应，因此常规设置优先使用宿主声明式 `dialog.fields`，自定义 UI 应限制依赖、动画和大对象处理。\n\n## 10. 权限声明\n\n支持以下权限：\n\n| 权限 | 含义 |\n|---|---|\n| `node.read` | 读取 `inputFields` 声明的节点字段 |\n| `node.write` | 更新当前节点或创建派生节点 |\n| `models.read` | 读取不含凭据的可调用模型目录 |\n| `models.invoke` | 请求宿主调用目录中的模型 |\n| `files.connected.read` | 读取 `resourceAccess` 明确允许的当前节点或直接入边项目文件 |\n| `files.output.create` | 通过宿主在项目目录创建派生输出，当前开放文本输出 |\n| `plugin.resources.read` | 读取 `manifest.resources` 随当前 revision 登记的包资源 |\n| `ui.custom` | 在主窗口隔离 Modal 中加载经摘要校验的自定义 UI bundle；代码可能影响主窗口响应 |\n\n节点工具必须声明 `node.write`。只要工具声明了输入字段，也必须声明 `node.read`。模型、资源和 UI 权限不会隐式授予。节点工具的常规配置如下：\n\n```json\n\"permissions\": [\"node.read\", \"node.write\"]\n```\n\n需要模型能力的节点工具再加上模型权限：\n\n```json\n\"permissions\": [\"node.read\", \"node.write\", \"models.read\", \"models.invoke\"]\n```\n\n| 权限 | 对节点工具的作用 |\n|---|---|\n| `models.read` | 填充 `input.models`，并允许弹窗使用 `model` 字段 |\n| `models.invoke` | 允许发出 `model.generate` |\n\n只声明 `models.read` 而没有 `models.invoke` 时，`model.generate` 会被拒绝，并以 `{ ok: false, error }` 回到 `effectResult`，不会中断工具。读取节点/连线文件、包资源和创建输出分别需要对应权限；拥有权限但未声明精确 `resourceAccess` 或资源清单时仍得不到句柄。\n\n声明权限不代表插件能绕过字段白名单；运行时仍会分别校验输入和输出字段。\n\n## 11. 安全与资源限制\n\nJavaScript 插件每次调用都会创建独立 QuickJS Runtime。宿主只传入裁剪后的 JSON 快照和不透明资源句柄，不向 JavaScript 暴露 DOM、网络、文件系统或 Tauri 宿主函数。自定义 UI 运行在主窗口 sandboxed iframe 中，CSP 禁止网络连接且没有 Tauri capability。Python 插件每次调用创建独立本机子进程，但它是可信代码，不受 QuickJS 或 iframe 沙箱保护。\n\nQuickJS 运行时还会在写回画布前检查媒体引用来源。检查覆盖直接媒体 URL、媒体节点的 `output` 回退、Markdown 图片、分镜/导演台/视频参考等嵌套媒体数据。`http/https` 地址（包括本机和局域网地址）不会因目标位置而豁免。画布笔记的 `strokeColor` 和 `backgroundColor` 只接受宿主当前色板值或 `#RGB`、`#RGBA`、`#RRGGBB`、`#RRGGBBAA`，不接受任意 CSS 函数或转义。此规则用于维持“JavaScript 无任意网络能力”的边界；可信 Python 插件本身已经能以当前用户权限联网，因此不受该来源集合约束。\n\n同一套来源集合也用于校验 `model.generate` 的 `imageUrls`：JavaScript 插件只能把本次输入已有的媒体引用交给模型，Python 不受限制。模型请求由宿主发起，因此这条能力不会给 JavaScript 沙箱带来新的网络出口。\n\n节点工具使用 effect 时，宿主会在每一轮结束后重新核对插件版本与画布状态；期间发生项目切换、节点变化、插件更新、停用或卸载，过期结果都不会继续请求宿主操作，也不会写入画布。\n\n### 原生信任注册与代码摘要\n\n安装或更新时，应用会计算入口源码 `sourceDigest`，Rust 还会把规范化 Manifest、入口源码、UI bundle 和按 ID 排序的包资源字节共同计算为 `revisionDigest`。可信 Python 或自定义 UI 的确认会显示来源、完整摘要、宿主权限及对应风险；Renderer 传入的布尔值不能替代 Rust 原生授权。声明的字节数、资源/UI 摘要或两端身份不一致时拒绝安装。\n\n入口源码、UI 和包资源随后以不可变快照登记到应用私有的 `plugin-private` 目录。运行命令只提交插件 ID、`sourceDigest`、`revisionDigest`、工具 ID、调用 ID 和结构化输入，不再把 `main.js` / `main.py` 或 runtime 交给执行命令。Rust 会确认插件已启用、双摘要属于活动 revision、工具由该 revision 声明，并在每次执行和资源读取前重新核对私有快照。\n\n`plugin-private` 不能通过普通文件 API、asset URL 或通用路径命令读取。不要手动编辑其中的 `registry.json` 或源码快照；注册缺失、摘要不一致或快照损坏会让插件失败关闭，而不会退回到直接执行 IndexedDB 源码。\n\n`sourceDigest` 只绑定 `main.js` / `main.py` 的精确字节；`revisionDigest` 绑定本次实际启用的 Manifest、入口、UI 和包资源。两者都不是作者签名或仓库签名，不能证明来源可信；作者和用户仍须核对来源并审查可信 Python 代码与 UI bundle。\n\n| 项目 | 限制 |\n|---|---:|\n| `manifest.json` | 最大 64 KiB |\n| `main.js` / `main.py` | 最大 512 KiB |\n| `ui.js` | 最大 2 MiB |\n| 单个包资源 | 最大 16 MiB；单插件最多 64 项、合计 64 MiB |\n| 单次资源分段读取 | 最大 256 KiB |\n| 单次输入 JSON | 最大 1 MiB |\n| 单次输出 JSON | 最大 1 MiB |\n| 沙箱内存 | 最大 64 MiB |\n| JavaScript 栈 | 最大 512 KiB |\n| JavaScript 单次执行时间 | 最长 2 秒 |\n| Python 单次执行时间 | 解释器探测与正文执行合计最长 30 秒；Windows 使用 Job Object，macOS/Linux 使用独立进程组；管道回收另有 2 秒关闭上限 |\n| 单插件节点工具 | 最多 64 个 |\n| 单插件自定义节点 | 最多 32 个 |\n| 单节点输入/输出端口 | 各最多 16 个 |\n| 单节点/单工具宿主 effect | 最多 4 次 |\n| 单工具输入字段 | 最多 64 个 |\n| 单工具输出字段 | 最多 64 个 |\n\n传入和返回的数据还会进行边界化处理：\n\n- 字符串最长保留 256,000 个字符；\n- 数组最多保留 256 项；\n- 单个对象最多保留 128 个键；\n- JSON 嵌套深度最多 8 层；\n- 非有限数字、函数、Symbol 和危险对象键会被拒绝或移除。\n\n画布在插件执行期间发生项目切换、节点变化、插件 revision 更新、插件停用或卸载时，过期结果不会继续请求宿主 effect，也不会写入画布。更新、停用和卸载会在原生 mutation 前先撤销前端版本租约和资源句柄；旧 revision 的资源不会自动交给新代码。\n\n## 12. 安装、更新、启停与卸载\n\n### 安装\n\n1. 打开“设置”；\n2. 选择“插件”；\n3. 将插件文件夹拖到上传区，或点击上传区打开目录选择器；\n4. 选择包含同级 `manifest.json` 与 `main.js` 或 `main.py` 的插件目录；\n5. 可信 Python 或自定义 UI 插件会先显示来源、入口源码摘要、完整 revision 摘要、宿主权限和对应风险；\n6. 随后的 Rust 原生 Warning 会再次绑定插件 ID、版本与当前 revision。只有原生确认通过后才会暂存代码、UI 和声明资源；\n7. 安装成功后，在匹配类型的节点上打开右键菜单，或选择节点查看上方工具栏按钮。\n\n也可以在“插件市场”中点击安装，或粘贴 GitHub 仓库地址。GitHub 安装仍会经过与本地导入完全相同的 Manifest、权限、源码大小和沙箱校验。\n\nPython 或自定义 UI 插件在安装、更新和从停用状态重新启用时，都会先经过前端来源、摘要、宿主权限和风险复核，再经过 Rust 原生 Warning。确认表示用户信任该 revision，并不表示 AI Canvas 已对其完成安全审计。\n\n原生注册表会保留上一批准 revision，供更新失败补偿或内部回滚使用；它不是插件页中的手动降级功能。任何真实切换到上一 Python revision 的原生流程都必须重新显示高风险授权，不能沿用当前版本的批准状态。\n\n### GitHub 发布规范\n\n需要被插件市场追踪的仓库必须满足：\n\n1. 公开 GitHub 仓库根目录包含 `manifest.json` 和 Manifest 声明的 `main.js` 或 `main.py`；\n2. Manifest 填写规范化的 `repository`，且必须与当前仓库一致；\n3. `version` 使用稳定三段版本号，如 `1.2.0`；\n4. 创建正式 GitHub Release，标签使用 `vX.Y.Z`，如 `v1.2.0`；\n5. Release 标签中的版本必须与 Manifest `version` 完全一致；\n6. 不使用 Draft 或 Pre-release 作为市场稳定版。\n\n示例发布字段：\n\n```json\n{\n  \"version\": \"1.2.0\",\n  \"repository\": \"https://github.com/example/my-ai-canvas-plugin\",\n  \"homepage\": \"https://example.com/my-ai-canvas-plugin\",\n  \"license\": \"MIT\"\n}\n```\n\n应用读取 GitHub 的最新正式 Release，再从该 Release 标签对应的仓库快照读取根目录文件。仓库地址、Release 标签和 Manifest 版本任一不匹配时都会拒绝安装。\n\n### 提交到插件市场\n\n插件市场索引位于项目的 `public/plugin-marketplace.json`。作者通过 Pull Request 添加仓库地址：\n\n```json\n{\n  \"schemaVersion\": 1,\n  \"plugins\": [\n    {\n      \"repository\": \"https://github.com/example/my-ai-canvas-plugin\",\n      \"featured\": false\n    }\n  ]\n}\n```\n\n市场收录只登记仓库，不复制插件源码。收录后，作者发布新的稳定版 Release，应用会在刷新插件页时自动识别新版本。未收录的公开仓库仍可通过仓库地址直接安装；直接安装后也会继续检查更新。\n\n### 更新\n\n修改 Manifest、入口、UI 或包资源后重新导入相同 `id` 的插件，会先暂存新的不可执行快照。安装记录保存成功后，宿主先撤销旧版本租约和资源句柄，再原子激活新 `revisionDigest`，并保留原来的启用或停用状态；原生层同时保留上一批准 revision 供本次失败补偿，不代表用户可以手动降级。摘要比较、数据库保存或激活任一步失败，都会回切旧 active 或移除首次注册，并丢弃未提交的 staged 快照。\n\n完整 revision 身份包含 Manifest、入口源码、UI 和包资源；只修改其中任一部分都会形成新的 `revisionDigest`，不需要为了改变 Manifest 而人为改动入口源码。\n\nGitHub 插件有新稳定版时会显示“可更新”。更新必须由用户点击确认，不会静默替换本地插件。检查结果会短期缓存，以避免频繁消耗 GitHub API 限额。\n\n### 启用、停用与卸载\n\n- 从停用状态重新启用时，宿主重新激活已登记的 active 摘要；可信 Python 必须重新通过前端复核和 Rust 原生 Warning，JavaScript 不获得 Python 授权语义；\n- 停用后，插件工具不会显示在节点右键菜单或工具栏中；\n- 停用、卸载或切换 revision 时，前端会先撤销版本租约并清除资源句柄，原生层随后阻止新调用并取消活动 Python 调用；\n- 卸载成功后会移除应用内的原生注册、IndexedDB 安装记录和私有源码快照，但不会删除用户最初选择的插件开发目录，也不会修改 GitHub 仓库；\n- 已经写入节点的数据不会随插件卸载而自动撤销，可通过画布历史记录撤销最近操作。\n\n## 13. 常见错误\n\n### 插件工具没有出现在右键菜单或工具栏\n\n检查：\n\n- 插件是否处于“已启用”状态；\n- 当前节点类型是否包含在 `nodeTypes` 中；\n- `placements` 是否包含目标入口：`node-context-menu` 或 `node-toolbar`；\n- 工具栏入口是否配置了合法的 `icon` 和 `dialog`；\n- Manifest 工具 ID 是否与 `main.js` 中的 `tools` 键一致。\n\n### 安装时报“请求了不允许暴露给插件的本地字段”\n\n`inputFields` 中包含了本地路径或受保护字段。请改为读取安全的展示字段，例如 `output`、`imageUrl` 或 `fileName`。\n\n### 执行时报“返回了未声明字段”\n\n插件返回的 `data` 包含了 `output.fields` 未声明的字段。将需要写入的安全字段加入 Manifest，或者从返回值中删除该字段。\n\n### 执行时报“未经宿主授权的远程媒体引用”或“未经宿主授权的本地媒体引用”\n\nJavaScript 插件返回了一个并非来自真实媒体输入或本轮宿主媒体模型结果的媒体 URL。请改为原样透传输入，或通过 `model.generate` 让宿主创建媒体；不要自行拼接 CDN、跟踪像素、查询参数、局域网地址，也不要猜测 `asset:`、`file:` 或 `blob:` 本地引用。\n\n### 执行时报“端口类型不兼容”\n\n插件输出端口与目标输入端口的声明类型不同。请连接相同的 `text`、`image`、`video`、`audio` 或 `json` 类型；需要格式转换时，应使用一个显式转换节点。\n\n### 模型调用后 `input.models` 是空数组，或模型下拉为空\n\n插件没有声明 `models.read`，或当前没有已配置凭据的模型。下拉只列出已配置且可调用的模型，未配置的厂商不会出现；声明 `models.read` 后仍为空时，请检查设置中的厂商连接。\n\n### 宿主操作返回 `ok: false`，提示未声明 models.invoke\n\n工具发出了 `model.generate`，但 Manifest 只声明了 `models.read`。宿主不会抛出错误，而是把 `{ ok: false, error: \"插件未声明 models.invoke 权限\" }` 放进 `effectResult` 交回插件。在 `permissions` 中加入 `models.invoke`，或在插件里对该结果做降级处理。\n\n### 执行时报“模型调用的 imageUrls 必须是字符串数组”或“未经宿主授权的远程媒体引用”\n\n`imageUrls` 必须是字符串数组，且 JavaScript 插件只能提交本次 `inputFields` 中已有的媒体引用或本轮宿主模型结果。不要从文本、JSON、文件正文或弹窗参数里拼接新的 `http/https` 地址；确实需要新图时改用 Python 运行时，或让宿主先生成媒体再引用。\n\n### 执行时报“来源插件未安装或已卸载”\n\n当前连线指向一个无法从安装记录解析的显式插件输出端口。请重新安装提供该节点的兼容插件，或删除这条失效连线后重新连接；宿主不会把遗留的通用输出静默代替目标端口。\n\n### 执行时报“不允许的画布笔记颜色”\n\nJavaScript 插件为画布笔记返回了任意 CSS 表达式。请使用宿主色板中的现有值，或使用 3、4、6、8 位十六进制颜色；不要使用 `url()`、转义函数或其他 CSS 代码。\n\n### 执行时报“源码摘要”或“插件未注册”\n\n安装记录与原生私有注册表不一致，或者源码快照已损坏。请停用插件并从原始本地目录或可信仓库重新安装。应用不会为了兼容而直接执行 IndexedDB 中的源码。\n\n### 执行时报“首版插件工具不支持异步返回值”\n\n工具返回了 Promise，或使用了 `async`。v1 工具必须同步完成并直接返回普通对象。\n\n### 执行超过 2 秒\n\n减少输入规模和循环次数，避免无限循环。超过时间限制的执行会被沙箱中断，结果不会写入画布。\n\n### 未找到可用的 Python 3\n\n在插件设置页点击“重新检测”。确认终端中能直接运行 `python3`、`python`，或 Windows 的 `py -3`。AI Canvas 不会自动下载解释器或安装依赖。\n\n### Python 插件输出不是有效 JSON\n\n工具必须返回可由 `json.dumps` 序列化的字典。不要向原始 stdout 写入额外协议内容；普通 `print` 会被 runner 捕获，但直接写文件描述符或子进程继承 stdout 仍可能破坏 JSON 输出。\n\n## 14. 发布前检查清单\n\n- [ ] 文件夹根目录包含 `manifest.json` 和对应的 `main.js` 或 `main.py`；\n- [ ] `apiVersion` 固定为 `1`；JavaScript 使用 `main.js`，Python 使用 `runtime: python` 与 `main.py`；\n- [ ] 插件 ID 稳定且不会随版本变化；\n- [ ] GitHub 发布填写了正确的 `repository`、`license` 和三段式 `version`；\n- [ ] GitHub Release 标签为与 Manifest 版本一致的 `vX.Y.Z`；\n- [ ] 每个 Manifest 工具 ID 都在 `definePlugin().tools` 或 `define_plugin()[\"tools\"]` 中注册；\n- [ ] 工具栏工具配置了合法的 Iconify `icon` 和声明式 `dialog`；\n- [ ] `nodeTypes` 只包含实际支持的节点类型；\n- [ ] `inputFields` 只申请工具确实需要的数据；\n- [ ] `output.fields` 与工具实际返回的 `data` 字段完全一致；\n- [ ] 对缺失、空字符串、空数组等输入进行了处理；\n- [ ] 工具同步执行；JavaScript 正常数据规模下远低于 2 秒，Python 远低于 30 秒；\n- [ ] JavaScript 未使用任意网络、任意路径、DOM、Tauri、npm 包或异步 API；模型和资源操作只返回受支持 effect；\n- [ ] JavaScript 的远程媒体输出只原样透传真实媒体输入或本轮宿主媒体模型结果，没有自行拼接 URL；\n- [ ] Markdown 图片和画布笔记颜色没有形成新的远程资源加载入口；\n- [ ] 自定义节点的来源/目标端口类型一致，并已验证多个输出端口分别连线时的结果；\n- [ ] Python 插件的本机访问、依赖和供应链风险已经由作者与用户审查；\n- [ ] 已测试“更新当前节点”和“创建派生节点”是否符合预期；\n- [ ] `name`、`description` 和工具标题能让用户理解插件用途与出现位置；\n- [ ] 使用模型能力时声明了 `models.read`（目录与模型下拉）与 `models.invoke`（`model.generate`）；\n- [ ] `resourceAccess` 只包含确实需要的 `self`、直接 `incoming` 和端口；没有依赖真实路径；\n- [ ] `resources[]` 的路径、字节数、MIME 与 SHA-256 和发布包实际文件一致；\n- [ ] 自定义 UI 在主窗口 Modal 的深浅主题下均可读，且只通过 props / `runEffect` 使用宿主能力；\n- [ ] 弹窗 `model` 字段的 `modelCategories` 与实际调用的模型分类一致；\n- [ ] 用 `input.effectResult` 或 `input.iteration` 区分了 effect 前后两种阶段，并处理了 `ok: false`；\n- [ ] JavaScript 插件提交的 `imageUrls` 都来自本次输入已有的媒体引用或本轮宿主模型结果。\n\n## 15. 版本约定\n\n- 当前只接受 `apiVersion: 1`，它直接包含本文档列出的节点工具、自定义节点、资源、effect、可信 Python 与主窗口隔离 UI；\n- 不存在更早插件格式的加载、迁移或运行兜底；缺少有效 `sourceDigest` / `revisionDigest` 或原生私有快照的记录会失败关闭，必须重新安装；\n- 插件自身的 `version` 用于展示、更新和发布管理，不决定 API 兼容性；同一插件升级时保持 `id` 不变；\n- 已发布工具和节点应尽量保持各自 `id` 稳定；改变端口 ID 会让现有连线按安全规则失效；\n- 插件不得依赖未在本文档中声明的宿主内部对象。后续能力优先通过 v1 的可选声明扩展；只有出现无法安全表达的破坏性变化时才重新评估 API 版本。\n\n相关架构设计见：[用户插件平台设计](./plans/2026-08-23-user-plugin-platform.md)、[ADR 0009：可信 Python 插件运行时](./adr/0009-trusted-python-plugin-runtime.md)与[原生信任注册表 ADR（0010-native-plugin-trust-registry.md）](./adr/0010-native-plugin-trust-registry.md)。\n"), gr, [{
					name: "Markdown 文档",
					extensions: ["md"]
				}]) && a("插件开发规范已保存");
				return;
			}
			let e = URL.createObjectURL(new Blob([Pn], { type: "text/markdown;charset=utf-8" })), t = document.createElement("a");
			t.href = e, t.download = gr, document.body.appendChild(t), t.click(), t.remove(), window.setTimeout(() => URL.revokeObjectURL(e), 0), a("插件开发规范已下载");
		} catch (e) {
		...
		if (r.length !== 0) {
			...
			try {
				...
				let i = e[0], a = await i.file.text(), o = h(a), s = i.path.slice(0, Math.max(0, i.path.length - i.file.name.length)), c = r.find(({ path: e }) => e === `${s}${o.entry}`);
				if (!c) throw Error(`manifest.json 同级目录缺少 ${o.entry}`);
				let l = t.some((e) => e.id === o.id) ? "更新" : "安装", u = await c.file.text(), d = await Mr(r, s, o), f = await Nr(r, s, o), p = await Tr(o, u, l, "本地文件夹");
				if (!p) return;
				await n(a, u, {
		...
		if (!(o || e.length === 0)) {
			...
			try {
				let i = await Vn(e, r);
				if (!i) return;
				let { manifestText: a, manifest: o, source: s, uiSource: c, resourcePayloads: l } = i, u = await Tr(o, s, t.some((e) => e.id === o.id) ? "更新" : "安装", "本地文件夹");
				if (!u) return;
				await n(a, s, {
					trustedPythonConfirmed: o.runtime === "python",
					expectedSourceDigest: u,
					uiSource: c,
					resourcePayloads: l
				});
			} catch (e) {
	...
	let B = async () => {
		if (!o) try {
			await br({
				tauri: F(),
				openNativeDirectory: Rn,
				openBrowserDirectory: () => e.current?.click(),
				installFromPaths: (e) => z.current(e, !0)
			});
		} catch (e) {
			a(Cr(e, "无法选择插件文件夹"), "error");
		}
	}, V = async (e) => {
		let t = !e.enabled;
		t && !await Er(e.manifest, e.sourceDigest) || await r(e.id, t, { trustedPythonConfirmed: t && e.manifest.runtime === "python" });
	}, te = async (e) => {
		if (e.preventDefault(), l(!1), !o) try {
			let t = await jr(e.dataTransfer);
		...
		children: [
			/* @__PURE__ */ (0, $.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, $.jsxs)("div", {
						className: `mt-3 flex items-center justify-between gap-3 rounded-lg border px-3 py-2 ${E?.available ? "border-emerald-500/20 bg-emerald-500/5" : "border-amber-500/20 bg-amber-500/5"}`,
						children: [/* @__PURE__ */ (0, $.jsxs)("div", {
							className: "min-w-0",
							children: [/* @__PURE__ */ (0, $.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, $.jsx)(K, {
									...
									width: 14,
									height: 14,
									className: E?.available ? "text-emerald-400" : "text-amber-400"
								}), "本机 Python"]
							}), /* @__PURE__ */ (0, $.jsx)("div", {
								className: "mt-0.5 break-words text-[11px] text-canvas-text-muted",
								children: k ? "正在检测 Python 3…" : E?.available ? `可用：${E.command} · Python ${E.version}` : E?.error || "尚未检测"
							})]
						}), /* @__PURE__ */ (0, $.jsx)(W, {
							type: "button",
							disabled: k,
					...
					/* @__PURE__ */ (0, $.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, $.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, $.jsx)(W, {
								type: "button",
								className: "rounded-md px-2.5 py-1.5 text-xs text-indigo-400 hover:bg-indigo-500/10",
								onClick: () => void n(fr, pr).catch((e) => {
									a(Cr(e, "示例插件安装失败"), "error");
								}),
								children: "JavaScript"
							}), /* @__PURE__ */ (0, $.jsx)(W, {
								type: "button",
								...
								onClick: () => void (async () => {
									let e = await Tr(h(mr), hr, "安装", "应用内置开发者示例");
									e && await n(mr, hr, {
										trustedPythonConfirmed: !0,
										expectedSourceDigest: e
									});
								})().catch((e) => {
									a(Cr(e, "Python 示例安装失败"), "error");
								}),
								children: "Python"
							})]
						})]
				...
				children: [
					...
					/* @__PURE__ */ (0, $.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, $.jsx)("input", {
							...
							onClick: () => void I(x),
							children: C === x ? "读取中…" : "从仓库安装"
						})]
					}),
					(f.length > 0 || y) && /* @__PURE__ */ (0, $.jsxs)("div", {
					...
					/* @__PURE__ */ (0, $.jsxs)("div", {
						...
						children: [
							...
							P.map((e) => {
								...
								let n = t.find((t) => t.id === e.manifest.id), r = n ? dr(e.manifest.version, n.manifest.version) : !1, i = !!(n && !r) || !!C;
									...
									children: /* @__PURE__ */ (0, $.jsxs)("div", {
										...
										children: [
											...
											/* @__PURE__ */ (0, $.jsx)(W, {
												...
												children: C === e.repository ? "安装中…" : r ? "更新" : n ? "已安装" : "安装"
											})
										]
									})
								}, e.repository);
							}),
							!m && f.length > 0 && P.length === 0 && /* @__PURE__ */ (0, $.jsx)("div", {
							...
							children: [
										...
										/* @__PURE__ */ (0, $.jsxs)("div", {
											...
											children: [
												...
												/* @__PURE__ */ (0, $.jsx)("span", {
													...
													children: ur[e.manifest.category]
												}),
												/* @__PURE__ */ (0, $.jsx)("span", {
								...
								/* @__PURE__ */ (0, $.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, $.jsx)(W, {
										...
										onClick: () => {
											ie(`确定卸载插件「${e.manifest.name}」吗？`, { title: "卸载插件" }).then((t) => {
												t && i(e.id).catch((e) => {
			...
			/* @__PURE__ */ (0, $.jsxs)(U, {
				...
				children: [/* @__PURE__ */ (0, $.jsxs)("header", {
					...
					children: /* @__PURE__ */ (0, $.jsx)(X, { value: Pn })
				})]
			})
		]
	});
		...
		a.onload = () => {
			c(), (async () => {
				...
				try {
					...
					c.drawImage(a, 0, 0);
					let [l, u] = await Promise.all([zr(o, "image/png"), zr(o, "image/webp", 1)]);
...
async function Hr(e, t) {
	try {
		let { getCurrentWindow: n, LogicalSize: r, currentMonitor: i } = await import("./window-Mv3S1g6R.js"), a = n();
...
}], Kr = typeof navigator < "u" && /Macintosh|Mac OS X/.test(navigator.userAgent);
function qr(e) {
	return e < 1024 ? `${e} B` : e < 1024 * 1024 ? `${(e / 1024).toFixed(1)} KB` : `${(e / (1024 * 1024)).toFixed(2)} MB`;
}
function Jr() {
	let e = i(), t = o(), { settingsOpen: n, setSettingsOpen: r, settingsInitialTab: c, setSettingsInitialTab: l, config: u, updateConfig: d, saveConfig: f, showToast: p } = T(le((e) => ({
	...
	(0, Q.useEffect)(() => {
		...
		return (async () => {
			try {
				let { getCurrentWindow: n } = await import("./window-Mv3S1g6R.js"), r = n(), i = async () => {
	...
	let S = h && !g, C = u.interactionMode ?? "default", w = u.nodeToolbarMode ?? "icons", E = u.nodeLabelVisible !== !1, D = u.canvasNoteToolbarVisible !== !1, O = u.startupView ?? "last-project", k = Ur.find((e) => e.id === C) ?? Ur[0], [A, j] = (0, Q.useState)("general"), [M, N] = (0, Q.useState)(!1), [P, F] = (0, Q.useState)(null), I = (0, Q.useRef)(null), L = (n ? c : null) ?? A;
	return /* @__PURE__ */ (0, $.jsxs)(U, {
		isOpen: n,
		onClose: () => r(!1),
		ariaLabel: e("设置"),
		...
		children: [/* @__PURE__ */ (0, $.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, $.jsx)(Sn, {
				...
				children: [
					L === "api" && /* @__PURE__ */ (0, $.jsx)(Gt, { onClose: () => r(!1) }),
					L === "comfyui" && /* @__PURE__ */ (0, $.jsx)(jn, {}),
						...
						children: [
							...
							/* @__PURE__ */ (0, $.jsxs)("section", { children: [
								...
								/* @__PURE__ */ (0, $.jsx)("div", {
									...
									role: "radiogroup",
									"aria-label": e("应用窗口大小"),
									children: (Vr.find((e) => e.id === _) ?? Vr[0]).presets.map(({ w: t, h: n, label: r }) => {
							...
							/* @__PURE__ */ (0, $.jsxs)("div", { children: [
								...
								/* @__PURE__ */ (0, $.jsx)("div", {
									className: "grid grid-cols-3 gap-2",
									children: Fr.map(({ value: t, label: n, theme: r }) => /* @__PURE__ */ (0, $.jsxs)(W, {
										onClick: async () => {
											if (t === "custom") {
								...
								/* @__PURE__ */ (0, $.jsx)("input", {
									...
									onChange: async (t) => {
										...
										if (n) {
											...
											N(!0), F(null);
											try {
												let t = await Rr(n), r = await Ir(t.dataUrl);
												F(r), d({
													canvasBackground: "custom",
												...
												let i = qr(t.compressedSize), a = t.keptOriginal ? e("（保留原图，重编码会增大）") : t.compressionRatio > 0 ? e("（缩减 {ratio}%，{format}）", {
					...
					L === "files" && /* @__PURE__ */ (0, $.jsx)(Nn, { active: !0 }),
					L === "shortcuts" && /* @__PURE__ */ (0, $.jsx)(Tn, {}),
					L === "storage" && /* @__PURE__ */ (0, $.jsxs)($.Fragment, { children: [/* @__PURE__ */ (0, $.jsx)(fn, {}), /* @__PURE__ */ (0, $.jsx)(mn, {})] }),
					L === "mcp" && /* @__PURE__ */ (0, $.jsx)(yn, {}),
					L === "plugins" && /* @__PURE__ */ (0, $.jsx)(Pr, {})
				]
			})]
		})]
	});
