...
var o = a(), s = /* @__PURE__ */ n(i(), 1), c = (0, s.createContext)({});
//#endregion
...
var u = typeof window < "u" ? s.useLayoutEffect : s.useEffect, d = /* @__PURE__ */ (0, s.createContext)(null);
//#endregion
...
var g = () => {}, _ = () => {};
typeof process < "u" && process.env.NODE_ENV !== "production" && (g = (e, t, n) => {
	!e && typeof console < "u" && console.warn(h(t, n));
}, _ = (e, t, n) => {
	if (!e) throw Error(h(t, n));
});
//#endregion
//#region node_modules/motion-utils/dist/es/global-config.mjs
var v = {}, y = (e) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(e), b = (e) => typeof e == "object" && !!e, x = (e) => /^0[^.\s]+$/u.test(e);
//#endregion
...
var C = /* @__NO_SIDE_EFFECTS__ */ (e) => e, w = (...e) => e.reduce((e, t) => (n) => t(e(n))), T = /* @__NO_SIDE_EFFECTS__ */ (e, t, n) => {
	let r = t - e;
	return r ? (n - e) / r : 1;
}, E = class {
	constructor() {
...
}, D = /* @__NO_SIDE_EFFECTS__ */ (e) => e * 1e3, O = /* @__NO_SIDE_EFFECTS__ */ (e) => e / 1e3, ee = /* @__NO_SIDE_EFFECTS__ */ (e, t) => t ? 1e3 / t * e : 0, te = /* @__PURE__ */ new Set();
function ne(e, t, n) {
	e || te.has(t) || (console.warn(h(t, n)), te.add(t));
}
//#endregion
//#region node_modules/motion-utils/dist/es/easing/cubic-bezier.mjs
var re = (e, t, n) => (((1 - 3 * n + 3 * t) * e + (3 * n - 6 * t)) * e + 3 * t) * e, ie = 1e-7, ae = 12;
...
var ce = /* @__NO_SIDE_EFFECTS__ */ (e) => (t) => t <= .5 ? e(2 * t) / 2 : (2 - e(2 * (1 - t))) / 2, le = /* @__NO_SIDE_EFFECTS__ */ (e) => (t) => 1 - e(1 - t), ue = /* @__PURE__ */ se(.33, 1.53, .69, .99), de = /* @__PURE__ */ le(ue), fe = /* @__PURE__ */ ce(de), pe = (e) => e >= 1 ? 1 : (e *= 2) < 1 ? .5 * de(e) : .5 * (2 - 2 ** (-10 * (e - 1))), me = (e) => 1 - Math.sin(Math.acos(e)), he = /* @__PURE__ */ le(me), ge = /* @__PURE__ */ ce(me), _e = /* @__PURE__ */ se(.42, 0, 1, 1), ve = /* @__PURE__ */ se(0, 0, .58, 1), ye = /* @__PURE__ */ se(.42, 0, .58, 1), be = /* @__NO_SIDE_EFFECTS__ */ (e) => Array.isArray(e) && typeof e[0] != "number", xe = /* @__NO_SIDE_EFFECTS__ */ (e) => Array.isArray(e) && typeof e[0] == "number", Se = {
	linear: C,
	easeIn: _e,
	easeInOut: ye,
	easeOut: ve,
	...
	backOut: ue,
	anticipate: pe
}, Ce = (e) => typeof e == "string", we = (e) => {
	if (/* @__PURE__ */ xe(e)) {
		_(e.length === 4, "Cubic bezier arrays must contain four numerical values.", "cubic-bezier-length");
		let [t, n, r, i] = e;
		return /* @__PURE__ */ se(t, n, r, i);
	} else if (Ce(e)) return _(Se[e] !== void 0, `Invalid easing type '${e}'`, "invalid-easing-type"), Se[e];
	return e;
}, Te = [
	"setup",
	"read",
...
function Oe(e, t) {
	let n = !1, r = !0, i = {
		...
		timestamp: 0,
		isProcessing: !1
	}, a = () => n = !0, o = Te.reduce((e, t) => (e[t] = Ee(a), e), {}), { setup: s, read: c, resolveKeyframes: l, preUpdate: u, update: d, preRender: f, render: p, postRender: m } = o, h = () => {
		let a = v.useManualTiming, o = a ? i.timestamp : performance.now();
		n = !1, a || (i.delta = r ? 1e3 / 60 : Math.max(Math.min(o - i.timestamp, De), 1)), i.timestamp = o, i.isProcessing = !0, s.process(i), c.process(i), l.process(i), u.process(i), d.process(i), f.process(i), p.process(i), m.process(i), i.isProcessing = !1, n && t && (r = !1, e(h));
	}, g = () => {
...
var { schedule: k, cancel: A, state: j, steps: ke } = /* @__PURE__ */ Oe(typeof requestAnimationFrame < "u" ? requestAnimationFrame : C, !0), Ae;
function je() {
	Ae = void 0;
}
var M = {
	now: () => (Ae === void 0 && M.set(j.isProcessing || v.useManualTiming ? j.timestamp : performance.now()), Ae),
	set: (e) => {
...
var Re = {
	...
	...Re,
	default: 1
}, Ve = (e) => Math.round(e * 1e5) / 1e5, He = /-?(?:\d+(?:\.\d+)?|\.\d+)/gu;
//#endregion
...
var We = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu, Ge = (e, t) => (n) => !!(typeof n == "string" && We.test(n) && n.startsWith(e) || t && !Ue(n) && Object.prototype.hasOwnProperty.call(n, t)), Ke = (e, t, n) => (r) => {
	...
	transform: ({ red: e, green: t, blue: n, alpha: r = 1 }) => "rgba(" + Je.transform(e) + ", " + Je.transform(t) + ", " + Je.transform(n) + ", " + Ve(ze.transform(r)) + ")"
};
//#endregion
...
var Ze = {
	...
	transform: ({ hue: e, saturation: t, lightness: n, alpha: r = 1 }) => "hsla(" + Math.round(e) + ", " + P.transform(Ve(t)) + ", " + P.transform(Ve(n)) + ", " + Ve(ze.transform(r)) + ")"
}, I = {
	test: (e) => Ye.test(e) || Ze.test(e) || nt.test(e),
	parse: (e) => Ye.test(e) ? Ye.parse(e) : nt.test(e) ? nt.parse(e) : Ze.parse(e),
	transform: (e) => typeof e == "string" ? e : e.hasOwnProperty("red") ? Ye.transform(e) : nt.transform(e),
	getAnimatableNone: (e) => {
		let t = I.parse(e);
		return t.alpha = 0, I.transform(t);
	}
}, rt = /(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))/giu;
//#endregion
//#region node_modules/motion-dom/dist/es/value/types/complex/index.mjs
function it(e) {
	return isNaN(e) && typeof e == "string" && (e.match(He)?.length || 0) + (e.match(rt)?.length || 0) > 0;
}
var at = "number", ot = "color", st = "var", ct = "var(", lt = "${}", ut = /var\s*\(\s*--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)|#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\)|-?(?:\d+(?:\.\d+)?|\.\d+)/giu;
function dt(e) {
	...
	return {
		values: n,
		split: t.replace(ut, (e) => (I.test(e) ? (r.color.push(a), i.push(ot), n.push(I.parse(e))) : e.startsWith(ct) ? (r.var.push(a), i.push(st), n.push(e)) : (r.number.push(a), i.push(at), n.push(parseFloat(e))), ++a, lt)).split(lt),
		indexes: r,
		types: i
	};
}
...
function pt({ split: e, types: t }) {
	...
	return (r) => {
		...
		for (let a = 0; a < n; a++) if (i += e[a], r[a] !== void 0) {
			let e = t[a];
			e === at ? i += Ve(r[a]) : e === ot ? i += I.transform(r[a]) : i += r[a];
		}
		return i;
	};
}
...
var ht = (e) => typeof e == "number" ? 0 : I.test(e) ? I.getAnimatableNone(e) : e, gt = (e, t) => typeof e == "number" ? t?.trim().endsWith("/") ? e : 0 : ht(e);
function _t(e) {
	let t = dt(e);
	return pt(t)(t.values.map((e, n) => gt(e, t.split[n])));
}
var L = {
	test: it,
	parse: ft,
	createTransformer: mt,
	getAnimatableNone: _t
};
//#endregion
...
function yt({ hue: e, saturation: t, lightness: n, alpha: r }) {
	e /= 360, t /= 100, n /= 100;
	let i = 0, a = 0, o = 0;
	if (!t) i = a = o = n;
	else {
...
var R = (e, t, n) => e + (t - e) * n, xt = (e, t, n) => {
	...
	Ye,
	nt
], Ct = (e) => St.find((t) => t.test(e));
function wt(e) {
	let t = Ct(e);
	if (g(!!t, `'${e}' is not an animatable color. Use the equivalent color code instead.`, "color-not-animatable"), !t) return !1;
	let n = t.parse(e);
	return t === nt && (n = yt(n)), n;
}
var Tt = (e, t) => {
	let n = wt(e), r = wt(t);
	if (!n || !r) return bt(e, t);
	let i = { ...n };
	return (e) => (i.red = xt(n.red, r.red, e), i.green = xt(n.green, r.green, e), i.blue = xt(n.blue, r.blue, e), i.alpha = R(n.alpha, r.alpha, e), Ye.transform(i));
...
function kt(e) {
	return typeof e == "number" ? Ot : typeof e == "string" ? Fe(e) ? bt : I.test(e) ? Tt : Nt : Array.isArray(e) ? At : typeof e == "object" ? I.test(e) ? Tt : jt : bt;
}
function At(e, t) {
	let n = [...e], r = n.length, i = e.map((e, n) => kt(e)(e, t[n]));
	return (e) => {
...
function jt(e, t) {
	...
	for (let i in n) e[i] !== void 0 && t[i] !== void 0 && (r[i] = kt(e[i])(e[i], t[i]));
	return (e) => {
...
var Nt = (e, t) => {
	let n = L.createTransformer(t), r = dt(e), i = dt(t);
	return r.indexes.var.length === i.indexes.var.length && r.indexes.color.length === i.indexes.color.length && r.indexes.number.length >= i.indexes.number.length ? Et.has(e) && !i.values.length || Et.has(t) && !r.values.length ? Dt(e, t) : w(At(Mt(r, i), i.values), n) : (g(!0, `Complex values '${e}' and '${t}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`, "complex-values-different"), bt(e, t));
};
//#endregion
//#region node_modules/motion-dom/dist/es/utils/mix/index.mjs
function Pt(e, t, n) {
	return typeof e == "number" && typeof t == "number" && typeof n == "number" ? R(e, t, n) : kt(e)(e, t);
}
//#endregion
...
function Ht(e, t, n) {
	let r = n;
	for (let n = 1; n < Vt; n++) r -= e(r) / t(r);
	return r;
}
var Ut = .001;
function Wt({ duration: e = z.duration, bounce: t = z.bounce, velocity: n = z.velocity, mass: r = z.mass }) {
	let i, a;
	g(e <= /* @__PURE__ */ D(z.maxDuration), "Spring duration must be 10 seconds or less", "spring-duration-limit");
	let o = 1 - t;
	o = m(z.minDamping, z.maxDamping, o), e = m(z.minDuration, z.maxDuration, /* @__PURE__ */ O(e)), o < 1 ? (i = (t) => {
		let r = t * o, i = r * e, a = r - n, s = Bt(t, o), c = Math.exp(-i);
		return Ut - a / s * c;
	}, a = (t) => {
		let r = t * o * e, a = r * n + n, s = o ** 2 * t ** 2 * e, c = Math.exp(-r), l = Bt(t ** 2, o);
		return (-i(t) + Ut > 0 ? -1 : 1) * ((a - s) * c) / l;
	}) : (i = (t) => -.001 + Math.exp(-t * e) * ((t - n) * e + 1), a = (t) => Math.exp(-t * e) * ((n - t) * (e * e)));
	let s = 5 / e, c = Ht(i, a, s);
...
function Jt(e) {
	...
	if (!qt(e, Kt) && qt(e, Gt)) if (t.velocity = 0, e.visualDuration) {
...
function Yt(e = z.visualDuration, t = z.bounce) {
	let n = typeof e == "object" ? e : {
		...
		value: a
	}, { stiffness: c, damping: l, mass: u, duration: d, velocity: f, isResolvedFromDuration: p } = Jt({
		...n,
	...
	let y, b, x, S, C, w;
	if (h < 1) x = Bt(_, h), S = (m + h * _ * g) / x, y = (e) => o - Math.exp(-h * _ * e) * (S * Math.sin(x * e) + g * Math.cos(x * e)), C = h * _ * S + g * x, w = h * _ * g - S * x, b = (e) => Math.exp(-h * _ * e) * (C * Math.sin(x * e) + w * Math.cos(x * e));
	else if (h === 1) {
	...
	let T = {
		...
		toString: () => {
			let e = Math.min(Rt(T), Lt), t = It((t) => T.next(e * t).value, e, 30);
			return e + "ms " + t;
		},
		toTransition: () => {}
	};
...
var Xt = 5;
function Zt(e, t, n) {
	let r = Math.max(t - Xt, 0);
	return /* @__PURE__ */ ee(n - e(r), t - r);
}
//#endregion
...
function $t(e, t, n) {
	let r = [], i = n || v.mix || Pt, a = e.length - 1;
	for (let n = 0; n < a; n++) {
		let a = i(e[n], e[n + 1]);
		t && (a = w(Array.isArray(t) ? t[n] || C : t, a)), r.push(a);
	}
	return r;
}
function en(e, t, { clamp: n = !0, ease: r, mixer: i } = {}) {
	let a = e.length;
	if (_(a === t.length, "Both input and output ranges must be the same length", "range-length"), a === 1) return () => t[0];
	if (a === 2 && t[0] === t[1]) return () => t[1];
	let o = e[0] === e[1];
	e[0] > e[a - 1] && (e = [...e].reverse(), t = [...t].reverse());
	let s = $t(t, r, i), c = s.length, l = (n) => {
...
function on({ duration: e = 300, keyframes: t, times: n, ease: r = "easeInOut" }) {
	let i = /* @__PURE__ */ be(r) ? r.map(we) : we(r), a = {
		done: !1,
		value: t[0]
	}, o = en(rn(n && n.length === t.length ? n : nn(t), e), t, { ease: Array.isArray(i) ? i : an(t, i) });
	return {
...
function cn(e, { repeat: t, repeatType: n = "loop" }, r, i = 1) {
	let a = e.filter(sn), o = i < 0 || t && n !== "loop" && t % 2 == 1 ? 0 : a.length - 1;
...
function un(e) {
	typeof e.type == "string" && (e.type = ln[e.type]);
}
//#endregion
...
var dn = class {
...
}, fn = (e) => e / 100, pn = class extends dn {
	constructor(e) {
	...
	initAnimation() {
		...
		process.env.NODE_ENV !== "production" && s !== on && _(o.length <= 2, `Only two keyframes currently supported with spring and inertia animations. Trying to animate ${o}`, "spring-two-frames"), s !== on && typeof o[0] != "number" && (this.mixKeyframes = w(fn, Pt(o[0], o[1])), o = [0, 100]);
		let c = s({
			...e,
			keyframes: o
		});
	...
	tick(e, t = !1) {
		...
		return C && p !== Qt && (x.value = cn(l, this.options, g, this.speed)), h && h(x.value), C && this.finish(), x;
	}
	then(e, t) {
		return this.finished.then(e, t);
	}
	...
	play() {
		...
		let { driver: e = Ft, startTime: t } = this.options;
...
var hn = (e) => e * 180 / Math.PI, gn = (e) => vn(hn(Math.atan2(e[1], e[0]))), _n = {
	x: 4,
	y: 5,
	translateX: 4,
	translateY: 5,
...
}, vn = (e) => (e %= 360, e < 0 && (e += 360), e), yn = gn, bn = (e) => Math.sqrt(e[0] * e[0] + e[1] * e[1]), xn = (e) => Math.sqrt(e[4] * e[4] + e[5] * e[5]), Sn = {
	x: 12,
	y: 13,
	z: 14,
	translateX: 12,
	...
	scaleY: xn,
	scale: (e) => (bn(e) + xn(e)) / 2,
	rotateX: (e) => vn(hn(Math.atan2(e[6], e[5]))),
	rotateY: (e) => vn(hn(Math.atan2(-e[2], e[0]))),
	rotateZ: yn,
	rotate: yn,
...
var Dn = [
	...
	"skewX",
	"skewY"
], On = /* @__PURE__ */ new Set([...Dn, "pathRotation"]), kn = (e) => e === Re || e === F, An = new Set([
	"x",
	"y",
	"z"
]), jn = Dn.filter((e) => !An.has(e));
function Mn(e) {
	let t = [];
	return jn.forEach((n) => {
		let r = e.getValue(n);
...
var B = {
	...
	x: (e, { transform: t }) => wn(t, "x"),
	y: (e, { transform: t }) => wn(t, "y")
};
B.translateX = B.x, B.translateY = B.y;
//#endregion
//#region node_modules/motion-dom/dist/es/animation/keyframes/KeyframesResolver.mjs
var V = /* @__PURE__ */ new Set(), Nn = !1, Pn = !1, Fn = !1;
function In() {
	if (Pn) {
		let e = Array.from(V).filter((e) => e.needsMeasurement), t = new Set(e.map((e) => e.element)), n = /* @__PURE__ */ new Map();
		t.forEach((e) => {
			let t = Mn(e);
	...
	Pn = !1, Nn = !1, V.forEach((e) => e.complete(Fn)), V.clear();
}
function Ln() {
	V.forEach((e) => {
...
var zn = class {
	...
	scheduleResolve() {
		this.state = "scheduled", this.isAsync ? (V.add(this), Nn || (Nn = !0, k.read(Ln), k.resolveKeyframes(In))) : (this.readKeyframes(), this.complete());
	}
	readKeyframes() {
	...
	measureEndState() {}
	complete(e = !1) {
		this.state = "complete", this.onComplete(this.unresolvedKeyframes, this.finalKeyframe, e), V.delete(this);
	}
	cancel() {
		this.state === "scheduled" && (V.delete(this), this.state = "pending");
	}
	resume() {
...
var Wn = /* @__PURE__ */ Un(() => window.ScrollTimeline !== void 0, "scrollTimeline"), Gn = /* @__PURE__ */ Un(() => {
	...
	return !0;
}, "linearEasing"), Kn = ([e, t, n, r]) => `cubic-bezier(${e}, ${t}, ${n}, ${r})`, qn = {
	linear: "linear",
	ease: "ease",
	easeIn: "ease-in",
	easeOut: "ease-out",
...
function Jn(e, t) {
	if (e) return typeof e == "function" ? Gn() ? It(e, t) : "ease-out" : /* @__PURE__ */ xe(e) ? Kn(e) : Array.isArray(e) ? e.map((e) => Jn(e, t) || qn.easeOut) : qn[e];
}
//#endregion
//#region node_modules/motion-dom/dist/es/animation/waapi/start-waapi-animation.mjs
function Yn(e, t, n, { delay: r = 0, duration: i = 300, repeat: a = 0, repeatType: o = "loop", ease: s = "easeOut", times: c } = {}, l = void 0) {
	let u = { [t]: n };
	c && (u.offset = c);
	let d = Jn(s, i);
...
function Zn({ type: e, ...t }) {
	return Xn(e) && Gn() ? e.applyToOptions(t) : (t.duration ??= 300, t.ease ??= "easeOut", t);
}
//#endregion
...
var Qn = class extends dn {
	constructor(e) {
		...
		this.isPseudoElement = !!i, this.allowFlatten = a, this.options = e, _(typeof e.type != "string", "Mini animate() doesn't support \"type\" as a string.", "mini-spring");
		let c = Zn(e);
		this.animation = Yn(t, n, r, c, i), c.autoplay === !1 && this.animation.pause(), this.animation.onfinish = () => {
	...
	attachTimeline({ timeline: e, rangeStart: t, rangeEnd: n, observe: r }) {
		return this.allowFlatten && this.animation.effect?.updateTiming({ easing: "linear" }), this.animation.onfinish = null, e && Wn() ? (this.animation.timeline = e, t && (this.animation.rangeStart = t), n && (this.animation.rangeEnd = n), C) : r(this);
	}
}, $n = {
	anticipate: pe,
	backInOut: fe,
...
function tr(e) {
	typeof e.ease == "string" && er(e.ease) && (e.ease = $n[e.ease]);
}
//#endregion
//#region node_modules/motion-dom/dist/es/animation/NativeAnimationExtended.mjs
var nr = 10, rr = class extends Qn {
	constructor(e) {
		tr(e), un(e), super(e), e.startTime !== void 0 && e.autoplay !== !1 && (this.startTime = e.startTime), this.options = e;
	}
	updateMotionValue(e) {
		...
		let o = new pn({
			...a,
			autoplay: !1
		}), s = Math.max(nr, M.now() - this.startTime), c = m(0, nr, s - nr), l = o.sample(s).value, { name: u } = this.options;
		i && u && Vn(i, u, l), t.setWithVelocity(o.sample(Math.max(0, s - c)).value, l, c), o.stop();
	}
}, ir = (e, t) => t === "zIndex" ? !1 : !!(typeof e == "number" || Array.isArray(e) || typeof e == "string" && (L.test(e) || e === "0") && !e.startsWith("url("));
//#endregion
...
function or(e, t, n, r) {
	...
	let a = e[e.length - 1], o = ir(i, t), s = ir(a, t);
	return g(o === s, `You are trying to animate ${t} from "${i}" to "${a}". "${o ? a : i}" is not an animatable value.`, "value-not-animatable"), !o || !s ? !1 : ar(e) || (n === "spring" || Xn(n)) && r;
}
//#endregion
...
var cr = new Set([
	...
	"transform",
	"backgroundColor"
]), lr = /^(?:oklch|oklab|lab|lch|color|color-mix|light-dark)\(/;
function ur(e) {
	for (let t = 0; t < e.length; t++) if (typeof e[t] == "string" && lr.test(e[t])) return !0;
	return !1;
}
//#endregion
...
var dr = new Set([
	...
	"borderBottomColor",
	"borderLeftColor"
]), fr = /* @__PURE__ */ S(() => Object.hasOwnProperty.call(Element.prototype, "animate"));
function pr(e) {
	...
	return fr() && n && (cr.has(n) || dr.has(n) && ur(s)) && (n !== "transform" || !u) && !l && !r && i !== "mirror" && a !== 0 && o !== "inertia";
}
//#endregion
//#region node_modules/motion-dom/dist/es/animation/AsyncMotionValueAnimation.mjs
var mr = 40, hr = class extends dn {
	...
	onKeyframesResolved(e, t, n, r) {
		...
		let u = !0;
		or(e, i, a, o) || (u = !1, (v.instantAnimations || !s) && l?.(cn(e, n, t)), e[0] = e[e.length - 1], sr(n), n.repeat = 0);
		let d = {
		...
		m.finished.then(() => {
			this.notifyFinished();
		}).catch(C), this.pendingTimeline &&= (this.stopTimeline = m.attachTimeline(this.pendingTimeline), void 0), this._animation = m;
	}
	get finished() {
...
var _r = 30, vr = (e) => !isNaN(parseFloat(e)), yr = { current: void 0 }, br = class {
	constructor(e, t = {}) {
	...
	getVelocity() {
		let e = M.now();
		if (!this.canTrackVelocity || this.prevFrameValue === void 0 || e - this.updatedAt > _r) return 0;
		let t = Math.min(this.updatedAt - this.prevUpdatedAt, _r);
		return /* @__PURE__ */ ee(parseFloat(this.current) - parseFloat(this.prevFrameValue), t);
	}
	start(e) {
...
var Cr = {
	...
	duration: .3
}, Dr = (e, { keyframes: t }) => t.length > 2 ? Tr : On.has(e) ? e.startsWith("scale") ? wr(t[1]) : Cr : Er, Or = new Set([
	"when",
	"delay",
	"delayChildren",
	"staggerChildren",
...
var Ar = (e, t, n, r = {}, i, a) => (o) => {
	...
	kr(s) || Object.assign(u, Dr(e, u)), u.duration &&= /* @__PURE__ */ D(u.duration), u.repeatDelay &&= /* @__PURE__ */ D(u.repeatDelay), u.from !== void 0 && (u.keyframes[0] = u.from);
	let d = !1;
	if ((u.type === !1 || u.duration === 0 && !u.repeatDelay) && (sr(u), u.delay === 0 && (d = !0)), (v.instantAnimations || v.skipAnimations || i?.shouldSkipAnimations || s.skipAnimations) && (d = !0, sr(u), u.delay = 0), u.allowFlatten = !s.type && !s.ease, d && !a && t.get() !== void 0) {
	...
	return s.isSync ? new pn(u) : new hr(u);
...
var Nr = 4;
function Pr(e, t, n = 1) {
	_(n <= Nr, `Max CSS variable fallback depth detected in property "${e}". This may indicate a circular fallback dependency.`, "max-css-var-depth");
	let [r, i] = Mr(e);
	if (!r) return;
...
function U(e, t, n) {
	let r = e.getProps();
	return Ir(r, t, n === void 0 ? r.custom : n, e);
}
//#endregion
...
function Ur(e, t) {
	...
	if (Hr(n)) return n.add(t);
	if (!n && v.WillChange) {
		let n = new v.WillChange("auto");
...
function Jr(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
	...
	for (let t in s) {
		...
		r.start(Ar(t, r, i, m && Lr.has(t) ? { type: !1 } : o, e, p));
		let h = r.animation;
		h && d.push(h);
	}
	if (o) {
...
function Yr(e, t, n = {}) {
	...
	let a = r ? () => Promise.all(Jr(e, r, n)) : () => Promise.resolve(), o = e.variantChildren && e.variantChildren.size ? (r = 0) => {
		let { delayChildren: a = 0, staggerChildren: o, staggerDirection: s } = i;
		return Xr(e, t, r, a, o, s, n);
...
function Xr(e, t, n = 0, r = 0, i = 0, a = 1, o) {
	let s = [];
	for (let c of e.variantChildren) c.notify("AnimationStart", t), s.push(Yr(c, t, {
		...o,
...
function Zr(e, t, n = {}) {
	...
	let r;
	if (Array.isArray(t)) {
		let i = t.map((t) => Yr(e, t, n));
		r = Promise.all(i);
	} else if (typeof t == "string") r = Yr(e, t, n);
	else {
		let i = typeof t == "function" ? U(e, t, n.custom) : t;
		r = Promise.all(Jr(e, i, n));
	}
	return r.then(() => {
...
function ni(e) {
	return typeof e == "number" ? e === 0 : e === null ? !0 : e === "none" || e === "0" || x(e);
}
//#endregion
...
var ai = /\b([a-z-]*)\(.*?\)/gu, oi = {
	...
	mask: si,
	WebkitMask: si
}, di = (e) => ui[e], fi = /* @__PURE__ */ new Set([oi, si]);
function pi(e, t) {
	let n = di(e);
	return fi.has(n) || (n = L), n.getAnimatableNone ? n.getAnimatableNone(t) : void 0;
}
//#endregion
...
function hi(e, t, n) {
	...
	for (; r < e.length && !i;) {
		let t = e[r];
		typeof t == "string" && !mi.has(t) && dt(t).values.length && (i = e[r]), r++;
	}
...
var gi = class extends zn {
	...
	readKeyframes() {
		...
		if (this.resolveNoneKeyframes(), !Lr.has(n) || e.length !== 2) return;
		...
		else B[n] && (this.needsMeasurement = !0);
	}
	...
	measureInitialState() {
		...
		n === "height" && (this.suspendedScrollY = window.pageYOffset), this.measuredOrigin = B[n](e.measureViewportBox(), window.getComputedStyle(e.current)), t[0] = this.measuredOrigin;
		let r = t[t.length - 1];
	...
	measureEndState() {
		...
		n[i] = B[t](e.measureViewportBox(), window.getComputedStyle(e.current)), a !== null && this.finalKeyframe === void 0 && (this.finalKeyframe = a), this.removedTransforms?.length && this.removedTransforms.forEach(([t, n]) => {
			e.getValue(t).set(n);
...
var yi = (e, t) => t && typeof e == "number" ? t.transform(e) : e;
//#endregion
//#region node_modules/motion-dom/dist/es/utils/is-html-element.mjs
function bi(e) {
	return b(e) && "offsetHeight" in e && !("ownerSVGElement" in e);
}
//#endregion
//#region node_modules/motion-dom/dist/es/frameloop/microtask.mjs
var { schedule: xi, cancel: Si } = /* @__PURE__ */ Oe(queueMicrotask, !1), G = {
	x: !1,
	y: !1
};
function Ci() {
...
var Oi = (e, t) => t ? e === t ? !0 : Oi(e, t.parentElement) : !1, ki = (e) => e.pointerType === "mouse" ? typeof e.button != "number" || e.button <= 0 : e.isPrimary !== !1, Ai = new Set([
	"BUTTON",
	"INPUT",
	"SELECT",
	"TEXTAREA",
...
function Bi(e, t, n = {}) {
	let [r, i, a] = Ti(e, n), o = (e) => {
		...
		let a = t(r, e), o = {
			...
			window.removeEventListener("pointerup", c, o), window.removeEventListener("pointercancel", l, o), Pi.has(r) && Pi.delete(r), Ri(e) && typeof a == "function" && a(e, { success: t });
		}, c = (e) => {
	...
	return r.forEach((e) => {
		(n.useGlobalTarget ? window : e).addEventListener("pointerdown", o, i), bi(e) && (e.addEventListener("focus", (e) => Li(e, i)), !ji(e) && !e.hasAttribute("tabindex") && (e.tabIndex = 0));
	}), a;
}
//#endregion
//#region node_modules/motion-dom/dist/es/utils/is-svg-element.mjs
function Vi(e) {
	return b(e) && "ownerSVGElement" in e;
}
//#endregion
//#region node_modules/motion-dom/dist/es/resize/handle-element.mjs
var Hi = /* @__PURE__ */ new WeakMap(), Ui, Wi = (e, t, n) => (r, i) => i && i[0] ? i[0][e + "Size"] : Vi(r) && "getBBox" in r ? r.getBBox()[t] : r[n], Gi = /* @__PURE__ */ Wi("inline", "width", "offsetWidth"), Ki = /* @__PURE__ */ Wi("block", "height", "offsetHeight");
...
function Xi(e, t) {
	...
	return n.forEach((e) => {
		let n = Hi.get(e);
		n || (n = /* @__PURE__ */ new Set(), Hi.set(e, n)), n.add(t), Ui?.observe(e);
	}), () => {
		n.forEach((e) => {
			let n = Hi.get(e);
...
var _a = { current: null }, va = { current: !1 }, ya = typeof window < "u";
function ba() {
	if (va.current = !0, ya) if (window.matchMedia) {
		let e = window.matchMedia("(prefers-reduced-motion)"), t = () => _a.current = e.matches;
...
var Ta = class {
	...
	constructor({ parent: e, props: t, presenceContext: n, reducedMotionConfig: r, skipAnimations: i, blockInitialAnimation: a, visualState: o }, s = {}) {
		...
		this.latestValues = c, this.baseTarget = { ...c }, this.initialValues = t.initial ? { ...c } : {}, this.renderState = l, this.parent = e, this.props = t, this.presenceContext = n, this.depth = e ? e.depth + 1 : 0, this.reducedMotionConfig = r, this.skipAnimationsConfig = i, this.options = s, this.blockInitialAnimation = !!a, this.isControllingVariants = ma(t), this.isVariantNode = ha(t), this.isVariantNode && (this.variantChildren = /* @__PURE__ */ new Set()), this.manuallyAnimateOnMount = !!(e && e.current);
	...
	bindToMotionValue(e, t) {
		if (this.valueSubscriptions.has(e) && this.valueSubscriptions.get(e)(), t.accelerate && cr.has(e) && this.current instanceof HTMLElement) {
			let { factory: n, keyframes: r, times: i, ease: a, duration: o } = t.accelerate, s = new Qn({
	...
	getValue(e, t) {
		...
		let n = this.values.get(e);
		return n === void 0 && t !== void 0 && (n = H(t === null ? void 0 : t, { owner: this }), this.addValue(e, n)), n;
	}
	readValue(e, t) {
		let n = this.latestValues[e] !== void 0 || !this.current ? this.latestValues[e] : this.getBaseTargetFromProps(this.props, e) ?? this.readValueFromInstance(this.current, e, this.options);
		return n != null && (typeof n == "string" && (y(n) || x(n)) ? n = parseFloat(n) : !aa(n) && L.test(t) && (n = pi(e, t)), this.setBaseTarget(e, W(n) ? n.get() : n)), W(n) ? n.get() : n;
	}
	setBaseTarget(e, t) {
		this.baseTarget[e] = t;
	}
	getBaseTarget(e) {
		...
		if (typeof t == "string" || typeof t == "object") {
			let r = Ir(this.props, t, this.presenceContext?.custom);
			r && (n = r[e]);
		}
		if (t && n !== void 0) return n;
		let r = this.getBaseTargetFromProps(this.props, e);
		return r !== void 0 && !W(r) ? r : this.initialValues[e] !== void 0 && n === void 0 ? void 0 : this.baseTarget[e];
	}
	on(e, t) {
	...
	handleChildMotionValue() {
		...
		W(e) && (this.childSubscription = e.on("change", (e) => {
...
function Da({ top: e, left: t, right: n, bottom: r }) {
	return {
		x: {
			min: t,
			max: n
...
function J(e) {
	return ja(e) || Ma(e) || e.z || e.rotate || e.rotateX || e.rotateY || e.skewX || e.skewY;
}
function Ma(e) {
...
function Ia(e, t = 0, n = 1, r, i) {
	e.min = Fa(e.min, t, n, r, i), e.max = Fa(e.max, t, n, r, i);
}
function La(e, { x: t, y: n }) {
	Ia(e.x, t.translate, t.scale, t.originPoint), Ia(e.y, n.translate, n.scale, n.originPoint);
}
var Ra = .999999999999, za = 1.0000000000001;
function Ba(e, t, n, r = !1) {
	...
	for (let s = 0; s < i; s++) {
		...
		i && i.props.style && i.props.style.display === "contents" || (r && a.options.layoutScroll && a.scroll && a !== a.root && (Y(e.x, -a.scroll.offset.x), Y(e.y, -a.scroll.offset.y)), o && (t.x *= o.x.scale, t.y *= o.y.scale, La(e, o)), r && J(a.latestValues) && Ua(e, a.latestValues, a.layout?.layoutBox));
	}
	t.x < za && t.x > Ra && (t.x = 1), t.y < za && t.y > Ra && (t.y = 1);
}
function Y(e, t) {
	e.min += t, e.max += t;
}
function Va(e, t, n, r, i = .5) {
	Ia(e, t, n, R(e.min, e.max, i), r);
}
function Ha(e, t) {
...
function Ua(e, t, n) {
	let r = n ?? e;
	Va(e.x, Ha(t.x, r.x), t.scaleX, t.scale, t.originX), Va(e.y, Ha(t.y, r.y), t.scaleY, t.scale, t.originY);
}
//#endregion
//#region node_modules/motion-dom/dist/es/projection/utils/measure.mjs
function Wa(e, t) {
	return Da(ka(e.getBoundingClientRect(), t));
}
function Ga(e, t, n) {
	let r = Wa(e, n), { scroll: i } = t;
...
function Ja(e, t, n) {
	...
	return a && (i = !1, r += `rotate(${yi(a, li.pathRotation)}) `), r = r.trim(), n ? r = n(t, i ? "" : r) : i && (r = "none"), r;
}
//#endregion
...
function Ya(e, t, n) {
	...
	if (t.transform || (o || n ? r.transform = Ja(t, e.transform, n) : r.transform &&= "none"), s) {
...
function Xa(e, { style: t, vars: n }, r, i) {
	let a = e.style, o;
	for (o in t) a[o] = t[o];
...
} }, $a = { correct: (e, { treeScale: t, projectionDelta: n }) => {
	let r = e, i = L.parse(e);
...
function to(e, { layout: t, layoutId: n }) {
	return On.has(e) || e.startsWith("origin") || (t || n !== void 0) && (!!eo[e] || e === "opacity");
}
//#endregion
...
function no(e, t, n) {
	...
	if (!r) return a;
	for (let t in r) (W(r[t]) || i && W(i[t]) || to(t, e) || n?.getValue(t)?.liveStyle !== void 0) && (a[t] = r[t]);
	return a;
}
//#endregion
...
var io = class extends Ea {
	constructor() {
		super(...arguments), this.type = "html", this.renderInstance = Xa;
	}
	mount(e) {
		_(!!e.style, "motion.create() components must forward their ref to a HTML or SVG element", "custom-component-ref"), super.mount(e);
	}
	readValueFromInstance(e, t) {
		if (On.has(t)) return this.projection?.isProjecting ? Cn(t) : Tn(e, t);
		{
			let n = ro(e), r = (Ne(t) ? n.getPropertyValue(t) : n[t]) || 0;
...
function lo(e, { attrX: t, attrY: n, attrScale: r, pathLength: i, pathSpacing: a = 1, pathOffset: o = 0, ...s }, c, l, u) {
	if (Ya(e, s, l), c) {
	...
	t !== void 0 && (d.x = t), n !== void 0 && (d.y = n), r !== void 0 && (d.scale = r), i !== void 0 && so(d, i, a, o, !1);
}
//#endregion
...
function po(e, t, n, r) {
	Xa(e, t, void 0, r);
	for (let n in t.attrs) e.setAttribute(uo.has(n) ? n : Wr(n), t.attrs[n]);
}
//#endregion
//#region node_modules/motion-dom/dist/es/render/svg/utils/scrape-motion-values.mjs
function mo(e, t, n) {
	let r = no(e, t, n);
	for (let n in e) if (W(e[n]) || W(t[n])) {
		let t = Dn.indexOf(n) === -1 ? n : "attr" + n.charAt(0).toUpperCase() + n.substring(1);
		r[t] = e[n];
	}
	return r;
}
...
var ho = class extends Ea {
	...
	readValueFromInstance(e, t) {
		...
		return t = uo.has(t) ? t : Wr(t), e.getAttribute(t);
	}
	scrapeMotionValuesFromProps(e, t, n) {
		return mo(e, t, n);
	}
	build(e, t, n) {
		lo(e, t, this.isSVGTag, n.transformTemplate, n.style);
	}
...
function _o(e) {
	...
	if (!e.isControllingVariants) {
		let t = e.parent && _o(e.parent) || {};
		return e.props.initial !== void 0 && (t.initial = e.props.initial), t;
	}
	let t = {};
	for (let n = 0; n < go; n++) {
		let r = pa[n], i = e.props[r];
		(da(i) || i === !1) && (t[r] = i);
	}
	return t;
}
...
var yo = [...fa].reverse(), bo = fa.length;
function xo(e) {
	return (t) => Promise.all(t.map(({ animation: t, options: n }) => Zr(e, t, n)));
}
function So(e) {
	let t = xo(e), n = wo(), r = !0, i = !1, a = (t) => (n, r) => {
	...
	function s(o) {
		let { props: s } = e, c = _o(e.parent) || {}, l = [], u = /* @__PURE__ */ new Set(), d = {}, f = Infinity;
		for (let t = 0; t < bo; t++) {
			let p = yo[t], m = n[p], h = s[p] === void 0 ? c[p] : s[p], g = da(h), _ = p === o ? m.isActive : null;
			_ === !1 && (f = t);
			let v = h === c[p] && h !== s[p] && g;
			if (v && (r || i) && e.manuallyAnimateOnMount && (v = !1), m.protectedKeys = { ...d }, !m.isActive && _ === null || !h && !m.prevProp || ua(h) || typeof h == "boolean") continue;
			...
			let y = Co(m.prevProp, h), b = y || p === o && m.isActive && !v && g || t > f && g, x = !1, S = Array.isArray(h) ? h : [h], C = S.reduce(a(p), {});
			_ === !1 && (C = {});
			...
			for (let e in T) {
				...
				let r = !1;
				r = Rr(t) && Rr(n) ? !vo(t, n) || y : t !== n, r ? t == null ? u.add(e) : E(e) : t !== void 0 && u.has(e) ? E(e) : m.protectedKeys[e] = !0;
			}
...
var Do = .9999, Oo = 1.0001, ko = -.01, Ao = .01;
function Q(e) {
	return e.max - e.min;
}
function jo(e, t, n) {
...
function Mo(e, t, n, r = .5) {
	e.origin = r, e.originPoint = R(t.min, t.max, e.origin), e.scale = Q(n) / Q(t), e.translate = R(n.min, n.max, e.origin) - e.originPoint, (e.scale >= Do && e.scale <= Oo || isNaN(e.scale)) && (e.scale = 1), (e.translate >= ko && e.translate <= Ao || isNaN(e.translate)) && (e.translate = 0);
}
function No(e, t, n, r) {
	Mo(e.x, t.x, n.x, r ? r.originX : void 0), Mo(e.y, t.y, n.y, r ? r.originY : void 0);
}
...
function Lo(e, t, n, r) {
	Io(e.x, t.x, n.x, r?.x), Io(e.y, t.y, n.y, r?.y);
}
//#endregion
...
function Uo(e, t, n, r) {
	Bo(e.x, t, Vo, n ? n.x : void 0, r ? r.x : void 0), Bo(e.y, t, Ho, n ? n.y : void 0, r ? r.y : void 0);
}
//#endregion
...
var $o = _i.length, es = (e) => typeof e == "string" ? parseFloat(e) : e, ts = (e) => typeof e == "number" || F.test(e);
function ns(e, t, n, r, i, a) {
	i ? (e.opacity = R(0, n.opacity ?? 1, is(r)), e.opacityExit = R(t.opacity ?? 1, 0, as(r))) : a && (e.opacity = R(t.opacity ?? 1, n.opacity ?? 1, r));
	for (let i = 0; i < $o; i++) {
		let a = _i[i], o = rs(t, a), s = rs(n, a);
		o === void 0 && s === void 0 || (o ||= 0, s ||= 0, o === 0 || s === 0 || ts(o) === ts(s) ? (e[a] = Math.max(R(es(o), es(s), r), 0), (P.test(s) || P.test(o)) && (e[a] += "%")) : e[a] = s);
	}
...
var is = /* @__PURE__ */ os(0, .5, he), as = /* @__PURE__ */ os(.5, .95, C);
function os(e, t, n) {
	return (r) => r < e ? 0 : r > t ? 1 : n(/* @__PURE__ */ T(e, t, r));
}
//#endregion
...
var ls = (e, t) => e.depth - t.depth, us = class {
	constructor() {
	...
	forEach(e) {
		this.isDirty && this.children.sort(ls), this.isDirty = !1, this.children.forEach(e);
	}
};
//#endregion
	...
	return class {
		constructor(e = {}, n = t?.()) {
			this.id = vs++, this.animationId = 0, this.animationCommitId = 0, this.children = /* @__PURE__ */ new Set(), this.options = {}, this.isTreeAnimating = !1, this.isAnimationBlocked = !1, this.isLayoutDirty = !1, this.isProjectionDirty = !1, this.isSharedProjectionDirty = !1, this.isTransformDirty = !1, this.updateManuallyBlocked = !1, this.updateBlockedByResize = !1, this.isUpdating = !1, this.isSVG = !1, this.needsReset = !1, this.shouldResetTransform = !1, this.hasCheckedOptimisedAppear = !1, this.treeScale = {
				...
				this.projectionUpdateScheduled = !1, na.value && (hs.nodes = hs.calculatedTargetDeltas = hs.calculatedProjections = 0), this.nodes.forEach(ws), this.nodes.forEach(Ns), this.nodes.forEach(Ps), this.nodes.forEach(Ts), na.addProjectionMetrics && na.addProjectionMetrics(hs);
		...
		mount(t) {
			...
			if (i && !i.current && i.mount(t), this.root.nodes.add(this), this.parent && this.parent.children.add(this), this.root.hasTreeAnimated && (r || n) && (this.isLayoutDirty = !0), e) {
				...
				k.read(() => {
					...
					e !== r && (r = e, this.root.updateBlockedByResize = !0, n && n(), n = ds(i, 250), ms.hasAnimatedSinceResize && (ms.hasAnimatedSinceResize = !1, this.nodes.forEach(Ms)));
				});
			}
			n && this.root.registerSharedNode(n, this), this.options.animate !== !1 && i && (n || r) && this.addEventListener("didUpdate", ({ delta: e, hasLayoutChanged: t, hasRelativeLayoutChanged: n, layout: r }) => {
				...
				let a = this.options.transition || i.getDefaultTransition() || Vs, { onLayoutAnimationStart: o, onLayoutAnimationComplete: s } = i.getProps(), c = !this.targetLayout || !Yo(this.targetLayout, r), l = !t && n;
				...
				} else t || Ms(this), this.isLead() && this.options.onExitComplete && this.options.onExitComplete();
				this.targetLayout = r;
			});
		}
		unmount() {
		...
		willUpdate(e = !0) {
			...
			if (window.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && bs(this), !this.root.isUpdating && this.root.startUpdate(), this.isLayoutDirty) return;
		...
		update() {
			if (this.updateScheduled = !1, this.isUpdateBlocked()) {
				...
				this.unblockUpdate(), this.updateBlockedByResize = !1, this.clearAllSnapshots(), e && this.nodes.forEach(Os), this.nodes.forEach(Ds);
				return;
			}
			...
			this.animationCommitId = this.animationId, this.isUpdating ? (this.isUpdating = !1, this.nodes.forEach(As), this.nodes.forEach(js), this.nodes.forEach(Ss), this.nodes.forEach(Cs)) : this.nodes.forEach(ks), this.clearAllSnapshots();
			let e = M.now();
			j.delta = m(0, 1e3 / 60, e - j.timestamp), j.timestamp = e, j.isProcessing = !0, ke.update.process(j), ke.preRender.process(j), ke.render.process(j), j.isProcessing = !1;
		}
		didUpdate() {
			this.updateScheduled || (this.updateScheduled = !0, xi.read(this.scheduleUpdate));
		}
		clearAllSnapshots() {
			this.nodes.forEach(Es), this.sharedNodes.forEach(Is);
		}
		...
		resetTransform() {
			if (!i) return;
			let e = this.isLayoutDirty || this.shouldResetTransform || this.options.alwaysMeasureLayout, t = this.projectionDelta && !Go(this.projectionDelta), n = this.getTransformTemplate(), r = n ? n(this.latestValues, "") : void 0, a = r !== this.prevTransformTemplateValue;
			e && this.instance && (t || J(this.latestValues) || a) && (i(this.instance, r), this.shouldResetTransform = !1, this.scheduleRender());
		}
		measure(e = !0) {
			let t = this.measurePageBox(), n = this.removeElementScroll(t);
			return e && (n = this.removeTransform(n)), Gs(n), {
				animationId: this.root.animationId,
				measuredBox: t,
				layoutBox: n,
				latestValues: {},
		...
		applyTransform(e, t = !1, n) {
			...
			for (let e = 0; e < this.path.length; e++) {
				let n = this.path[e];
				!t && n.options.layoutScroll && n.scroll && n !== n.root && (Y(r.x, -n.scroll.offset.x), Y(r.y, -n.scroll.offset.y)), J(n.latestValues) && Ua(r, n.latestValues, n.layout?.layoutBox);
			}
			return J(this.latestValues) && Ua(r, this.latestValues, this.layout?.layoutBox), r;
		}
		removeTransform(e) {
			let t = K();
			Z(t, e);
			for (let e = 0; e < this.path.length; e++) {
				...
				let r;
				n.instance && (ja(n.latestValues) && n.updateSnapshot(), r = K(), Z(r, n.measurePageBox())), Uo(t, n.latestValues, n.snapshot?.layoutBox, r);
			}
			return J(this.latestValues) && Uo(t, this.latestValues), t;
		}
		setTargetDelta(e) {
		...
		resolveTargetDelta(e = !1) {
			...
			a && this.linkedParentVersion !== a.layoutVersion && !a.options.layoutRoot && this.removeRelativeTarget(), !this.targetDelta && !this.relativeTarget && (this.options.layoutAnchor !== !1 && a && a.layout ? this.createRelativeTarget(a, this.layout.layoutBox, a.layout.layoutBox) : this.removeRelativeTarget()), !(!this.relativeTarget && !this.targetDelta) && (this.target || (this.target = K(), this.targetWithTransforms = K()), this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target ? (this.forceRelativeParentToResolveTarget(), Fo(this.target, this.relativeTarget, this.relativeParent.target, this.options.layoutAnchor || void 0)) : this.targetDelta ? (this.resumingFrom ? this.applyTransform(this.layout.layoutBox, !1, this.target) : Z(this.target, this.layout.layoutBox), La(this.target, this.targetDelta)) : Z(this.target, this.layout.layoutBox), this.attemptToResolveRelativeTarget && (this.attemptToResolveRelativeTarget = !1, this.options.layoutAnchor !== !1 && a && !!a.resumingFrom == !!this.resumingFrom && !a.options.layoutScroll && a.target && this.animationProgress !== 1 ? this.createRelativeTarget(a, this.target, a.target) : this.relativeParent = this.relativeTarget = void 0), na.value && hs.calculatedTargetDeltas++);
		}
		getClosestProjectingParent() {
			if (!(!this.parent || ja(this.parent.latestValues) || Ma(this.parent.latestValues))) return this.parent.isProjecting() ? this.parent : this.parent.getClosestProjectingParent();
		}
		isProjecting() {
			return !!((this.relativeTarget || this.targetDelta || this.options.layoutRoot) && this.layout);
		}
		createRelativeTarget(e, t, n) {
			this.relativeParent = e, this.linkedParentVersion = e.layoutVersion, this.forceRelativeParentToResolveTarget(), this.relativeTarget = K(), this.relativeTargetOrigin = K(), Lo(this.relativeTargetOrigin, t, n, this.options.layoutAnchor || void 0), Z(this.relativeTarget, this.relativeTargetOrigin);
		}
		...
		calcProjection() {
			...
			Ba(this.layoutCorrected, this.treeScale, this.path, t), e.layout && !e.target && (this.treeScale.x !== 1 || this.treeScale.y !== 1) && (e.target = e.layout.layoutBox, e.targetWithTransforms = K());
			let { target: s } = e;
			if (!s) {
				this.prevProjectionDelta && (this.createProjectionDeltas(), this.scheduleRender());
				return;
			}
			!this.projectionDelta || !this.prevProjectionDelta ? this.createProjectionDeltas() : (Eo(this.prevProjectionDelta.x, this.projectionDelta.x), Eo(this.prevProjectionDelta.y, this.projectionDelta.y)), No(this.projectionDelta, this.layoutCorrected, s, this.latestValues), (this.treeScale.x !== a || this.treeScale.y !== o || !Zo(this.projectionDelta.x, this.prevProjectionDelta.x) || !Zo(this.projectionDelta.y, this.prevProjectionDelta.y)) && (this.hasProjected = !0, this.scheduleRender(), this.notifyListeners("projectionUpdate", s)), na.value && hs.calculatedProjections++;
		}
		hide() {
			this.isVisible = !1;
		}
		...
		setAnimationOrigin(e, t = !1, n) {
			let r = this.snapshot, i = r ? r.latestValues : {}, a = { ...this.latestValues }, o = sa();
			(!this.relativeParent || !this.relativeParent.options.layoutRoot) && (this.relativeTarget = this.relativeTargetOrigin = void 0), this.attemptToResolveRelativeTarget = !t;
			let s = K(), c = (r ? r.source : void 0) !== (this.layout ? this.layout.source : void 0), l = this.getStack(), u = !l || l.members.length <= 1, d = !!(c && !u && this.options.crossfade === !0 && !this.path.some(Bs));
			this.animationProgress = 0;
			let f, p = n?.interpolateProjection(e);
			this.mixTargetDelta = (t) => {
				let n = t / 1e3, r = p?.(n);
				r ? (o.x.translate = r.x, o.x.scale = R(e.x.scale, 1, n), o.x.origin = e.x.origin, o.x.originPoint = e.x.originPoint, o.y.translate = r.y, o.y.scale = R(e.y.scale, 1, n), o.y.origin = e.y.origin, o.y.originPoint = e.y.originPoint) : (Ls(o.x, e.x, n), Ls(o.y, e.y, n)), this.setTargetDelta(o), this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout && (Lo(s, this.layout.layoutBox, this.relativeParent.layout.layoutBox, this.options.layoutAnchor || void 0), zs(this.relativeTarget, this.relativeTargetOrigin, s, n), f && qo(this.relativeTarget, f) && (this.isProjectionDirty = !1), f ||= K(), Z(f, this.relativeTarget)), c && (this.animationValues = a, ns(a, i, this.latestValues, n, d, u)), r && r.rotate !== void 0 && (this.animationValues ||= a, this.animationValues.pathRotation = r.rotate), this.root.scheduleUpdateProjection(), this.scheduleRender(), this.animationProgress = n;
		...
		startAnimation(e) {
			this.notifyListeners("animationStart"), this.currentAnimation?.stop(), this.resumingFrom?.currentAnimation?.stop(), this.pendingAnimation &&= (A(this.pendingAnimation), void 0), this.pendingAnimation = k.update(() => {
				ms.hasAnimatedSinceResize = !0, this.motionValue ||= H(0), this.motionValue.jump(0, !1), this.currentAnimation = ss(this.motionValue, [0, 1e3], {
					...e,
					velocity: 0,
					isSync: !0,
					onUpdate: (t) => {
		...
		finishAnimation() {
			this.currentAnimation && (this.mixTargetDelta && this.mixTargetDelta(_s), this.currentAnimation.stop()), this.completeAnimation();
		}
		applyTransformsToTarget() {
			...
			if (!(!t || !n || !r)) {
				...
				Z(t, n), Ua(t, i), No(this.projectionDeltaWithTransform, this.layoutCorrected, t, i);
			}
		}
		registerSharedNode(e, t) {
			this.sharedNodes.has(e) || this.sharedNodes.set(e, new ps()), this.sharedNodes.get(e).add(t);
		...
		resetSkewAndRotation() {
			...
			for (let t = 0; t < gs.length; t++) ys(`rotate${gs[t]}`, e, r, this.animationValues), ys(`skew${gs[t]}`, e, r, this.animationValues);
			e.render();
		...
		applyProjectionStyles(e, t) {
			...
			if (!this.projectionDelta || !this.layout || !r.target) {
				this.options.layoutId && (e.opacity = this.latestValues.opacity === void 0 ? 1 : this.latestValues.opacity, e.pointerEvents = fs(t?.pointerEvents) || ""), this.hasProjected && !J(this.latestValues) && (e.transform = n ? n({}, "") : "none", this.hasProjected = !1);
				return;
			}
			e.visibility = "";
			let i = r.animationValues || r.latestValues;
			this.applyTransformsToTarget();
			let a = Qo(this.projectionDeltaWithTransform, this.treeScale, i);
			...
			for (let t in eo) {
				...
				let { correct: n, applyTo: o, isCSSVariable: s } = eo[t], c = a === "none" ? i[t] : n(i[t], r);
				if (o) {
					let t = o.length;
		...
		resetTree() {
			this.root.nodes.forEach((e) => e.currentAnimation?.stop()), this.root.nodes.forEach(Ds), this.root.sharedNodes.clear();
		}
	};
}
function Ss(e) {
...
function Cs(e) {
	...
	if (e.isLead() && e.layout && t && e.hasListeners("didUpdate")) {
		...
		if (i === "size") $((e) => {
			...
			let e = i === "x" ? "y" : "x";
			To(a ? t.measuredBox[e] : t.layoutBox[e], n[e]);
		} else Ks(i, t.layoutBox, n) && $((r) => {
		...
		No(o, n, t.layoutBox);
		let s = sa();
		a ? No(s, e.applyTransform(r, !0), t.measuredBox) : No(s, n, t.layoutBox);
		let c = !Go(o), l = !1;
		if (!e.resumeFrom) {
			...
			if (r && !r.resumeFrom) {
				...
				if (i && a) {
					let o = e.options.layoutAnchor || void 0, s = K();
					Lo(s, t.layoutBox, i.layoutBox, o);
					let c = K();
					Lo(c, n, a.layoutBox, o), Yo(s, c) || (l = !0), r.options.layoutRoot && (e.relativeTarget = c, e.relativeTargetOrigin = s, e.relativeParent = r);
				}
			}
		}
...
function ws(e) {
	na.value && hs.nodes++, e.parent && (e.isProjecting() || (e.isProjectionDirty = e.parent.isProjectionDirty), e.isSharedProjectionDirty ||= !!(e.isProjectionDirty || e.parent.isProjectionDirty || e.parent.isSharedProjectionDirty), e.isTransformDirty ||= e.parent.isTransformDirty);
}
function Ts(e) {
...
function zs(e, t, n, r) {
	Rs(e.x, t.x, n.x, r), Rs(e.y, t.y, n.y, r);
}
function Bs(e) {
...
}, Hs = (e) => typeof navigator < "u" && navigator.userAgent && navigator.userAgent.toLowerCase().includes(e), Us = Hs("applewebkit/") && !Hs("chrome/") ? Math.round : C;
function Ws(e) {
...
function Ks(e, t, n) {
	return e === "position" || e === "preserve-aspect" && !jo(Xo(t), Xo(n), .2);
}
function qs(e) {
	...
	return (t) => {
		...
		if (n) return () => {
			for (let t = 0; t < r.length; t++) {
				let n = r[t];
				typeof n == "function" ? n() : Qs(e[t], null);
			}
		};
	};
}
...
var tc = class extends s.Component {
	getSnapshotBeforeUpdate(e) {
		let t = this.props.childRef.current;
		if (bi(t) && e.isPresent && !this.props.isPresent && this.props.pop !== !1) {
			let e = t.offsetParent, n = bi(e) && e.offsetWidth || 0, r = bi(e) && e.offsetHeight || 0, i = getComputedStyle(t), a = this.props.sizeRef.current;
...
function nc({ children: e, isPresent: t, anchorX: n, anchorY: r, root: i, pop: a }) {
	let c = (0, s.useId)(), l = (0, s.useRef)(null), u = (0, s.useRef)({
		width: 0,
		height: 0,
		top: 0,
		left: 0,
		...
		bottom: 0,
		direction: "ltr"
	}), { nonce: d } = (0, s.useContext)(Zs), f = ec(l, a === !1 ? void 0 : e.props?.ref ?? e?.ref);
	return (0, s.useInsertionEffect)(() => {
		let { width: e, height: o, top: s, left: f, right: p, bottom: m, direction: h } = u.current;
		if (t || a === !1 || !l.current || !e || !o) return;
		let g = h === "rtl", _ = n === "left" ? g ? `right: ${p}` : `left: ${f}` : g ? `left: ${f}` : `right: ${p}`, v = r === "bottom" ? `bottom: ${m}` : `top: ${s}`;
		...
		sizeRef: u,
		pop: a,
		children: a === !1 ? e : s.cloneElement(e, { ref: f })
	});
}
//#endregion
//#region node_modules/framer-motion/dist/es/components/AnimatePresence/PresenceChild.mjs
var rc = ({ children: e, initial: t, isPresent: n, onExitComplete: r, custom: i, presenceAffectsLayout: a, mode: c, anchorX: f, anchorY: p, root: m }) => {
	let h = l(ic), g = (0, s.useId)(), _ = (0, s.useRef)(n), v = (0, s.useRef)(r);
	u(() => {
		_.current = n, v.current = r;
	});
	let y = !0, b = (0, s.useMemo)(() => (y = !1, {
		id: g,
		initial: t,
		isPresent: n,
		custom: i,
		...
		register: (e) => (h.set(e, !1), () => {
			h.delete(e), !_.current && !h.size && v.current?.();
		})
	}), [
		n,
		h,
...
function ac(e = !0) {
	...
	let { isPresent: n, onExitComplete: r, register: i } = t, a = (0, s.useId)();
	(0, s.useEffect)(() => {
		if (e) return i(a);
	}, [e]);
	let o = (0, s.useCallback)(() => e && r && r(a), [
		a,
		r,
		e
	]);
...
var cc = ({ children: e, custom: t, initial: n = !0, onExitComplete: r, presenceAffectsLayout: i = !0, mode: a = "sync", propagate: d = !1, anchorX: f = "left", anchorY: p = "top", root: m }) => {
	let [h, g] = ac(d), _ = (0, s.useMemo)(() => sc(e), [e]), v = d && !h ? [] : _.map(oc), y = (0, s.useRef)(!0), b = (0, s.useRef)(_), x = l(() => /* @__PURE__ */ new Map()), S = (0, s.useRef)(/* @__PURE__ */ new Set()), [C, w] = (0, s.useState)(_), [T, E] = (0, s.useState)(_);
	u(() => {
	...
	if (_ !== C) {
		...
		return a === "wait" && D.length && (e = D), E(sc(e)), w(_), null;
	}
	...
	let { forceRender: O } = (0, s.useContext)(c);
	return (0, o.jsx)(o.Fragment, { children: T.map((e) => {
		let s = oc(e), c = d && !h ? !1 : _ === T || v.includes(s);
		return (0, o.jsx)(rc, {
			isPresent: c,
			...
			onExitComplete: c ? void 0 : () => {
				if (S.current.has(s)) return;
				if (x.has(s)) S.current.add(s), x.set(s, !0);
				else return;
				let e = !0;
				x.forEach((t) => {
					t || (e = !1);
				}), e && (O?.(), E(b.current), d && g?.(), r && r());
			},
			anchorX: f,
			anchorY: p,
			children: e
...
}, lc = (0, s.createContext)({ strict: !1 }), uc = {
	animation: [
		"animate",
		"variants",
		"whileHover",
...
function fc() {
	if (dc) return;
	let e = {};
	for (let t in uc) e[t] = { isEnabled: (e) => uc[t].some((t) => !!e[t]) };
	Ca(e), dc = !0;
}
function pc() {
	return fc(), wa();
...
var hc = new Set(/* @__PURE__ */ "animate.exit.variants.initial.style.values.variants.transition.transformTemplate.custom.inherit.onBeforeLayoutMeasure.onAnimationStart.onAnimationComplete.onUpdate.onDragStart.onDrag.onDragEnd.onMeasureDragConstraints.onDirectionLock.onDragTransitionEnd._dragX._dragY.onHoverStart.onHoverEnd.onViewportEnter.onViewportLeave.globalTapTarget.propagate.ignoreStrict.viewport".split("."));
function gc(e) {
	return e.startsWith("while") || e.startsWith("drag") && e !== "draggable" || e.startsWith("layout") || e.startsWith("onTap") || e.startsWith("onPan") || e.startsWith("onLayout") || hc.has(e);
}
//#endregion
//#region __vite-optional-peer-dep:@emotion/is-prop-valid:framer-motion
var _c = /* @__PURE__ */ t({ default: () => vc }), vc, yc = r((() => {
	throw vc = {}, Error("Could not resolve \"@emotion/is-prop-valid\" imported by \"framer-motion\". Is it installed?");
})), bc = (e) => !gc(e);
function xc(e) {
	typeof e == "function" && (bc = (t) => t.startsWith("on") ? !gc(t) : e(t));
}
try {
	xc((yc(), e(_c)).default);
} catch {}
function Sc(e, t, n) {
	let r = {};
	for (let i in e) i === "values" && typeof e.values == "object" || W(e[i]) || (bc(i) || n === !0 && gc(i) || !t && !gc(i) || e.draggable && i.startsWith("onDrag")) && (r[i] = e[i]);
	return r;
}
//#endregion
//#region node_modules/framer-motion/dist/es/context/MotionContext/index.mjs
var Cc = /* @__PURE__ */ (0, s.createContext)({});
//#endregion
...
function Tc(e) {
	let { initial: t, animate: n } = wc(e, (0, s.useContext)(Cc));
	return (0, s.useMemo)(() => ({
		initial: t,
		animate: n
	}), [Ec(t), Ec(n)]);
...
function Oc(e, t, n) {
	for (let r in t) !W(t[r]) && !to(r, n) && (e[r] = t[r]);
}
...
function Nc(e, t, n, r) {
	let i = (0, s.useMemo)(() => {
		let n = Mc();
		return lo(n, t, fo(r), e.transformTemplate, e.style), {
			...n.attrs,
			style: { ...n.style }
		};
	}, [t]);
...
function Fc(e) {
	return typeof e != "string" || e.includes("-") ? !1 : !!(Pc.indexOf(e) > -1 || /[A-Z]/u.test(e));
}
//#endregion
//#region node_modules/framer-motion/dist/es/render/dom/use-render.mjs
function Ic(e, t, n, { latestValues: r }, i, a = !1, o) {
	let c = (o ?? Fc(e) ? Nc : jc)(t, r, i, e), l = Sc(t, typeof e == "string", a), u = e === s.Fragment ? {} : {
		...l,
		...c,
		ref: n
	}, { children: d } = t, f = (0, s.useMemo)(() => W(d) ? d.get() : d, [d]);
...
function Lc({ scrapeMotionValuesFromProps: e, createRenderState: t }, n, r, i) {
	return {
		latestValues: Rc(n, r, i, e),
		renderState: t()
	};
}
function Rc(e, t, n, r) {
	...
	let { initial: o, animate: s } = e, c = ma(e), l = ha(e);
...
var zc = (e) => (t, n) => {
	let r = (0, s.useContext)(Cc), i = (0, s.useContext)(d), a = () => Lc(e, t, r, i);
	return n ? a() : l(a);
}, Bc = /* @__PURE__ */ zc({
...
}), Hc = Symbol.for("motionComponentSymbol");
//#endregion
...
function Kc(e, t, n, r, i, a) {
	let { visualElement: o } = (0, s.useContext)(Cc), c = (0, s.useContext)(lc), l = (0, s.useContext)(d), f = (0, s.useContext)(Zs), p = f.reducedMotion, m = f.skipAnimations, h = (0, s.useRef)(null), g = (0, s.useRef)(!1);
	...
	let _ = h.current, v = (0, s.useContext)(Wc);
	_ && !_.projection && i && (_.type === "html" || _.type === "svg") && qc(h.current, n, i, v);
	let y = (0, s.useRef)(!1);
	(0, s.useInsertionEffect)(() => {
		_ && y.current && _.update(n, l);
	});
	let b = n[Gr], x = (0, s.useRef)(!!b && typeof window < "u" && !window.MotionHandoffIsComplete?.(b) && window.MotionHasOptimisedAnimation?.(b));
	return u(() => {
...
function qc(e, t, n, r) {
	...
	e.projection = new n(e.latestValues, t["data-framer-portal-id"] ? void 0 : Jc(e.parent)), e.projection.setOptions({
		layoutId: i,
		layout: a,
		alwaysMeasureLayout: !!o || s && Gc(s),
		visualElement: e,
...
function Jc(e) {
	if (e) return e.options.allowProjection === !1 ? Jc(e.parent) : e.projection;
}
//#endregion
//#region node_modules/framer-motion/dist/es/motion/index.mjs
function Yc(e, { forwardMotionProps: t = !1, type: n } = {}, r, i) {
	r && mc(r);
	let a = n ? n === "svg" : Fc(e), c = a ? Vc : Bc;
	function l(n, l) {
		let u, d = {
			...(0, s.useContext)(Zs),
			...n,
			layoutId: Xc(n)
		}, { isStatic: f } = d, p = Tc(n), m = c(n, f);
		if (!f && typeof window < "u") {
			Zc(d, r);
			let t = Qc(d);
			u = t.MeasureLayout, p.visualElement = Kc(e, m, d, i, t.ProjectionNode, a);
		}
		return (0, o.jsxs)(Cc.Provider, {
			value: p,
			children: [u && p.visualElement ? (0, o.jsx)(u, {
				visualElement: p.visualElement,
				...d
			}) : null, Ic(e, n, Uc(m, p.visualElement, l), m, f, t, a)]
		});
	}
...
function Xc({ layoutId: e }) {
	let t = (0, s.useContext)(c).id;
	return t && e !== void 0 ? t + "-" + e : e;
}
function Zc(e, t) {
	let n = (0, s.useContext)(lc).strict;
	if (process.env.NODE_ENV !== "production" && t && n) {
		...
		e.ignoreStrict ? g(!1, t, "lazy-strict-mode") : _(!1, t, "lazy-strict-mode");
	}
}
function Qc(e) {
	let { drag: t, layout: n } = pc();
	if (!t && !n) return {};
	let r = {
		...t,
		...n
...
function $c(e, t) {
	if (typeof Proxy > "u") return Yc;
	let n = /* @__PURE__ */ new Map(), r = (n, r) => Yc(n, r, e, t);
	return new Proxy((e, t) => (process.env.NODE_ENV !== "production" && ne(!1, "motion() is deprecated. Use motion.create() instead."), r(e, t)), { get: (i, a) => a === "create" ? r : (n.has(a) || n.set(a, Yc(a, void 0, e, t)), n.get(a)) });
}
//#endregion
//#region node_modules/framer-motion/dist/es/render/dom/create-visual-element.mjs
var el = (e, t) => t.isSVG ?? Fc(e) ? new ho(t) : new io(t, { allowProjection: e !== s.Fragment }), tl = class extends q {
	constructor(e) {
		super(e), e.animationState ||= So(e);
	}
	...
	animation: { Feature: tl },
	exit: { Feature: class extends q {
		constructor() {
			super(...arguments), this.id = nl++, this.isExitComplete = !1;
		}
		update() {
...
var ul = /* @__PURE__ */ new Set(["auto", "scroll"]), dl = class {
	constructor(e, t, { transformPagePoint: n, contextWindow: r = window, dragSnapToOrigin: i = !1, distanceThreshold: a = 3, element: o } = {}) {
		if (this.startEvent = null, this.lastMoveEvent = null, this.lastMoveEventInfo = null, this.lastRawMoveEventInfo = null, this.handlers = {}, this.contextWindow = window, this.scrollPositions = /* @__PURE__ */ new Map(), this.removeScrollListeners = null, this.onElementScroll = (e) => {
			...
			this.lastRawMoveEventInfo && (this.lastMoveEventInfo = fl(this.lastRawMoveEventInfo, this.transformPagePoint));
			let e = ml(this.lastMoveEventInfo, this.history), t = this.startEvent !== null, n = ll(e.offset, {
				x: 0,
				y: 0
			...
			this.lastMoveEvent = e, this.lastRawMoveEventInfo = t, this.lastMoveEventInfo = fl(t, this.transformPagePoint), k.update(this.updatePoint, !0);
		}, this.handlePointerUp = (e, t) => {
			this.end();
			let { onEnd: n, onSessionEnd: r, resumeAnimation: i } = this.handlers;
			if ((this.dragSnapToOrigin || !this.startEvent) && i && i(), !(this.lastMoveEvent && this.lastMoveEventInfo)) return;
			let a = ml(e.type === "pointercancel" ? this.lastMoveEventInfo : fl(t, this.transformPagePoint), this.history);
		...
		let s = fl(il(e), this.transformPagePoint), { point: c } = s, { timestamp: l } = j;
		this.history = [{
			...c,
			timestamp: l
		}];
		...
		this.removeListeners = w(ol(this.contextWindow, "pointermove", this.handlePointerMove, d), ol(this.contextWindow, "pointerup", this.handlePointerUp, d), ol(this.contextWindow, "pointercancel", this.handlePointerUp, d)), o && this.startScrollTracking(o);
	}
	startScrollTracking(e) {
		let t = e.parentElement;
		for (; t;) {
			let e = getComputedStyle(t);
			(ul.has(e.overflowX) || ul.has(e.overflowY)) && this.scrollPositions.set(t, {
				x: t.scrollLeft,
				y: t.scrollTop
			}), t = t.parentElement;
		}
...
function _l(e, t) {
	...
	let n = e.length - 1, r = null, i = gl(e);
...
function bl(e, { top: t, left: n, bottom: r, right: i }) {
	return {
		x: yl(e.x, n, i),
		y: yl(e.y, t, r)
	};
...
function Cl(e, t) {
	let n = .5, r = Q(e), i = Q(t);
	return i > r ? n = /* @__PURE__ */ T(t.min, t.max - r, e.min) : r > i && (n = /* @__PURE__ */ T(e.min, e.max - i, t.min)), m(0, 1, n);
}
function wl(e, t) {
	let n = {};
...
var kl = /* @__PURE__ */ new WeakMap(), Al = class {
	constructor(e) {
		this.openDragLock = null, this.isDragging = !1, this.currentDirection = null, this.originPoint = {
			x: 0,
			y: 0
		}, this.constraints = !1, this.hasMutatedConstraints = !1, this.elastic = K(), this.latestPointerEvent = null, this.latestPanInfo = null, this.visualElement = e;
	}
	start(e, { snapToCursor: t = !1, distanceThreshold: n } = {}) {
		let { presenceContext: r } = this.visualElement;
		if (r && r.isPresent === !1) return;
		let i = (e) => {
			t && this.snapToCursor(il(e).point), this.stopAnimation();
		}, a = (e, t) => {
			...
			}), i && k.update(() => i(e, t), !1, !0), Ur(this.visualElement, "transform");
			...
			if (r && this.currentDirection === null) {
				this.currentDirection = Pl(o), this.currentDirection !== null && i && i(this.currentDirection);
				return;
			}
	...
	updateAxis(e, t, n) {
		...
		if (!n || !Nl(e, r, this.currentDirection)) return;
		let i = this.getAxisMotionValue(e), a = this.originPoint[e] + n[e];
		this.constraints && this.constraints[e] && (a = vl(a, this.constraints[e], this.elastic[e])), i.set(a);
	}
	resolveConstraints() {
		...
		e && Gc(e) ? this.constraints ||= this.resolveRefConstraints() : e && n ? this.constraints = bl(n.layoutBox, e) : this.constraints = !1, this.elastic = El(t), r !== this.constraints && !Gc(e) && n && this.constraints && !this.hasMutatedConstraints && $((e) => {
			this.constraints !== !1 && this.getAxisMotionValue(e) && (this.constraints[e] = wl(n.layoutBox[e], this.constraints[e]));
		});
	}
	resolveRefConstraints() {
		...
		if (!e || !Gc(e)) return !1;
		let n = e.current;
		_(n !== null, "If `dragConstraints` is set as a React ref, that ref must be passed to another component's `ref` prop.", "drag-constraints-ref");
		let { projection: r } = this.visualElement;
		if (!r || !r.layout) return !1;
		r.root && (r.root.scroll = void 0, r.root.updateScroll());
		let i = Ga(n, r.root, this.visualElement.getTransformPagePoint()), a = Sl(r.layout.layoutBox, i);
		if (t) {
			let e = t(Oa(a));
			this.hasMutatedConstraints = !!e, e && (a = Da(e));
		}
		return a;
	}
	startAnimation(e) {
		let { drag: t, dragMomentum: n, dragElastic: r, dragTransition: i, dragSnapToOrigin: a, onDragTransitionEnd: o } = this.getProps(), s = this.constraints || {}, c = $((o) => {
			if (!Nl(o, t, this.currentDirection)) return;
			let c = s && s[o] || {};
			(a === !0 || a === o) && (c = {
				min: 0,
				max: 0
	...
	startAxisValueAnimation(e, t) {
		...
		return Ur(this.visualElement, e), n.start(Ar(e, n, 0, t, this.visualElement, !1));
	}
	stopAnimation() {
	...
	snapToCursor(e) {
		$((t) => {
			...
			if (!Nl(t, n, this.currentDirection)) return;
	...
	scalePositionWithinConstraints() {
		...
		if (!Gc(t) || !n || !this.constraints) return;
		this.stopAnimation();
		let r = {
			x: 0,
			y: 0
	...
	addListeners() {
		...
		let e = this.visualElement.current, t = ol(e, "pointerdown", (t) => {
			let { drag: n, dragListener: r = !0 } = this.getProps(), i = t.target, a = i !== e && Ni(i);
			n && r && !a && this.start(t);
		}), n, r = () => {
			let { dragConstraints: t } = this.getProps();
			Gc(t) && t.current && (this.constraints = this.resolveRefConstraints(), n ||= Ml(e, t.current, () => this.scalePositionWithinConstraints()));
		...
		let o = cs(window, "resize", () => this.scalePositionWithinConstraints()), s = i.addEventListener("didUpdate", (({ delta: e, hasLayoutChanged: t }) => {
			this.isDragging && t && ($((t) => {
	...
	getProps() {
		let e = this.visualElement.getProps(), { drag: t = !1, dragDirectionLock: n = !1, dragPropagation: r = !1, dragConstraints: i = !1, dragElastic: a = Tl, dragMomentum: o = !0 } = e;
		return {
			...e,
			drag: t,
			dragDirectionLock: n,
...
var Fl = class extends q {
	constructor(e) {
		super(e), this.removeGroupControls = C, this.removeListeners = C, this.controls = new Al(e);
	}
	mount() {
		let { dragControls: e } = this.node.getProps();
		e && (this.removeGroupControls = e.subscribe(this.controls)), this.removeListeners = this.controls.addListeners() || C;
	}
	update() {
	...
	onPointerDown(e) {
		this.session = new dl(e, this.createPanHandlers(), {
	...
	mount() {
		this.removePointerDownListener = ol(this.node.current, "pointerdown", (e) => this.onPointerDown(e));
	}
	update() {
...
}, Rl = !1, zl = class extends s.Component {
	componentDidMount() {
		let { visualElement: e, layoutGroup: t, switchLayoutGroup: n, layoutId: r } = this.props, { projection: i } = e;
		i && (t.group && t.group.add(i), n && n.register && r && n.register(i), Rl && i.root.didUpdate(), i.addEventListener("animationComplete", () => {
			this.safeToRemove();
		}), i.setOptions({
			...i.options,
	...
	getSnapshotBeforeUpdate(e) {
		...
		return a ? (a.isPresent = i, e.layoutDependency !== t && a.setOptions({
			...a.options,
			layoutDependency: t
		}), Rl = !0, r || e.layoutDependency !== t || t === void 0 || e.isPresent !== i ? a.willUpdate() : this.safeToRemove(), e.isPresent !== i && (i ? a.promote() : a.relegate() || k.postRender(() => {
			let e = a.getStack();
	...
	componentDidUpdate() {
		...
		n && (n.options.layoutAnchor = t, n.root.didUpdate(), xi.postRender(() => {
			!n.currentAnimation && n.isLead() && this.safeToRemove();
		}));
	}
	componentWillUnmount() {
		let { visualElement: e, layoutGroup: t, switchLayoutGroup: n } = this.props, { projection: r } = e;
		Rl = !0, r && (r.scheduleCheckAfterUnmount(), t && t.group && t.group.remove(r), n && n.deregister && n.deregister(r));
	}
	safeToRemove() {
...
function Bl(e) {
	let [t, n] = ac(), r = (0, s.useContext)(c);
	return (0, o.jsx)(zl, {
		...e,
		layoutGroup: r,
		switchLayoutGroup: (0, s.useContext)(Wc),
		isPresent: t,
		safeToRemove: n
	});
}
...
function Hl(e, t, n) {
	...
	let i = r["onHover" + n];
	i && k.postRender(() => i(t, il(t)));
}
var Ul = class extends q {
	mount() {
		let { current: e } = this.node;
		e && (this.unmount = Di(e, (e, t) => (Hl(this.node, t, "Start"), (e) => Hl(this.node, e, "End"))));
	}
	unmount() {}
}, Wl = class extends q {
	constructor() {
	...
	mount() {
		this.unmount = w(cs(this.node.current, "focus", () => this.onFocus()), cs(this.node.current, "blur", () => this.onBlur()));
	}
	unmount() {}
};
//#endregion
...
var Kl = class extends q {
	mount() {
		...
		this.unmount = Bi(e, (e, t) => (Gl(this.node, t, "Start"), (e, { success: t }) => Gl(this.node, e, t ? "End" : "Cancel")), {
			useGlobalTarget: t,
			stopPropagation: n?.tap === !1
		});
	}
	unmount() {}
}, ql = /* @__PURE__ */ new WeakMap(), Jl = /* @__PURE__ */ new WeakMap(), Yl = (e) => {
	let t = ql.get(e.target);
	t && t(e);
}, Xl = (e) => {
	e.forEach(Yl);
};
function Zl({ root: e, ...t }) {
	let n = e || document;
	Jl.has(n) || Jl.set(n, {});
	let r = Jl.get(n), i = JSON.stringify(t);
	return r[i] || (r[i] = new IntersectionObserver(Xl, {
		root: e,
		...t
	})), r[i];
}
...
var $l = {
	...
	update() {
		...
		[
			...
			"margin",
			"root"
		].some(tu(e, t)) && this.startObserver();
	}
	unmount() {
...
function su(e, t, n) {
	...
	return r.listeners.set(e, n), r.observer.observe(e), () => {
		r?.observer.unobserve(e), r?.listeners.delete(e), r?.listeners.size === 0 && (r.observer.disconnect(), au.delete(t));
	};
}
function cu(e, t, { eager: n = !1, rootMargin: r = "800px 0px", unloadDelayMs: i = 2e3 } = {}) {
	let [a, o] = (0, s.useState)(), c = n || ou() || a === e;
...
function lu({ src: e, eager: t = !1, rootMargin: n = "800px 0px", unloadDelayMs: r = 2e3, loading: i = "lazy", decoding: a = "async", ...c }) {
	let l = (0, s.useRef)(null), u = cu(e, l, {
		eager: t,
		rootMargin: n,
		unloadDelayMs: r
	});
	return /* @__PURE__ */ (0, o.jsx)("img", {
		...
		loading: i,
		decoding: a,
		"data-viewport-image": u ? "loaded" : "deferred"
	});
}
//#endregion
export { cc as a, va as c, H as d, ne as f, xc as i, _a as l, cu as n, Zs as o, l as p, iu as r, ba as s, lu as t, xr as u };
