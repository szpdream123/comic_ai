...
import { Si as i, t as a } from "./useAppStore-BH-MdRLu.js";
import { It as o, Lt as s, Pt as c } from "./useTooltipAutoPlacement-D1FArkVS.js";
...
function h({ nodeType: e, selectedModel: t, selectedWorkflowId: n, onSelect: d, onWorkflowSelect: h, groups: g = c, workflows: _ = [], generalModelsOverride: v, groupAvailability: y, defaultExpandedGroupIds: b = [] }) {
	let x = r(), [S, C] = (0, l.useState)(!1), w = f[e] ?? e, T = a((e) => e.config), E = T.providers, D = T.generalModels || [], O = !!T.dreaminaAuth?.loggedIn, k = v ?? D, A = (0, l.useMemo)(() => o(T, w, g, { filterSelectedModels: g === c }), [
		T,
		g,
		w
	]), j = (0, l.useMemo)(() => s(k, T, w, {
		genericName: x("通用模型"),
	...
	}, [t, e]), W = U ? H.flatMap((e) => e.models).find((e) => e.value === U) : void 0, G = i(e), K = (0, l.useMemo)(() => G ? _.filter((e) => e.category === G) : [], [_, G]), q = n ? K.find((e) => e.id === n) : void 0, J = q ? q.name : W?.label ?? x("选择模型"), Y = (e) => {
		F(e) && P((t) => {
			let n = new Set(t);
			...
			children: [
				/* @__PURE__ */ (0, u.jsx)("span", {
					...
					children: /* @__PURE__ */ (0, u.jsxs)("svg", {
						...
						stroke: "currentColor",
						strokeWidth: "1.8",
						children: [/* @__PURE__ */ (0, u.jsx)("path", { d: "m12 3 8 4.5v9L12 21l-8-4.5v-9L12 3Z" }), /* @__PURE__ */ (0, u.jsx)("path", { d: "m4.5 7.5 7.5 4 7.5-4M12 12v9" })]
					})
				}),
				/* @__PURE__ */ (0, u.jsx)("span", {
