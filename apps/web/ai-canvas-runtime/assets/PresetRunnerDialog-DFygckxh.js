...
import { t as i, xi as a, yi as o } from "./useAppStore-BH-MdRLu.js";
import { a as s, r as c } from "./ViewportImage-txaOn4PW.js";
import { A as l, D as u, M as d, Nt as f, T as p } from "./useTooltipAutoPlacement-D1FArkVS.js";
...
function C({ preset: e, sourceNode: t, onClose: n }) {
	let r = e.advanced?.parameters ?? v, s = e.advanced?.steps ?? b, [p, g] = (0, h.useState)(() => {
		let t = l(r), n = y.get(e.id);
		if (!n) return t;
		for (let e of r) e.key in n && (t[e.key] = n[e.key]);
		return t;
	}), C = i((e) => e.showToast), w = (0, h.useMemo)(() => d(r, p), [r, p]);
									...
									return /* @__PURE__ */ (0, _.jsxs)("div", {
										...
										children: [
											...
											/* @__PURE__ */ (0, _.jsx)("span", {
												...
												children: o[e.nodeType].replace("预设", "")
											}),
					...
					children: [/* @__PURE__ */ (0, _.jsx)("span", { children: "每完成一个节点记录一次生成历史" }), /* @__PURE__ */ (0, _.jsxs)("div", { children: [/* @__PURE__ */ (0, _.jsx)("button", {
						...
						onClick: () => {
							...
							y.set(e.id, p), n(), u({
								...
								!e.success && e.failedStepIndex === void 0 && e.message && i.getState().showToast(e.message, "error");
							});
						},
						children: [/* @__PURE__ */ (0, _.jsx)(m, {
							icon: "mdi:play",
...
function w() {
	let e = i((e) => e.presetRunRequest), t = i((t) => e ? t.userPresets.find((t) => t.id === e.presetId) : void 0), n = i((t) => e ? t.nodes.find((t) => t.id === e.sourceNodeId) : void 0), r = i((e) => e.setPresetRunRequest);
	return (0, h.useEffect)(() => {
		...
		r,
		n
	]), (0, g.createPortal)(/* @__PURE__ */ (0, _.jsx)(s, { children: e && t && n && p(t) ? /* @__PURE__ */ (0, _.jsx)(C, {
		preset: t,
		sourceNode: n,
		onClose: () => r(null)
