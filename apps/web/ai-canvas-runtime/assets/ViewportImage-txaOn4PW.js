import { a as e, i as t, o as n, r, t as i } from "./react-Dfufv8pq.js";
import { t as a } from "./jsx-runtime-BAkIPmuO.js";
import { a as o, i as s, n as c, r as l, t as u } from "./reduced-motion-BxGVFIo6.js";
//#region node_modules/framer-motion/dist/es/context/LayoutGroupContext.mjs
var d = a(), f = /* @__PURE__ */ n(i(), 1), p = (0, f.createContext)({});
//#endregion
...
var h = typeof window < "u" ? f.useLayoutEffect : f.useEffect, g = /* @__PURE__ */ (0, f.createContext)(null);
//#endregion
...
var y = (e, t, n) => n > t ? t : n < e ? e : n, b = () => {}, x = () => {};
typeof process < "u" && process.env.NODE_ENV !== "production" && (b = (e, t, n) => {
	!e && typeof console < "u" && console.warn(o(t, n));
}, x = (e, t, n) => {
	if (!e) throw Error(o(t, n));
});
//#endregion
//#region node_modules/motion-utils/dist/es/global-config.mjs
var S = {}, C = (e) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(e), w = (e) => typeof e == "object" && !!e, T = (e) => /^0[^.\s]+$/u.test(e);
//#endregion
...
var E = /* @__NO_SIDE_EFFECTS__ */ (e) => e, te = (...e) => e.reduce((e, t) => (n) => t(e(n))), ne = /* @__NO_SIDE_EFFECTS__ */ (e, t, n) => {
	let r = t - e;
	return r ? (n - e) / r : 1;
}, re = class {
	constructor() {
	...
	add(e) {
		return _(this.subscriptions, e), () => v(this.subscriptions, e);
	}
	notify(e, t, n) {
...
}, D = /* @__NO_SIDE_EFFECTS__ */ (e) => e * 1e3, O = /* @__NO_SIDE_EFFECTS__ */ (e) => e / 1e3, ie = /* @__NO_SIDE_EFFECTS__ */ (e, t) => t ? 1e3 / t * e : 0, ae = (e, t, n) => (((1 - 3 * n + 3 * t) * e + (3 * n - 6 * t)) * e + 3 * t) * e, oe = 1e-7, se = 12;
function ce(e, t, n, r, i) {
	let a, o, s = 0;
	do
		o = t + (n - t) / 2, a = ae(o, r, i) - e, a > 0 ? n = o : t = o;
	while (Math.abs(a) > oe && ++s < se);
	return o;
}
/* @__NO_SIDE_EFFECTS__ */
function le(e, t, n, r) {
...
var ue = /* @__NO_SIDE_EFFECTS__ */ (e) => (t) => t <= .5 ? e(2 * t) / 2 : (2 - e(2 * (1 - t))) / 2, de = /* @__NO_SIDE_EFFECTS__ */ (e) => (t) => 1 - e(1 - t), fe = /* @__PURE__ */ le(.33, 1.53, .69, .99), pe = /* @__PURE__ */ de(fe), me = /* @__PURE__ */ ue(pe), he = (e) => e >= 1 ? 1 : (e *= 2) < 1 ? .5 * pe(e) : .5 * (2 - 2 ** (-10 * (e - 1))), ge = (e) => 1 - Math.sin(Math.acos(e)), _e = /* @__PURE__ */ de(ge), ve = /* @__PURE__ */ ue(ge), ye = /* @__PURE__ */ le(.42, 0, 1, 1), be = /* @__PURE__ */ le(0, 0, .58, 1), xe = /* @__PURE__ */ le(.42, 0, .58, 1), Se = /* @__NO_SIDE_EFFECTS__ */ (e) => Array.isArray(e) && typeof e[0] != "number", Ce = /* @__NO_SIDE_EFFECTS__ */ (e) => Array.isArray(e) && typeof e[0] == "number", we = {
	linear: E,
	easeIn: ye,
	easeInOut: xe,
	easeOut: be,
	...
	if (/* @__PURE__ */ Ce(e)) {
		...
		let [t, n, r, i] = e;
		return /* @__PURE__ */ le(t, n, r, i);
	} else if (Te(e)) return x(we[e] !== void 0, `Invalid easing type '${e}'`, "invalid-easing-type"), we[e];
	return e;
}, De = [
	"setup",
	"read",
...
var { schedule: k, cancel: A, state: j, steps: je } = /* @__PURE__ */ Ae(typeof requestAnimationFrame < "u" ? requestAnimationFrame : E, !0), Me;
function Ne() {
	Me = void 0;
}
var M = {
	now: () => (Me === void 0 && M.set(j.isProcessing || S.useManualTiming ? j.timestamp : performance.now()), Me),
	set: (e) => {
...
var Be = {
	...
	...Be,
	default: 1
}, Ue = (e) => Math.round(e * 1e5) / 1e5, We = /-?(?:\d+(?:\.\d+)?|\.\d+)/gu;
//#endregion
...
var Ke = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu, qe = (e, t) => (n) => !!(typeof n == "string" && Ke.test(n) && n.startsWith(e) || t && !Ge(n) && Object.prototype.hasOwnProperty.call(n, t)), Je = (e, t, n) => (r) => {
	...
	...Be,
	transform: (e) => Math.round(Ye(e))
}, Ze = {
	test: /* @__PURE__ */ qe("rgb", "red"),
	parse: /* @__PURE__ */ Je("red", "green", "blue"),
	transform: ({ red: e, green: t, blue: n, alpha: r = 1 }) => "rgba(" + Xe.transform(e) + ", " + Xe.transform(t) + ", " + Xe.transform(n) + ", " + Ue(Ve.transform(r)) + ")"
};
//#endregion
...
}, et = /* @__NO_SIDE_EFFECTS__ */ (e) => ({
	test: (t) => typeof t == "string" && t.endsWith(e) && t.split(" ").length === 1,
	parse: parseFloat,
	transform: (t) => `${t}${e}`
}), N = /* @__PURE__ */ et("deg"), P = /* @__PURE__ */ et("%"), F = /* @__PURE__ */ et("px"), tt = /* @__PURE__ */ et("vh"), nt = /* @__PURE__ */ et("vw"), rt = {
	...P,
	parse: (e) => P.parse(e) / 100,
	transform: (e) => P.transform(e * 100)
}, it = {
	test: /* @__PURE__ */ qe("hsl", "hue"),
	parse: /* @__PURE__ */ Je("hue", "saturation", "lightness"),
	transform: ({ hue: e, saturation: t, lightness: n, alpha: r = 1 }) => "hsla(" + Math.round(e) + ", " + P.transform(Ue(t)) + ", " + P.transform(Ue(n)) + ", " + Ue(Ve.transform(r)) + ")"
}, I = {
	test: (e) => Ze.test(e) || $e.test(e) || it.test(e),
	parse: (e) => Ze.test(e) ? Ze.parse(e) : it.test(e) ? it.parse(e) : $e.parse(e),
	transform: (e) => typeof e == "string" ? e : e.hasOwnProperty("red") ? Ze.transform(e) : it.transform(e),
	getAnimatableNone: (e) => {
		let t = I.parse(e);
...
function ot(e) {
	return isNaN(e) && typeof e == "string" && (e.match(We)?.length || 0) + (e.match(at)?.length || 0) > 0;
}
var st = "number", ct = "color", lt = "var", ut = "var(", dt = "${}", ft = /var\s*\(\s*--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)|#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\)|-?(?:\d+(?:\.\d+)?|\.\d+)/giu;
function pt(e) {
	...
	return {
		values: n,
		split: t.replace(ft, (e) => (I.test(e) ? (r.color.push(a), i.push(ct), n.push(I.parse(e))) : e.startsWith(ut) ? (r.var.push(a), i.push(lt), n.push(e)) : (r.number.push(a), i.push(st), n.push(parseFloat(e))), ++a, dt)).split(dt),
		indexes: r,
		types: i
	};
}
...
function ht({ split: e, types: t }) {
	let n = e.length;
	return (r) => {
		let i = "";
		for (let a = 0; a < n; a++) if (i += e[a], r[a] !== void 0) {
			let e = t[a];
			e === st ? i += Ue(r[a]) : e === ct ? i += I.transform(r[a]) : i += r[a];
		}
		return i;
	};
}
...
var _t = (e) => typeof e == "number" ? 0 : I.test(e) ? I.getAnimatableNone(e) : e, vt = (e, t) => typeof e == "number" ? t?.trim().endsWith("/") ? e : 0 : _t(e);
function yt(e) {
	let t = pt(e);
	return ht(t)(t.values.map((e, n) => vt(e, t.split[n])));
}
var L = {
	test: ot,
	parse: mt,
...
function Et(e) {
	let t = Tt(e);
	if (b(!!t, `'${e}' is not an animatable color. Use the equivalent color code instead.`, "color-not-animatable"), !t) return !1;
	let n = t.parse(e);
	return t === it && (n = xt(n)), n;
}
var Dt = (e, t) => {
	let n = Et(e), r = Et(t);
	if (!n || !r) return St(e, t);
	let i = { ...n };
	return (e) => (i.red = Ct(n.red, r.red, e), i.green = Ct(n.green, r.green, e), i.blue = Ct(n.blue, r.blue, e), i.alpha = R(n.alpha, r.alpha, e), Ze.transform(i));
...
function jt(e) {
	return typeof e == "number" ? At : typeof e == "string" ? Le(e) ? St : I.test(e) ? Dt : Ft : Array.isArray(e) ? Mt : typeof e == "object" ? I.test(e) ? Dt : Nt : St;
}
function Mt(e, t) {
...
var Ft = (e, t) => {
	let n = L.createTransformer(t), r = pt(e), i = pt(t);
	return r.indexes.var.length === i.indexes.var.length && r.indexes.color.length === i.indexes.color.length && r.indexes.number.length >= i.indexes.number.length ? Ot.has(e) && !i.values.length || Ot.has(t) && !r.values.length ? kt(e, t) : te(Mt(Pt(r, i), i.values), n) : (b(!0, `Complex values '${e}' and '${t}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`, "complex-values-different"), St(e, t));
};
//#endregion
//#region node_modules/motion-dom/dist/es/utils/mix/index.mjs
function It(e, t, n) {
	return typeof e == "number" && typeof t == "number" && typeof n == "number" ? R(e, t, n) : jt(e)(e, t);
}
//#endregion
...
var Gt = .001;
function Kt({ duration: e = z.duration, bounce: t = z.bounce, velocity: n = z.velocity, mass: r = z.mass }) {
	let i, a;
	b(e <= /* @__PURE__ */ D(z.maxDuration), "Spring duration must be 10 seconds or less", "spring-duration-limit");
	let o = 1 - t;
	o = y(z.minDamping, z.maxDamping, o), e = y(z.minDuration, z.maxDuration, /* @__PURE__ */ O(e)), o < 1 ? (i = (t) => {
		let r = t * o, i = r * e, a = r - n, s = Ht(t, o), c = Math.exp(-i);
		return Gt - a / s * c;
	}, a = (t) => {
		let r = t * o * e, a = r * n + n, s = o ** 2 * t ** 2 * e, c = Math.exp(-r), l = Ht(t ** 2, o);
		return (-i(t) + Gt > 0 ? -1 : 1) * ((a - s) * c) / l;
	}) : (i = (t) => -.001 + Math.exp(-t * e) * ((t - n) * e + 1), a = (t) => Math.exp(-t * e) * ((n - t) * (e * e)));
	let s = 5 / e, c = Wt(i, a, s);
...
function Xt(e) {
	...
	if (!Yt(e, Jt) && Yt(e, qt)) if (t.velocity = 0, e.visualDuration) {
		let n = e.visualDuration, r = 2 * Math.PI / (n * 1.2), i = r * r, a = 2 * y(.05, 1, 1 - (e.bounce || 0)) * Math.sqrt(i);
		t = {
			...t,
			mass: z.mass,
			stiffness: i,
...
function Zt(e = z.visualDuration, t = z.bounce) {
	let n = typeof e == "object" ? e : {
		...
		value: a
	}, { stiffness: c, damping: l, mass: u, duration: d, velocity: f, isResolvedFromDuration: p } = Xt({
		...n,
		velocity: -/* @__PURE__ */ O(n.velocity || 0)
	}), m = f || 0, h = l / (2 * Math.sqrt(c * u)), g = o - a, _ = /* @__PURE__ */ O(Math.sqrt(c / u)), v = Math.abs(g) < 5;
	r ||= v ? z.restSpeed.granular : z.restSpeed.default, i ||= v ? z.restDelta.granular : z.restDelta.default;
	let y, b, x, S, C, w;
	if (h < 1) x = Ht(_, h), S = (m + h * _ * g) / x, y = (e) => o - Math.exp(-h * _ * e) * (S * Math.sin(x * e) + g * Math.cos(x * e)), C = h * _ * S + g * x, w = h * _ * g - S * x, b = (e) => Math.exp(-h * _ * e) * (C * Math.sin(x * e) + w * Math.cos(x * e));
	else if (h === 1) {
	...
	let T = {
		...
		toString: () => {
			let e = Math.min(Bt(T), zt), t = Rt((t) => T.next(e * t).value, e, 30);
			return e + "ms " + t;
		},
		toTransition: () => {}
	};
...
function tn(e, t, n) {
	let r = [], i = n || S.mix || It, a = e.length - 1;
	for (let n = 0; n < a; n++) {
		let a = i(e[n], e[n + 1]);
		t && (a = te(Array.isArray(t) ? t[n] || E : t, a)), r.push(a);
	}
	return r;
}
function nn(e, t, { clamp: n = !0, ease: r, mixer: i } = {}) {
	let a = e.length;
	if (x(a === t.length, "Both input and output ranges must be the same length", "range-length"), a === 1) return () => t[0];
	if (a === 2 && t[0] === t[1]) return () => t[1];
	let o = e[0] === e[1];
	e[0] > e[a - 1] && (e = [...e].reverse(), t = [...t].reverse());
	let s = tn(t, r, i), c = s.length, l = (n) => {
...
function cn({ duration: e = 300, keyframes: t, times: n, ease: r = "easeInOut" }) {
	let i = /* @__PURE__ */ Se(r) ? r.map(Ee) : Ee(r), a = {
		done: !1,
		value: t[0]
	}, o = nn(on(n && n.length === t.length ? n : an(t), e), t, { ease: Array.isArray(i) ? i : sn(t, i) });
	return {
...
var pn = class {
...
}, mn = (e) => e / 100, hn = class extends pn {
	constructor(e) {
	...
	initAnimation() {
		let { options: e } = this;
		fn(e);
		let { type: t = cn, repeat: n = 0, repeatDelay: r = 0, repeatType: i, velocity: a = 0 } = e, { keyframes: o } = e, s = t || cn;
		process.env.NODE_ENV !== "production" && s !== cn && x(o.length <= 2, `Only two keyframes currently supported with spring and inertia animations. Trying to animate ${o}`, "spring-two-frames"), s !== cn && typeof o[0] != "number" && (this.mixKeyframes = te(mn, It(o[0], o[1])), o = [0, 100]);
		let c = s({
			...e,
			keyframes: o
		});
	...
	tick(e, t = !1) {
		...
		let v = this.currentTime, b = n;
		if (u) {
			let e = Math.min(this.currentTime, r) / o, t = Math.floor(e), n = e % 1;
			!n && e >= 1 && (n = 1), n === 1 && t--, t = Math.min(t, u + 1), t % 2 && (d === "reverse" ? (n = 1 - n, f && (n -= f / o)) : d === "mirror" && (b = a)), v = y(0, 1, n) * o;
		}
		let x;
		_ ? (this.delayState.value = l[0], x = this.delayState) : x = b.next(v), i && !_ && (x.value = i(x.value));
		let { done: S } = x;
		!_ && s !== null && (S = this.playbackSpeed >= 0 ? this.currentTime >= r : this.currentTime <= 0);
		let C = this.holdTime === null && (this.state === "finished" || this.state === "running" && S);
		return C && p !== en && (x.value = un(l, this.options, h, this.speed)), m && m(x.value), C && this.finish(), x;
	}
	then(e, t) {
		return this.finished.then(e, t);
	}
	...
	set speed(e) {
		...
		t && this.driver && this.updateTime(M.now()), this.playbackSpeed = e, t && this.driver && (this.time = /* @__PURE__ */ O(this.currentTime));
	}
	play() {
...
var B = (e) => e * 180 / Math.PI, _n = (e) => yn(B(Math.atan2(e[1], e[0]))), vn = {
	x: 4,
	y: 5,
	translateX: 4,
	translateY: 5,
...
}, yn = (e) => (e %= 360, e < 0 && (e += 360), e), bn = _n, xn = (e) => Math.sqrt(e[0] * e[0] + e[1] * e[1]), Sn = (e) => Math.sqrt(e[4] * e[4] + e[5] * e[5]), Cn = {
	x: 12,
	y: 13,
	z: 14,
	translateX: 12,
	...
	scaleY: Sn,
	scale: (e) => (xn(e) + Sn(e)) / 2,
	rotateX: (e) => yn(B(Math.atan2(e[6], e[5]))),
	rotateY: (e) => yn(B(Math.atan2(-e[2], e[0]))),
	rotateZ: bn,
	rotate: bn,
...
var On = [
	...
	"skewX",
	"skewY"
], kn = /* @__PURE__ */ new Set([...On, "pathRotation"]), An = (e) => e === Be || e === F, jn = new Set([
	"x",
	"y",
	"z"
]), Mn = On.filter((e) => !jn.has(e));
function Nn(e) {
	let t = [];
	return Mn.forEach((n) => {
		let r = e.getValue(n);
...
var V = {
	...
	x: (e, { transform: t }) => Tn(t, "x"),
	y: (e, { transform: t }) => Tn(t, "y")
};
V.translateX = V.x, V.translateY = V.y;
//#endregion
//#region node_modules/motion-dom/dist/es/animation/keyframes/KeyframesResolver.mjs
var H = /* @__PURE__ */ new Set(), Pn = !1, Fn = !1, In = !1;
function Ln() {
	if (Fn) {
		let e = Array.from(H).filter((e) => e.needsMeasurement), t = new Set(e.map((e) => e.element)), n = /* @__PURE__ */ new Map();
		t.forEach((e) => {
			let t = Nn(e);
	...
	Fn = !1, Pn = !1, H.forEach((e) => e.complete(In)), H.clear();
}
function Rn() {
	H.forEach((e) => {
		e.readKeyframes(), e.needsMeasurement && (Fn = !0);
	});
}
function zn() {
	In = !0, Rn(), Ln(), In = !1;
...
var Bn = class {
	...
	scheduleResolve() {
		this.state = "scheduled", this.isAsync ? (H.add(this), Pn || (Pn = !0, k.read(Rn), k.resolveKeyframes(Ln))) : (this.readKeyframes(), this.complete());
	}
	readKeyframes() {
...
function Hn(e, t, n) {
	Vn(t) ? e.style.setProperty(t, n) : e.style[t] = n;
}
//#endregion
...
var Gn = /* @__PURE__ */ Wn(() => window.ScrollTimeline !== void 0, "scrollTimeline"), Kn = /* @__PURE__ */ Wn(() => {
	try {
	...
	return !0;
}, "linearEasing"), qn = ([e, t, n, r]) => `cubic-bezier(${e}, ${t}, ${n}, ${r})`, Jn = {
	linear: "linear",
	ease: "ease",
	easeIn: "ease-in",
	easeOut: "ease-out",
...
function Yn(e, t) {
	if (e) return typeof e == "function" ? Kn() ? Rt(e, t) : "ease-out" : /* @__PURE__ */ Ce(e) ? qn(e) : Array.isArray(e) ? e.map((e) => Yn(e, t) || Jn.easeOut) : Jn[e];
}
//#endregion
//#region node_modules/motion-dom/dist/es/animation/waapi/start-waapi-animation.mjs
function Xn(e, t, n, { delay: r = 0, duration: i = 300, repeat: a = 0, repeatType: o = "loop", ease: s = "easeOut", times: c } = {}, l = void 0) {
	let u = { [t]: n };
	c && (u.offset = c);
	let d = Yn(s, i);
...
function Qn({ type: e, ...t }) {
	return Zn(e) && Kn() ? e.applyToOptions(t) : (t.duration ??= 300, t.ease ??= "easeOut", t);
}
//#endregion
//#region node_modules/motion-dom/dist/es/animation/NativeAnimation.mjs
var $n = class extends pn {
	constructor(e) {
		if (super(), this.finishedTime = null, this.isStopped = !1, this.manualStartTime = null, !e) return;
		let { element: t, name: n, keyframes: r, pseudoElement: i, allowFlatten: a = !1, finalKeyframe: o, onComplete: s } = e;
		this.isPseudoElement = !!i, this.allowFlatten = a, this.options = e, x(typeof e.type != "string", "Mini animate() doesn't support \"type\" as a string.", "mini-spring");
		let c = Qn(e);
		this.animation = Xn(t, n, r, c, i), c.autoplay === !1 && this.animation.pause(), this.animation.onfinish = () => {
			if (this.finishedTime = this.time, !i) {
				let e = un(r, this.options, o, this.speed);
				this.updateMotionValue && this.updateMotionValue(e), Hn(t, n, e), this.animation.cancel();
			}
	...
	attachTimeline({ timeline: e, rangeStart: t, rangeEnd: n, observe: r }) {
		return this.allowFlatten && this.animation.effect?.updateTiming({ easing: "linear" }), this.animation.onfinish = null, e && Gn() ? (this.animation.timeline = e, t && (this.animation.rangeStart = t), n && (this.animation.rangeEnd = n), E) : r(this);
	}
}, er = {
	anticipate: he,
	backInOut: me,
...
function nr(e) {
	typeof e.ease == "string" && tr(e.ease) && (e.ease = er[e.ease]);
}
//#endregion
//#region node_modules/motion-dom/dist/es/animation/NativeAnimationExtended.mjs
var rr = 10, ir = class extends $n {
	constructor(e) {
		nr(e), fn(e), super(e), e.startTime !== void 0 && e.autoplay !== !1 && (this.startTime = e.startTime), this.options = e;
	}
	updateMotionValue(e) {
		...
		let o = new hn({
			...a,
			autoplay: !1
		}), s = Math.max(rr, M.now() - this.startTime), c = y(0, rr, s - rr), l = o.sample(s).value, { name: u } = this.options;
		i && u && Hn(i, u, l), t.setWithVelocity(o.sample(Math.max(0, s - c)).value, l, c), o.stop();
	}
}, ar = (e, t) => t === "zIndex" ? !1 : !!(typeof e == "number" || Array.isArray(e) || typeof e == "string" && (L.test(e) || e === "0") && !e.startsWith("url("));
//#endregion
...
function sr(e, t, n, r) {
	...
	let a = e[e.length - 1], o = ar(i, t), s = ar(a, t);
	return b(o === s, `You are trying to animate ${t} from "${i}" to "${a}". "${o ? a : i}" is not an animatable value.`, "value-not-animatable"), !o || !s ? !1 : or(e) || (n === "spring" || Zn(n)) && r;
}
//#endregion
...
function dr(e) {
	for (let t = 0; t < e.length; t++) if (typeof e[t] == "string" && ur.test(e[t])) return !0;
	return !1;
}
//#endregion
...
var fr = new Set([
	...
	"borderBottomColor",
	"borderLeftColor"
]), pr = /* @__PURE__ */ ee(() => Object.hasOwnProperty.call(Element.prototype, "animate"));
function mr(e) {
	...
	return pr() && n && (lr.has(n) || fr.has(n) && dr(s)) && (n !== "transform" || !u) && !l && !r && i !== "mirror" && a !== 0 && o !== "inertia";
}
//#endregion
//#region node_modules/motion-dom/dist/es/animation/AsyncMotionValueAnimation.mjs
var hr = 40, gr = class extends pn {
	...
	onKeyframesResolved(e, t, n, r) {
		...
		let u = !0;
		sr(e, i, a, o) || (u = !1, (S.instantAnimations || !s) && l?.(un(e, n, t)), e[0] = e[e.length - 1], cr(n), n.repeat = 0);
		let d = {
			startTime: r ? this.resolvedAt && this.resolvedAt - this.createdAt > hr ? this.resolvedAt : this.createdAt : void 0,
			finalKeyframe: t,
			...n,
			keyframes: e
		}, f = u && !c && mr(d), p = d.motionValue?.owner?.current, m;
		if (f) try {
			m = new ir({
				...d,
				element: p
		...
		m.finished.then(() => {
			this.notifyFinished();
		}).catch(E), this.pendingTimeline &&= (this.stopTimeline = m.attachTimeline(this.pendingTimeline), void 0), this._animation = m;
	}
	get finished() {
	...
	get animation() {
		return this._animation || (this.keyframeResolver?.resume(), zn()), this._animation;
	}
	get duration() {
...
var vr = 30, yr = (e) => !isNaN(parseFloat(e)), br = { current: void 0 }, xr = class {
	constructor(e, t = {}) {
	...
	setCurrent(e) {
		this.current = e, this.updatedAt = M.now(), this.canTrackVelocity === null && e !== void 0 && (this.canTrackVelocity = yr(this.current));
	}
	setPrevFrameValue(e = this.current) {
		this.prevFrameValue = e, this.prevUpdatedAt = this.updatedAt;
	}
	onChange(e) {
		return process.env.NODE_ENV !== "production" && s(!1, "value.onChange(callback) is deprecated. Switch to value.on(\"change\", callback)."), this.on("change", e);
	}
	on(e, t) {
	...
	getVelocity() {
		...
		return /* @__PURE__ */ ie(parseFloat(this.current) - parseFloat(this.prevFrameValue), t);
	}
	start(e) {
...
var wr = {
	...
	duration: .3
}, Or = (e, { keyframes: t }) => t.length > 2 ? Er : kn.has(e) ? e.startsWith("scale") ? Tr(t[1]) : wr : Dr, kr = new Set([
	"when",
	"delay",
	"delayChildren",
	"staggerChildren",
...
var jr = (e, t, n, r = {}, i, a) => (o) => {
	let s = Cr(r, e) || {}, c = s.delay || r.delay || 0, { elapsed: l = 0 } = r;
	l -= /* @__PURE__ */ D(c);
	let u = {
	...
	Ar(s) || Object.assign(u, Or(e, u)), u.duration &&= /* @__PURE__ */ D(u.duration), u.repeatDelay &&= /* @__PURE__ */ D(u.repeatDelay), u.from !== void 0 && (u.keyframes[0] = u.from);
	let d = !1;
	if ((u.type === !1 || u.duration === 0 && !u.repeatDelay) && (cr(u), u.delay === 0 && (d = !0)), (S.instantAnimations || S.skipAnimations || i?.shouldSkipAnimations || s.skipAnimations) && (d = !0, cr(u), u.delay = 0), u.allowFlatten = !s.type && !s.ease, d && !a && t.get() !== void 0) {
	...
	return s.isSync ? new hn(u) : new gr(u);
...
var Pr = 4;
function Fr(e, t, n = 1) {
	x(n <= Pr, `Max CSS variable fallback depth detected in property "${e}". This may indicate a circular fallback dependency.`, "max-css-var-depth");
	let [r, i] = Nr(e);
	if (!r) return;
...
function W(e, t, n) {
	let r = e.getProps();
	return Lr(r, t, n === void 0 ? r.custom : n, e);
}
//#endregion
...
var Rr = new Set([
	...
	"bottom",
	...On
]), zr = (e) => Array.isArray(e);
//#endregion
//#region node_modules/motion-dom/dist/es/render/utils/setters.mjs
function Br(e, t, n) {
	e.hasValue(t) ? e.getValue(t).set(n) : e.addValue(t, U(n));
}
function Vr(e) {
...
function Yr(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
	...
	for (let t in s) {
		...
		r.start(jr(t, r, i, m && Rr.has(t) ? { type: !1 } : o, e, p));
		let h = r.animation;
		h && d.push(h);
	}
	if (o) {
...
function Xr(e, t, n = {}) {
	...
	let a = r ? () => Promise.all(Yr(e, r, n)) : () => Promise.resolve(), o = e.variantChildren && e.variantChildren.size ? (r = 0) => {
		let { delayChildren: a = 0, staggerChildren: o, staggerDirection: s } = i;
		return Zr(e, t, r, a, o, s, n);
...
function Zr(e, t, n = 0, r = 0, i = 0, a = 1, o) {
	let s = [];
	for (let c of e.variantChildren) c.notify("AnimationStart", t), s.push(Xr(c, t, {
		...o,
		delay: n + (typeof r == "function" ? 0 : r) + _r(e.variantChildren, c, r, i, a)
...
function Qr(e, t, n = {}) {
	...
	let r;
	if (Array.isArray(t)) {
		let i = t.map((t) => Xr(e, t, n));
		r = Promise.all(i);
	} else if (typeof t == "string") r = Xr(e, t, n);
	else {
...
function ri(e) {
	return typeof e == "number" ? e === 0 : e === null ? !0 : e === "none" || e === "0" || T(e);
}
//#endregion
...
var oi = /\b([a-z-]*)\(.*?\)/gu, si = {
	...
	getAnimatableNone: (e) => {
		let t = e.match(oi);
		return t ? t.map(ai).join(" ") : e;
	}
}, ci = {
	...L,
	getAnimatableNone: (e) => {
		let t = L.parse(e);
		return L.createTransformer(e)(t.map((e) => typeof e == "number" ? 0 : typeof e == "object" ? {
			...e,
			alpha: 1
		} : e));
	}
	...
	mask: ci,
	WebkitMask: ci
}, fi = (e) => di[e], pi = /* @__PURE__ */ new Set([si, ci]);
function mi(e, t) {
	let n = fi(e);
	return pi.has(n) || (n = L), n.getAnimatableNone ? n.getAnimatableNone(t) : void 0;
}
//#endregion
...
var _i = class extends Bn {
	...
	readKeyframes() {
		...
		if (this.resolveNoneKeyframes(), !Rr.has(n) || e.length !== 2) return;
		let [r, i] = e, a = ni(r), o = ni(i);
		if (ze(r) !== ze(i) && V[n]) {
			this.needsMeasurement = !0;
			return;
		}
		if (a !== o) if (An(a) && An(o)) for (let t = 0; t < e.length; t++) {
			let n = e[t];
	...
	resolveNoneKeyframes() {
		...
		for (let t = 0; t < e.length; t++) (e[t] === null || ri(e[t])) && n.push(t);
		n.length && gi(e, n, t);
	}
	measureInitialState() {
		let { element: e, unresolvedKeyframes: t, name: n } = this;
		if (!e || !e.current) return;
		n === "height" && (this.suspendedScrollY = window.pageYOffset), this.measuredOrigin = V[n](e.measureViewportBox(), window.getComputedStyle(e.current)), t[0] = this.measuredOrigin;
		let r = t[t.length - 1];
	...
	measureEndState() {
		...
		n[i] = V[t](e.measureViewportBox(), window.getComputedStyle(e.current)), a !== null && this.finalKeyframe === void 0 && (this.finalKeyframe = a), this.removedTransforms?.length && this.removedTransforms.forEach(([t, n]) => {
			e.getValue(t).set(n);
...
var bi = (e, t) => t && typeof e == "number" ? t.transform(e) : e;
//#endregion
//#region node_modules/motion-dom/dist/es/utils/is-html-element.mjs
function xi(e) {
	return w(e) && "offsetHeight" in e && !("ownerSVGElement" in e);
}
//#endregion
//#region node_modules/motion-dom/dist/es/frameloop/microtask.mjs
var { schedule: Si, cancel: Ci } = /* @__PURE__ */ Ae(queueMicrotask, !1), K = {
	x: !1,
	y: !1
};
function wi() {
...
function Ei(e, t) {
	let n = yi(e), r = new AbortController();
	return [
		n,
		{
			passive: !0,
...
var ki = (e, t) => t ? e === t ? !0 : ki(e, t.parentElement) : !1, Ai = (e) => e.pointerType === "mouse" ? typeof e.button != "number" || e.button <= 0 : e.isPrimary !== !1, ji = new Set([
	"BUTTON",
	"INPUT",
	"SELECT",
	"TEXTAREA",
...
function Pi(e) {
	return Ni.has(e.tagName) || e.isContentEditable === !0;
}
//#endregion
//#region node_modules/motion-dom/dist/es/gestures/press/utils/state.mjs
var Fi = /* @__PURE__ */ new WeakSet();
//#endregion
...
var Ri = (e, t) => {
	...
	let r = Ii(() => {
		...
		n.addEventListener("keyup", e, t), n.addEventListener("blur", () => Li(n, "cancel"), t);
	});
...
function Vi(e, t, n = {}) {
	let [r, i, a] = Ei(e, n), o = (e) => {
		let r = e.currentTarget;
		if (!zi(e) || Bi.has(e)) return;
		Fi.add(r), n.stopPropagation && Bi.add(e);
		let a = t(r, e), o = {
			...i,
			capture: !0
		}, s = (e, t) => {
			window.removeEventListener("pointerup", c, o), window.removeEventListener("pointercancel", l, o), Fi.has(r) && Fi.delete(r), zi(e) && typeof a == "function" && a(e, { success: t });
		}, c = (e) => {
	...
	return r.forEach((e) => {
		(n.useGlobalTarget ? window : e).addEventListener("pointerdown", o, i), xi(e) && (e.addEventListener("focus", (e) => Ri(e, i)), !Mi(e) && !e.hasAttribute("tabindex") && (e.tabIndex = 0));
	}), a;
}
//#endregion
...
var Ui = /* @__PURE__ */ new WeakMap(), Wi, Gi = (e, t, n) => (r, i) => i && i[0] ? i[0][e + "Size"] : Hi(r) && "getBBox" in r ? r.getBBox()[t] : r[n], Ki = /* @__PURE__ */ Gi("inline", "width", "offsetWidth"), qi = /* @__PURE__ */ Gi("block", "height", "offsetHeight");
function Ji({ target: e, borderBoxSize: t }) {
	Ui.get(e)?.forEach((n) => {
		n(e, {
			get width() {
				return Ki(e, t);
...
function Xi() {
	typeof ResizeObserver > "u" || (Wi = new ResizeObserver(Yi));
}
function Zi(e, t) {
	Wi || Xi();
	let n = yi(e);
	return n.forEach((e) => {
		let n = Ui.get(e);
		n || (n = /* @__PURE__ */ new Set(), Ui.set(e, n)), n.add(t), Wi?.observe(e);
	}), () => {
		n.forEach((e) => {
			let n = Ui.get(e);
			n?.delete(t), n?.size || Wi?.unobserve(e);
		});
	};
}
//#endregion
//#region node_modules/motion-dom/dist/es/resize/handle-window.mjs
var Qi = /* @__PURE__ */ new Set(), $i;
function ea() {
	$i = () => {
		let e = {
			get width() {
...
function ta(e) {
	return Qi.add(e), $i || ea(), () => {
		Qi.delete(e), !Qi.size && typeof $i == "function" && (window.removeEventListener("resize", $i), $i = void 0);
	};
}
//#endregion
//#region node_modules/motion-dom/dist/es/resize/index.mjs
function na(e, t) {
	return typeof e == "function" ? ta(e) : Zi(e, t);
}
//#endregion
...
function ha(e) {
	return da(e.animate) || ma.some((t) => fa(e[t]));
}
function ga(e) {
...
function _a(e, t, n) {
	for (let r in t) {
		...
		else if (G(a)) e.addValue(r, U(i, { owner: e }));
		else if (a !== i) if (e.hasValue(r)) {
			let t = e.getValue(r);
			t.liveStyle === !0 ? t.jump(i) : t.hasAnimated || t.set(i);
		} else {
			let t = e.getStaticValue(r);
			e.addValue(r, U(t === void 0 ? i : t, { owner: e }));
		}
	}
...
var Sa = class {
	...
	constructor({ parent: e, props: t, presenceContext: n, reducedMotionConfig: r, skipAnimations: i, blockInitialAnimation: a, visualState: o }, s = {}) {
		this.current = null, this.children = /* @__PURE__ */ new Set(), this.isVariantNode = !1, this.isControllingVariants = !1, this.shouldReduceMotion = null, this.shouldSkipAnimations = !1, this.values = /* @__PURE__ */ new Map(), this.KeyframeResolver = Bn, this.features = {}, this.valueSubscriptions = /* @__PURE__ */ new Map(), this.prevMotionValues = {}, this.hasBeenMounted = !1, this.events = {}, this.propEventSubscriptions = {}, this.notifyUpdate = () => this.notify("Update", this.latestValues), this.render = () => {
		...
		this.latestValues = c, this.baseTarget = { ...c }, this.initialValues = t.initial ? { ...c } : {}, this.renderState = l, this.parent = e, this.props = t, this.presenceContext = n, this.depth = e ? e.depth + 1 : 0, this.reducedMotionConfig = r, this.skipAnimationsConfig = i, this.options = s, this.blockInitialAnimation = !!a, this.isControllingVariants = ha(t), this.isVariantNode = ga(t), this.isVariantNode && (this.variantChildren = /* @__PURE__ */ new Set()), this.manuallyAnimateOnMount = !!(e && e.current);
	...
	bindToMotionValue(e, t) {
		if (this.valueSubscriptions.has(e) && this.valueSubscriptions.get(e)(), t.accelerate && lr.has(e) && this.current instanceof HTMLElement) {
			let { factory: n, keyframes: r, times: i, ease: a, duration: o } = t.accelerate, s = new $n({
	...
	update(e, t) {
		...
		this.prevMotionValues = _a(this, this.scrapeMotionValuesFromProps(e, this.prevProps || {}, this), this.prevMotionValues), this.handleChildMotionValue && this.handleChildMotionValue();
	}
	getProps() {
		return this.props;
	}
	...
	getValue(e, t) {
		...
		let n = this.values.get(e);
		return n === void 0 && t !== void 0 && (n = U(t === null ? void 0 : t, { owner: this }), this.addValue(e, n)), n;
	}
	readValue(e, t) {
		let n = this.latestValues[e] !== void 0 || !this.current ? this.latestValues[e] : this.getBaseTargetFromProps(this.props, e) ?? this.readValueFromInstance(this.current, e, this.options);
		return n != null && (typeof n == "string" && (C(n) || T(n)) ? n = parseFloat(n) : !oa(n) && L.test(t) && (n = mi(e, t)), this.setBaseTarget(e, G(n) ? n.get() : n)), G(n) ? n.get() : n;
	}
	setBaseTarget(e, t) {
		this.baseTarget[e] = t;
	}
	getBaseTarget(e) {
		...
		if (typeof t == "string" || typeof t == "object") {
			let r = Lr(this.props, t, this.presenceContext?.custom);
			r && (n = r[e]);
		}
	...
	constructor() {
		super(...arguments), this.KeyframeResolver = _i;
	}
...
function ka(e) {
	return Oa(e) || Aa(e) || e.z || e.rotate || e.rotateX || e.rotateY || e.skewX || e.skewY;
}
function Aa(e) {
...
function Na(e, t, n, r, i) {
	return i !== void 0 && (e = Ma(e, i, r)), Ma(e, n, r) + t;
}
function Pa(e, t = 0, n = 1, r, i) {
	e.min = Na(e.min, t, n, r, i), e.max = Na(e.max, t, n, r, i);
}
function Fa(e, { x: t, y: n }) {
	Pa(e.x, t.translate, t.scale, t.originPoint), Pa(e.y, n.translate, n.scale, n.originPoint);
}
var Ia = .999999999999, La = 1.0000000000001;
function Ra(e, t, n, r = !1) {
	...
	for (let s = 0; s < i; s++) {
		...
		i && i.props.style && i.props.style.display === "contents" || (r && a.options.layoutScroll && a.scroll && a !== a.root && (Y(e.x, -a.scroll.offset.x), Y(e.y, -a.scroll.offset.y)), o && (t.x *= o.x.scale, t.y *= o.y.scale, Fa(e, o)), r && ka(a.latestValues) && Va(e, a.latestValues, a.layout?.layoutBox));
	}
	t.x < La && t.x > Ia && (t.x = 1), t.y < La && t.y > Ia && (t.y = 1);
}
function Y(e, t) {
	e.min += t, e.max += t;
}
function za(e, t, n, r, i = .5) {
	Pa(e, t, n, R(e.min, e.max, i), r);
}
function Ba(e, t) {
...
function Va(e, t, n) {
	let r = n ?? e;
	za(e.x, Ba(t.x, r.x), t.scaleX, t.scale, t.originX), za(e.y, Ba(t.y, r.y), t.scaleY, t.scale, t.originY);
}
//#endregion
//#region node_modules/motion-dom/dist/es/projection/utils/measure.mjs
function Ha(e, t) {
	return wa(Ea(e.getBoundingClientRect(), t));
}
function Ua(e, t, n) {
	let r = Ha(e, n), { scroll: i } = t;
...
function Ka(e, t, n) {
	...
	return a && (i = !1, r += `rotate(${bi(a, ui.pathRotation)}) `), r = r.trim(), n ? r = n(t, i ? "" : r) : i && (r = "none"), r;
}
//#endregion
...
function qa(e, t, n) {
	...
	if (t.transform || (o || n ? r.transform = Ka(t, e.transform, n) : r.transform &&= "none"), s) {
...
function Ja(e, { style: t, vars: n }, r, i) {
	let a = e.style, o;
	for (o in t) a[o] = t[o];
...
var Xa = { correct: (e, t) => {
	...
	return `${Ya(e, t.target.x)}% ${Ya(e, t.target.y)}%`;
} }, Za = { correct: (e, { treeScale: t, projectionDelta: n }) => {
	let r = e, i = L.parse(e);
	if (i.length > 5) return r;
	let a = L.createTransformer(e), o = typeof i[0] == "number" ? 0 : 1, s = n.x.scale * t.x, c = n.y.scale * t.y;
	i[0 + o] /= s, i[1 + o] /= c;
	let l = R(s, c, .5);
...
function $a(e, { layout: t, layoutId: n }) {
	return kn.has(e) || e.startsWith("origin") || (t || n !== void 0) && (!!Qa[e] || e === "opacity");
}
//#endregion
...
function eo(e, t, n) {
	...
	if (!r) return a;
	for (let t in r) (G(r[t]) || i && G(i[t]) || $a(t, e) || n?.getValue(t)?.liveStyle !== void 0) && (a[t] = r[t]);
	return a;
}
//#endregion
...
var no = class extends Ca {
	constructor() {
		super(...arguments), this.type = "html", this.renderInstance = Ja;
	}
	mount(e) {
		x(!!e.style, "motion.create() components must forward their ref to a HTML or SVG element", "custom-component-ref"), super.mount(e);
	}
	readValueFromInstance(e, t) {
		if (kn.has(t)) return this.projection?.isProjecting ? wn(t) : En(e, t);
		{
			let n = to(e), r = (Fe(t) ? n.getPropertyValue(t) : n[t]) || 0;
...
function so(e, { attrX: t, attrY: n, attrScale: r, pathLength: i, pathSpacing: a = 1, pathOffset: o = 0, ...s }, c, l, u) {
	if (qa(e, s, l), c) {
	...
	t !== void 0 && (d.x = t), n !== void 0 && (d.y = n), r !== void 0 && (d.scale = r), i !== void 0 && ao(d, i, a, o, !1);
}
//#endregion
...
function uo(e, t, n, r) {
	Ja(e, t, void 0, r);
	for (let n in t.attrs) e.setAttribute(co.has(n) ? n : Gr(n), t.attrs[n]);
}
//#endregion
...
function fo(e, t, n) {
	...
	for (let n in e) if (G(e[n]) || G(t[n])) {
		let t = On.indexOf(n) === -1 ? n : "attr" + n.charAt(0).toUpperCase() + n.substring(1);
		r[t] = e[n];
	}
	return r;
}
...
var po = class extends Ca {
	...
	readValueFromInstance(e, t) {
		...
		return t = co.has(t) ? t : Gr(t), e.getAttribute(t);
	}
	scrapeMotionValuesFromProps(e, t, n) {
		return fo(e, t, n);
	}
	build(e, t, n) {
		so(e, t, this.isSVGTag, n.transformTemplate, n.style);
	}
...
var _o = [...pa].reverse(), vo = pa.length;
function yo(e) {
	return (t) => Promise.all(t.map(({ animation: t, options: n }) => Qr(e, t, n)));
}
function bo(e) {
	let t = yo(e), n = So(), r = !0, i = !1, a = (t) => (n, r) => {
	...
	function s(o) {
		let { props: s } = e, c = ho(e.parent) || {}, l = [], u = /* @__PURE__ */ new Set(), d = {}, f = Infinity;
		for (let t = 0; t < vo; t++) {
			let p = _o[t], m = n[p], h = s[p] === void 0 ? c[p] : s[p], g = fa(h), _ = p === o ? m.isActive : null;
			_ === !1 && (f = t);
			let v = h === c[p] && h !== s[p] && g;
			...
			let y = xo(m.prevProp, h), b = y || p === o && m.isActive && !v && g || t > f && g, x = !1, S = Array.isArray(h) ? h : [h], C = S.reduce(a(p), {});
			_ === !1 && (C = {});
			...
			for (let e in T) {
				...
				let r = !1;
				r = zr(t) && zr(n) ? !go(t, n) || y : t !== n, r ? t == null ? u.add(e) : ee(e) : t !== void 0 && u.has(e) ? ee(e) : m.protectedKeys[e] = !0;
			}
			...
			b && (!E || x) && l.push(...S.map((t) => {
				...
				if (typeof t == "string" && (r || i) && !E && e.manuallyAnimateOnMount && e.parent) {
					...
					if (r.enteringChildren && i) {
						...
						n.delay = _r(r.enteringChildren, e, t);
					}
				}
				return {
					animation: t,
...
function xo(e, t) {
	return typeof t == "string" ? t !== e : Array.isArray(t) ? !go(t, e) : !1;
}
function X(e = !1) {
	return {
		isActive: e,
...
var To = .9999, Eo = 1.0001, Do = -.01, Oo = .01;
function Q(e) {
	return e.max - e.min;
}
function ko(e, t, n) {
...
function Ao(e, t, n, r = .5) {
	e.origin = r, e.originPoint = R(t.min, t.max, e.origin), e.scale = Q(n) / Q(t), e.translate = R(n.min, n.max, e.origin) - e.originPoint, (e.scale >= To && e.scale <= Eo || isNaN(e.scale)) && (e.scale = 1), (e.translate >= Do && e.translate <= Oo || isNaN(e.translate)) && (e.translate = 0);
}
function jo(e, t, n, r) {
	Ao(e.x, t.x, n.x, r ? r.originX : void 0), Ao(e.y, t.y, n.y, r ? r.originY : void 0);
}
function Mo(e, t, n, r = 0) {
	e.min = (r ? R(n.min, n.max, r) : n.min) + t.min, e.max = e.min + Q(t);
}
function No(e, t, n, r) {
	Mo(e.x, t.x, n.x, r?.x), Mo(e.y, t.y, n.y, r?.y);
}
...
function Fo(e, t, n, r) {
	Po(e.x, t.x, n.x, r?.x), Po(e.y, t.y, n.y, r?.y);
}
//#endregion
//#region node_modules/motion-dom/dist/es/projection/geometry/delta-remove.mjs
function Io(e, t, n, r, i) {
	return e -= t, e = Ma(e, 1 / n, r), i !== void 0 && (e = Ma(e, 1 / i, r)), e;
}
function Lo(e, t = 0, n = 1, r = .5, i, a = e, o = e) {
	if (P.test(t) && (t = parseFloat(t), t = R(o.min, o.max, t / 100) - o.min), typeof t != "number") return;
	let s = R(a.min, a.max, r);
	e === a && (s -= t), e.min = Io(e.min, t, n, s, i), e.max = Io(e.max, t, n, s, i);
}
function Ro(e, t, [n, r, i], a, o) {
	Lo(e, t[n], t[r], t[i], t.scale, a, o);
}
var zo = [
	"x",
	"scaleX",
...
function Vo(e, t, n, r) {
	Ro(e.x, t, zo, n ? n.x : void 0, r ? r.x : void 0), Ro(e.y, t, Bo, n ? n.y : void 0, r ? r.y : void 0);
}
//#endregion
...
var Zo = vi.length, Qo = (e) => typeof e == "string" ? parseFloat(e) : e, $o = (e) => typeof e == "number" || F.test(e);
function es(e, t, n, r, i, a) {
	i ? (e.opacity = R(0, n.opacity ?? 1, ns(r)), e.opacityExit = R(t.opacity ?? 1, 0, rs(r))) : a && (e.opacity = R(t.opacity ?? 1, n.opacity ?? 1, r));
	for (let i = 0; i < Zo; i++) {
		let a = vi[i], o = ts(t, a), s = ts(n, a);
		o === void 0 && s === void 0 || (o ||= 0, s ||= 0, o === 0 || s === 0 || $o(o) === $o(s) ? (e[a] = Math.max(R(Qo(o), Qo(s), r), 0), (P.test(s) || P.test(o)) && (e[a] += "%")) : e[a] = s);
	}
...
var ns = /* @__PURE__ */ is(0, .5, _e), rs = /* @__PURE__ */ is(.5, .95, E);
function is(e, t, n) {
	return (r) => r < e ? 0 : r > t ? 1 : n(/* @__PURE__ */ ne(e, t, r));
}
//#endregion
...
function ls(e, t) {
	let n = M.now(), r = ({ timestamp: i }) => {
		let a = i - n;
		a >= t && (A(r), e(a - t));
	};
	return k.setup(r, !0), () => A(r);
}
//#endregion
...
function ys({ attachResizeListener: e, defaultParent: t, measureScroll: n, checkIsScrollRoot: r, resetTransform: i }) {
	return class {
		constructor(e = {}, n = t?.()) {
			this.id = gs++, this.animationId = 0, this.animationCommitId = 0, this.children = /* @__PURE__ */ new Set(), this.options = {}, this.isTreeAnimating = !1, this.isAnimationBlocked = !1, this.isLayoutDirty = !1, this.isProjectionDirty = !1, this.isSharedProjectionDirty = !1, this.isTransformDirty = !1, this.updateManuallyBlocked = !1, this.updateBlockedByResize = !1, this.isUpdating = !1, this.isSVG = !1, this.needsReset = !1, this.shouldResetTransform = !1, this.hasCheckedOptimisedAppear = !1, this.treeScale = {
				...
				this.projectionUpdateScheduled = !1, ra.value && (ps.nodes = ps.calculatedTargetDeltas = ps.calculatedProjections = 0), this.nodes.forEach(Ss), this.nodes.forEach(js), this.nodes.forEach(Ms), this.nodes.forEach(Cs), ra.addProjectionMetrics && ra.addProjectionMetrics(ps);
		...
		mount(t) {
			...
			this.isSVG = Hi(t) && !ia(t), this.instance = t;
			...
			if (i && !i.current && i.mount(t), this.root.nodes.add(this), this.parent && this.parent.children.add(this), this.root.hasTreeAnimated && (r || n) && (this.isLayoutDirty = !0), e) {
				...
				k.read(() => {
					...
					e !== r && (r = e, this.root.updateBlockedByResize = !0, n && n(), n = ls(i, 250), fs.hasAnimatedSinceResize && (fs.hasAnimatedSinceResize = !1, this.nodes.forEach(As)));
				});
			}
			n && this.root.registerSharedNode(n, this), this.options.animate !== !1 && i && (n || r) && this.addEventListener("didUpdate", ({ delta: e, hasLayoutChanged: t, hasRelativeLayoutChanged: n, layout: r }) => {
				...
				let a = this.options.transition || i.getDefaultTransition() || zs, { onLayoutAnimationStart: o, onLayoutAnimationComplete: s } = i.getProps(), c = !this.targetLayout || !qo(this.targetLayout, r), l = !t && n;
				...
				} else t || As(this), this.isLead() && this.options.onExitComplete && this.options.onExitComplete();
				this.targetLayout = r;
			});
		}
		unmount() {
			...
			let e = this.getStack();
			e && e.remove(this), this.parent && this.parent.children.delete(this), this.instance = void 0, this.eventHandlers.clear(), A(this.updateProjection);
		}
		blockUpdate() {
		...
		update() {
			if (this.updateScheduled = !1, this.isUpdateBlocked()) {
				...
				this.unblockUpdate(), this.updateBlockedByResize = !1, this.clearAllSnapshots(), e && this.nodes.forEach(Es), this.nodes.forEach(Ts);
				return;
			}
			...
			this.animationCommitId = this.animationId, this.isUpdating ? (this.isUpdating = !1, this.nodes.forEach(Os), this.nodes.forEach(ks), this.nodes.forEach(bs), this.nodes.forEach(xs)) : this.nodes.forEach(Ds), this.clearAllSnapshots();
			let e = M.now();
			j.delta = y(0, 1e3 / 60, e - j.timestamp), j.timestamp = e, j.isProcessing = !0, je.update.process(j), je.preRender.process(j), je.render.process(j), j.isProcessing = !1;
		}
		didUpdate() {
			this.updateScheduled || (this.updateScheduled = !0, Si.read(this.scheduleUpdate));
		}
		clearAllSnapshots() {
			this.nodes.forEach(ws), this.sharedNodes.forEach(Ps);
		}
		...
		resetTransform() {
			if (!i) return;
			let e = this.isLayoutDirty || this.shouldResetTransform || this.options.alwaysMeasureLayout, t = this.projectionDelta && !Uo(this.projectionDelta), n = this.getTransformTemplate(), r = n ? n(this.latestValues, "") : void 0, a = r !== this.prevTransformTemplateValue;
		...
		measure(e = !0) {
			...
			return e && (n = this.removeTransform(n)), Us(n), {
				animationId: this.root.animationId,
				measuredBox: t,
				layoutBox: n,
				latestValues: {},
		...
		measurePageBox() {
			...
			if (!(this.scroll?.wasRoot || this.path.some(Gs))) {
		...
		removeElementScroll(e) {
			...
			for (let n = 0; n < this.path.length; n++) {
				...
				r !== this.root && i && a.layoutScroll && (i.wasRoot && Z(t, e), Y(t.x, i.offset.x), Y(t.y, i.offset.y));
			}
			return t;
		}
		applyTransform(e, t = !1, n) {
			...
			for (let e = 0; e < this.path.length; e++) {
				let n = this.path[e];
				!t && n.options.layoutScroll && n.scroll && n !== n.root && (Y(r.x, -n.scroll.offset.x), Y(r.y, -n.scroll.offset.y)), ka(n.latestValues) && Va(r, n.latestValues, n.layout?.layoutBox);
			}
			return ka(this.latestValues) && Va(r, this.latestValues, this.layout?.layoutBox), r;
		}
		removeTransform(e) {
			let t = q();
			Z(t, e);
			for (let e = 0; e < this.path.length; e++) {
				...
				let r;
				n.instance && (Oa(n.latestValues) && n.updateSnapshot(), r = q(), Z(r, n.measurePageBox())), Vo(t, n.latestValues, n.snapshot?.layoutBox, r);
			}
			return ka(this.latestValues) && Vo(t, this.latestValues), t;
		}
		setTargetDelta(e) {
		...
		resolveTargetDelta(e = !1) {
			...
			a && this.linkedParentVersion !== a.layoutVersion && !a.options.layoutRoot && this.removeRelativeTarget(), !this.targetDelta && !this.relativeTarget && (this.options.layoutAnchor !== !1 && a && a.layout ? this.createRelativeTarget(a, this.layout.layoutBox, a.layout.layoutBox) : this.removeRelativeTarget()), !(!this.relativeTarget && !this.targetDelta) && (this.target || (this.target = q(), this.targetWithTransforms = q()), this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target ? (this.forceRelativeParentToResolveTarget(), No(this.target, this.relativeTarget, this.relativeParent.target, this.options.layoutAnchor || void 0)) : this.targetDelta ? (this.resumingFrom ? this.applyTransform(this.layout.layoutBox, !1, this.target) : Z(this.target, this.layout.layoutBox), Fa(this.target, this.targetDelta)) : Z(this.target, this.layout.layoutBox), this.attemptToResolveRelativeTarget && (this.attemptToResolveRelativeTarget = !1, this.options.layoutAnchor !== !1 && a && !!a.resumingFrom == !!this.resumingFrom && !a.options.layoutScroll && a.target && this.animationProgress !== 1 ? this.createRelativeTarget(a, this.target, a.target) : this.relativeParent = this.relativeTarget = void 0), ra.value && ps.calculatedTargetDeltas++);
		}
		getClosestProjectingParent() {
			if (!(!this.parent || Oa(this.parent.latestValues) || Aa(this.parent.latestValues))) return this.parent.isProjecting() ? this.parent : this.parent.getClosestProjectingParent();
		}
		isProjecting() {
			return !!((this.relativeTarget || this.targetDelta || this.options.layoutRoot) && this.layout);
		}
		createRelativeTarget(e, t, n) {
			this.relativeParent = e, this.linkedParentVersion = e.layoutVersion, this.forceRelativeParentToResolveTarget(), this.relativeTarget = q(), this.relativeTargetOrigin = q(), Fo(this.relativeTargetOrigin, t, n, this.options.layoutAnchor || void 0), Z(this.relativeTarget, this.relativeTargetOrigin);
		}
		...
		calcProjection() {
			...
			if ((this.isProjectionDirty || this.parent?.isProjectionDirty) && (n = !1), t && (this.isSharedProjectionDirty || this.isTransformDirty) && (n = !1), this.resolvedRelativeTargetAt === j.timestamp && (n = !1), n) return;
			let { layout: r, layoutId: i } = this.options;
			...
			Ra(this.layoutCorrected, this.treeScale, this.path, t), e.layout && !e.target && (this.treeScale.x !== 1 || this.treeScale.y !== 1) && (e.target = e.layout.layoutBox, e.targetWithTransforms = q());
			let { target: s } = e;
			if (!s) {
				this.prevProjectionDelta && (this.createProjectionDeltas(), this.scheduleRender());
				return;
			}
			!this.projectionDelta || !this.prevProjectionDelta ? this.createProjectionDeltas() : (wo(this.prevProjectionDelta.x, this.projectionDelta.x), wo(this.prevProjectionDelta.y, this.projectionDelta.y)), jo(this.projectionDelta, this.layoutCorrected, s, this.latestValues), (this.treeScale.x !== a || this.treeScale.y !== o || !Yo(this.projectionDelta.x, this.prevProjectionDelta.x) || !Yo(this.projectionDelta.y, this.prevProjectionDelta.y)) && (this.hasProjected = !0, this.scheduleRender(), this.notifyListeners("projectionUpdate", s)), ra.value && ps.calculatedProjections++;
		}
		hide() {
			this.isVisible = !1;
		}
		...
		setAnimationOrigin(e, t = !1, n) {
			let r = this.snapshot, i = r ? r.latestValues : {}, a = { ...this.latestValues }, o = ca();
			(!this.relativeParent || !this.relativeParent.options.layoutRoot) && (this.relativeTarget = this.relativeTargetOrigin = void 0), this.attemptToResolveRelativeTarget = !t;
			let s = q(), c = (r ? r.source : void 0) !== (this.layout ? this.layout.source : void 0), l = this.getStack(), u = !l || l.members.length <= 1, d = !!(c && !u && this.options.crossfade === !0 && !this.path.some(Rs));
			this.animationProgress = 0;
			let f, p = n?.interpolateProjection(e);
			this.mixTargetDelta = (t) => {
				let n = t / 1e3, r = p?.(n);
				r ? (o.x.translate = r.x, o.x.scale = R(e.x.scale, 1, n), o.x.origin = e.x.origin, o.x.originPoint = e.x.originPoint, o.y.translate = r.y, o.y.scale = R(e.y.scale, 1, n), o.y.origin = e.y.origin, o.y.originPoint = e.y.originPoint) : (Fs(o.x, e.x, n), Fs(o.y, e.y, n)), this.setTargetDelta(o), this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout && (Fo(s, this.layout.layoutBox, this.relativeParent.layout.layoutBox, this.options.layoutAnchor || void 0), Ls(this.relativeTarget, this.relativeTargetOrigin, s, n), f && Go(this.relativeTarget, f) && (this.isProjectionDirty = !1), f ||= q(), Z(f, this.relativeTarget)), c && (this.animationValues = a, es(a, i, this.latestValues, n, d, u)), r && r.rotate !== void 0 && (this.animationValues ||= a, this.animationValues.pathRotation = r.rotate), this.root.scheduleUpdateProjection(), this.scheduleRender(), this.animationProgress = n;
			}, this.mixTargetDelta(this.options.layoutRoot ? 1e3 : 0);
		}
		startAnimation(e) {
			this.notifyListeners("animationStart"), this.currentAnimation?.stop(), this.resumingFrom?.currentAnimation?.stop(), this.pendingAnimation &&= (A(this.pendingAnimation), void 0), this.pendingAnimation = k.update(() => {
				fs.hasAnimatedSinceResize = !0, this.motionValue ||= U(0), this.motionValue.jump(0, !1), this.currentAnimation = as(this.motionValue, [0, 1e3], {
					...e,
					velocity: 0,
					isSync: !0,
					onUpdate: (t) => {
		...
		applyTransformsToTarget() {
			...
			if (!(!t || !n || !r)) {
				...
				Z(t, n), Va(t, i), jo(this.projectionDeltaWithTransform, this.layoutCorrected, t, i);
			}
		}
		...
		resetSkewAndRotation() {
			...
			let r = {};
			n.z && _s("z", e, r, this.animationValues);
			for (let t = 0; t < ms.length; t++) _s(`rotate${ms[t]}`, e, r, this.animationValues), _s(`skew${ms[t]}`, e, r, this.animationValues);
			e.render();
		...
		applyProjectionStyles(e, t) {
			...
			if (this.needsReset) {
				this.needsReset = !1, e.visibility = "", e.opacity = "", e.pointerEvents = us(t?.pointerEvents) || "", e.transform = n ? n(this.latestValues, "") : "none";
				return;
			}
			let r = this.getLead();
			if (!this.projectionDelta || !this.layout || !r.target) {
				this.options.layoutId && (e.opacity = this.latestValues.opacity === void 0 ? 1 : this.latestValues.opacity, e.pointerEvents = us(t?.pointerEvents) || ""), this.hasProjected && !ka(this.latestValues) && (e.transform = n ? n({}, "") : "none", this.hasProjected = !1);
				return;
			}
			e.visibility = "";
			let i = r.animationValues || r.latestValues;
			this.applyTransformsToTarget();
			let a = Xo(this.projectionDeltaWithTransform, this.treeScale, i);
			...
			for (let t in Qa) {
				...
				let { correct: n, applyTo: o, isCSSVariable: s } = Qa[t], c = a === "none" ? i[t] : n(i[t], r);
				if (o) {
					let t = o.length;
					for (let n = 0; n < t; n++) e[o[n]] = c;
				} else s ? this.options.visualElement.renderState.vars[t] = c : e[t] = c;
			}
			this.options.layoutId && (e.pointerEvents = r === this ? us(t?.pointerEvents) || "" : "none");
		}
		clearSnapshot() {
			this.resumeFrom = this.snapshot = void 0;
		}
		resetTree() {
			this.root.nodes.forEach((e) => e.currentAnimation?.stop()), this.root.nodes.forEach(Ts), this.root.sharedNodes.clear();
		}
	};
}
function bs(e) {
...
function xs(e) {
	...
	if (e.isLead() && e.layout && t && e.hasListeners("didUpdate")) {
		...
		if (i === "size") $((e) => {
			...
			let e = i === "x" ? "y" : "x";
			Co(a ? t.measuredBox[e] : t.layoutBox[e], n[e]);
		} else Ws(i, t.layoutBox, n) && $((r) => {
		...
		if (!e.resumeFrom) {
			...
			if (r && !r.resumeFrom) {
				...
				if (i && a) {
					...
					Fo(s, t.layoutBox, i.layoutBox, o);
					let c = q();
					Fo(c, n, a.layoutBox, o), qo(s, c) || (l = !0), r.options.layoutRoot && (e.relativeTarget = c, e.relativeTargetOrigin = s, e.relativeParent = r);
				}
			}
		}
...
function Ss(e) {
	ra.value && ps.nodes++, e.parent && (e.isProjecting() || (e.isProjectionDirty = e.parent.isProjectionDirty), e.isSharedProjectionDirty ||= !!(e.isProjectionDirty || e.parent.isProjectionDirty || e.parent.isSharedProjectionDirty), e.isTransformDirty ||= e.parent.isTransformDirty);
}
function Cs(e) {
...
function Ls(e, t, n, r) {
	Is(e.x, t.x, n.x, r), Is(e.y, t.y, n.y, r);
}
function Rs(e) {
...
}, Bs = (e) => typeof navigator < "u" && navigator.userAgent && navigator.userAgent.toLowerCase().includes(e), Vs = Bs("applewebkit/") && !Bs("chrome/") ? Math.round : E;
function Hs(e) {
	e.min = Vs(e.min), e.max = Vs(e.max);
}
function Us(e) {
	Hs(e.x), Hs(e.y);
}
function Ws(e, t, n) {
	return e === "position" || e === "preserve-aspect" && !ko(Jo(t), Jo(n), .2);
}
function Gs(e) {
	...
	return (t) => {
		...
		if (n) return () => {
			for (let t = 0; t < r.length; t++) {
				let n = r[t];
				typeof n == "function" ? n() : Xs(e[t], null);
			}
		};
	};
}
function Qs(...e) {
	return f.useCallback(Zs(...e), e);
}
//#endregion
//#region node_modules/framer-motion/dist/es/components/AnimatePresence/PopChild.mjs
var $s = class extends f.Component {
	getSnapshotBeforeUpdate(e) {
		let t = this.props.childRef.current;
		if (xi(t) && e.isPresent && !this.props.isPresent && this.props.pop !== !1) {
			let e = t.offsetParent, n = xi(e) && e.offsetWidth || 0, r = xi(e) && e.offsetHeight || 0, i = getComputedStyle(t), a = this.props.sizeRef.current;
...
function ec({ children: e, isPresent: t, anchorX: n, anchorY: r, root: i, pop: a }) {
	let o = (0, f.useId)(), s = (0, f.useRef)(null), c = (0, f.useRef)({
		width: 0,
		height: 0,
		top: 0,
		left: 0,
		...
		bottom: 0,
		direction: "ltr"
	}), { nonce: l } = (0, f.useContext)(Ys), u = Qs(s, a === !1 ? void 0 : e.props?.ref ?? e?.ref);
...
var tc = ({ children: e, initial: t, isPresent: n, onExitComplete: r, custom: i, presenceAffectsLayout: a, mode: o, anchorX: s, anchorY: c, root: l }) => {
	let u = m(nc), p = (0, f.useId)(), _ = (0, f.useRef)(n), v = (0, f.useRef)(r);
	h(() => {
		_.current = n, v.current = r;
	});
	let y = !0, b = (0, f.useMemo)(() => (y = !1, {
		id: p,
		initial: t,
		isPresent: n,
		custom: i,
		...
		register: (e) => (u.set(e, !1), () => {
			u.delete(e), !_.current && !u.size && v.current?.();
		})
	}), [
		n,
		u,
...
function rc(e = !0) {
	let t = (0, f.useContext)(g);
	if (t === null) return [!0, null];
	let { isPresent: n, onExitComplete: r, register: i } = t, a = (0, f.useId)();
	(0, f.useEffect)(() => {
		if (e) return i(a);
	}, [e]);
	let o = (0, f.useCallback)(() => e && r && r(a), [
		a,
		r,
		e
	]);
...
var oc = ({ children: e, custom: t, initial: n = !0, onExitComplete: r, presenceAffectsLayout: i = !0, mode: a = "sync", propagate: o = !1, anchorX: s = "left", anchorY: c = "top", root: l }) => {
	let [u, g] = rc(o), _ = (0, f.useMemo)(() => ac(e), [e]), v = o && !u ? [] : _.map(ic), y = (0, f.useRef)(!0), b = (0, f.useRef)(_), x = m(() => /* @__PURE__ */ new Map()), S = (0, f.useRef)(/* @__PURE__ */ new Set()), [C, w] = (0, f.useState)(_), [T, ee] = (0, f.useState)(_);
	h(() => {
		y.current = !1, b.current = _;
		for (let e = 0; e < T.length; e++) {
			let t = ic(T[e]);
			v.includes(t) ? (x.delete(t), S.current.delete(t)) : x.get(t) !== !0 && x.set(t, !1);
		}
	}, [
		T,
		v.length,
	...
	if (_ !== C) {
		...
		for (let t = 0; t < T.length; t++) {
			let n = T[t], r = ic(n);
			v.includes(r) || (e.splice(t, 0, n), E.push(n));
		}
		return a === "wait" && E.length && (e = E), ee(ac(e)), w(_), null;
	}
	process.env.NODE_ENV !== "production" && a === "wait" && T.length > 1 && console.warn("You're attempting to animate multiple children within AnimatePresence, but its mode is set to \"wait\". This will lead to odd visual behaviour.");
	let { forceRender: te } = (0, f.useContext)(p);
	return (0, d.jsx)(d.Fragment, { children: T.map((e) => {
		let f = ic(e), p = o && !u ? !1 : _ === T || v.includes(f);
		return (0, d.jsx)(tc, {
			isPresent: p,
			...
			mode: a,
			root: l,
			onExitComplete: p ? void 0 : () => {
				if (S.current.has(f)) return;
				if (x.has(f)) S.current.add(f), x.set(f, !0);
				else return;
				let e = !0;
				x.forEach((t) => {
					t || (e = !1);
				}), e && (te?.(), ee(b.current), o && g?.(), r && r());
			},
			anchorX: s,
			anchorY: c,
			children: e
...
}, sc = (0, f.createContext)({ strict: !1 }), cc = {
	animation: [
		"animate",
		"variants",
		"whileHover",
...
function uc() {
	if (lc) return;
	let e = {};
	for (let t in cc) e[t] = { isEnabled: (e) => cc[t].some((t) => !!e[t]) };
	ba(e), lc = !0;
}
function dc() {
	return uc(), xa();
...
var hc = /* @__PURE__ */ t({ default: () => gc }), gc, _c = r((() => {
	throw gc = {}, Error("Could not resolve \"@emotion/is-prop-valid\" imported by \"framer-motion\". Is it installed?");
})), vc = (e) => !mc(e);
function yc(e) {
	typeof e == "function" && (vc = (t) => t.startsWith("on") ? !mc(t) : e(t));
}
try {
	yc((_c(), e(hc)).default);
} catch {}
function bc(e, t, n) {
	let r = {};
	for (let i in e) i === "values" && typeof e.values == "object" || G(e[i]) || (vc(i) || n === !0 && mc(i) || !t && !mc(i) || e.draggable && i.startsWith("onDrag")) && (r[i] = e[i]);
	return r;
}
//#endregion
//#region node_modules/framer-motion/dist/es/context/MotionContext/index.mjs
var xc = /* @__PURE__ */ (0, f.createContext)({});
//#endregion
...
function Cc(e) {
	let { initial: t, animate: n } = Sc(e, (0, f.useContext)(xc));
	return (0, f.useMemo)(() => ({
		initial: t,
		animate: n
	}), [wc(t), wc(n)]);
...
function Ec(e, t, n) {
	for (let r in t) !G(t[r]) && !$a(r, n) && (e[r] = t[r]);
}
...
function Oc(e, t) {
	let n = e.style || {}, r = {};
	return Ec(r, n, e), Object.assign(r, Dc(e, t)), r;
}
function kc(e, t) {
	let n = {}, r = Oc(e, t);
...
function jc(e, t, n, r) {
	let i = (0, f.useMemo)(() => {
		let n = Ac();
		return so(n, t, lo(r), e.transformTemplate, e.style), {
			...n.attrs,
			style: { ...n.style }
		};
	}, [t]);
...
function Nc(e) {
	return typeof e != "string" || e.includes("-") ? !1 : !!(Mc.indexOf(e) > -1 || /[A-Z]/u.test(e));
}
//#endregion
//#region node_modules/framer-motion/dist/es/render/dom/use-render.mjs
function Pc(e, t, n, { latestValues: r }, i, a = !1, o) {
	let s = (o ?? Nc(e) ? jc : kc)(t, r, i, e), c = bc(t, typeof e == "string", a), l = e === f.Fragment ? {} : {
		...c,
		...s,
		ref: n
	}, { children: u } = t, d = (0, f.useMemo)(() => G(u) ? u.get() : u, [u]);
	return (0, f.createElement)(e, {
		...l,
		children: d
	});
}
...
function Fc({ scrapeMotionValuesFromProps: e, createRenderState: t }, n, r, i) {
	return {
		latestValues: Ic(n, r, i, e),
		renderState: t()
	};
}
function Ic(e, t, n, r) {
	let i = {}, a = r(e, {});
	for (let e in a) i[e] = us(a[e]);
	let { initial: o, animate: s } = e, c = ha(e), l = ga(e);
...
var Lc = (e) => (t, n) => {
	let r = (0, f.useContext)(xc), i = (0, f.useContext)(g), a = () => Fc(e, t, r, i);
	return n ? a() : m(a);
}, Rc = /* @__PURE__ */ Lc({
...
}), Bc = Symbol.for("motionComponentSymbol");
//#endregion
...
function Wc(e, t, n, r, i, a) {
	let { visualElement: o } = (0, f.useContext)(xc), s = (0, f.useContext)(sc), c = (0, f.useContext)(g), l = (0, f.useContext)(Ys), u = l.reducedMotion, d = l.skipAnimations, p = (0, f.useRef)(null), m = (0, f.useRef)(!1);
	r ||= s.renderer, !p.current && r && (p.current = r(e, {
		visualState: t,
		parent: o,
		props: n,
		presenceContext: c,
	...
	let _ = p.current, v = (0, f.useContext)(Hc);
	_ && !_.projection && i && (_.type === "html" || _.type === "svg") && Gc(p.current, n, i, v);
	let y = (0, f.useRef)(!1);
	(0, f.useInsertionEffect)(() => {
		_ && y.current && _.update(n, c);
	});
	let b = n[Kr], x = (0, f.useRef)(!!b && typeof window < "u" && !window.MotionHandoffIsComplete?.(b) && window.MotionHasOptimisedAnimation?.(b));
	return h(() => {
		m.current = !0, _ && (y.current = !0, window.MotionIsMounted = !0, _.updateFeatures(), _.scheduleRenderMicrotask(), x.current && _.animationState && _.animationState.animateChanges());
	}), (0, f.useEffect)(() => {
...
function Kc(e) {
	if (e) return e.options.allowProjection === !1 ? Kc(e.parent) : e.projection;
}
//#endregion
//#region node_modules/framer-motion/dist/es/motion/index.mjs
function qc(e, { forwardMotionProps: t = !1, type: n } = {}, r, i) {
	r && fc(r);
	let a = n ? n === "svg" : Nc(e), o = a ? zc : Rc;
	function s(n, s) {
		let c, l = {
			...(0, f.useContext)(Ys),
			...n,
			layoutId: Jc(n)
		}, { isStatic: u } = l, p = Cc(n), m = o(n, u);
		if (!u && typeof window < "u") {
			Yc(l, r);
			let t = Xc(l);
			c = t.MeasureLayout, p.visualElement = Wc(e, m, l, i, t.ProjectionNode, a);
		}
		return (0, d.jsxs)(xc.Provider, {
			value: p,
			children: [c && p.visualElement ? (0, d.jsx)(c, {
				visualElement: p.visualElement,
				...l
			}) : null, Pc(e, n, Vc(m, p.visualElement, s), m, u, t, a)]
		});
	}
	s.displayName = `motion.${typeof e == "string" ? e : `create(${e.displayName ?? e.name ?? ""})`}`;
	let c = (0, f.forwardRef)(s);
	return c[Bc] = e, c;
}
function Jc({ layoutId: e }) {
	let t = (0, f.useContext)(p).id;
	return t && e !== void 0 ? t + "-" + e : e;
}
function Yc(e, t) {
	let n = (0, f.useContext)(sc).strict;
	if (process.env.NODE_ENV !== "production" && t && n) {
		...
		e.ignoreStrict ? b(!1, t, "lazy-strict-mode") : x(!1, t, "lazy-strict-mode");
	}
}
function Xc(e) {
...
function Zc(e, t) {
	...
	return new Proxy((e, t) => (process.env.NODE_ENV !== "production" && s(!1, "motion() is deprecated. Use motion.create() instead."), r(e, t)), { get: (i, a) => a === "create" ? r : (n.has(a) || n.set(a, qc(a, void 0, e, t)), n.get(a)) });
}
//#endregion
//#region node_modules/framer-motion/dist/es/render/dom/create-visual-element.mjs
var Qc = (e, t) => t.isSVG ?? Nc(e) ? new po(t) : new no(t, { allowProjection: e !== f.Fragment }), $c = class extends J {
	constructor(e) {
		super(e), e.animationState ||= bo(e);
	}
	...
	exit: { Feature: class extends J {
		constructor() {
			super(...arguments), this.id = el++, this.isExitComplete = !1;
		}
		update() {
...
var cl = /* @__PURE__ */ new Set(["auto", "scroll"]), ll = class {
	constructor(e, t, { transformPagePoint: n, contextWindow: r = window, dragSnapToOrigin: i = !1, distanceThreshold: a = 3, element: o } = {}) {
		if (this.startEvent = null, this.lastMoveEvent = null, this.lastMoveEventInfo = null, this.lastRawMoveEventInfo = null, this.handlers = {}, this.contextWindow = window, this.scrollPositions = /* @__PURE__ */ new Map(), this.removeScrollListeners = null, this.onElementScroll = (e) => {
			...
			this.lastRawMoveEventInfo && (this.lastMoveEventInfo = ul(this.lastRawMoveEventInfo, this.transformPagePoint));
			let e = fl(this.lastMoveEventInfo, this.history), t = this.startEvent !== null, n = sl(e.offset, {
				x: 0,
				y: 0
			}) >= this.distanceThreshold;
			if (!t && !n) return;
			let { point: r } = e, { timestamp: i } = j;
			this.history.push({
				...r,
				timestamp: i
			});
			...
			this.lastMoveEvent = e, this.lastRawMoveEventInfo = t, this.lastMoveEventInfo = ul(t, this.transformPagePoint), k.update(this.updatePoint, !0);
		}, this.handlePointerUp = (e, t) => {
			this.end();
			let { onEnd: n, onSessionEnd: r, resumeAnimation: i } = this.handlers;
			if ((this.dragSnapToOrigin || !this.startEvent) && i && i(), !(this.lastMoveEvent && this.lastMoveEventInfo)) return;
			let a = fl(e.type === "pointercancel" ? this.lastMoveEventInfo : ul(t, this.transformPagePoint), this.history);
		...
		let s = ul(nl(e), this.transformPagePoint), { point: c } = s, { timestamp: l } = j;
		this.history = [{
			...c,
			timestamp: l
		}];
		let { onSessionStart: u } = t;
		u && u(e, fl(s, this.history));
		let d = {
			passive: !0,
			capture: !0
		};
		this.removeListeners = te(il(this.contextWindow, "pointermove", this.handlePointerMove, d), il(this.contextWindow, "pointerup", this.handlePointerUp, d), il(this.contextWindow, "pointercancel", this.handlePointerUp, d)), o && this.startScrollTracking(o);
	}
	startScrollTracking(e) {
		let t = e.parentElement;
		for (; t;) {
			let e = getComputedStyle(t);
			(cl.has(e.overflowX) || cl.has(e.overflowY)) && this.scrollPositions.set(t, {
				x: t.scrollLeft,
				y: t.scrollTop
			}), t = t.parentElement;
		}
...
function hl(e, t) {
	...
	let n = e.length - 1, r = null, i = ml(e);
...
function vl(e, { top: t, left: n, bottom: r, right: i }) {
	return {
		x: _l(e.x, n, i),
		y: _l(e.y, t, r)
	};
...
function xl(e, t) {
	let n = .5, r = Q(e), i = Q(t);
	return i > r ? n = /* @__PURE__ */ ne(t.min, t.max - r, e.min) : r > i && (n = /* @__PURE__ */ ne(e.min, e.max - i, t.min)), y(0, 1, n);
}
function Sl(e, t) {
	let n = {};
...
var Dl = /* @__PURE__ */ new WeakMap(), Ol = class {
	constructor(e) {
	...
	start(e, { snapToCursor: t = !1, distanceThreshold: n } = {}) {
		...
		let i = (e) => {
			t && this.snapToCursor(nl(e).point), this.stopAnimation();
		}, a = (e, t) => {
			let { drag: n, dragPropagation: r, onDragStart: i } = this.getProps();
			if (n && !r && (this.openDragLock && this.openDragLock(), this.openDragLock = Ti(n), !this.openDragLock)) return;
			...
			}), i && k.update(() => i(e, t), !1, !0), Wr(this.visualElement, "transform");
			...
			if (r && this.currentDirection === null) {
				this.currentDirection = Ml(o), this.currentDirection !== null && i && i(this.currentDirection);
				return;
			}
	...
	updateAxis(e, t, n) {
		...
		if (!n || !jl(e, r, this.currentDirection)) return;
		let i = this.getAxisMotionValue(e), a = this.originPoint[e] + n[e];
		this.constraints && this.constraints[e] && (a = gl(a, this.constraints[e], this.elastic[e])), i.set(a);
	}
	resolveConstraints() {
		...
		e && Uc(e) ? this.constraints ||= this.resolveRefConstraints() : e && n ? this.constraints = vl(n.layoutBox, e) : this.constraints = !1, this.elastic = wl(t), r !== this.constraints && !Uc(e) && n && this.constraints && !this.hasMutatedConstraints && $((e) => {
			this.constraints !== !1 && this.getAxisMotionValue(e) && (this.constraints[e] = Sl(n.layoutBox[e], this.constraints[e]));
		});
	}
	resolveRefConstraints() {
		...
		if (!e || !Uc(e)) return !1;
		let n = e.current;
		x(n !== null, "If `dragConstraints` is set as a React ref, that ref must be passed to another component's `ref` prop.", "drag-constraints-ref");
		let { projection: r } = this.visualElement;
		if (!r || !r.layout) return !1;
		r.root && (r.root.scroll = void 0, r.root.updateScroll());
		let i = Ua(n, r.root, this.visualElement.getTransformPagePoint()), a = bl(r.layout.layoutBox, i);
		if (t) {
			let e = t(Ta(a));
	...
	startAnimation(e) {
		let { drag: t, dragMomentum: n, dragElastic: r, dragTransition: i, dragSnapToOrigin: a, onDragTransitionEnd: o } = this.getProps(), s = this.constraints || {}, c = $((o) => {
			if (!jl(o, t, this.currentDirection)) return;
			let c = s && s[o] || {};
			(a === !0 || a === o) && (c = {
				min: 0,
				max: 0
	...
	startAxisValueAnimation(e, t) {
		...
		return Wr(this.visualElement, e), n.start(jr(e, n, 0, t, this.visualElement, !1));
	}
	stopAnimation() {
	...
	snapToCursor(e) {
		$((t) => {
			...
			if (!jl(t, n, this.currentDirection)) return;
	...
	scalePositionWithinConstraints() {
		...
		if (!Uc(t) || !n || !this.constraints) return;
		this.stopAnimation();
		let r = {
			x: 0,
			y: 0
	...
	addListeners() {
		...
		let e = this.visualElement.current, t = il(e, "pointerdown", (t) => {
			let { drag: n, dragListener: r = !0 } = this.getProps(), i = t.target, a = i !== e && Pi(i);
			n && r && !a && this.start(t);
		}), n, r = () => {
			let { dragConstraints: t } = this.getProps();
			Uc(t) && t.current && (this.constraints = this.resolveRefConstraints(), n ||= Al(e, t.current, () => this.scalePositionWithinConstraints()));
		...
		let o = os(window, "resize", () => this.scalePositionWithinConstraints()), s = i.addEventListener("didUpdate", (({ delta: e, hasLayoutChanged: t }) => {
			this.isDragging && t && ($((t) => {
	...
	getProps() {
		let e = this.visualElement.getProps(), { drag: t = !1, dragDirectionLock: n = !1, dragPropagation: r = !1, dragConstraints: i = !1, dragElastic: a = Cl, dragMomentum: o = !0 } = e;
		return {
			...e,
			drag: t,
			dragDirectionLock: n,
...
var Nl = class extends J {
	constructor(e) {
		super(e), this.removeGroupControls = E, this.removeListeners = E, this.controls = new Ol(e);
	}
	mount() {
	...
	onPointerDown(e) {
		this.session = new ll(e, this.createPanHandlers(), {
...
}, Il = !1, Ll = class extends f.Component {
	componentDidMount() {
		let { visualElement: e, layoutGroup: t, switchLayoutGroup: n, layoutId: r } = this.props, { projection: i } = e;
		i && (t.group && t.group.add(i), n && n.register && r && n.register(i), Il && i.root.didUpdate(), i.addEventListener("animationComplete", () => {
			this.safeToRemove();
		}), i.setOptions({
			...i.options,
	...
	getSnapshotBeforeUpdate(e) {
		...
		return a ? (a.isPresent = i, e.layoutDependency !== t && a.setOptions({
			...a.options,
			layoutDependency: t
		}), Il = !0, r || e.layoutDependency !== t || t === void 0 || e.isPresent !== i ? a.willUpdate() : this.safeToRemove(), e.isPresent !== i && (i ? a.promote() : a.relegate() || k.postRender(() => {
			let e = a.getStack();
	...
	componentDidUpdate() {
		...
		n && (n.options.layoutAnchor = t, n.root.didUpdate(), Si.postRender(() => {
			!n.currentAnimation && n.isLead() && this.safeToRemove();
		}));
	}
	componentWillUnmount() {
		let { visualElement: e, layoutGroup: t, switchLayoutGroup: n } = this.props, { projection: r } = e;
		Il = !0, r && (r.scheduleCheckAfterUnmount(), t && t.group && t.group.remove(r), n && n.deregister && n.deregister(r));
	}
	safeToRemove() {
...
function Rl(e) {
	let [t, n] = rc(), r = (0, f.useContext)(p);
	return (0, d.jsx)(Ll, {
		...e,
		layoutGroup: r,
		switchLayoutGroup: (0, f.useContext)(Hc),
		isPresent: t,
		safeToRemove: n
	});
}
...
function Bl(e, t, n) {
	...
	let i = r["onHover" + n];
	i && k.postRender(() => i(t, nl(t)));
}
var Vl = class extends J {
	mount() {
		let { current: e } = this.node;
		e && (this.unmount = Oi(e, (e, t) => (Bl(this.node, t, "Start"), (e) => Bl(this.node, e, "End"))));
	}
	unmount() {}
}, Hl = class extends J {
	constructor() {
	...
	mount() {
		this.unmount = te(os(this.node.current, "focus", () => this.onFocus()), os(this.node.current, "blur", () => this.onBlur()));
	}
	unmount() {}
};
//#endregion
...
var Wl = class extends J {
	mount() {
		let { current: e } = this.node;
		if (!e) return;
		let { globalTapTarget: t, propagate: n } = this.node.props;
		this.unmount = Vi(e, (e, t) => (Ul(this.node, t, "Start"), (e, { success: t }) => Ul(this.node, e, t ? "End" : "Cancel")), {
			useGlobalTarget: t,
...
var eu = {
	...
	...zl,
	...tu
}, Qc), ru = /* @__PURE__ */ new Map();
function iu() {
	return typeof IntersectionObserver > "u";
}
function au(e, t, n) {
	let r = ru.get(t);
	if (!r) {
		...
		r = {
			observer: new IntersectionObserver((t) => {
				for (let n of t) e.get(n.target)?.(n.isIntersecting);
			}, { rootMargin: t }),
			listeners: e
		}, ru.set(t, r);
	}
	return r.listeners.set(e, n), r.observer.observe(e), () => {
		r?.observer.unobserve(e), r?.listeners.delete(e), r?.listeners.size === 0 && (r.observer.disconnect(), ru.delete(t));
	};
}
function ou(e, t, { eager: n = !1, rootMargin: r = "800px 0px", unloadDelayMs: i = 2e3 } = {}) {
	let [a, o] = (0, f.useState)(), s = n || iu() || a === e;
	return (0, f.useEffect)(() => {
		...
		let s, c = au(a, r, (t) => {
			if (t) {
				s !== void 0 && clearTimeout(s), s = void 0, o(e);
				return;
			}
...
//#endregion
//#region src/components/shared/ViewportImage.tsx
function su({ src: e, eager: t = !1, rootMargin: n = "800px 0px", unloadDelayMs: r = 2e3, loading: i = "lazy", decoding: a = "async", ...o }) {
	let s = (0, f.useRef)(null), c = ou(e, s, {
		eager: t,
		rootMargin: n,
		unloadDelayMs: r
	});
	return /* @__PURE__ */ (0, d.jsx)("img", {
		...
		loading: i,
		decoding: a,
		"data-viewport-image": c ? "loaded" : "deferred"
	});
}
//#endregion
export { oc as a, U as c, yc as i, m as l, ou as n, Ys as o, nu as r, Sr as s, su as t };
