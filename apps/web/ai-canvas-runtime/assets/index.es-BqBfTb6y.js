...
${T}
${N(t)}
`}var G=new Set,K=null,q=0,J=1e3/30-2,Y=Math.PI*2;function X(e){return(1-Math.cos(Y*e))/2}function Z(e){if(K=requestAnimationFrame(Z),e-q<J)return;q=e;let t=e/1e3;G.forEach(({el:e,config:n})=>{for(let r of n.oscillators){let n=(t-r.delay)/r.period,i=r.a+(r.b-r.a)*X(n);e.style.setProperty(r.prop,r.unit===`px`?`${i.toFixed(2)}px`:i.toFixed(4))}if(n.hue){let{prop:r,range:i,period:a,continuous:o}=n.hue,s=o?t/a%1*i:-i+2*i*X(t/a);e.style.setProperty(r,`${s.toFixed(2)}deg`)}})}function Q(){K??=(q=0,requestAnimationFrame(Z))}function ee(){G.size===0&&K!=null&&(cancelAnimationFrame(K),K=null)}function te(e,t){let n={el:e,config:t};return G.add(n),Q(),()=>{G.delete(n),ee()}}function ne(){let[e,t]=(0,i.useState)(()=>typeof window>`u`||window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`);return(0,i.useEffect)(()=>{if(typeof window>`u`)return;let e=window.matchMedia(`(prefers-color-scheme: dark)`),n=e=>{t(e.matches?`dark`:`light`)};return e.addEventListener(`change`,n),()=>e.removeEventListener(`change`,n)},[]),e}function re(e,t){return e===`auto`?t:e}var $=(0,i.forwardRef)(function({children:e,size:t=`md`,colorVariant:n=`colorful`,theme:s=`dark`,staticColors:c=!1,duration:l,active:u=!0,borderRadius:d,brightness:f,saturation:p,hueRange:m=30,strength:h=1,className:g,style:_,onActivate:v,onDeactivate:y,onAnimationEnd:b,...x},S){let C=(0,i.useId)().replace(/:/g,`-`),w=ne(),T=(0,i.useRef)(null),[E,D]=(0,i.useState)(u),[O,k]=(0,i.useState)(!1),[A,j]=(0,i.useState)(!0),[M,N]=(0,i.useState)(null),[P,F]=(0,i.useState)({x:1,y:1});(0,i.useEffect)(()=>{if(d!=null)return;let e=T.current;if(!e)return;let t=()=>{let t=e.firstElementChild;if(!t)return;let n=getComputedStyle(t),r=parseFloat(n.borderTopLeftRadius);!isNaN(r)&&r>0&&N(r)};t();let n=new MutationObserver(t);return n.observe(e,{childList:!0,subtree:!1}),()=>n.disconnect()},[d,e]),(0,i.useEffect)(()=>{u&&!E&&!O?D(!0):!u&&E&&!O&&k(!0)},[u,E,O]),(0,i.useEffect)(()=>{let e=T.current;if(!e||typeof IntersectionObserver>`u`)return;let t=new IntersectionObserver(e=>{for(let t of e)j(t.isIntersecting)},{rootMargin:`256px`});return t.observe(e),()=>t.disconnect()},[]),(0,i.useEffect)(()=>{if(t!==`pulse-outside`){F({x:1,y:1});return}let e=T.current;if(!e)return;let n=e=>Math.max(.35,Math.min(4,e)),r=()=>{let t=e.firstElementChild;if(!t)return;let r=t.getBoundingClientRect();if(!r.width||!r.height)return;let i=+n(r.width/350).toFixed(3),a=+n(r.height/140).toFixed(3);F(e=>e.x===i&&e.y===a?e:{x:i,y:a})};if(r(),typeof ResizeObserver>`u`)return;let i=e.firstElementChild;if(!i)return;let a=new ResizeObserver(r);return a.observe(i),()=>a.disconnect()},[t,e]);let I=(0,i.useCallback)(e=>{let t=e.animationName;t.includes(`fade-out`)?(D(!1),k(!1),y?.()):t.includes(`fade-in`)&&v?.(),b?.(e)},[v,y,b]),R=re(s,w),B=o[t][R],V=a[t],H=t===`pulse-inner`||t===`pulse-outside`,U=d??M??V.borderRadius,W=l??(t===`line`?3.1:H?2.3:1.96),G=p??B.saturation,K=f??B.brightness??1.3,q=t===`line`?Math.min(m,13):m,J=n===`mono`?!0:c,Y=(0,i.useMemo)(()=>z({id:C,borderRadius:U,borderWidth:V.borderWidth,duration:W,strokeOpacity:B.strokeOpacity,innerOpacity:B.innerOpacity,bloomOpacity:B.bloomOpacity,innerShadow:B.innerShadow,size:t,colorVariant:n,staticColors:J,brightness:K,saturation:G,hueRange:q,theme:R,hairlineOpacity:B.hairlineOpacity}),[C,U,V.borderWidth,W,B.strokeOpacity,B.innerOpacity,B.bloomOpacity,B.innerShadow,B.hairlineOpacity,t,n,J,K,G,q,R]),X=(0,i.useMemo)(()=>H?L(t,R,W,q,J,C):null,[H,t,R,W,q,J,C]);(0,i.useEffect)(()=>{var e;if(!X||!(E||O)||!A)return;let t=T.current;if(t&&!(typeof window<`u`&&(e=window.matchMedia)!=null&&e.call(window,`(prefers-reduced-motion: reduce)`).matches))return te(t,X)},[X,E,O,A]);let Z=(0,i.useCallback)(e=>{T.current=e,typeof S==`function`?S(e):S&&(S.current=e)},[S]),Q={..._??{},"--beam-strength":Math.max(0,Math.min(1,h)),...t===`pulse-outside`?{"--pulse-glow-sx":P.x,"--pulse-glow-sy":P.y}:{}};return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(`style`,{children:Y}),(0,r.jsxs)(`div`,{...x,ref:Z,"data-beam":C,"data-active":E&&!O?``:void 0,"data-fading":O?``:void 0,"data-paused":E&&!O&&!A?``:void 0,className:g,style:Q,onAnimationEnd:I,children:[e,(0,r.jsx)(`div`,{"data-beam-bloom":!0})]})]})});export{$ as BorderBeam,$ as default};