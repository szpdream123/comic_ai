...
async function d() {
	...
	let { getAllWindows: e } = await import("./window-WhVtX8QG.js"), t = new Set(r);
...
async function p(e) {
	...
	let { Window: t } = await import("./window-WhVtX8QG.js"), n = await t.getByLabel(e);
...
async function h(e, t) {
	let n = await p(e), { PhysicalPosition: r, PhysicalSize: i } = await import("./dpi-Deo8qMXP.js").then((e) => e.s);
...
async function g(e) {
	if (!s()) return l(e);
	let { getCurrentWindow: t } = await import("./window-WhVtX8QG.js");
	if (t().label === e.target) return l(e);
	let { emitTo: n, listen: r } = await import("./event-h5Ir25pQ.js").then((e) => e.i), o = `capture-${Date.now().toString(36)}-${Math.random().toString(36).slice(2, 8)}`;
...
async function _() {
	if (!s()) return () => {};
	let { emitTo: e, listen: t } = await import("./event-h5Ir25pQ.js").then((e) => e.i);
	return t(i, (t) => {
