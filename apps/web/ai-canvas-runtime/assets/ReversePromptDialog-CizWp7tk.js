...
import { ni as a, ri as o, t as s } from "./useAppStore-CcUL4Jo0.js";
import { n as c } from "./num-vBm-9Bix.js";
import { a as l, r as u } from "./ViewportImage-Dsz9jsTU.js";
import { I as d, Nt as f, Ot as p, Tt as m, Y as h } from "./useTooltipAutoPlacement-BSvTkR9V.js";
import { n as g } from "./rasterImageDimensions-CX1VK2cM.js";
import { i as _ } from "./clipboardService-CzwkqkrP.js";
import { t as v } from "./ModelSelector-BaXUXLCf.js";
...
function w() {
	let e = d("ai-text");
	if (e && f(e.model)) return e;
	let t = s.getState().config, n = p(t, "ai-text").flatMap((e) => e.models).find((e) => f(e.value));
	if (n) return {
		model: n.value,
		provider: n.provider
	};
	let r = (t?.generalModels || []).find((e) => e.category === "text" && f(e.modelId));
	return r ? {
		model: `general/${r.id}`,
		provider: "general"
	} : e;
...
function A({ request: e, onClose: t }) {
	let n = i(), r = n(C[e.kind]), a = (0, y.useMemo)(() => w(), []), [o, s] = (0, y.useState)(a?.model ?? ""), [c, l] = (0, y.useState)(a?.provider ?? ""), [d, f] = (0, y.useState)(""), [p, h] = (0, y.useState)(""), [b, x] = (0, y.useState)(""), [S, T] = (0, y.useState)(!1), [A, j] = (0, y.useState)(!1), M = (0, y.useCallback)((e) => {
		...
		p.trim() && (D(e.sourceNodeId, e.kind, p.trim()), t());
	}, [
		t,
		e.kind,
		e.sourceNodeId,
				...
				/* @__PURE__ */ (0, O.jsxs)("footer", {
					...
					children: [/* @__PURE__ */ (0, O.jsxs)("button", {
						...
						children: [/* @__PURE__ */ (0, O.jsx)(g, {
							...
							width: 15,
							height: 15
						}), /* @__PURE__ */ (0, O.jsx)("span", { children: n(S ? "反推中..." : p || b ? "重新反推" : "开始反推") })]
