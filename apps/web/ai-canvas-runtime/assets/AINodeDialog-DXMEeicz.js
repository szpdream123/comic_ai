...
import { Gt as a, Jt as o, _i as s, _r as c, ci as l, et as u, gr as d, hi as f, li as p, mi as m, ni as h, pt as g, ri as _, t as v, tt as y, vr as b } from "./useAppStore-CcUL4Jo0.js";
import { b as x, c as S, l as C, m as w, s as T, t as E } from "./shotlist-DkMSyocu.js";
import { i as D } from "./core-CoHQ9AE0.js";
import { h as O } from "./fileService-zQLozbOU.js";
import { n as k } from "./dramaAssetExtract-TP_lzZcC.js";
import { a as A, r as j } from "./ViewportImage-Dsz9jsTU.js";
import { A as M, B as N, Dt as P, Ft as F, G as I, H as ee, It as L, K as R, O as z, P as te, Rt as B, T as V, Tt as ne, U as re, V as H, Y as ie, a as ae, j as oe, k as se, q as ce, z as le, zt as ue } from "./useTooltipAutoPlacement-BSvTkR9V.js";
import { n as U } from "./rasterImageDimensions-CX1VK2cM.js";
import { t as de } from "./QualityRatioSelector-DwYxbR6P.js";
import { a as fe, c as pe, i as W, o as me, r as he, s as ge, t as _e } from "./MentionEditor-jpE2Ig5o.js";
import { t as ve } from "./FullscreenOverlay-Dpw1A125.js";
import { i as ye } from "./onnxService-BVMRtTc4.js";
import { t as be } from "./ModelSelector-BaXUXLCf.js";
					...
					children: [
						...
						/* @__PURE__ */ (0, K.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, K.jsx)("div", {
								...
								children: Oe.map((e) => /* @__PURE__ */ (0, K.jsx)(B, {
									type: "button",
...
function Me({ nodeType: e, currentPrompt: t, anchorEl: n, userPresets: r, userSkills: i, onSelect: a, onRunAdvancedPreset: o, onSelectSkill: s, onUploadSkill: c, onManageSkills: l, onClose: u, onManagePresets: d }) {
	let f = (0, G.useMemo)(() => i.filter(y), [i]), [p, m] = (0, G.useState)(null), [h, g] = (0, G.useState)(null), [_, v] = (0, G.useState)({
		left: 0,
		top: 0,
		direction: "right"
	...
	let T = (e, t = "slash-command-icon") => e.includes(":") ? /* @__PURE__ */ (0, K.jsx)(U, {
	...
	}, [n, E]), O = S.find((e) => e.id === p), k = p === je, A = (0, G.useCallback)((e) => {
		b.current && v(me(b.current.getBoundingClientRect(), 268, e * 48 + 16));
	}, []), j = (0, G.useCallback)((e) => {
		e.children && A(e.children.length);
	}, [A]), M = (0, G.useCallback)((e) => {
		if (e.promptTemplate) {
			let n = le(e.promptTemplate, t), r = {};
		...
		if (V(e)) o(e);
		else if (e.triggerMode === "direct") a(le(e.promptTemplate, t), !0, e);
		else {
			let n = le(e.promptTemplate, t);
			a(t ? `${t}\n${n}` : n, !1, e);
		}
		u();
	}, [
		...
		s(e), u();
	}, [s, u]), I = (0, G.useCallback)((e) => {
		e.children ? (m(e.id), g(e.id), j(e)) : m(null);
	}, [j]), ee = (0, G.useCallback)(() => {
		m(je), g(je), A(f.length + 3);
	}, [f.length, A]);
	return (0, J.createPortal)(/* @__PURE__ */ (0, K.jsxs)(K.Fragment, { children: [
		/* @__PURE__ */ (0, K.jsxs)("div", {
			...
			children: [
				S.length > 0 && /* @__PURE__ */ (0, K.jsxs)(K.Fragment, { children: [/* @__PURE__ */ (0, K.jsx)("div", {
					...
					className: `slash-command-item${e.children ? " has-submenu" : " has-trigger"}${e.children && p === e.id ? " active" : ""}`,
					"data-item-id": e.id,
					onMouseEnter: () => I(e),
					onClick: () => {
						e.children ? (j(e), m(p === e.id ? null : e.id)) : M(e);
					},
					children: [
						T(e.icon),
						/* @__PURE__ */ (0, K.jsxs)("div", {
				...
				C.length > 0 && /* @__PURE__ */ (0, K.jsxs)(K.Fragment, { children: [
					...
					C.map((e) => /* @__PURE__ */ (0, K.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, K.jsx)("span", {
								className: "slash-command-badge",
								children: V(e) ? "顺序执行" : e.triggerMode === "direct" ? "直接触发" : "加入提示词"
							})
						]
					}, e.id))
				] }),
		...
		O && /* @__PURE__ */ (0, K.jsx)("div", {
			...
			children: O.children?.map((e) => /* @__PURE__ */ (0, K.jsxs)("div", {
				className: `slash-command-item has-trigger${h === e.id ? " active" : ""}`,
		...
		k && /* @__PURE__ */ (0, K.jsxs)("div", {
			...
			children: [
				...
				f.length > 0 && /* @__PURE__ */ (0, K.jsx)("div", { className: "slash-command-divider" }),
				/* @__PURE__ */ (0, K.jsx)("div", {
					className: "slash-command-item has-trigger",
					onClick: () => {
						l(), u();
					},
					onMouseEnter: () => g("manage-skills"),
					children: /* @__PURE__ */ (0, K.jsxs)("div", {
						className: "slash-command-text",
						children: [/* @__PURE__ */ (0, K.jsx)("span", {
							className: "slash-command-title",
...
function Le({ config: e, defaultNodeType: t, onChange: n }) {
	let r = v((e) => e.workflows), i = (0, G.useMemo)(() => oe(e), [e]), a = (0, G.useMemo)(() => M(e.parameters), [e.parameters]), o = (t, r) => {
		n({
			...e,
		...
		c(e.id, { promptTemplate: e.promptTemplate + n + "{{" + t + "}}" });
	};
						...
						return /* @__PURE__ */ (0, K.jsxs)("article", {
							...
							children: [
								/* @__PURE__ */ (0, K.jsxs)("header", {
									...
									children: [
										...
										/* @__PURE__ */ (0, K.jsx)("input", {
											...
											placeholder: "步骤名称",
											onChange: (e) => c(t.id, { name: e.target.value })
										}),
										/* @__PURE__ */ (0, K.jsx)("select", {
											...
											children: m.map((e) => /* @__PURE__ */ (0, K.jsx)("option", {
												value: e,
												children: f[e].replace("预设", "生成")
											}, e))
										}),
										/* @__PURE__ */ (0, K.jsxs)("div", {
											className: "preset-advanced-row-actions",
								...
								/* @__PURE__ */ (0, K.jsx)("textarea", {
									...
									onChange: (e) => c(t.id, { promptTemplate: e.target.value })
								}),
								/* @__PURE__ */ (0, K.jsxs)("div", {
								...
								/* @__PURE__ */ (0, K.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, K.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, K.jsx)("span", { children: "尺寸" }), /* @__PURE__ */ (0, K.jsx)(de, {
											...
											onChangeImageSize: (e) => c(t.id, { imageSize: e }),
											onChangeAspectRatio: (e) => c(t.id, { aspectRatio: e }),
											placement: "bottom",
											showImageSize: !0
										})]
									}) : null]
...
function We() {
	let { userPresets: e, presetManagerOpen: t, setPresetManagerOpen: n, addUserPreset: r, updateUserPreset: i, deleteUserPreset: a, showToast: o } = v(ue((e) => ({
	...
	(0, G.useEffect)(() => {
		t && queueMicrotask(() => {
			if (!l) {
				p(""), g(""), b(""), S("direct"), w("basic"), E(X(s)), O(void 0), M(""), P(""), I(""), L(""), z(!1), V(!1), H.current && (H.current.innerHTML = "");
				return;
			}
			let t = e.find((e) => e.id === l);
			t && (p(t.name), g(t.description), b(t.promptTemplate), S(t.triggerMode), w(t.mode === "advanced" ? "advanced" : "basic"), E(t.advanced ?? X(t.nodeType)), O(t.thumbnail), M(t.model || ""), P(t.provider || ""), I(t.imageSize || ""), L(t.aspectRatio || ""), z(!!t.model), V(!!t.imageSize || !!t.aspectRatio), H.current && Ve(H.current, t.promptTemplate));
		});
	}, [
		s,
		t,
	...
	let ce = (0, G.useCallback)(() => {
		...
		let e = C === "basic" && H.current ? Be(H.current) : y;
		i(l, {
			name: d.trim(),
			description: h.trim(),
			promptTemplate: e,
			...
			model: R && k || void 0,
			provider: R && N || void 0,
			imageSize: te && F || void 0,
			aspectRatio: te && ee || void 0,
			mode: C,
			advanced: T
		}), o("快捷指令已保存");
	}, [
		...
		w(e), e === "basic" && requestAnimationFrame(() => {
			H.current && Ve(H.current, y);
		});
	}, [y]), pe = (0, G.useCallback)((e) => {
		...
		children: /* @__PURE__ */ (0, K.jsxs)(j.div, {
			...
			children: [
				/* @__PURE__ */ (0, K.jsxs)("div", {
					...
					}), /* @__PURE__ */ (0, K.jsx)(ne, { onClick: () => n(!1) })]
				}),
				/* @__PURE__ */ (0, K.jsx)("div", {
					className: "preset-manager-tabs",
					role: "tablist",
					children: m.map((e) => /* @__PURE__ */ (0, K.jsxs)(j.button, {
						type: "button",
						...
						}), /* @__PURE__ */ (0, K.jsx)("span", { children: f[e] })]
					}, e))
				}),
				/* @__PURE__ */ (0, K.jsxs)("div", {
								...
								C === "basic" ? /* @__PURE__ */ (0, K.jsxs)(K.Fragment, { children: [
									...
									/* @__PURE__ */ (0, K.jsxs)("div", {
										...
										children: [
											...
											/* @__PURE__ */ (0, K.jsx)("span", {
												...
												children: R ? "已指定模型，生图时覆盖节点设置" : "未指定则使用节点当前模型"
											}),
											R ? /* @__PURE__ */ (0, K.jsxs)(K.Fragment, { children: [/* @__PURE__ */ (0, K.jsx)(be, {
												nodeType: s,
									...
									ie && /* @__PURE__ */ (0, K.jsxs)("div", {
										...
										children: [
											...
											/* @__PURE__ */ (0, K.jsx)("span", {
												className: "preset-manager-section-desc",
												children: te ? "已指定尺寸，生图时覆盖节点设置" : "未指定则使用节点当前画质和比例"
											}),
											te ? /* @__PURE__ */ (0, K.jsxs)(K.Fragment, { children: [/* @__PURE__ */ (0, K.jsx)(de, {
												imageSize: F || void 0,
												aspectRatio: ee || void 0,
...
function qe({ open: e, onClose: t }) {
	let n = v((e) => e.userSkills), r = v((e) => e.deleteSkill), i = v((e) => e.showToast), [a, o] = (0, G.useState)(null), s = a ?? n[0]?.id ?? null, c = (0, G.useMemo)(() => n.find((e) => e.id === s) ?? n[0] ?? null, [s, n]), l = (0, G.useCallback)(async (e) => {
...
function ot({ nodeType: e, nodeId: t, prompt: n = "", placeholder: r, selectedModel: a, selectedProvider: o, selectedWorkflowId: s, animationAction: c = "idle", onAnimationActionChange: d, animationFrames: f = 8, onAnimationFramesChange: p, canGenerate: m = !0, isGenerating: h = !1, onCancelGeneration: g, onChange: _, onContinuousEditEnd: y, onSubmit: b, onModelSelect: x, onWorkflowSelect: S, onDebug: C, onPassThrough: w, imageSize: T, aspectRatio: E, onChangeImageSize: D, onChangeAspectRatio: O, batchCount: k = 1, onChangeBatchCount: A, cameraSettings: j, onChangeCameraSettings: M, videoResolution: N, videoFps: P, videoFrames: I, onChangeVideoResolution: ee, onChangeVideoFps: R, seedanceResolution: z, seedanceRatio: te, seedanceDuration: B, generateAudio: V, videoReferences: ne, onChangeVideoReferences: re, onChangeSeedanceResolution: H, onChangeSeedanceRatio: ie, onChangeSeedanceDuration: ae, onChangeGenerateAudio: oe, audioPurpose: se, audioVoice: ce, audioFormat: le, audioSpeed: ue, musicTitle: U, musicLyrics: fe, musicBpm: W, musicDuration: me, autoGenerateLyrics: he, onChangeAudioVoice: ve, onChangeAudioFormat: ye, onChangeAudioSpeed: xe, onChangeMusicTitle: Se, onChangeMusicLyrics: Ce, onChangeMusicBpm: q, onChangeMusicDuration: we, onChangeAutoGenerateLyrics: Te, workflows: Ee = [], editorRef: De, selectedStyle: Oe, onStyleChange: ke }) {
	let J = i(), je = r ?? J("输入提示词开始创作   (Enter 生成，Shift+Enter 换行)"), [Ne, Pe] = (0, G.useState)(!1), [Fe, Y] = (0, G.useState)(!1), [Ie, Le] = (0, G.useState)(!1), [Re, X] = (0, G.useState)(null), ze = (0, G.useRef)(null), Be = (0, G.useRef)(null), Ve = (0, G.useRef)(null), He = (0, G.useRef)(null), Ue = (0, G.useRef)(!1), [Ge, Ke] = (0, G.useState)(!1), Z = e === "ai-image" && o === "dreamina" ? L(a) : void 0;
	(0, G.useEffect)(() => {
		if (!Z) return;
		let e = T?.toLowerCase();
		if (!Z.resolutions.some((t) => t.toLowerCase() === e)) {
			let e = Z.resolutions.find((e) => e.toLowerCase() === "2k") ?? Z.resolutions[0];
			D?.(e);
		}
		E && !F.includes(E) && O?.("16:9");
	}, [
		E,
		Z,
		T,
	...
	let $e = v((e) => e.config.performanceMode === !0), et = v((e) => e.userPresets), tt = v((e) => e.userSkills), nt = v((e) => e.uploadSkill), rt = v((e) => e.setPresetManagerOpen), ot = v((e) => e.setPresetRunRequest), st = v((e) => e.showToast), ct = v((e) => e.pendingPresetAction), lt = v((e) => e.setPendingPresetAction), ut = (0, G.useCallback)((e, t) => {
		b(u(e ?? n, tt), t);
	}, [
		b,
		n,
		...
		!$ || e.button !== 0 || !m || !n.trim() || (Ue.current = !1, Q(), He.current = setTimeout(() => {
	...
	let ht = (0, G.useCallback)((e, t, n) => {
		Y(!1), n && (n.model && n.provider && x({
			...
			label: n.model,
			nodeTypes: []
		}), n.imageSize && D && D(n.imageSize), n.aspectRatio && O && O(n.aspectRatio)), t ? dt(e, n?.postProcess) : (_(e), y?.());
	}, [
		dt,
		_,
		y,
		...
		/* @__PURE__ */ (0, K.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, K.jsx)("div", {
				...
				children: [
					...
					e === "ai-animation" && d && /* @__PURE__ */ (0, K.jsxs)(K.Fragment, { children: [/* @__PURE__ */ (0, K.jsx)("div", {
						...
						"aria-label": J("生成帧数"),
						onChange: (e) => {
							e.stopPropagation(), p?.(Number(e.target.value));
						},
						children: [
							6,
							8,
					...
					e === "ai-image" && /* @__PURE__ */ (0, K.jsx)(de, {
						imageSize: T,
						aspectRatio: E,
						onChangeImageSize: D || (() => {}),
					...
					e === "ai-video" && /* @__PURE__ */ (0, K.jsx)(ge, {
						...
						nodeId: t,
						videoReferences: ne,
						onChangeVideoReferences: re,
						videoResolution: N,
						videoFps: P,
						videoFrames: I,
						onChangeResolution: ee || (() => {}),
						onChangeFps: R || (() => {}),
						seedanceResolution: z,
						seedanceRatio: te,
						seedanceDuration: B,
						generateAudio: V,
						onChangeSeedanceResolution: H,
					...
					/* @__PURE__ */ (0, K.jsxs)("div", {
						...
						children: [
							...
							h && g ? /* @__PURE__ */ (0, K.jsx)("div", {
								...
								children: [/* @__PURE__ */ (0, K.jsx)("button", {
									type: "button",
									className: `prompt-btn prompt-submit-btn${h ? " is-generating" : ""} ${!m || !n.trim() ? "disabled" : ""}`,
									disabled: !m || !n.trim(),
...
function Q({ nodeId: e, onInsertMention: t, hoverEmphasis: n = "default" }) {
	let r = i(), { nodes: a, edges: o } = v(ue((e) => ({
		nodes: e.nodes,
		edges: e.edges
	}))), s = v((e) => e.hoveredMentionNodeId), [c, l] = (0, G.useState)(null), [u, d] = (0, G.useState)(null), f = (0, G.useCallback)(() => {
		l(null), d(null);
	}, []), [p, m] = (0, G.useState)(null), [h, g] = (0, G.useState)(null), _ = (0, G.useRef)(null), y = (0, G.useCallback)(() => {
		_.current = setTimeout(() => m(null), 120);
	}, [m]), b = (0, G.useCallback)(() => {
	...
	let D = (e, n) => {
		t?.(`@{${e}:${n}}`);
	}, O = s ? x.findIndex((e) => e.id === s || e.sbCells?.some((e) => e.mentionId === s)) : -1, k = S === null ? O >= 0 ? O : null : S, M = n === "expanded", N = M ? 2.5 : 1.22, P = M ? 1.16 : 1.1, F = (e) => {
		if (S === null) return 1;
		let t = Math.abs(e - S);
	...
	return /* @__PURE__ */ (0, K.jsxs)("div", {
		...
		children: [
			c === null && /* @__PURE__ */ (0, K.jsx)("div", {
				...
				children: x.map((e, t) => {
					let n = F(t), i = I(t), a = k === t, o = e.nodeType === "ai-storyboard", s = e.nodeType === "ai-shotlist", c = !!(e.mediaUrl || e.thumbnailUrl || e.previewText), l = `${e.label}${e.displayId == null ? "" : ` #${e.displayId}`}`, f = c ? `${r("点击引用")} · ${r("长按全屏显示")}` : r("点击引用");
					return /* @__PURE__ */ (0, K.jsxs)(j.button, {
						...
						onMouseEnter: (t) => {
							o && (b(), m(e.id), g(t.currentTarget.getBoundingClientRect()));
						},
						onMouseLeave: () => {
							o && y();
						},
...
function pt() {
	let e = i(), { activeNodeId: t, dialogPosition: n, closeNodeDialog: r, updateNodeData: s, updateNodeDataTransient: l, commitToHistory: u, recordOutputHistory: f, showToast: m, workflows: y, currentProjectId: S } = v(ue((e) => ({
	...
	}))), C = v((e) => e.activeNodeId ? e.nodes.find((t) => t.id === e.activeNodeId) : void 0), w = v((e) => e.config.performanceMode === !0), T = C?.data, E = T?.type, k = (0, G.useRef)(null), A = (0, G.useRef)(null), j = (0, G.useRef)(/* @__PURE__ */ new Set()), [M, N] = (0, G.useState)(!1);
	(0, G.useLayoutEffect)(() => {
		let e = k.current, n = A.current;
		if (!e || !t || M) return;
		let r = 0, i = 0, a = 0, o = !1, s = !1, c = null, l = (e) => e ? 12 : -20, u = (t, r) => {
			let i = l(r);
			e.style.left = `${t.x}px`, e.style.top = `${t.y + i}px`, n && (n.style.left = `${t.x}px`, n.style.top = `${t.y + i - 42}px`);
		}, d = () => {
			if (!t) return !1;
			let e = v.getState().nodes.find((e) => e.id === t)?.data;
			...
			ae({
				...
				onComplete: (r) => {
					...
					u(i, p), v.getState().openNodeDialog(t, i), a = requestAnimationFrame(() => {
		...
		g.observe(e);
		let _ = e.closest(".app-box");
		return _ && g.observe(_), h(), i = window.setTimeout(h, 280), window.addEventListener("resize", h), window.visualViewport?.addEventListener("resize", h), () => {
			s = !0, cancelAnimationFrame(r), cancelAnimationFrame(a), window.clearTimeout(i), e.style.removeProperty("transition"), n?.style.removeProperty("transition"), g.disconnect(), window.removeEventListener("resize", h), window.visualViewport?.removeEventListener("resize", h);
		};
	}, [t, M]), (0, G.useEffect)(() => {
		if (!t || M) return;
	...
	let F = (0, G.useRef)(null), L = (0, G.useRef)(!1), z = (0, G.useCallback)(() => {
		L.current &&= (u(), !1);
	}, [u]), B = (0, G.useCallback)((e) => {
		t && (L.current ||= (u(), !0), l(t, e));
	}, [
		t,
		u,
		l
	...
	let ne = (0, G.useCallback)((e) => {
		...
		z();
		let i = v.getState(), a = i.nodes.find((e) => e.id === t)?.data;
		if (!a) {
			m(e("节点不存在"), "error");
			return;
		}
		...
		let g = i.projects.find((e) => e.id === S)?.settings, y = o({
			prompt: u,
			data: a,
			settings: g,
			customStyles: i.customStyles
		}), C = xe(a.cameraSettings), w = C && (E === "ai-image" || E === "ai-video") ? `${y}\n\nCamera settings: ${C}.` : y, T = a?.model, k = a?.provider, A = a?.label ?? "";
		if (!T || !k) {
			m(e("请先在底部模型选择器中选择一个模型"), "error");
			return;
		}
		let j = t, M = S, N = () => {
			let e = v.getState();
		...
		let P;
		try {
			let n = Math.min(8, Math.max(1, Math.floor(Number(a.batchCount) || 1)));
			if (E === "ai-image" && n > 1) {
				if (r) throw Error(e("批量生成暂不支持图片后处理，请将数量设为 1"));
				let i = a.imageSize || "2K", o = a.aspectRatio || "1:1";
				P = b({
					nodeId: j,
					count: n,
					projectId: M
				}).nodeIds, m(e("正在批量生成 {count} 张图片", { count: n }));
				let s = await ce({
					prompt: w,
					model: T,
					provider: k,
			...
			if (E === "ai-image" || E === "ai-animation") {
				let n = E === "ai-animation", i = a.imageSize || "2K", o = a.animationAction ?? "idle", c = a.animationFrames ?? 8, l = n ? W(c, k) : a.aspectRatio || "1:1", u = await R({
					prompt: n ? he(w, o, c, l) : w,
					model: T,
					provider: k,
					imageSize: i,
					aspectRatio: l,
				...
				if (s(t, {
					...
					...n ? { aspectRatio: l } : {}
				}), v.getState().syncDramaAssetImageFromNode?.(t, g), f(t, {
					nodeId: t,
					nodeLabel: A,
					timestamp: Date.now(),
					prompt: w,
					...
					params: n ? {
						...
						imageSize: i,
						aspectRatio: l,
						cameraSettings: a.cameraSettings
					}
				}), r === "character-8-direction-grid") if (!d.filePath) m(e("原图已生成，但未能保存到本地，无法自动生成 8 向宫格"), "error");
				else {
					m(e("图片生成完成，正在后台切图生成 8 向宫格"));
					try {
						if (!N()) return;
						let t = await ye(d.filePath);
						if (!N()) return;
						let n = v.getState(), r = n.nodes.find((e) => e.id === j);
						if (!r) return;
						n.addNode({
							id: `node-${_()}`,
							type: "ai-storyboard",
						...
						m(e("原图已生成，8 向宫格处理失败：{message}", { message: t instanceof Error ? t.message : typeof t == "string" ? t : e("未知错误") }), "error");
					}
				}
				else m(e(n ? "Sprite Sheet 生成完成" : "图片生成完成"));
			} else if (E === "ai-panorama") {
				let n = a.imageSize || "2K", r = a.aspectRatio || "2:1", i = await R({
					prompt: te(w),
					model: T,
					provider: k,
					imageSize: n,
				...
				if (!N()) return;
				let o = S ? await O(i.url, S, "ai-panorama", A) : {
					mediaUrl: i.url,
					sourceUrl: i.url
				}, c = o.mediaUrl;
				s(t, {
				...
				let { videoResolution: n, videoFps: r, videoFrames: i, seedanceResolution: o, seedanceRatio: c, seedanceDuration: l } = I({
					provider: k,
					workflowId: a.workflowId,
				...
				if (!N()) return;
				let p = S ? await O(d.url, S, "ai-video", A) : {
					mediaUrl: d.url,
					sourceUrl: d.url
				}, h = p.mediaUrl;
				s(t, {
				...
				s(t, {
					...
					params: {
						...
						audioFormat: a.audioFormat,
						audioSpeed: a.audioSpeed,
						musicTitle: n.title || a.musicTitle,
						musicBpm: a.musicBpm,
						musicDuration: a.musicDuration,
						autoGenerateLyrics: a.autoGenerateLyrics
					}
				...
				let n = x(a.shotlistColumns), r = await ie({
					prompt: Ce(w, n),
					model: T,
					provider: k
				});
				if (!N()) return;
				let i = Te(r), o = Ee(v.getState().nodes.find((e) => e.id === j)?.data.shotlistRows ?? [], i);
				s(t, {
					shotlistRows: o,
					status: "success"
				}), f(t, {
					...
					status: "success",
					params: { columns: n }
				}), m(e("已生成 {count} 个镜头", { count: o.length }));
			} else {
				let n = await ie({
					prompt: w,
					model: T,
				...
				if (s(t, {
					...
					i.ok && i.parsed && v.getState().mergeDramaExtract(i.parsed, {
						sourceNodeId: t,
						modelId: T
					});
					let n = i.kind === "character" ? e("人物") : i.kind === "scene" ? e("场景") : e("道具");
					i.ok ? m(e("{kind}简介已提取并入库 · 「资产管理 > 短剧资产」可查看", { kind: n })) : m(e("已提取，但 JSON 未完全规范化，请检查输出"), "error");
				}
			}
		} catch (n) {
		...
		try {
			...
			l(n, {
				status: "idle",
				error: void 0
			}), m(e("已停止本地等待，但{message}", { message: t instanceof Error ? t.message : e("无法终止 ComfyUI 任务") }), "error");
		} finally {
			j.current.delete(n);
		}
	}, [
		...
		e,
		l
	]), le = E !== "ai-image" && E !== "ai-animation" && E !== "ai-video" && E !== "ai-audio" && E !== "ai-shotlist", U = (0, G.useCallback)(() => {
		let e = v.getState().nodes.find((e) => e.id === t)?.data;
		!e?.prompt?.trim() || !e?.type || (s(t, {
			output: e.prompt,
			status: "success"
		}), f(t, {
			nodeId: t,
	...
	}, [t, s]), pe = (0, G.useCallback)((e) => s(t, { imageSize: e }), [t, s]), me = (0, G.useCallback)((e) => {
		let n = { aspectRatio: e }, r = a(e);
		r && Object.assign(n, r), s(t, n);
	}, [t, s]), ge = (0, G.useCallback)((e) => s(t, { batchCount: e }), [t, s]), _e = (0, G.useCallback)((e) => s(t, { cameraSettings: e }), [t, s]), ve = (0, G.useCallback)((e) => B({ videoResolution: e }), [B]), be = (0, G.useCallback)((e) => s(t, { videoFps: e }), [t, s]), Se = (0, G.useCallback)((e) => s(t, { seedanceResolution: e }), [t, s]), q = (0, G.useCallback)((e) => s(t, { seedanceRatio: e }), [t, s]), we = (0, G.useCallback)((e) => B({ seedanceDuration: e }), [B]), De = (0, G.useCallback)((e) => s(t, { generateAudio: e }), [t, s]), Oe = (0, G.useCallback)((e) => s(t, { videoReferences: e }), [t, s]), ke = (0, G.useCallback)((e) => s(t, { audioVoice: e }), [t, s]), Ae = (0, G.useCallback)((e) => s(t, { audioFormat: e }), [t, s]), J = (0, G.useCallback)((e) => B({ audioSpeed: e }), [B]), je = (0, G.useCallback)((e) => B({ musicTitle: e }), [B]), Me = (0, G.useCallback)((e) => B({ musicLyrics: e }), [B]), Ne = (0, G.useCallback)((e) => B({ musicBpm: e }), [B]), Pe = (0, G.useCallback)((e) => B({ musicDuration: e }), [B]), Fe = (0, G.useCallback)((e) => s(t, { autoGenerateLyrics: e }), [t, s]), Y = (0, G.useCallback)((e) => s(t, { style: e }), [t, s]), Ie = (0, G.useCallback)((e) => s(t, { animationAction: e }), [t, s]), Le = (0, G.useCallback)((e) => s(t, { animationFrames: e }), [t, s]);
	if (!t || !C || !T || !E) return null;
	let Re = T.audioPurpose ?? (T.model ? P(T.model)?.audioPurpose : void 0), X = T.imageUrl || T.thumbnailUrl || T.videoUrl || T.audioUrl ? 12 : -20, ze = (e) => {
		let n = e.match(/^@\{([^:]+):([^}]+)\}$/);
		if (n && F.current) {
			F.current.insertMentionAtCursor(n[1], n[2]);
			return;
		}
		let r = (v.getState().nodes.find((e) => e.id === t)?.data?.prompt ?? T.prompt) || "";
		B({ prompt: r ? `${r} ${e}` : e });
	};
	return /* @__PURE__ */ (0, K.jsxs)(K.Fragment, { children: [
		...
		/* @__PURE__ */ (0, K.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, K.jsx)(ot, {
					...
					onChange: ne,
					onContinuousEditEnd: z,
					onSubmit: oe,
					onModelSelect: de,
					onWorkflowSelect: fe,
					onPassThrough: le ? U : void 0,
