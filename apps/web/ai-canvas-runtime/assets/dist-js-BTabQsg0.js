import { a as e, t } from "./core-D3lATfku.js";
//#region node_modules/@tauri-apps/plugin-shell/dist-js/index.js
var n = class {
	constructor() {
	...
	off(e, t) {
		return e in this.eventListeners && (this.eventListeners[e] = this.eventListeners[e].filter((e) => e !== t)), this;
	}
	...
	async write(t) {
		await e("plugin:shell|stdin_write", {
			pid: this.pid,
			buffer: t
		});
	}
	async kill() {
		await e("plugin:shell|kill", {
			cmd: "killChild",
			pid: this.pid
		});
	}
	...
	constructor(e, t = [], r) {
		super(), this.stdout = new n(), this.stderr = new n(), this.program = e, this.args = typeof t == "string" ? [t] : t, this.options = r ?? {};
	}
	static create(e, t = [], n) {
		return new i(e, t, n);
	}
	...
	async spawn() {
		let n = this.program, i = this.args, a = this.options;
		typeof i == "object" && Object.freeze(i);
		let o = new t();
	...
	async execute() {
		let t = this.program, n = this.args, r = this.options;
		return typeof n == "object" && Object.freeze(n), await e("plugin:shell|execute", {
			program: t,
			args: n,
			options: r
		});
