var e = 1e3, t = 1001, n = 1002, r = 1003, i = 1004, a = 1005, o = 1006, s = 1007, c = 1008, l = 1009, u = 1010, d = 1011, f = 1012, p = 1013, m = 1014, h = 1015, g = 1016, _ = 1017, v = 1018, y = 1020, b = 35902, x = 35899, S = 1021, C = 1022, w = 1023, T = 1026, E = 1027, D = 1028, O = 1029, k = 1030, A = 1031, ee = 1033, j = 33776, M = 33777, N = 33778, P = 33779, F = 35840, te = 35841, ne = 35842, re = 35843, ie = 36196, I = 37492, ae = 37496, oe = 37488, L = 37489, R = 37490, se = 37491, ce = 37808, le = 37809, ue = 37810, de = 37811, fe = 37812, pe = 37813, me = 37814, he = 37815, ge = 37816, _e = 37817, ve = 37818, ye = 37819, be = 37820, xe = 37821, Se = 36492, Ce = 36494, we = 36495, Te = 36283, Ee = 36284, z = 36285, De = 36286, B = 2300, Oe = 2301, V = 2302, ke = 2303, H = 2400, U = 2401, Ae = 2402, je = 3200, Me = "srgb", Ne = "srgb-linear", Pe = "linear", Fe = "srgb", Ie = 7680, Le = 35044, Re = 2e3;
function ze(e) {
...
var St = {
	...
	*[Symbol.iterator]() {
	...
	applyEuler(e) {
		return this.applyQuaternion(Tt.setFromEuler(e));
	}
	applyAxisAngle(e, t) {
		return this.applyQuaternion(Tt.setFromAxisAngle(e, t));
	}
	applyMatrix3(e) {
	...
	projectOnPlane(e) {
		return wt.copy(this).projectOnVector(e), this.sub(wt);
	}
	reflect(e) {
		return this.sub(wt.copy(e).multiplyScalar(2 * this.dot(e)));
	}
	angleTo(e) {
		let t = Math.sqrt(this.lengthSq() * e.lengthSq());
		if (t === 0) return Math.PI / 2;
...
}, wt = /* @__PURE__ */ new J(), Tt = /* @__PURE__ */ new Ct(), Y = class e {
	static {
...
}, Et = /* @__PURE__ */ new Y(), Dt = /* @__PURE__ */ new Y().set(.4123908, .3575843, .1804808, .212639, .7151687, .0721923, .0193308, .1191948, .9505322), Ot = /* @__PURE__ */ new Y().set(3.2409699, -1.5373832, -.4986108, -.9692436, 1.8759675, .0415551, .0556301, -.203977, 1.0569715);
function kt() {
	let e = {
		enabled: !0,
		...
		getTransfer: function(e) {
			return e === "" ? Pe : this.spaces[e].transfer;
		},
...
var Mt, Nt = class {
	static getDataURL(e, t = "image/png") {
		...
		if (e instanceof HTMLCanvasElement) n = e;
			...
			Mt === void 0 && (Mt = Ve("canvas")), Mt.width = e.width, Mt.height = e.height;
	...
	constructor(e = null) {
		this.isSource = !0, Object.defineProperty(this, "id", { value: Pt++ }), this.uuid = tt(), this.data = e, this.dataReady = !0, this.version = 0;
	}
	getSize(e) {
		let t = this.data;
...
var Bt = class e {
	...
	*[Symbol.iterator]() {
	...
	extractRotation(e) {
		...
		let t = this.elements, n = e.elements, r = 1 / Kt.setFromMatrixColumn(e, 0).length(), i = 1 / Kt.setFromMatrixColumn(e, 1).length(), a = 1 / Kt.setFromMatrixColumn(e, 2).length();
	...
	makeRotationFromQuaternion(e) {
		return this.compose(Jt, e, Yt);
	}
	lookAt(e, t, n) {
		let r = this.elements;
		return Qt.subVectors(e, t), Qt.lengthSq() === 0 && (Qt.z = 1), Qt.normalize(), Xt.crossVectors(n, Qt), Xt.lengthSq() === 0 && (Math.abs(n.z) === 1 ? Qt.x += 1e-4 : Qt.z += 1e-4, Qt.normalize(), Xt.crossVectors(n, Qt)), Xt.normalize(), Zt.crossVectors(Qt, Xt), r[0] = Xt.x, r[4] = Zt.x, r[8] = Qt.x, r[1] = Xt.y, r[5] = Zt.y, r[9] = Qt.y, r[2] = Xt.z, r[6] = Zt.z, r[10] = Qt.z, this;
	}
	multiply(e) {
		return this.multiplyMatrices(this, e);
	}
	...
	multiplyMatrices(e, t) {
		let n = e.elements, r = t.elements, i = this.elements, a = n[0], o = n[4], s = n[8], c = n[12], l = n[1], u = n[5], d = n[9], f = n[13], p = n[2], m = n[6], h = n[10], g = n[14], _ = n[3], v = n[7], y = n[11], b = n[15], x = r[0], S = r[4], C = r[8], w = r[12], T = r[1], E = r[5], D = r[9], O = r[13], k = r[2], A = r[6], ee = r[10], j = r[14], M = r[3], N = r[7], P = r[11], F = r[15];
		return i[0] = a * x + o * T + s * k + c * M, i[4] = a * S + o * E + s * A + c * N, i[8] = a * C + o * D + s * ee + c * P, i[12] = a * w + o * O + s * j + c * F, i[1] = l * x + u * T + d * k + f * M, i[5] = l * S + u * E + d * A + f * N, i[9] = l * C + u * D + d * ee + f * P, i[13] = l * w + u * O + d * j + f * F, i[2] = p * x + m * T + h * k + g * M, i[6] = p * S + m * E + h * A + g * N, i[10] = p * C + m * D + h * ee + g * P, i[14] = p * w + m * O + h * j + g * F, i[3] = _ * x + v * T + y * k + b * M, i[7] = _ * S + v * E + y * A + b * N, i[11] = _ * C + v * D + y * ee + b * P, i[15] = _ * w + v * O + y * j + b * F, this;
	}
	multiplyScalar(e) {
		let t = this.elements;
	...
	decompose(e, t, n) {
		...
		let a = Kt.set(r[0], r[1], r[2]).length(), o = Kt.set(r[4], r[5], r[6]).length(), s = Kt.set(r[8], r[9], r[10]).length();
		i < 0 && (a = -a), qt.copy(this);
		let c = 1 / a, l = 1 / o, u = 1 / s;
		return qt.elements[0] *= c, qt.elements[1] *= c, qt.elements[2] *= c, qt.elements[4] *= l, qt.elements[5] *= l, qt.elements[6] *= l, qt.elements[8] *= u, qt.elements[9] *= u, qt.elements[10] *= u, t.setFromRotationMatrix(qt), n.x = a, n.y = o, n.z = s, this;
	}
	makePerspective(e, t, n, r, i, a, o = Re, s = !1) {
	...
	makeOrthographic(e, t, n, r, i, a, o = Re, s = !1) {
...
}, Kt = /* @__PURE__ */ new J(), qt = /* @__PURE__ */ new Gt(), Jt = /* @__PURE__ */ new J(0, 0, 0), Yt = /* @__PURE__ */ new J(1, 1, 1), Xt = /* @__PURE__ */ new J(), Zt = /* @__PURE__ */ new J(), Qt = /* @__PURE__ */ new J(), $t = /* @__PURE__ */ new Gt(), en = /* @__PURE__ */ new Ct(), tn = class e {
	...
	setFromQuaternion(e, t, n) {
		return $t.makeRotationFromQuaternion(e), this.setFromRotationMatrix($t, t, n);
	}
...
var nn = class {
...
}, rn = 0, an = /* @__PURE__ */ new J(), on = /* @__PURE__ */ new Ct(), sn = /* @__PURE__ */ new Gt(), cn = /* @__PURE__ */ new J(), ln = /* @__PURE__ */ new J(), un = /* @__PURE__ */ new J(), dn = /* @__PURE__ */ new Ct(), fn = /* @__PURE__ */ new J(1, 0, 0), pn = /* @__PURE__ */ new J(0, 1, 0), mn = /* @__PURE__ */ new J(0, 0, 1), hn = { type: "added" }, gn = { type: "removed" }, _n = {
	type: "childadded",
	child: null
}, vn = {
	type: "childremoved",
	child: null
}, yn = class e extends Xe {
	constructor() {
		super(), this.isObject3D = !0, Object.defineProperty(this, "id", { value: rn++ }), this.uuid = tt(), this.name = "", this.type = "Object3D", this.parent = null, this.children = [], this.up = e.DEFAULT_UP.clone();
		let t = new J(), n = new tn(), r = new Ct(), i = new J(1, 1, 1);
		function a() {
			r.setFromEuler(n, !1);
		}
		function o() {
		...
		}), this.matrix = new Gt(), this.matrixWorld = new Gt(), this.matrixAutoUpdate = e.DEFAULT_MATRIX_AUTO_UPDATE, this.matrixWorldAutoUpdate = e.DEFAULT_MATRIX_WORLD_AUTO_UPDATE, this.matrixWorldNeedsUpdate = !1, this.layers = new nn(), this.visible = !0, this.castShadow = !1, this.receiveShadow = !1, this.frustumCulled = !0, this.renderOrder = 0, this.animations = [], this.customDepthMaterial = void 0, this.customDistanceMaterial = void 0, this.static = !1, this.userData = {}, this.pivot = null;
	}
	onBeforeShadow() {}
	onAfterShadow() {}
	onBeforeRender() {}
	...
	lookAt(e, t, n) {
		...
		let r = this.parent;
		this.updateWorldMatrix(!0, !1), ln.setFromMatrixPosition(this.matrixWorld), this.isCamera || this.isLight ? sn.lookAt(ln, cn, this.up) : sn.lookAt(cn, ln, this.up), this.quaternion.setFromRotationMatrix(sn), r && (sn.extractRotation(r.matrixWorld), on.setFromRotationMatrix(sn), this.quaternion.premultiply(on.invert()));
	}
	add(e) {
		...
		return e === this ? (G("Object3D.add: object can't be added as a child of itself.", e), this) : (e && e.isObject3D ? (e.removeFromParent(), e.parent = this, this.children.push(e), e.dispatchEvent(hn), _n.child = e, this.dispatchEvent(_n), _n.child = null) : G("Object3D.add: object not an instance of THREE.Object3D.", e), this);
	}
	remove(e) {
		if (arguments.length > 1) {
		...
		return t !== -1 && (e.parent = null, this.children.splice(t, 1), e.dispatchEvent(gn), vn.child = e, this.dispatchEvent(vn), vn.child = null), this;
	}
	removeFromParent() {
		let e = this.parent;
	...
	attach(e) {
		return this.updateWorldMatrix(!0, !1), sn.copy(this.matrixWorld).invert(), e.parent !== null && (e.parent.updateWorldMatrix(!0, !1), sn.multiply(e.parent.matrixWorld)), e.applyMatrix4(sn), e.removeFromParent(), e.parent = this, this.children.push(e), e.updateWorldMatrix(!1, !0), e.dispatchEvent(hn), _n.child = e, this.dispatchEvent(_n), _n.child = null, this;
	}
	getObjectById(e) {
	...
	getWorldQuaternion(e) {
		return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(ln, e, un), e;
	}
	getWorldScale(e) {
		return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(ln, dn, e), e;
	}
	getWorldDirection(e) {
...
yn.DEFAULT_UP = /* @__PURE__ */ new J(0, 1, 0), yn.DEFAULT_MATRIX_AUTO_UPDATE = !0, yn.DEFAULT_MATRIX_WORLD_AUTO_UPDATE = !0;
var bn = class extends yn {
	constructor() {
		super(), this.isGroup = !0, this.type = "Group";
	}
}, xn = { type: "move" }, Sn = class {
	constructor() {
	...
	getTargetRaySpace() {
		return this._targetRay === null && (this._targetRay = new bn(), this._targetRay.matrixAutoUpdate = !1, this._targetRay.visible = !1, this._targetRay.hasLinearVelocity = !1, this._targetRay.linearVelocity = new J(), this._targetRay.hasAngularVelocity = !1, this._targetRay.angularVelocity = new J()), this._targetRay;
	}
	getGripSpace() {
		return this._grip === null && (this._grip = new bn(), this._grip.matrixAutoUpdate = !1, this._grip.visible = !1, this._grip.hasLinearVelocity = !1, this._grip.linearVelocity = new J(), this._grip.hasAngularVelocity = !1, this._grip.angularVelocity = new J(), this._grip.eventsEnabled = !1), this._grip;
	}
	dispatchEvent(e) {
	...
	update(e, t, n) {
		...
		if (e && t.session.visibilityState !== "visible-blurred") {
			...
			o !== null && (r = t.getPose(e.targetRaySpace, n), r === null && i !== null && (r = i), r !== null && (o.matrix.fromArray(r.transform.matrix), o.matrix.decompose(o.position, o.rotation, o.scale), o.matrixWorldNeedsUpdate = !0, r.linearVelocity ? (o.hasLinearVelocity = !0, o.linearVelocity.copy(r.linearVelocity)) : o.hasLinearVelocity = !1, r.angularVelocity ? (o.hasAngularVelocity = !0, o.angularVelocity.copy(r.angularVelocity)) : o.hasAngularVelocity = !1, this.dispatchEvent(xn)));
		}
...
var Z = class {
	...
	setHSL(e, t, n, r = X.workingColorSpace) {
		if (e = nt(e, 1), t = K(t, 0, 1), n = K(n, 0, 1), t === 0) this.r = this.g = this.b = n;
		else {
			let r = n <= .5 ? n * (1 + t) : n + t - n * t, i = 2 * n - r;
			this.r = En(i, r, e + 1 / 3), this.g = En(i, r, e), this.b = En(i, r, e - 1 / 3);
		}
	...
	getHex(e = Me) {
		return X.workingToColorSpace(Dn.copy(this), e), Math.round(K(Dn.r * 255, 0, 255)) * 65536 + Math.round(K(Dn.g * 255, 0, 255)) * 256 + Math.round(K(Dn.b * 255, 0, 255));
	}
	getHexString(e = Me) {
		return ("000000" + this.getHex(e).toString(16)).slice(-6);
	}
	getHSL(e, t = X.workingColorSpace) {
		X.workingToColorSpace(Dn.copy(this), t);
		let n = Dn.r, r = Dn.g, i = Dn.b, a = Math.max(n, r, i), o = Math.min(n, r, i), s, c, l = (o + a) / 2;
		if (o === a) s = 0, c = 0;
		else {
			let e = a - o;
	...
	getRGB(e, t = X.workingColorSpace) {
		return X.workingToColorSpace(Dn.copy(this), t), e.r = Dn.r, e.g = Dn.g, e.b = Dn.b, e;
	}
	getStyle(e = Me) {
		X.workingToColorSpace(Dn.copy(this), e);
		let t = Dn.r, n = Dn.g, r = Dn.b;
	...
	lerpHSL(e, t) {
		this.getHSL(wn), e.getHSL(Tn);
		let n = at(wn.h, Tn.h, t), r = at(wn.s, Tn.s, t), i = at(wn.l, Tn.l, t);
...
var On = class e {
	constructor(e, t = 25e-5) {
		this.isFogExp2 = !0, this.name = "", this.color = new Z(e), this.density = t;
	}
	clone() {
...
}, An = /* @__PURE__ */ new J(), jn = /* @__PURE__ */ new J(), Mn = /* @__PURE__ */ new J(), Nn = /* @__PURE__ */ new J(), Pn = /* @__PURE__ */ new J(), Fn = /* @__PURE__ */ new J(), In = /* @__PURE__ */ new J(), Ln = /* @__PURE__ */ new J(), Rn = /* @__PURE__ */ new J(), zn = /* @__PURE__ */ new J(), Bn = /* @__PURE__ */ new Bt(), Vn = /* @__PURE__ */ new Bt(), Hn = /* @__PURE__ */ new Bt(), Un = class e {
	constructor(e = new J(), t = new J(), n = new J()) {
		this.a = e, this.b = t, this.c = n;
	}
	static getNormal(e, t, n, r) {
		r.subVectors(n, t), An.subVectors(e, t), r.cross(An);
		let i = r.lengthSq();
		return i > 0 ? r.multiplyScalar(1 / Math.sqrt(i)) : r.set(0, 0, 0);
	}
	static getBarycoord(e, t, n, r, i) {
		An.subVectors(r, t), jn.subVectors(n, t), Mn.subVectors(e, t);
		let a = An.dot(An), o = An.dot(jn), s = An.dot(Mn), c = jn.dot(jn), l = jn.dot(Mn), u = a * c - o * o;
	...
	static getInterpolation(e, t, n, r, i, a, o, s) {
		return this.getBarycoord(e, t, n, r, Nn) === null ? (s.x = 0, s.y = 0, "z" in s && (s.z = 0), "w" in s && (s.w = 0), null) : (s.setScalar(0), s.addScaledVector(i, Nn.x), s.addScaledVector(a, Nn.y), s.addScaledVector(o, Nn.z), s);
	}
	static getInterpolatedAttribute(e, t, n, r, i, a) {
		return Bn.setScalar(0), Vn.setScalar(0), Hn.setScalar(0), Bn.fromBufferAttribute(e, t), Vn.fromBufferAttribute(e, n), Hn.fromBufferAttribute(e, r), a.setScalar(0), a.addScaledVector(Bn, i.x), a.addScaledVector(Vn, i.y), a.addScaledVector(Hn, i.z), a;
	}
	static isFrontFacing(e, t, n, r) {
		return An.subVectors(n, t), jn.subVectors(e, t), An.cross(jn).dot(r) < 0;
	}
	set(e, t, n) {
	...
	getArea() {
		return An.subVectors(this.c, this.b), jn.subVectors(this.a, this.b), An.cross(jn).length() * .5;
	}
	getMidpoint(e) {
	...
	closestPointToPoint(e, t) {
		...
		Pn.subVectors(r, n), Fn.subVectors(i, n), Ln.subVectors(e, n);
		let s = Pn.dot(Ln), c = Fn.dot(Ln);
		if (s <= 0 && c <= 0) return t.copy(n);
		Rn.subVectors(e, r);
		let l = Pn.dot(Rn), u = Fn.dot(Rn);
		if (l >= 0 && u <= l) return t.copy(r);
		let d = s * u - l * c;
		if (d <= 0 && s >= 0 && l <= 0) return a = s / (s - l), t.copy(n).addScaledVector(Pn, a);
		zn.subVectors(e, i);
		let f = Pn.dot(zn), p = Fn.dot(zn);
		if (p >= 0 && f <= p) return t.copy(i);
		let m = f * c - s * p;
		if (m <= 0 && c >= 0 && p <= 0) return o = c / (c - p), t.copy(n).addScaledVector(Fn, o);
		let h = l * p - f * u;
		if (h <= 0 && u - l >= 0 && f - p >= 0) return In.subVectors(i, r), o = (u - l) / (u - l + (f - p)), t.copy(r).addScaledVector(In, o);
		let g = 1 / (h + m + d);
		return a = m * g, o = d * g, t.copy(n).addScaledVector(Pn, a).addScaledVector(Fn, o);
	}
	equals(e) {
	...
	setFromArray(e) {
		this.makeEmpty();
		for (let t = 0, n = e.length; t < n; t += 3) this.expandByPoint(Kn.fromArray(e, t));
		return this;
	}
	setFromBufferAttribute(e) {
		this.makeEmpty();
		for (let t = 0, n = e.count; t < n; t++) this.expandByPoint(Kn.fromBufferAttribute(e, t));
		return this;
	}
	setFromPoints(e) {
		this.makeEmpty();
	...
	setFromCenterAndSize(e, t) {
		let n = Kn.copy(t).multiplyScalar(.5);
	...
	expandByObject(e, t = !1) {
		...
		if (n !== void 0) {
			...
			if (t === !0 && r !== void 0 && e.isInstancedMesh !== !0) for (let t = 0, n = r.count; t < n; t++) e.isMesh === !0 ? e.getVertexPosition(t, Kn) : Kn.fromBufferAttribute(r, t), Kn.applyMatrix4(e.matrixWorld), this.expandByPoint(Kn);
			else e.boundingBox === void 0 ? (n.boundingBox === null && n.computeBoundingBox(), qn.copy(n.boundingBox)) : (e.boundingBox === null && e.computeBoundingBox(), qn.copy(e.boundingBox)), qn.applyMatrix4(e.matrixWorld), this.union(qn);
		}
		let r = e.children;
	...
	intersectsTriangle(e) {
		...
		this.getCenter(er), tr.subVectors(this.max, er), Jn.subVectors(e.a, er), Yn.subVectors(e.b, er), Xn.subVectors(e.c, er), Zn.subVectors(Yn, Jn), Qn.subVectors(Xn, Yn), $n.subVectors(Jn, Xn);
		let t = [
			0,
			-Zn.z,
			Zn.y,
		...
		return !ir(t, Jn, Yn, Xn, tr) || (t = [
			...
			0,
			1
		], !ir(t, Jn, Yn, Xn, tr)) ? !1 : (nr.crossVectors(Zn, Qn), t = [
			nr.x,
			nr.y,
			nr.z
		], ir(t, Jn, Yn, Xn, tr));
	...
	getBoundingSphere(e) {
		return this.isEmpty() ? e.makeEmpty() : (this.getCenter(e.center), e.radius = this.getSize(Kn).length() * .5), e;
	}
	intersect(e) {
	...
	/* @__PURE__ */ new J(),
	/* @__PURE__ */ new J()
], Kn = /* @__PURE__ */ new J(), qn = /* @__PURE__ */ new Wn(), Jn = /* @__PURE__ */ new J(), Yn = /* @__PURE__ */ new J(), Xn = /* @__PURE__ */ new J(), Zn = /* @__PURE__ */ new J(), Qn = /* @__PURE__ */ new J(), $n = /* @__PURE__ */ new J(), er = /* @__PURE__ */ new J(), tr = /* @__PURE__ */ new J(), nr = /* @__PURE__ */ new J(), rr = /* @__PURE__ */ new J();
function ir(e, t, n, r, i) {
	for (let a = 0, o = e.length - 3; a <= o; a += 3) {
		rr.fromArray(e, a);
		let o = i.x * Math.abs(rr.x) + i.y * Math.abs(rr.y) + i.z * Math.abs(rr.z), s = t.dot(rr), c = n.dot(rr), l = r.dot(rr);
		if (Math.max(-Math.max(s, c, l), Math.min(s, c, l)) > o) return !1;
	}
	return !0;
}
var ar = /* @__PURE__ */ new J(), or = /* @__PURE__ */ new q(), sr = 0, cr = class extends Xe {
	constructor(e, t, n = !1) {
		if (super(), Array.isArray(e)) throw TypeError("THREE.BufferAttribute: array should be a Typed Array.");
		this.isBufferAttribute = !0, Object.defineProperty(this, "id", { value: sr++ }), this.name = "", this.array = e, this.itemSize = t, this.count = e === void 0 ? 0 : e.length / t, this.normalized = n, this.usage = Le, this.updateRanges = [], this.gpuType = h, this.version = 0;
	}
	onUploadCallback() {}
	set needsUpdate(e) {
		e === !0 && this.version++;
	...
	applyMatrix3(e) {
		...
		else if (this.itemSize === 3) for (let t = 0, n = this.count; t < n; t++) ar.fromBufferAttribute(this, t), ar.applyMatrix3(e), this.setXYZ(t, ar.x, ar.y, ar.z);
		return this;
	}
	applyMatrix4(e) {
		for (let t = 0, n = this.count; t < n; t++) ar.fromBufferAttribute(this, t), ar.applyMatrix4(e), this.setXYZ(t, ar.x, ar.y, ar.z);
		return this;
	}
	applyNormalMatrix(e) {
...
}, fr = /* @__PURE__ */ new Wn(), pr = /* @__PURE__ */ new J(), mr = /* @__PURE__ */ new J(), hr = class {
	...
	setFromPoints(e, t) {
		let n = this.center;
		t === void 0 ? fr.setFromPoints(e).getCenter(n) : n.copy(t);
		let r = 0;
	...
	union(e) {
		return e.isEmpty() ? this : this.isEmpty() ? (this.copy(e), this) : (this.center.equals(e.center) === !0 ? this.radius = Math.max(this.radius, e.radius) : (mr.subVectors(e.center, this.center).setLength(e.radius), this.expandByPoint(pr.copy(e.center).add(mr)), this.expandByPoint(pr.copy(e.center).sub(mr))), this);
	}
	equals(e) {
...
}, gr = 0, _r = /* @__PURE__ */ new Gt(), vr = /* @__PURE__ */ new yn(), yr = /* @__PURE__ */ new J(), br = /* @__PURE__ */ new Wn(), xr = /* @__PURE__ */ new Wn(), Sr = /* @__PURE__ */ new J(), Cr = class e extends Xe {
	constructor() {
	...
	setIndex(e) {
		return Array.isArray(e) ? this.index = new (ze(e) ? ur : lr)(e, 1) : this.index = e, this;
	}
	setIndirect(e, t = 0) {
	...
	applyQuaternion(e) {
		return _r.makeRotationFromQuaternion(e), this.applyMatrix4(_r), this;
	}
	rotateX(e) {
	...
	setFromPoints(e) {
		...
		if (t === void 0) {
			...
			this.setAttribute("position", new dr(t, 3));
		} else {
	...
	computeBoundingBox() {
		...
		if (e !== void 0) {
			if (this.boundingBox.setFromBufferAttribute(e), t) for (let e = 0, n = t.length; e < n; e++) {
				let n = t[e];
				br.setFromBufferAttribute(n), this.morphTargetsRelative ? (Sr.addVectors(this.boundingBox.min, br.min), this.boundingBox.expandByPoint(Sr), Sr.addVectors(this.boundingBox.max, br.max), this.boundingBox.expandByPoint(Sr)) : (this.boundingBox.expandByPoint(br.min), this.boundingBox.expandByPoint(br.max));
			}
	...
	computeBoundingSphere() {
		...
		if (e) {
			...
			if (br.setFromBufferAttribute(e), t) for (let e = 0, n = t.length; e < n; e++) {
				let n = t[e];
				xr.setFromBufferAttribute(n), this.morphTargetsRelative ? (Sr.addVectors(br.min, xr.min), br.expandByPoint(Sr), Sr.addVectors(br.max, xr.max), br.expandByPoint(Sr)) : (br.expandByPoint(xr.min), br.expandByPoint(xr.max));
			}
			br.getCenter(n);
			let r = 0;
			for (let t = 0, i = e.count; t < i; t++) Sr.fromBufferAttribute(e, t), r = Math.max(r, n.distanceToSquared(Sr));
			if (t) for (let i = 0, a = t.length; i < a; i++) {
				let a = t[i], o = this.morphTargetsRelative;
				for (let t = 0, i = a.count; t < i; t++) Sr.fromBufferAttribute(a, t), o && (yr.fromBufferAttribute(e, t), Sr.add(yr)), r = Math.max(r, n.distanceToSquared(Sr));
			}
	...
	computeTangents() {
		...
		this.hasAttribute("tangent") === !1 && this.setAttribute("tangent", new cr(new Float32Array(4 * n.count), 4));
	...
	computeVertexNormals() {
		...
		if (t !== void 0) {
			...
			if (n === void 0) n = new cr(new Float32Array(t.count * 3), 3), this.setAttribute("normal", n);
	...
	normalizeNormals() {
		...
		for (let t = 0, n = e.count; t < n; t++) Sr.fromBufferAttribute(e, t), Sr.normalize(), e.setXYZ(t, Sr.x, Sr.y, Sr.z);
	}
	toNonIndexed() {
		function t(e, t) {
...
}, wr = 0, Tr = class extends Xe {
	constructor() {
		super(), this.isMaterial = !0, Object.defineProperty(this, "id", { value: wr++ }), this.uuid = tt(), this.name = "", this.type = "Material", this.blending = 1, this.side = 0, this.vertexColors = !1, this.opacity = 1, this.transparent = !1, this.alphaHash = !1, this.blendSrc = 204, this.blendDst = 205, this.blendEquation = 100, this.blendSrcAlpha = null, this.blendDstAlpha = null, this.blendEquationAlpha = null, this.blendColor = new Z(0, 0, 0), this.blendAlpha = 0, this.depthFunc = 3, this.depthTest = !0, this.depthWrite = !0, this.stencilWriteMask = 255, this.stencilFunc = 519, this.stencilRef = 0, this.stencilFuncMask = 255, this.stencilFail = Ie, this.stencilZFail = Ie, this.stencilZPass = Ie, this.stencilWrite = !1, this.clippingPlanes = null, this.clipIntersection = !1, this.clipShadows = !1, this.shadowSide = null, this.colorWrite = !0, this.precision = null, this.polygonOffset = !1, this.polygonOffsetFactor = 0, this.polygonOffsetUnits = 0, this.dithering = !1, this.alphaToCoverage = !1, this.premultipliedAlpha = !1, this.forceSinglePass = !1, this.allowOverride = !0, this.visible = !0, this.toneMapped = !0, this.userData = {}, this.version = 0, this._alphaTest = 0;
	}
	get alphaTest() {
...
}, Er = /* @__PURE__ */ new J(), Dr = /* @__PURE__ */ new J(), Or = /* @__PURE__ */ new J(), kr = /* @__PURE__ */ new J(), Ar = /* @__PURE__ */ new J(), jr = /* @__PURE__ */ new J(), Mr = /* @__PURE__ */ new J(), Nr = class {
	...
	distanceSqToPoint(e) {
		let t = Er.subVectors(e, this.origin).dot(this.direction);
		return t < 0 ? this.origin.distanceToSquared(e) : (Er.copy(this.origin).addScaledVector(this.direction, t), Er.distanceToSquared(e));
	}
	distanceSqToSegment(e, t, n, r) {
		Dr.copy(e).add(t).multiplyScalar(.5), Or.copy(t).sub(e).normalize(), kr.copy(this.origin).sub(Dr);
		let i = e.distanceTo(t) * .5, a = -this.direction.dot(Or), o = kr.dot(this.direction), s = -kr.dot(Or), c = kr.lengthSq(), l = Math.abs(1 - a * a), u, d, f, p;
		...
		return n && n.copy(this.origin).addScaledVector(this.direction, u), r && r.copy(Dr).addScaledVector(Or, d), f;
	}
	intersectSphere(e, t) {
		Er.subVectors(e.center, this.origin);
		let n = Er.dot(this.direction), r = Er.dot(Er) - n * n, i = e.radius * e.radius;
		if (r > i) return null;
	...
	intersectTriangle(e, t, n, r, i) {
		Ar.subVectors(t, e), jr.subVectors(n, e), Mr.crossVectors(Ar, jr);
		...
		let s = o * this.direction.dot(jr.crossVectors(kr, jr));
		if (s < 0) return null;
		let c = o * this.direction.dot(Ar.cross(kr));
...
}, Fr = /* @__PURE__ */ new Gt(), Ir = /* @__PURE__ */ new Nr(), Lr = /* @__PURE__ */ new hr(), Rr = /* @__PURE__ */ new J(), zr = /* @__PURE__ */ new J(), Br = /* @__PURE__ */ new J(), Vr = /* @__PURE__ */ new J(), Hr = /* @__PURE__ */ new J(), Ur = /* @__PURE__ */ new J(), Wr = /* @__PURE__ */ new J(), Gr = /* @__PURE__ */ new J(), Kr = class extends yn {
	constructor(e = new Cr(), t = new Pr()) {
	...
	getVertexPosition(e, t) {
		...
		if (i && o) {
			...
			for (let n = 0, r = i.length; n < r; n++) {
				let r = o[n], s = i[n];
				r !== 0 && (Hr.fromBufferAttribute(s, e), a ? Ur.addScaledVector(Hr, r) : Ur.addScaledVector(Hr.sub(t), r));
			}
			t.add(Ur);
		}
		return t;
	...
	raycast(e, t) {
		...
		r !== void 0 && (n.boundingSphere === null && n.computeBoundingSphere(), Lr.copy(n.boundingSphere), Lr.applyMatrix4(i), Ir.copy(e.ray).recast(e.near), !(Lr.containsPoint(Ir.origin) === !1 && (Ir.intersectSphere(Lr, Rr) === null || Ir.origin.distanceToSquared(Rr) > (e.far - e.near) ** 2)) && (Fr.copy(i).invert(), Ir.copy(e.ray).applyMatrix4(Fr), !(n.boundingBox !== null && Ir.intersectsBox(n.boundingBox) === !1) && this._computeIntersections(e, t, Ir)));
	}
	_computeIntersections(e, t, n) {
		...
		if (o !== null) if (Array.isArray(a)) for (let i = 0, s = d.length; i < s; i++) {
			...
			for (let i = m, a = h; i < a; i += 3) {
				...
				r = Jr(this, p, e, n, c, l, u, a, d, f), r && (r.faceIndex = Math.floor(i / 3), r.face.materialIndex = s.materialIndex, t.push(r));
			}
		}
		else {
			...
			for (let d = i, f = s; d < f; d += 3) {
				...
				r = Jr(this, a, e, n, c, l, u, i, s, f), r && (r.faceIndex = Math.floor(d / 3), t.push(r));
			}
		}
			...
			for (let i = m, a = h; i < a; i += 3) {
				let a = i, s = i + 1, d = i + 2;
				r = Jr(this, p, e, n, c, l, u, a, s, d), r && (r.faceIndex = Math.floor(i / 3), r.face.materialIndex = o.materialIndex, t.push(r));
			}
		}
		else {
			...
			for (let s = i, d = o; s < d; s += 3) {
				let i = s, o = s + 1, d = s + 2;
				r = Jr(this, a, e, n, c, l, u, i, o, d), r && (r.faceIndex = Math.floor(s / 3), t.push(r));
			}
		}
	}
};
function qr(e, t, n, r, i, a, o, s) {
	...
	let l = n.ray.origin.distanceTo(Gr);
...
function Jr(e, t, n, r, i, a, o, s, c, l) {
	e.getVertexPosition(s, zr), e.getVertexPosition(c, Br), e.getVertexPosition(l, Vr);
	let u = qr(e, t, n, r, zr, Br, Vr, Wr);
	if (u) {
		let e = new J();
		Un.getBarycoord(Wr, zr, Br, Vr, e), i && (u.uv = Un.getInterpolatedAttribute(i, s, c, l, e, new q())), a && (u.uv1 = Un.getInterpolatedAttribute(a, s, c, l, e, new q())), o && (u.normal = Un.getInterpolatedAttribute(o, s, c, l, e, new J()), u.normal.dot(r.direction) > 0 && u.normal.multiplyScalar(-1));
		let t = {
			a: s,
			b: c,
			c: l,
		...
		Un.getNormal(zr, Br, Vr, t.normal), u.face = t, u.barycoord = e;
	}
	return u;
}
var Yr = class extends zt {
...
}, Zr = /* @__PURE__ */ new Gt(), Qr = /* @__PURE__ */ new Gt(), $r = [], ei = /* @__PURE__ */ new Wn(), ti = /* @__PURE__ */ new Gt(), ni = /* @__PURE__ */ new Kr(), ri = /* @__PURE__ */ new hr(), ii = class extends Kr {
	constructor(e, t, n) {
		super(e, t), this.isInstancedMesh = !0, this.instanceMatrix = new Xr(new Float32Array(n * 16), 16), this.previousInstanceMatrix = null, this.instanceColor = null, this.morphTexture = null, this.count = n, this.boundingBox = null, this.boundingSphere = null;
		for (let e = 0; e < n; e++) this.setMatrixAt(e, ti);
	}
	computeBoundingBox() {
		...
		for (let n = 0; n < t; n++) this.getMatrixAt(n, Zr), ei.copy(e.boundingBox).applyMatrix4(Zr), this.boundingBox.union(ei);
	}
	computeBoundingSphere() {
		let e = this.geometry, t = this.count;
		...
		for (let n = 0; n < t; n++) this.getMatrixAt(n, Zr), ri.copy(e.boundingSphere).applyMatrix4(Zr), this.boundingSphere.union(ri);
	}
	copy(e, t) {
	...
	raycast(e, t) {
		...
		if (ni.geometry = this.geometry, ni.material = this.material, ni.material !== void 0 && (this.boundingSphere === null && this.computeBoundingSphere(), ri.copy(this.boundingSphere), ri.applyMatrix4(n), e.ray.intersectsSphere(ri) !== !1)) for (let i = 0; i < r; i++) {
			this.getMatrixAt(i, Zr), Qr.multiplyMatrices(n, Zr), ni.matrixWorld = Qr, ni.raycast(e, $r);
	...
	setColorAt(e, t) {
		return this.instanceColor === null && (this.instanceColor = new Xr(new Float32Array(this.instanceMatrix.count * 3).fill(1), 3)), t.toArray(this.instanceColor.array, e * 3), this;
	}
	setMatrixAt(e, t) {
	...
	setMorphAt(e, t) {
		...
		this.morphTexture === null && (this.morphTexture = new Yr(new Float32Array(r * this.count), r, this.count, D, h));
...
}, ai = /* @__PURE__ */ new J(), oi = /* @__PURE__ */ new J(), si = /* @__PURE__ */ new Y(), ci = class {
	...
	setFromCoplanarPoints(e, t, n) {
		let r = ai.subVectors(n, t).cross(oi.subVectors(e, t)).normalize();
	...
	applyMatrix4(e, t) {
		let n = t || si.getNormalMatrix(e), r = this.coplanarPoint(ai).applyMatrix4(e), i = this.normal.applyMatrix3(n).normalize();
...
}, li = /* @__PURE__ */ new hr(), ui = /* @__PURE__ */ new q(.5, .5), di = /* @__PURE__ */ new J(), fi = class {
	...
	setFromProjectionMatrix(e, t = Re, n = !1) {
	...
	intersectsObject(e) {
		if (e.boundingSphere !== void 0) e.boundingSphere === null && e.computeBoundingSphere(), li.copy(e.boundingSphere).applyMatrix4(e.matrixWorld);
		else {
			let t = e.geometry;
	...
	intersectsSprite(e) {
		return li.center.set(0, 0, 0), li.radius = .7071067811865476 + ui.distanceTo(e.center), li.applyMatrix4(e.matrixWorld), this.intersectsSphere(li);
	}
	intersectsSphere(e) {
	...
	constructor(e, t, n = m, i, a, o, s = r, c = r, l, u = T, d = 1) {
		...
		super({
			...
			height: t,
			depth: d
		}, i, a, o, s, c, u, n, l), this.isDepthTexture = !0, this.flipY = !1, this.generateMipmaps = !1, this.compareFunction = null;
	}
	copy(e) {
	...
	constructor(e, t = m, n = 301, i, a, o = r, s = r, c, l = T) {
		...
		super(e, e, t, n, i, a, o, s, c, l), this.image = d, this.isCubeDepthTexture = !0, this.isCubeTexture = !0;
	}
	get images() {
		return this.image;
	}
	...
	constructor(e = 1, t = 1, n = 1, r = 1, i = 1, a = 1) {
		...
		let s = [], c = [], l = [], u = [], d = 0, f = 0;
		p("z", "y", "x", -1, -1, n, t, e, a, i, 0), p("z", "y", "x", 1, -1, n, t, -e, a, i, 1), p("x", "z", "y", 1, 1, e, n, t, r, a, 2), p("x", "z", "y", 1, -1, e, n, -t, r, a, 3), p("x", "y", "z", 1, -1, e, t, n, r, i, 4), p("x", "y", "z", -1, -1, e, t, -n, r, i, 5), this.setIndex(s), this.setAttribute("position", new dr(c, 3)), this.setAttribute("normal", new dr(l, 3)), this.setAttribute("uv", new dr(u, 2));
	...
	constructor(e = 1, t = 32, n = 0, r = Math.PI * 2) {
		...
		this.setIndex(i), this.setAttribute("position", new dr(a, 3)), this.setAttribute("normal", new dr(o, 3)), this.setAttribute("uv", new dr(s, 2));
	}
	copy(e) {
		return super.copy(e), this.parameters = Object.assign({}, e.parameters), this;
	}
	...
	constructor(e = 1, t = 1, n = 1, r = 32, i = 1, a = !1, o = 0, s = Math.PI * 2) {
		...
		_(), a === !1 && (e > 0 && v(!0), t > 0 && v(!1)), this.setIndex(l), this.setAttribute("position", new dr(u, 3)), this.setAttribute("normal", new dr(d, 3)), this.setAttribute("uv", new dr(f, 2));
		function _() {
			let a = new J(), _ = new J(), v = 0, y = (t - e) / n;
			for (let c = 0; c <= i; c++) {
		...
		function v(n) {
			let i = p, a = new q(), m = new J(), _ = 0, v = n === !0 ? e : t, y = n === !0 ? 1 : -1;
	...
	getTangent(e, t) {
		...
		r < 0 && (r = 0), i > 1 && (i = 1);
		let a = this.getPoint(r), o = this.getPoint(i), s = t || (a.isVector2 ? new q() : new J());
	...
	computeFrenetFrames(e, t = !1) {
		let n = new J(), r = [], i = [], a = [], o = new J(), s = new Gt();
		for (let t = 0; t <= e; t++) {
			let n = t / e;
...
var wi = /* @__PURE__ */ new J(), Ti = /* @__PURE__ */ new J(), Ei = /* @__PURE__ */ new Ci(), Di = /* @__PURE__ */ new Ci(), Oi = /* @__PURE__ */ new Ci(), ki = class extends bi {
	...
	getPoint(e, t = new J()) {
		...
		let c, l;
		this.closed || o > 0 ? c = r[(o - 1) % i] : (Ti.subVectors(r[0], r[1]).add(r[0]), c = Ti);
		let u = r[o % i], d = r[(o + 1) % i];
		if (this.closed || o + 2 < i ? l = r[(o + 2) % i] : (wi.subVectors(r[i - 1], r[i - 2]).add(r[i - 1]), l = wi), this.curveType === "centripetal" || this.curveType === "chordal") {
			let e = this.curveType === "chordal" ? .5 : .25, t = c.distanceToSquared(u) ** +e, n = u.distanceToSquared(d) ** +e, r = d.distanceToSquared(l) ** +e;
			n < 1e-4 && (n = 1), t < 1e-4 && (t = n), r < 1e-4 && (r = n), Ei.initNonuniformCatmullRom(c.x, u.x, d.x, l.x, t, n, r), Di.initNonuniformCatmullRom(c.y, u.y, d.y, l.y, t, n, r), Oi.initNonuniformCatmullRom(c.z, u.z, d.z, l.z, t, n, r);
		} else this.curveType === "catmullrom" && (Ei.initCatmullRom(c.x, u.x, d.x, l.x, this.tension), Di.initCatmullRom(c.y, u.y, d.y, l.y, this.tension), Oi.initCatmullRom(c.z, u.z, d.z, l.z, this.tension));
		return n.set(Ei.calc(s), Di.calc(s), Oi.calc(s)), n;
	}
	copy(e) {
...
function zi(e, t, n, r, i) {
	return Fi(e, t) + Ii(e, n) + Li(e, r) + Ri(e, i);
}
var Bi = class extends bi {
	...
	getPoint(e, t = new q()) {
		...
		return n.set(zi(e, r.x, i.x, a.x, o.x), zi(e, r.y, i.y, a.y, o.y)), n;
	}
	copy(e) {
	...
	getPoint(e, t = new J()) {
		let n = t, r = this.v0, i = this.v1, a = this.v2, o = this.v3;
		return n.set(zi(e, r.x, i.x, a.x, o.x), zi(e, r.y, i.y, a.y, o.y), zi(e, r.z, i.z, a.z, o.z)), n;
	}
	copy(e) {
		return super.copy(e), this.v0.copy(e.v0), this.v1.copy(e.v1), this.v2.copy(e.v2), this.v3.copy(e.v3), this;
	}
	...
	getPoint(e, t = new q()) {
		...
		return n.set(Pi(e, r.x, i.x, a.x), Pi(e, r.y, i.y, a.y)), n;
	}
	copy(e) {
	...
	getPoint(e, t = new J()) {
		let n = t, r = this.v0, i = this.v1, a = this.v2;
		return n.set(Pi(e, r.x, i.x, a.x), Pi(e, r.y, i.y, a.y), Pi(e, r.z, i.z, a.z)), n;
	}
	copy(e) {
		return super.copy(e), this.v0.copy(e.v0), this.v1.copy(e.v1), this.v2.copy(e.v2), this;
	}
	...
	getPoint(e, t = new q()) {
		...
		return n.set(Ai(o, s.x, c.x, l.x, u.x), Ai(o, s.y, c.y, l.y, u.y)), n;
	}
	copy(e) {
		super.copy(e), this.points = [];
		for (let t = 0, n = e.points.length; t < n; t++) {
	...
	CatmullRomCurve3: ki,
	CubicBezierCurve: Bi,
	CubicBezierCurve3: Vi,
	EllipseCurve: xi,
	LineCurve: Hi,
	LineCurve3: Ui,
	QuadraticBezierCurve: Wi,
	QuadraticBezierCurve3: Gi,
	SplineCurve: Ki
}), Ji = class extends bi {
	constructor() {
	...
	fromJSON(e) {
		...
		for (let t = 0, n = e.curves.length; t < n; t++) {
			let n = e.curves[t];
			this.curves.push(new qi[n.type]().fromJSON(n));
		}
		return this;
	}
}, Yi = class extends Ji {
	...
	lineTo(e, t) {
		let n = new Hi(this.currentPoint.clone(), new q(e, t));
		return this.curves.push(n), this.currentPoint.set(e, t), this;
	}
	quadraticCurveTo(e, t, n, r) {
		let i = new Wi(this.currentPoint.clone(), new q(e, t), new q(n, r));
		return this.curves.push(i), this.currentPoint.set(n, r), this;
	}
	bezierCurveTo(e, t, n, r, i, a) {
		let o = new Bi(this.currentPoint.clone(), new q(e, t), new q(n, r), new q(i, a));
		return this.curves.push(o), this.currentPoint.set(i, a), this;
	}
	splineThru(e) {
		let t = new Ki([this.currentPoint.clone()].concat(e));
	...
	constructor(e) {
		super(e), this.uuid = tt(), this.type = "Shape", this.holes = [];
	}
	getPointsHoles(e) {
		let t = [];
...
function Zi(e, t, n = 2) {
	let r = t && t.length, i = r ? t[0] * n : e.length, a = Qi(e, 0, i, n, !0), o = [];
	...
	return ea(a, o, n, s, c, l, 0), o;
}
function Qi(e, t, n, r, i) {
	let a;
	if (i === ka(e, t, n, r) > 0) for (let i = t; i < n; i += r) a = Ea(i / r | 0, e[i], e[i + 1], a);
	else for (let i = n - r; i >= t; i -= r) a = Ea(i / r | 0, e[i], e[i + 1], a);
	return a && va(a, a.next) && (Da(a), a = a.next), a;
}
function $i(e, t) {
	if (!e) return e;
	t ||= e;
	let n = e, r;
	do
		if (r = !1, !n.steiner && (va(n, n.next) || _a(n.prev, n, n.next) === 0)) {
			if (Da(n), n = t = n.prev, n === n.next) break;
			r = !0;
		} else n = n.next;
	while (r || n !== t);
	return t;
...
function ea(e, t, n, r, i, a, o) {
	...
	for (; e.prev !== e.next;) {
		...
		if (a ? na(e, r, i, a) : ta(e)) {
			t.push(c.i, e.i, l.i), Da(e), e = l.next, s = l.next;
			continue;
		}
		if (e = l, e === s) {
			o ? o === 1 ? (e = ra($i(e), t), ea(e, t, n, r, i, a, 2)) : o === 2 && ia(e, t, n, r, i, a) : ea($i(e), t, n, r, i, a, 1);
			break;
		}
	}
}
...
function na(e, t, n, r) {
	...
	for (; y && y.z >= _ && b && b.z <= v;) {
		if (y.x >= p && y.x <= h && y.y >= m && y.y <= g && y !== i && y !== o && ha(s, u, c, d, l, f, y.x, y.y) && _a(y.prev, y, y.next) >= 0 || (y = y.prevZ, b.x >= p && b.x <= h && b.y >= m && b.y <= g && b !== i && b !== o && ha(s, u, c, d, l, f, b.x, b.y) && _a(b.prev, b, b.next) >= 0)) return !1;
		b = b.nextZ;
	}
	for (; y && y.z >= _;) {
		if (y.x >= p && y.x <= h && y.y >= m && y.y <= g && y !== i && y !== o && ha(s, u, c, d, l, f, y.x, y.y) && _a(y.prev, y, y.next) >= 0) return !1;
		y = y.prevZ;
	}
	for (; b && b.z <= v;) {
		if (b.x >= p && b.x <= h && b.y >= m && b.y <= g && b !== i && b !== o && ha(s, u, c, d, l, f, b.x, b.y) && _a(b.prev, b, b.next) >= 0) return !1;
		b = b.nextZ;
	}
	return !0;
}
function ra(e, t) {
	...
	do {
		...
		!va(r, i) && ya(r, n, n.next, i) && Ca(r, i) && Ca(i, r) && (t.push(r.i, n.i, i.i), Da(n), Da(n.next), n = e = i), n = n.next;
	} while (n !== e);
	return $i(n);
}
function ia(e, t, n, r, i, a) {
	...
	do {
		...
		for (; e !== o.prev;) {
			if (o.i !== e.i && ga(o, e)) {
				let s = Ta(o, e);
				o = $i(o, o.next), s = $i(s, s.next), ea(o, t, n, r, i, a, 0), ea(s, t, n, r, i, a, 0);
				return;
			}
			e = e.next;
		}
...
function aa(e, t, n, r) {
	...
	for (let n = 0, a = t.length; n < a; n++) {
		let o = Qi(e, t[n] * r, n < a - 1 ? t[n + 1] * r : e.length, r, !1);
		o === o.next && (o.steiner = !0), i.push(pa(o));
	}
	i.sort(oa);
	for (let e = 0; e < i.length; e++) n = sa(i[e], n);
	return n;
}
function oa(e, t) {
	let n = e.x - t.x;
...
function ca(e, t) {
	...
	n = o;
	do {
		if (r >= n.x && n.x >= c && r !== n.x && ma(i < l ? r : a, i, c, l, i < l ? a : r, i, n.x, n.y)) {
			let t = Math.abs(i - n.y) / (r - n.x);
			Ca(n, e) && (t < u || t === u && (n.x > o.x || n.x === o.x && la(o, n))) && (o = n, u = t);
		}
		n = n.next;
	} while (n !== s);
	return o;
...
function la(e, t) {
	return _a(e.prev, e, t.prev) < 0 && _a(t.next, e, e.next) < 0;
}
function ua(e, t, n, r) {
	let i = e;
	do
	...
	while (i !== e);
	i.prevZ.nextZ = null, i.prevZ = null, da(i);
}
function da(e) {
	let t, n = 1;
	do {
...
function ha(e, t, n, r, i, a, o, s) {
	return !(e === o && t === s) && ma(e, t, n, r, i, a, o, s);
}
function ga(e, t) {
	return e.next.i !== t.i && e.prev.i !== t.i && !Sa(e, t) && (Ca(e, t) && Ca(t, e) && wa(e, t) && (_a(e.prev, e, t.prev) || _a(e, t.prev, t)) || va(e, t) && _a(e.prev, e, e.next) > 0 && _a(t.prev, t, t.next) > 0);
}
function _a(e, t, n) {
...
function ya(e, t, n, r) {
	let i = xa(_a(e, t, n)), a = xa(_a(e, t, r)), o = xa(_a(n, r, e)), s = xa(_a(n, r, t));
	return !!(i !== a && o !== s || i === 0 && ba(e, n, t) || a === 0 && ba(e, r, t) || o === 0 && ba(n, e, r) || s === 0 && ba(n, t, r));
}
function ba(e, t, n) {
...
function Sa(e, t) {
	let n = e;
	do {
		if (n.i !== e.i && n.next.i !== e.i && n.i !== t.i && n.next.i !== t.i && ya(n, n.next, e, t)) return !0;
		n = n.next;
	} while (n !== e);
	return !1;
}
function Ca(e, t) {
	return _a(e.prev, e, e.next) < 0 ? _a(e, t, e.next) >= 0 && _a(e, e.prev, t) >= 0 : _a(e, t, e.prev) < 0 || _a(e, e.next, t) < 0;
}
function wa(e, t) {
...
function Ta(e, t) {
	let n = Oa(e.i, e.x, e.y), r = Oa(t.i, t.x, t.y), i = e.next, a = t.prev;
...
var Aa = class {
	...
	static triangulateShape(e, t) {
		...
		let a = e.length;
		t.forEach(Ma);
		for (let e = 0; e < t.length; e++) r.push(a), a += t[e].length, Na(n, t[e]);
		let o = Aa.triangulate(n, r);
...
var Pa = class e extends Cr {
	constructor(e = new Xi([
		...
		this.setAttribute("position", new dr(r, 3)), this.setAttribute("uv", new dr(i, 2)), this.computeVertexNormals();
		function a(e) {
			let a = [], o = t.curveSegments === void 0 ? 12 : t.curveSegments, s = t.steps === void 0 ? 1 : t.steps, c = t.depth === void 0 ? 1 : t.depth, l = t.bevelEnabled === void 0 ? !0 : t.bevelEnabled, u = t.bevelThickness === void 0 ? .2 : t.bevelThickness, d = t.bevelSize === void 0 ? u - .1 : t.bevelSize, f = t.bevelOffset === void 0 ? 0 : t.bevelOffset, p = t.bevelSegments === void 0 ? 3 : t.bevelSegments, m = t.extrudePath, h = t.UVGenerator === void 0 ? Fa : t.UVGenerator, g, _ = !1, v, y, b, x;
			if (m) {
			...
			if (!ja.isClockWise(C)) {
				...
				for (let e = 0, t = w.length; e < t; e++) {
					let t = w[e];
					ja.isClockWise(t) && (w[e] = t.reverse());
				}
			}
			function T(e) {
				let t = e[0];
			...
			let P;
			if (p === 0) P = ja.triangulateShape(D, w);
			else {
				let e = [], t = [];
				for (let n = 0; n < p; n++) {
					...
					for (let e = 0, n = E; e < n; e++) {
						...
						for (let e = 0, t = n.length; e < t; e++) {
							let t = O(n[e], M[e], a);
							I(t.x, t.y, -i), r === 0 && o.push(t);
						}
						r === 0 && t.push(o);
					}
				}
				P = ja.triangulateShape(e, t);
			}
			let F = P.length, te = d + f;
			for (let e = 0; e < k; e++) {
				let t = l ? O(C[e], N[e], te) : C[e];
				_ ? (b.copy(v.normals[0]).multiplyScalar(t.x), y.copy(v.binormals[0]).multiplyScalar(t.y), x.copy(g[0]).add(b).add(y), I(x.x, x.y, x.z)) : I(t.x, t.y, 0);
			}
			for (let e = 1; e <= s; e++) for (let t = 0; t < k; t++) {
				let n = l ? O(C[t], N[t], te) : C[t];
				_ ? (b.copy(v.normals[e]).multiplyScalar(n.x), y.copy(v.binormals[e]).multiplyScalar(n.y), x.copy(g[e]).add(b).add(y), I(x.x, x.y, x.z)) : I(n.x, n.y, c / s * e);
			}
			for (let e = p - 1; e >= 0; e--) {
				...
				for (let e = 0, t = w.length; e < t; e++) {
					...
					for (let e = 0, i = t.length; e < i; e++) {
						let i = O(t[e], M[e], r);
						_ ? I(i.x, i.y + g[s - 1].y, g[s - 1].x + n) : I(i.x, i.y, c + n);
					}
				}
			}
			ne(), re();
	...
	static fromJSON(t, n) {
		...
		return i !== void 0 && (t.options.extrudePath = new qi[i.type]().fromJSON(i)), new e(r, t.options);
	}
}, Fa = {
...
var La = class e extends Cr {
	constructor(e = 1, t = 1, n = 1, r = 1) {
		...
		this.setIndex(f), this.setAttribute("position", new dr(p, 3)), this.setAttribute("normal", new dr(m, 3)), this.setAttribute("uv", new dr(h, 2));
	}
	copy(e) {
		return super.copy(e), this.parameters = Object.assign({}, e.parameters), this;
	}
	...
	constructor(e = .5, t = 1, n = 32, r = 1, i = 0, a = Math.PI * 2) {
		...
		let o = [], s = [], c = [], l = [], u = e, d = (t - e) / r, f = new J(), p = new q();
		for (let e = 0; e <= r; e++) {
			for (let e = 0; e <= n; e++) {
				let r = i + e / n * a;
		...
		this.setIndex(o), this.setAttribute("position", new dr(s, 3)), this.setAttribute("normal", new dr(c, 3)), this.setAttribute("uv", new dr(l, 2));
	}
	copy(e) {
		return super.copy(e), this.parameters = Object.assign({}, e.parameters), this;
	}
	...
	constructor(e = new Xi([
		...
		this.setIndex(n), this.setAttribute("position", new dr(r, 3)), this.setAttribute("normal", new dr(i, 3)), this.setAttribute("uv", new dr(a, 2));
		function c(e) {
			let o = r.length / 3, c = e.extractPoints(t), l = c.shape, u = c.holes;
			ja.isClockWise(l) === !1 && (l = l.reverse());
			for (let e = 0, t = u.length; e < t; e++) {
				let t = u[e];
				ja.isClockWise(t) === !0 && (u[e] = t.reverse());
			}
			let d = ja.triangulateShape(l, u);
			for (let e = 0, t = u.length; e < t; e++) {
				let t = u[e];
				l = l.concat(t);
			}
...
var Va = class e extends Cr {
	constructor(e = 1, t = 32, n = 16, r = 0, i = Math.PI * 2, a = 0, o = Math.PI) {
		...
		let s = Math.min(a + o, Math.PI), c = 0, l = [], u = new J(), d = new J(), f = [], p = [], m = [], h = [];
		for (let f = 0; f <= n; f++) {
			let g = [], _ = f / n, v = 0;
	...
	constructor(e = 1, t = .4, n = 12, r = 48, i = Math.PI * 2, a = 0, o = Math.PI * 2) {
		...
		let s = [], c = [], l = [], u = [], d = new J(), f = new J(), p = new J();
		for (let s = 0; s <= n; s++) {
			let m = a + s / n * o;
			for (let a = 0; a <= r; a++) {
				let o = a / r * i;
...
function Ua(e) {
	...
	for (let n in e) {
		...
		for (let r in e[n]) {
			let i = e[n][r];
			if (Ga(i)) i.isRenderTargetTexture ? (W("UniformsUtils: Textures of render targets cannot be cloned via cloneUniforms() or mergeUniforms()."), t[n][r] = null) : t[n][r] = i.clone();
			else if (Array.isArray(i)) if (Ga(i[0])) {
				let e = [];
...
var Ja = {
	...
	constructor(e) {
		super(), this.isShaderMaterial = !0, this.type = "ShaderMaterial", this.defines = {}, this.uniforms = {}, this.uniformsGroups = [], this.vertexShader = Ya, this.fragmentShader = Xa, this.linewidth = 1, this.wireframe = !1, this.wireframeLinewidth = 1, this.fog = !1, this.lights = !1, this.clipping = !1, this.forceSinglePass = !0, this.extensions = {
			clipCullDistance: !1,
			multiDraw: !1
	...
	constructor(e) {
		super(), this.isMeshLambertMaterial = !0, this.type = "MeshLambertMaterial", this.color = new Z(16777215), this.map = null, this.lightMap = null, this.lightMapIntensity = 1, this.aoMap = null, this.aoMapIntensity = 1, this.emissive = new Z(0), this.emissiveIntensity = 1, this.emissiveMap = null, this.bumpMap = null, this.bumpScale = 1, this.normalMap = null, this.normalMapType = 0, this.normalScale = new q(1, 1), this.displacementMap = null, this.displacementScale = 1, this.displacementBias = 0, this.specularMap = null, this.alphaMap = null, this.envMap = null, this.envMapRotation = new tn(), this.combine = 0, this.reflectivity = 1, this.envMapIntensity = 1, this.refractionRatio = .98, this.wireframe = !1, this.wireframeLinewidth = 1, this.wireframeLinecap = "round", this.wireframeLinejoin = "round", this.flatShading = !1, this.fog = !0, this.setValues(e);
	}
	copy(e) {
...
var ao = class {
	...
	InterpolantFactoryMethodBezier(e) {
		let t = new lo(this.times, this.values, this.getValueSize(), e);
	...
	getInterpolation() {
		switch (this.createInterpolant) {
			case this.InterpolantFactoryMethodDiscrete: return B;
			case this.InterpolantFactoryMethodLinear: return Oe;
			case this.InterpolantFactoryMethodSmooth: return V;
	...
	validate() {
		...
		if (r !== void 0 && Be(r)) for (let t = 0, n = r.length; t !== n; ++t) {
			let n = r[t];
			if (isNaN(n)) {
	...
	optimize() {
		let e = this.times.slice(), t = this.values.slice(), n = this.getValueSize(), r = this.getInterpolation() === V, i = e.length - 1, a = 1;
		for (let o = 1; o < i; ++o) {
			let i = !1, s = e[o];
...
uo.prototype.ValueTypeName = "", uo.prototype.TimeBufferType = Float32Array, uo.prototype.ValueBufferType = Float32Array, uo.prototype.DefaultInterpolation = Oe;
var fo = class extends uo {
	constructor(e, t, n) {
		super(e, t, n);
	}
};
fo.prototype.ValueTypeName = "bool", fo.prototype.ValueBufferType = Array, fo.prototype.DefaultInterpolation = B, fo.prototype.InterpolantFactoryMethodLinear = void 0, fo.prototype.InterpolantFactoryMethodSmooth = void 0;
...
var ho = class extends ao {
	...
	interpolate_(e, t, n, r) {
		...
		for (let e = c + o; c !== e; c += 4) Ct.slerpFlat(i, 0, a, c - o, a, c, s);
		return i;
	}
}, go = class extends uo {
	constructor(e, t, n, r) {
...
var _o = class extends uo {
	constructor(e, t, n) {
		super(e, t, n);
	}
};
_o.prototype.ValueTypeName = "string", _o.prototype.ValueBufferType = Array, _o.prototype.DefaultInterpolation = B, _o.prototype.InterpolantFactoryMethodLinear = void 0, _o.prototype.InterpolantFactoryMethodSmooth = void 0;
...
var yo = {
	...
	files: {},
	add: function(e, t) {
		this.enabled !== !1 && (bo(e) || (this.files[e] = t));
	},
	get: function(e) {
		if (this.enabled !== !1 && !bo(e)) return this.files[e];
	},
	remove: function(e) {
		delete this.files[e];
	},
...
var xo = /* @__PURE__ */ new class {
	...
	constructor(e) {
		this.manager = e === void 0 ? xo : e, this.crossOrigin = "anonymous", this.withCredentials = !1, this.path = "", this.resourcePath = "", this.requestHeader = {}, typeof __THREE_DEVTOOLS__ < "u" && __THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe", { detail: this }));
	}
	load() {}
	loadAsync(e, t) {
		let n = this;
...
var Co = /* @__PURE__ */ new WeakMap(), wo = class extends So {
	constructor(e) {
		super(e);
	}
	load(e, t, n, r) {
		this.path !== void 0 && (e = this.path + e), e = this.manager.resolveURL(e);
		let i = this, a = yo.get(`image:${e}`);
		if (a !== void 0) {
		...
		function s() {
			...
			Co.delete(this), i.manager.itemEnd(e);
		}
		function c(t) {
			l(), r && r(t), yo.remove(`image:${e}`);
			let n = Co.get(this) || [];
			for (let e = 0; e < n.length; e++) {
				let r = n[e];
				r.onError && r.onError(t);
			}
			Co.delete(this), i.manager.itemError(e), i.manager.itemEnd(e);
		}
		function l() {
			o.removeEventListener("load", s, !1), o.removeEventListener("error", c, !1);
		}
		return o.addEventListener("load", s, !1), o.addEventListener("error", c, !1), e.slice(0, 5) !== "data:" && this.crossOrigin !== void 0 && (o.crossOrigin = this.crossOrigin), yo.add(`image:${e}`, o), i.manager.itemStart(e), o.src = e, o;
	}
}, To = class extends So {
	constructor(e) {
		super(e);
	...
	load(e, t, n, r) {
		let i = new zt(), a = new wo(this.manager);
	...
	constructor(e, t, n) {
		super(e, n), this.isHemisphereLight = !0, this.type = "HemisphereLight", this.position.copy(yn.DEFAULT_UP), this.updateMatrix(), this.groundColor = new Z(t);
	}
	copy(e, t) {
...
}, Oo = /* @__PURE__ */ new Gt(), ko = /* @__PURE__ */ new J(), Ao = /* @__PURE__ */ new J(), jo = class {
	constructor(e) {
		this.camera = e, this.intensity = 1, this.bias = 0, this.biasNode = null, this.normalBias = 0, this.radius = 1, this.blurSamples = 8, this.mapSize = new q(512, 512), this.mapType = l, this.map = null, this.mapPass = null, this.matrix = new Gt(), this.autoUpdate = !0, this.needsUpdate = !1, this._frustum = new fi(), this._frameExtents = new q(1, 1), this._viewportCount = 1, this._viewports = [new Bt(0, 0, 1, 1)];
	}
	getViewportCount() {
	...
	updateMatrices(e) {
		...
		ko.setFromMatrixPosition(e.matrixWorld), t.position.copy(ko), Ao.setFromMatrixPosition(e.target.matrixWorld), t.lookAt(Ao), t.updateMatrixWorld(), Oo.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse), this._frustum.setFromProjectionMatrix(Oo, t.coordinateSystem, t.reversedDepth), t.coordinateSystem === 2001 || t.reversedDepth ? n.set(.5, 0, 0, .5, 0, .5, 0, .5, 0, 0, 1, 0, 0, 0, 0, 1) : n.set(.5, 0, 0, .5, 0, .5, 0, .5, 0, 0, .5, .5, 0, 0, 0, 1), n.multiply(Oo);
	}
	getViewport(e) {
...
}, Mo = /* @__PURE__ */ new J(), No = /* @__PURE__ */ new Ct(), Po = /* @__PURE__ */ new J(), Fo = class extends yn {
	constructor() {
		super(), this.isCamera = !0, this.type = "Camera", this.matrixWorldInverse = new Gt(), this.projectionMatrix = new Gt(), this.projectionMatrixInverse = new Gt(), this.coordinateSystem = Re, this._reversedDepth = !1;
	}
	get reversedDepth() {
	...
	updateMatrixWorld(e) {
		super.updateMatrixWorld(e), this.matrixWorld.decompose(Mo, No, Po), Po.x === 1 && Po.y === 1 && Po.z === 1 ? this.matrixWorldInverse.copy(this.matrixWorld).invert() : this.matrixWorldInverse.compose(Mo, No, Po.set(1, 1, 1)).invert();
	}
	updateWorldMatrix(e, t) {
		super.updateWorldMatrix(e, t), this.matrixWorld.decompose(Mo, No, Po), Po.x === 1 && Po.y === 1 && Po.z === 1 ? this.matrixWorldInverse.copy(this.matrixWorld).invert() : this.matrixWorldInverse.compose(Mo, No, Po.set(1, 1, 1)).invert();
	}
	clone() {
		return new this.constructor().copy(this);
	}
}, Io = /* @__PURE__ */ new J(), Lo = /* @__PURE__ */ new q(), Ro = /* @__PURE__ */ new q(), zo = class extends Fo {
	...
	getFocalLength() {
		let e = Math.tan($e * .5 * this.fov);
		return .5 * this.getFilmHeight() / e;
	}
	getEffectiveFOV() {
		return et * 2 * Math.atan(Math.tan($e * .5 * this.fov) / this.zoom);
	}
	getFilmWidth() {
	...
	getViewBounds(e, t, n) {
		Io.set(-1, -1, .5).applyMatrix4(this.projectionMatrixInverse), t.set(Io.x, Io.y).multiplyScalar(-e / Io.z), Io.set(1, 1, .5).applyMatrix4(this.projectionMatrixInverse), n.set(Io.x, Io.y).multiplyScalar(-e / Io.z);
	}
	getViewSize(e, t) {
		return this.getViewBounds(e, Lo, Ro), t.subVectors(Ro, Lo);
	}
	...
	updateProjectionMatrix() {
		let e = this.near, t = e * Math.tan($e * .5 * this.fov) / this.zoom, n = 2 * t, r = this.aspect * n, i = -.5 * r, a = this.view;
	...
	constructor() {
		super(new zo(90, 1, .5, 500)), this.isPointLightShadow = !0;
	}
}, Vo = class extends Eo {
	constructor(e, t, n = 0, r = 2) {
		super(e, t), this.isPointLight = !0, this.type = "PointLight", this.distance = n, this.decay = r, this.shadow = new Bo();
	}
	get power() {
	...
	constructor() {
		super(new Ho(-5, 5, 5, -5, .5, 500)), this.isDirectionalLightShadow = !0;
	}
}, Wo = class extends Eo {
	constructor(e, t) {
		super(e, t), this.isDirectionalLight = !0, this.type = "DirectionalLight", this.position.copy(yn.DEFAULT_UP), this.updateMatrix(), this.target = new yn(), this.shadow = new Uo();
	}
	dispose() {
		super.dispose(), this.shadow.dispose();
	}
...
}, Ko = -90, qo = 1, Jo = class extends yn {
	constructor(e, t, n) {
		super(), this.type = "CubeCamera", this.renderTarget = n, this.coordinateSystem = null, this.activeMipmapLevel = 0;
		let r = new zo(Ko, qo, e, t);
		r.layers = this.layers, this.add(r);
		let i = new zo(Ko, qo, e, t);
		i.layers = this.layers, this.add(i);
		let a = new zo(Ko, qo, e, t);
		a.layers = this.layers, this.add(a);
		let o = new zo(Ko, qo, e, t);
		o.layers = this.layers, this.add(o);
		let s = new zo(Ko, qo, e, t);
		s.layers = this.layers, this.add(s);
		let c = new zo(Ko, qo, e, t);
	...
	connect(e) {
		this._document = e, e.hidden !== void 0 && (this._pageVisibilityHandler = Zo.bind(this), e.addEventListener("visibilitychange", this._pageVisibilityHandler, !1));
	}
	disconnect() {
...
var Qo = "\\[\\]\\.:\\/", $o = /* @__PURE__ */ RegExp("[\\[\\]\\.:\\/]", "g"), es = "[^\\[\\]\\.:\\/]", ts = "[^" + Qo.replace("\\.", "") + "]", ns = /* @__PURE__ */ "((?:WC+[\\/:])*)".replace("WC", es), rs = /* @__PURE__ */ "(WCOD+)?".replace("WCOD", ts), is = /* @__PURE__ */ "(?:\\.(WC+)(?:\\[(.+)\\])?)?".replace("WC", es), as = /* @__PURE__ */ "\\.(WC+)(?:\\[(.+)\\])?".replace("WC", es), os = RegExp("^" + ns + rs + is + as + "$"), ss = [
	"material",
	"materials",
	"bones",
	"map"
	...
	static parseTrackName(e) {
		...
		if (r !== void 0 && r !== -1) {
			...
			ss.indexOf(e) !== -1 && (n.nodeName = n.nodeName.substring(0, r), n.objectName = e);
		}
...
ls.Composite = cs, ls.prototype.BindingType = {
	Direct: 0,
	EntireArray: 1,
	ArrayElement: 2,
	HasFromToArray: 3
}, ls.prototype.Versioning = {
	None: 0,
	NeedsUpdate: 1,
	MatrixWorldNeedsUpdate: 2
}, ls.prototype.GetterByBindingType = [
	ls.prototype._getValue_direct,
	ls.prototype._getValue_array,
	ls.prototype._getValue_arrayElement,
	ls.prototype._getValue_toArray
], ls.prototype.SetterByBindingTypeAndVersioning = [
	[
		ls.prototype._setValue_direct,
		ls.prototype._setValue_direct_setNeedsUpdate,
		ls.prototype._setValue_direct_setMatrixWorldNeedsUpdate
	],
	[
		ls.prototype._setValue_array,
		ls.prototype._setValue_array_setNeedsUpdate,
		ls.prototype._setValue_array_setMatrixWorldNeedsUpdate
	],
	[
		ls.prototype._setValue_arrayElement,
		ls.prototype._setValue_arrayElement_setNeedsUpdate,
		ls.prototype._setValue_arrayElement_setMatrixWorldNeedsUpdate
	],
	[
		ls.prototype._setValue_fromArray,
		ls.prototype._setValue_fromArray_setNeedsUpdate,
		ls.prototype._setValue_fromArray_setMatrixWorldNeedsUpdate
	]
];
var us = class e {
	constructor(e) {
...
}, ds = /* @__PURE__ */ new Gt(), fs = class {
	constructor(e, t, n = 0, r = Infinity) {
		this.ray = new Nr(e, t), this.near = n, this.far = r, this.camera = null, this.layers = new nn(), this.params = {
			Mesh: {},
			Line: { threshold: 1 },
			LOD: {},
			Points: { threshold: 1 },
	...
	setFromXRController(e) {
		return ds.identity().extractRotation(e.matrixWorld), this.ray.origin.setFromMatrixPosition(e.matrixWorld), this.ray.direction.set(0, 0, -1).applyMatrix4(ds), this;
	}
	intersectObject(e, t = !0, n = []) {
		return ms(e, this, n, t), n.sort(ps), n;
	}
	intersectObjects(e, t = !0, n = []) {
		for (let r = 0, i = e.length; r < i; r++) ms(e[r], this, n, t);
		return n.sort(ps), n;
	}
};
function ps(e, t) {
...
function ms(e, t, n, r) {
	...
	if (e.layers.test(t.layers) && e.raycast(t, n) === !1 && (i = !1), i === !0 && r === !0) {
		let r = e.children;
		for (let e = 0, i = r.length; e < i; e++) ms(r[e], t, n, !0);
	}
}
(class e {
	static {
...
function hs(e, t, n, r) {
	...
	switch (n) {
		case S: return e * t;
		case D: return e * t / i.components * i.byteLength;
		case O: return e * t / i.components * i.byteLength;
		case k: return e * t * 2 / i.components * i.byteLength;
		case A: return e * t * 2 / i.components * i.byteLength;
		case C: return e * t * 3 / i.components * i.byteLength;
		case w: return e * t * 4 / i.components * i.byteLength;
		...
		case te:
		case re: return Math.max(e, 16) * Math.max(t, 8) / 4;
		case F:
		case ne: return Math.max(e, 8) * Math.max(t, 8) / 2;
		case ie:
		case I:
		case oe:
		case L: return Math.floor((e + 3) / 4) * Math.floor((t + 3) / 4) * 8;
		case ae:
		case R:
		case se: return Math.floor((e + 3) / 4) * Math.floor((t + 3) / 4) * 16;
		case ce: return Math.floor((e + 3) / 4) * Math.floor((t + 3) / 4) * 16;
		case le: return Math.floor((e + 4) / 5) * Math.floor((t + 3) / 4) * 16;
		case ue: return Math.floor((e + 4) / 5) * Math.floor((t + 4) / 5) * 16;
		case de: return Math.floor((e + 5) / 6) * Math.floor((t + 4) / 5) * 16;
		case fe: return Math.floor((e + 5) / 6) * Math.floor((t + 5) / 6) * 16;
		case pe: return Math.floor((e + 7) / 8) * Math.floor((t + 4) / 5) * 16;
		case me: return Math.floor((e + 7) / 8) * Math.floor((t + 5) / 6) * 16;
		case he: return Math.floor((e + 7) / 8) * Math.floor((t + 7) / 8) * 16;
		case ge: return Math.floor((e + 9) / 10) * Math.floor((t + 4) / 5) * 16;
		case _e: return Math.floor((e + 9) / 10) * Math.floor((t + 5) / 6) * 16;
		case ve: return Math.floor((e + 9) / 10) * Math.floor((t + 7) / 8) * 16;
		case ye: return Math.floor((e + 9) / 10) * Math.floor((t + 9) / 10) * 16;
		case be: return Math.floor((e + 11) / 12) * Math.floor((t + 9) / 10) * 16;
...
ys.physical = {
	uniforms: /* @__PURE__ */ Wa([ys.standard.uniforms, {
		clearcoat: { value: 0 },
...
var bs = {
	...
	b: 0,
	g: 0
}, xs = /* @__PURE__ */ new Gt(), Ss = /* @__PURE__ */ new Y();
Ss.set(-1, 0, 0, 0, 1, 0, 0, 0, 1);
function Cs(e, t, n, r, i, a) {
	...
	function h(t, n) {
		let i = p(n);
		i && (i.isCubeTexture || i.mapping === 306) ? (l === void 0 && (l = new Kr(new _i(1, 1, 1), new Za({
			name: "BackgroundCubeMaterial",
			uniforms: Ua(ys.backgroundCube.uniforms),
		...
		} }), r.update(l)), l.material.uniforms.envMap.value = i, l.material.uniforms.backgroundBlurriness.value = n.backgroundBlurriness, l.material.uniforms.backgroundIntensity.value = n.backgroundIntensity, l.material.uniforms.backgroundRotation.value.setFromMatrix4(xs.makeRotationFromEuler(n.backgroundRotation)).transpose(), i.isCubeTexture && i.isRenderTargetTexture === !1 && l.material.uniforms.backgroundRotation.value.premultiply(Ss), l.material.toneMapped = X.getTransfer(i.colorSpace) !== Fe, (u !== i || d !== i.version || f !== e.toneMapping) && (l.material.needsUpdate = !0, u = i, d = i.version, f = e.toneMapping), l.layers.enableAll(), t.unshift(l, l.geometry, l.material, 0, 0, null)) : i && i.isTexture && (c === void 0 && (c = new Kr(new La(2, 2), new Za({
			name: "BackgroundMaterial",
			uniforms: Ua(ys.background.uniforms),
	...
	function g(t, r) {
		t.getRGB(bs, qa(e)), n.buffers.color.setClear(bs.r, bs.g, bs.b, r, a);
	}
	function _() {
...
function Ds(e) {
	let t = this, n = null, r = 0, i = !1, a = !1, o = new ci(), s = new Y(), c = {
		value: null,
		needsUpdate: !1
	};
...
var Os = 4, ks = [
	...
	.526,
	.582
], As = 20, js = 256, Ms = /* @__PURE__ */ new Ho(), Ns = /* @__PURE__ */ new Z(), Ps = null, Fs = 0, Is = 0, Ls = !1, Rs = /* @__PURE__ */ new J(), zs = class {
	constructor(e) {
		this._renderer = e, this._pingPongRenderTarget = null, this._lodMax = 0, this._cubeSize = 0, this._sizeLods = [], this._sigmas = [], this._lodMeshes = [], this._backgroundBox = null, this._cubemapMaterial = null, this._equirectMaterial = null, this._blurMaterial = null, this._ggxMaterial = null;
	}
	fromScene(e, t = 0, n = .1, r = 100, i = {}) {
		let { size: a = 256, position: o = Rs } = i;
		Ps = this._renderer.getRenderTarget(), Fs = this._renderer.getActiveCubeFace(), Is = this._renderer.getActiveMipmapLevel(), Ls = this._renderer.xr.enabled, this._renderer.xr.enabled = !1, this._setSize(a);
	...
	compileCubemapShader() {
		this._cubemapMaterial === null && (this._cubemapMaterial = Ks(), this._compileMaterial(this._cubemapMaterial));
	}
	...
	_cleanup(e) {
		this._renderer.setRenderTarget(Ps, Fs, Is), this._renderer.xr.enabled = Ls, e.scissorTest = !1, Hs(e, 0, 0, e.width, e.height);
	}
	_fromTexture(e, t) {
		e.mapping === 301 || e.mapping === 302 ? this._setSize(e.image.length === 0 ? 16 : e.image[0].width || e.image[0].image.width) : this._setSize(e.image.width / 4), Ps = this._renderer.getRenderTarget(), Fs = this._renderer.getActiveCubeFace(), Is = this._renderer.getActiveMipmapLevel(), Ls = this._renderer.xr.enabled, this._renderer.xr.enabled = !1;
	...
	_allocateTargets() {
		...
		if (this._pingPongRenderTarget === null || this._pingPongRenderTarget.width !== e || this._pingPongRenderTarget.height !== t) {
			...
			let { _lodMax: r } = this;
			({lodMeshes: this._lodMeshes, sizeLods: this._sizeLods, sigmas: this._sigmas} = Bs(r)), this._blurMaterial = Ws(r, e, t), this._ggxMaterial = Us(r, e, t);
		}
		return r;
	}
	_compileMaterial(e) {
		let t = new Kr(new Cr(), e);
		this._renderer.compile(t, Ms);
	}
	_sceneToCubeUV(e, t, n, r, i) {
		let a = new zo(90, 1, t, n), o = [
			1,
			-1,
			1,
			1,
		...
		c.getClearColor(Ns), c.toneMapping = 0, c.autoClear = !1, c.state.buffers.depth.getReversed() && (c.setRenderTarget(r), c.clearDepth(), c.setRenderTarget(null)), this._backgroundBox === null && (this._backgroundBox = new Kr(new _i(), new Pr({
		...
		m ? m.isColor && (f.color.copy(m), e.background = null, p = !0) : (f.color.copy(Ns), p = !0);
		for (let t = 0; t < 6; t++) {
			let n = t % 3;
			...
			Hs(r, n * l, t > 2 ? l : 0, l, l), c.setRenderTarget(r), p && c.render(d, a), c.render(e, a);
		}
		c.toneMapping = u, c.autoClear = l, e.background = m;
	}
	_textureToCubeUV(e, t) {
		let n = this._renderer, r = e.mapping === 301 || e.mapping === 302;
		r ? (this._cubemapMaterial === null && (this._cubemapMaterial = Ks()), this._cubemapMaterial.uniforms.flipEnvMap.value = e.isRenderTargetTexture === !1 ? -1 : 1) : this._equirectMaterial === null && (this._equirectMaterial = Gs());
		let i = r ? this._cubemapMaterial : this._equirectMaterial, a = this._lodMeshes[0];
		a.material = i;
		let o = i.uniforms;
		o.envMap.value = e;
		let s = this._cubeSize;
		Hs(t, 0, 0, 3 * s, 2 * s), n.setRenderTarget(t), n.render(a, Ms);
	}
	_applyPMREM(e) {
	...
	_applyGGXFilter(e, t, n) {
		...
		o.material = a;
		let s = a.uniforms, c = n / (this._lodMeshes.length - 1), l = t / (this._lodMeshes.length - 1), u = Math.sqrt(c * c - l * l) * (0 + c * 1.25), { _lodMax: d } = this, f = this._sizeLods[n], p = 3 * f * (n > d - Os ? n - d + Os : 0), m = 4 * (this._cubeSize - f);
		s.envMap.value = e.texture, s.roughness.value = u, s.mipInt.value = d - t, Hs(i, p, m, 3 * f, 2 * f), r.setRenderTarget(i), r.render(o, Ms), s.envMap.value = i.texture, s.roughness.value = 0, s.mipInt.value = d - n, Hs(e, p, m, 3 * f, 2 * f), r.setRenderTarget(e), r.render(o, Ms);
	}
	_blur(e, t, n, r, i) {
	...
	_halfBlur(e, t, n, r, i, a, o) {
		...
		l.material = c;
		let u = c.uniforms, d = this._sizeLods[n] - 1, f = isFinite(i) ? Math.PI / (2 * d) : 2 * Math.PI / (2 * As - 1), p = i / f, m = isFinite(i) ? 1 + Math.floor(3 * p) : As;
		m > As && W(`sigmaRadians, ${i}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${As}`);
		let h = [], g = 0;
		for (let e = 0; e < As; ++e) {
		...
		Hs(t, 3 * v * (r > _ - Os ? r - _ + Os : 0), 4 * (this._cubeSize - v), 3 * v, 2 * v), s.setRenderTarget(t), s.render(l, Ms);
	}
};
function Bs(e) {
	let t = [], n = [], r = [], i = e, a = e - Os + 1 + ks.length;
	for (let o = 0; o < a; o++) {
		let a = 2 ** i;
		t.push(a);
		let s = 1 / a;
		o > e - Os ? s = ks[o - e + Os - 1] : o === 0 && (s = 0), n.push(s);
		...
		let h = new Cr();
		h.setAttribute("position", new cr(f, 3)), h.setAttribute("uv", new cr(p, 2)), h.setAttribute("faceIndex", new cr(m, 1)), r.push(new Kr(h, null)), i > Os && i--;
	}
	return {
		lodMeshes: r,
		sizeLods: t,
...
function Ws(e, t, n) {
	let r = new Float32Array(As), i = new J(0, 1, 0);
	return new Za({
...
var Js = class extends Ht {
	constructor(e = 1, t = {}) {
		...
		this.texture = new pi(r), this._setTextureOptions(t), this.texture.isRenderTargetTexture = !0;
	}
	fromEquirectangularTexture(e, t) {
		...
		let a = new Kr(r, i), s = t.minFilter;
		return t.minFilter === 1008 && (t.minFilter = o), new Jo(1, 10, this).update(e, a), t.minFilter = s, a.geometry.dispose(), a.material.dispose(), this;
	}
	clear(e, t = !0, n = !0, r = !0) {
...
function Zs(e, t, n, r) {
	...
	function l(e) {
		...
		let s = new (i.count >= 65535 ? ur : lr)(n, 1);
		s.version = o;
		let c = a.get(e);
...
function ec(e, t, n) {
	let r = /* @__PURE__ */ new WeakMap(), i = new Bt();
	function a(a, o, s) {
		...
		if (d === void 0 || d.count !== u) {
			...
			let g = new Float32Array(p * m * 4 * u), _ = new Ut(g, p, m, u);
...
function rc(e, t, n, r, i) {
	let a = new Ht(t, n, {
		...
		depthBuffer: r,
		stencilBuffer: i,
		depthTexture: r ? new mi(t, n) : void 0
	}), o = new Ht(t, n, {
		type: g,
		depthBuffer: !1,
		stencilBuffer: !1
	}), s = new Cr();
	s.setAttribute("position", new dr([
		-1,
		3,
		0,
		-1,
	...
	let c = new Qa({
		...
		depthTest: !1,
		depthWrite: !1
	}), l = new Kr(s, c), u = new Ho(-1, 1, 1, -1, 0, 1), d = null, f = null, p = !1, m, h = null, _ = [], v = !1;
	this.setSize = function(e, t) {
		...
		if (d !== e.outputColorSpace || f !== e.toneMapping) {
			d = e.outputColorSpace, f = e.toneMapping, c.defines = {}, X.getTransfer(d) === "srgb" && (c.defines.SRGB_TRANSFER = "");
			let t = nc[f];
...
var ic = /* @__PURE__ */ new zt(), ac = /* @__PURE__ */ new mi(1, 1), oc = /* @__PURE__ */ new Ut(), sc = /* @__PURE__ */ new Wt(), cc = /* @__PURE__ */ new pi(), lc = [], uc = [], dc = new Float32Array(16), fc = new Float32Array(9), pc = new Float32Array(4);
function mc(e, t, n) {
	let r = e[0];
	if (r <= 0 || r > 0) return e;
	let i = t * n, a = lc[i];
	if (a === void 0 && (a = new Float32Array(i), lc[i] = a), t !== 0) {
		r.toArray(a, 0);
...
function _c(e, t) {
	let n = uc[t];
	n === void 0 && (n = new Int32Array(t), uc[t] = n);
...
function yc(e, t) {
	...
	if (t.x !== void 0) (n[0] !== t.x || n[1] !== t.y) && (e.uniform2f(this.addr, t.x, t.y), n[0] = t.x, n[1] = t.y);
		...
		if (hc(n, t)) return;
		e.uniform2fv(this.addr, t), gc(n, t);
	}
}
function bc(e, t) {
	let n = this.cache;
	if (t.x !== void 0) (n[0] !== t.x || n[1] !== t.y || n[2] !== t.z) && (e.uniform3f(this.addr, t.x, t.y, t.z), n[0] = t.x, n[1] = t.y, n[2] = t.z);
		...
		if (hc(n, t)) return;
		e.uniform3fv(this.addr, t), gc(n, t);
	}
}
function xc(e, t) {
	let n = this.cache;
	if (t.x !== void 0) (n[0] !== t.x || n[1] !== t.y || n[2] !== t.z || n[3] !== t.w) && (e.uniform4f(this.addr, t.x, t.y, t.z, t.w), n[0] = t.x, n[1] = t.y, n[2] = t.z, n[3] = t.w);
		...
		if (hc(n, t)) return;
		e.uniform4fv(this.addr, t), gc(n, t);
	}
}
function Sc(e, t) {
	...
	if (r === void 0) {
		if (hc(n, t)) return;
		e.uniformMatrix2fv(this.addr, !1, t), gc(n, t);
	} else {
		if (hc(n, r)) return;
		pc.set(r), e.uniformMatrix2fv(this.addr, !1, pc), gc(n, r);
	}
}
function Cc(e, t) {
	let n = this.cache, r = t.elements;
	if (r === void 0) {
		if (hc(n, t)) return;
		e.uniformMatrix3fv(this.addr, !1, t), gc(n, t);
	} else {
		if (hc(n, r)) return;
		fc.set(r), e.uniformMatrix3fv(this.addr, !1, fc), gc(n, r);
	}
}
function wc(e, t) {
	let n = this.cache, r = t.elements;
	if (r === void 0) {
		if (hc(n, t)) return;
		e.uniformMatrix4fv(this.addr, !1, t), gc(n, t);
	} else {
		if (hc(n, r)) return;
		dc.set(r), e.uniformMatrix4fv(this.addr, !1, dc), gc(n, r);
	}
}
function Tc(e, t) {
	let n = this.cache;
...
function Nc(e, t, n) {
	...
	let a;
	this.type === e.SAMPLER_2D_SHADOW ? (ac.compareFunction = n.isReversedDepthBuffer() ? 518 : 515, a = ac) : a = ic, n.setTexture2D(t || a, i);
}
function Pc(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTexture3D(t || sc, i);
}
function Fc(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTextureCube(t || cc, i);
}
function Ic(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTexture2DArray(t || oc, i);
}
function Lc(e) {
	switch (e) {
		case 5126: return vc;
...
function zc(e, t) {
	let n = mc(t, this.size, 2);
	e.uniform2fv(this.addr, n);
}
function Bc(e, t) {
	let n = mc(t, this.size, 3);
	e.uniform3fv(this.addr, n);
}
function Vc(e, t) {
	let n = mc(t, this.size, 4);
...
function Uc(e, t) {
	let n = mc(t, this.size, 9);
	e.uniformMatrix3fv(this.addr, !1, n);
}
function Wc(e, t) {
	let n = mc(t, this.size, 16);
...
function $c(e, t, n) {
	let r = this.cache, i = t.length, a = _c(n, i);
	hc(r, a) || (e.uniform1iv(this.addr, a), gc(r, a));
	let o;
	o = this.type === e.SAMPLER_2D_SHADOW ? ac : ic;
	for (let e = 0; e !== i; ++e) n.setTexture2D(t[e] || o, a[e]);
}
function el(e, t, n) {
	let r = this.cache, i = t.length, a = _c(n, i);
	hc(r, a) || (e.uniform1iv(this.addr, a), gc(r, a));
	for (let e = 0; e !== i; ++e) n.setTexture3D(t[e] || sc, a[e]);
}
function tl(e, t, n) {
	let r = this.cache, i = t.length, a = _c(n, i);
	hc(r, a) || (e.uniform1iv(this.addr, a), gc(r, a));
	for (let e = 0; e !== i; ++e) n.setTextureCube(t[e] || cc, a[e]);
}
function nl(e, t, n) {
	let r = this.cache, i = t.length, a = _c(n, i);
	hc(r, a) || (e.uniform1iv(this.addr, a), gc(r, a));
	for (let e = 0; e !== i; ++e) n.setTexture2DArray(t[e] || oc, a[e]);
}
function rl(e) {
	switch (e) {
		case 5126: return Rc;
		case 35664: return zc;
		case 35665: return Bc;
		case 35666: return Vc;
		case 35674: return Hc;
		case 35675: return Uc;
		case 35676: return Wc;
		case 5124:
		case 35670: return Gc;
		case 35667:
		case 35671: return Kc;
		case 35668:
		case 35672: return qc;
		case 35669:
		case 35673: return Jc;
		case 5125: return Yc;
		case 36294: return Xc;
		case 36295: return Zc;
		case 36296: return Qc;
		case 35678:
		case 36198:
		case 36298:
		case 36306:
		...
		case 35679:
		case 36299:
		case 36307: return el;
		case 35680:
		case 36300:
		case 36308:
		case 36293: return tl;
		case 36289:
		case 36303:
		case 36311:
		case 36292: return nl;
	}
}
var il = class {
	constructor(e, t, n) {
		this.id = e, this.addr = n, this.cache = [], this.type = t.type, this.setValue = Lc(t.type);
	}
}, al = class {
	constructor(e, t, n) {
		this.id = e, this.addr = n, this.cache = [], this.type = t.type, this.size = t.size, this.setValue = rl(t.type);
	}
}, ol = class {
	constructor(e) {
...
function ll(e, t, n) {
	...
	for (sl.lastIndex = 0;;) {
		let a = sl.exec(r), o = sl.lastIndex, s = a[1], c = a[2] === "]", l = a[3];
		if (c && (s |= 0), l === void 0 || l === "[" && o + 2 === i) {
			cl(n, l === void 0 ? new il(s, e, t) : new al(s, e, t));
			break;
		} else {
			let e = n.map[s];
			e === void 0 && (e = new ol(s), cl(n, e)), n = e;
		}
	}
}
var ul = class {
	constructor(e, t) {
		...
		for (let r = 0; r < n; ++r) {
			...
			ll(n, e.getUniformLocation(t, n.name), this);
		}
		let r = [], i = [];
...
var hl = /* @__PURE__ */ new Y();
function gl(e) {
	X._getMatrix(hl, X.workingColorSpace, e);
	let t = `mat3( ${hl.elements.map((e) => e.toFixed(4))} )`;
	switch (X.getTransfer(e)) {
		case Pe: return [t, "LinearTransferOETF"];
		case Fe: return [t, "sRGBTransferOETF"];
...
var xl = /* @__PURE__ */ new J();
function Sl() {
	return X.getLuminanceCoefficients(xl), [
		"float luminance( const in vec3 rgb ) {",
		`	const vec3 weights = vec3( ${xl.x.toFixed(4)}, ${xl.y.toFixed(4)}, ${xl.z.toFixed(4)} );`,
		"	return dot( weights, rgb );",
		"}"
	].join("\n");
}
function Cl(e) {
	return [e.extensionClipCullDistance ? "#extension GL_ANGLE_clip_cull_distance : require" : "", e.extensionMultiDraw ? "#extension GL_ANGLE_multi_draw : require" : ""].filter(El).join("\n");
}
function wl(e) {
	let t = [];
	for (let n in e) {
...
var kl = /^[ \t]*#include +<([\w\d./]+)>/gm;
function Al(e) {
	return e.replace(kl, Ml);
}
...
var Nl = /#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;
function Pl(e) {
	return e.replace(Nl, Fl);
}
function Fl(e, t, n, r) {
	let i = "";
...
function Rl(e) {
	return Ll[e.shadowMapType] || "SHADOWMAP_TYPE_BASIC";
}
var zl = {
...
var Vl = { 302: "ENVMAP_MODE_REFRACTION" };
function Hl(e) {
	return e.envMap === !1 ? "ENVMAP_MODE_REFLECTION" : Vl[e.envMapMode] || "ENVMAP_MODE_REFLECTION";
}
var Ul = {
...
function Wl(e) {
	return e.envMap === !1 ? "ENVMAP_BLENDING_NONE" : Ul[e.combine] || "ENVMAP_BLENDING_NONE";
}
function Gl(e) {
...
function Kl(e, t, n, r) {
	let i = e.getContext(), a = n.defines, o = n.vertexShader, s = n.fragmentShader, c = Rl(n), l = Bl(n), u = Hl(n), d = Wl(n), f = Gl(n), p = Cl(n), m = wl(a), h = i.createProgram(), g, _, v = n.glslVersion ? "#version " + n.glslVersion + "\n" : "";
	n.isRawShaderMaterial ? (g = [
		...
		n.toneMapping === 0 ? "" : bl("toneMapping", n.toneMapping),
	...
	let y = v + g + o, b = v + _ + s, x = dl(i, i.VERTEX_SHADER, y), S = dl(i, i.FRAGMENT_SHADER, b);
	...
	function C(t) {
		if (e.debug.checkShaderErrors) {
			...
			if (i.getProgramParameter(h, i.LINK_STATUS) === !1) if (l = !1, typeof e.debug.onShaderError == "function") e.debug.onShaderError(i, h, x, S);
				...
				let e = _l(i, x, "vertex"), n = _l(i, S, "fragment");
		...
		i.deleteShader(x), i.deleteShader(S), w = new ul(i, h), T = Tl(i, h);
	}
	let w;
	...
	return this.isReady = function() {
		return E === !1 && (E = i.getProgramParameter(h, fl)), E;
	}, this.destroy = function() {
		r.releaseStatesOfProgram(this), i.deleteProgram(h), this.program = void 0;
	}, this.type = n.shaderType, this.name = n.shaderName, this.id = pl++, this.cacheKey = t, this.usedTimes = 1, this.program = h, this.vertexShader = x, this.fragmentShader = S, this;
}
var ql = 0, Jl = class {
	constructor() {
	...
	_getShaderStage(e) {
		...
		return n === void 0 && (n = new Yl(e), t.set(e, n)), n;
	}
}, Yl = class {
	constructor(e) {
...
function Zl(e, t, n, r, i, a) {
	let o = new nn(), s = new Jl(), c = /* @__PURE__ */ new Set(), l = [], u = /* @__PURE__ */ new Map(), d = r.logarithmicDepthBuffer, f = r.precision, p = {
	...
	function h(i, o, l, u, h, g) {
		...
		let ke = {
			...
			packedNormalMap: I && i.normalMapType === 0 && Xl(i.normalMap.format),
			metalnessMap: L,
			roughnessMap: R,
			anisotropy: se,
			anisotropyMap: pe,
			...
			toneMapping: V,
			decodeVideoTexture: P && i.map.isVideoTexture === !0 && X.getTransfer(i.map.colorSpace) === "srgb",
			decodeVideoTextureEmissive: oe && i.emissiveMap.isVideoTexture === !0 && X.getTransfer(i.emissiveMap.colorSpace) === "srgb",
	...
	function y(e) {
		...
		if (t) {
			let e = ys[t];
			n = Ja.clone(e.uniforms);
		} else n = e.uniforms;
		return n;
	}
	function b(t, n) {
		let r = u.get(n);
		return r === void 0 ? (r = new Kl(e, n, t, i), l.push(r), u.set(n, r)) : ++r.usedTimes, r;
	}
	function x(e) {
		if (--e.usedTimes === 0) {
			let t = l.indexOf(e);
...
function tu() {
	...
	function u(e, t) {
		n.length > 1 && n.sort(e || $l), r.length > 1 && r.sort(t || eu), i.length > 1 && i.sort(t || eu);
	}
	function d() {
...
function nu() {
	...
	function t(t, n) {
		let r = e.get(t), i;
		return r === void 0 ? (i = new tu(), e.set(t, [i])) : n >= r.length ? (i = new tu(), r.push(i)) : i = r[n], i;
	}
	function n() {
		e = /* @__PURE__ */ new WeakMap();
	}
...
function lu(e) {
	...
	function n(n, r = 0) {
		let i = t.get(n), a;
		return i === void 0 ? (a = new cu(e), t.set(n, [a])) : r >= i.length ? (a = new cu(e), i.push(a)) : a = i[r], a;
	}
	function r() {
...
var uu = "void main() {\n	gl_Position = vec4( position, 1.0 );\n}", du = "uniform sampler2D shadow_pass;\nuniform vec2 resolution;\nuniform float radius;\nvoid main() {\n	const float samples = float( VSM_SAMPLES );\n	float mean = 0.0;\n	float squared_mean = 0.0;\n	float uvStride = samples <= 1.0 ? 0.0 : 2.0 / ( samples - 1.0 );\n	float uvStart = samples <= 1.0 ? 0.0 : - 1.0;\n	for ( float i = 0.0; i < samples; i ++ ) {\n		float uvOffset = uvStart + i * uvStride;\n		#ifdef HORIZONTAL_PASS\n			vec2 distribution = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( uvOffset, 0.0 ) * radius ) / resolution ).rg;\n			mean += distribution.x;\n			squared_mean += distribution.y * distribution.y + distribution.x * distribution.x;\n		#else\n			float depth = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( 0.0, uvOffset ) * radius ) / resolution ).r;\n			mean += depth;\n			squared_mean += depth * depth;\n		#endif\n	}\n	mean = mean / samples;\n	squared_mean = squared_mean / samples;\n	float std_dev = sqrt( max( 0.0, squared_mean - mean * mean ) );\n	gl_FragColor = vec4( mean, std_dev, 0.0, 1.0 );\n}", fu = [
	...
	/* @__PURE__ */ new J(0, -1, 0),
	/* @__PURE__ */ new J(0, -1, 0)
], mu = /* @__PURE__ */ new Gt(), hu = /* @__PURE__ */ new J(), gu = /* @__PURE__ */ new J();
function _u(e, t, n) {
	let i = new fi(), a = new q(), s = new q(), c = new Bt(), l = new no(), u = new ro(), d = {}, f = n.maxTextureSize, p = {
		0: 1,
		1: 0,
		2: 2
	}, _ = new Za({
	...
	let y = new Cr();
	y.setAttribute("position", new cr(new Float32Array([
		-1,
		-1,
		.5,
		3,
	...
	this.render = function(t, n, l) {
		...
		let u = e.getRenderTarget(), d = e.getActiveCubeFace(), p = e.getActiveMipmapLevel(), _ = e.state;
		_.setBlending(0), _.buffers.depth.getReversed() === !0 ? _.buffers.color.setClear(0, 0, 0, 0) : _.buffers.color.setClear(1, 1, 1, 1), _.buffers.depth.setTest(!0), _.setScissorTest(!1);
		let v = S !== this.type;
		v && n.traverse(function(e) {
		...
		for (let u = 0, d = t.length; u < d; u++) {
			...
			a.multiply(y), s.copy(p.mapSize), (a.x > f || a.y > f) && (a.x > f && (s.x = Math.floor(f / y.x), a.x = s.x * y.x, p.mapSize.x = s.x), a.y > f && (s.y = Math.floor(f / y.y), a.y = s.y * y.y, p.mapSize.y = s.y));
			...
			if (p.camera._reversedDepth = b, p.map === null || v === !0) {
				if (p.map !== null && (p.map.depthTexture !== null && (p.map.depthTexture.dispose(), p.map.depthTexture = null), p.map.dispose()), this.type === 3) {
					...
					p.map = new Ht(a.x, a.y, {
						format: k,
						type: g,
						minFilter: o,
						magFilter: o,
						generateMipmaps: !1
					}), p.map.texture.name = d.name + ".shadowMap", p.map.depthTexture = new mi(a.x, a.y, h), p.map.depthTexture.name = d.name + ".shadowMapDepth", p.map.depthTexture.format = T, p.map.depthTexture.compareFunction = null, p.map.depthTexture.minFilter = r, p.map.depthTexture.magFilter = r;
				} else d.isPointLight ? (p.map = new Js(a.x), p.map.depthTexture = new hi(a.x, m)) : (p.map = new Ht(a.x, a.y), p.map.depthTexture = new mi(a.x, a.y, m)), p.map.depthTexture.name = d.name + ".shadowMap", p.map.depthTexture.format = T, this.type === 1 ? (p.map.depthTexture.compareFunction = b ? 518 : 515, p.map.depthTexture.minFilter = o, p.map.depthTexture.magFilter = o) : (p.map.depthTexture.compareFunction = null, p.map.depthTexture.minFilter = r, p.map.depthTexture.magFilter = r);
	...
	function C(n, r) {
		let i = t.update(b);
		_.defines.VSM_SAMPLES !== n.blurSamples && (_.defines.VSM_SAMPLES = n.blurSamples, v.defines.VSM_SAMPLES = n.blurSamples, _.needsUpdate = !0, v.needsUpdate = !0), n.mapPass === null && (n.mapPass = new Ht(a.x, a.y, {
			format: k,
			type: g
		})), _.uniforms.shadow_pass.value = n.map.depthTexture, _.uniforms.resolution.value = n.mapSize, _.uniforms.radius.value = n.radius, e.setRenderTarget(n.mapPass), e.clear(), e.renderBufferDirect(r, null, i, _, b, null), v.uniforms.shadow_pass.value = n.mapPass.texture, v.uniforms.resolution.value = n.mapSize, v.uniforms.radius.value = n.radius, e.setRenderTarget(n.map), e.clear(), e.renderBufferDirect(r, null, i, v, b, null);
	}
	function w(t, n, r, i) {
...
function vu(e, t) {
	function n() {
		let t = !1, n = new Bt(), r = null, i = new Bt(0, 0, 0, 0);
		return {
			setMask: function(n) {
	...
	let a = new n(), o = new r(), s = new i(), c = /* @__PURE__ */ new WeakMap(), l = /* @__PURE__ */ new WeakMap(), u = {}, d = {}, f = {}, p = /* @__PURE__ */ new WeakMap(), m = [], h = null, g = !1, _ = null, v = null, y = null, b = null, x = null, S = null, C = null, w = new Z(0, 0, 0), T = 0, E = !1, D = null, O = null, k = null, A = null, ee = null, j = e.getParameter(e.MAX_COMBINED_TEXTURE_IMAGE_UNITS), M = !1, N = 0, P = e.getParameter(e.VERSION);
	P.indexOf("WebGL") === -1 ? P.indexOf("OpenGL ES") !== -1 && (N = parseFloat(/^OpenGL ES (\d)/.exec(P)[1]), M = N >= 2) : (N = parseFloat(/^WebGL (\d)/.exec(P)[1]), M = N >= 1);
	let F = null, te = {}, ne = e.getParameter(e.SCISSOR_BOX), re = e.getParameter(e.VIEWPORT), ie = new Bt().fromArray(ne), I = new Bt().fromArray(re);
	function ae(t, n, r, i) {
	...
	function _e(t, n, r) {
		t ? (L(e.POLYGON_OFFSET_FILL), (A !== n || ee !== r) && (A = n, ee = r, o.getReversed() && (n = -n), e.polygonOffset(n, r))) : R(e.POLYGON_OFFSET_FILL);
	}
	function ve(t) {
	...
	function be(t, n, r) {
		...
		i === void 0 && (i = {
			type: void 0,
			texture: void 0
		}, te[r] = i), (i.type !== t || i.texture !== n) && (F !== r && (e.activeTexture(r), F = r), e.bindTexture(t, n || oe[t]), i.type = t, i.texture = n);
	}
	function xe() {
		let t = te[F];
...
function yu(l, u, d, f, p, m, h) {
	let g = u.has("WEBGL_multisampled_render_to_texture") ? u.get("WEBGL_multisampled_render_to_texture") : null, _ = typeof navigator > "u" ? !1 : /OculusBrowser/g.test(navigator.userAgent), v = new q(), y = /* @__PURE__ */ new WeakMap(), b = /* @__PURE__ */ new Set(), x, S = /* @__PURE__ */ new WeakMap(), C = !1;
	try {
		C = typeof OffscreenCanvas < "u" && new OffscreenCanvas(1, 1).getContext("2d") !== null;
	} catch {}
	function w(e, t) {
		return C ? new OffscreenCanvas(e, t) : Ve("canvas");
	}
	function T(e, t, n) {
		let r = 1, i = ke(e);
	...
	function k(e) {
		return e.isWebGLCubeRenderTarget ? l.TEXTURE_CUBE_MAP : e.isWebGL3DRenderTarget ? l.TEXTURE_3D : e.isWebGLArrayRenderTarget || e.isCompressedArrayTexture ? l.TEXTURE_2D_ARRAY : l.TEXTURE_2D;
	}
	function A(e, t, n, r, i, a = !1) {
		...
		let o;
		r && (o = u.get("EXT_texture_norm16"), o || W("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));
		let s = t;
		if (t === l.RED && (n === l.FLOAT && (s = l.R32F), n === l.HALF_FLOAT && (s = l.R16F), n === l.UNSIGNED_BYTE && (s = l.R8), n === l.UNSIGNED_SHORT && o && (s = o.R16_EXT), n === l.SHORT && o && (s = o.R16_SNORM_EXT)), t === l.RED_INTEGER && (n === l.UNSIGNED_BYTE && (s = l.R8UI), n === l.UNSIGNED_SHORT && (s = l.R16UI), n === l.UNSIGNED_INT && (s = l.R32UI), n === l.BYTE && (s = l.R8I), n === l.SHORT && (s = l.R16I), n === l.INT && (s = l.R32I)), t === l.RG && (n === l.FLOAT && (s = l.RG32F), n === l.HALF_FLOAT && (s = l.RG16F), n === l.UNSIGNED_BYTE && (s = l.RG8), n === l.UNSIGNED_SHORT && o && (s = o.RG16_EXT), n === l.SHORT && o && (s = o.RG16_SNORM_EXT)), t === l.RG_INTEGER && (n === l.UNSIGNED_BYTE && (s = l.RG8UI), n === l.UNSIGNED_SHORT && (s = l.RG16UI), n === l.UNSIGNED_INT && (s = l.RG32UI), n === l.BYTE && (s = l.RG8I), n === l.SHORT && (s = l.RG16I), n === l.INT && (s = l.RG32I)), t === l.RGB_INTEGER && (n === l.UNSIGNED_BYTE && (s = l.RGB8UI), n === l.UNSIGNED_SHORT && (s = l.RGB16UI), n === l.UNSIGNED_INT && (s = l.RGB32UI), n === l.BYTE && (s = l.RGB8I), n === l.SHORT && (s = l.RGB16I), n === l.INT && (s = l.RGB32I)), t === l.RGBA_INTEGER && (n === l.UNSIGNED_BYTE && (s = l.RGBA8UI), n === l.UNSIGNED_SHORT && (s = l.RGBA16UI), n === l.UNSIGNED_INT && (s = l.RGBA32UI), n === l.BYTE && (s = l.RGBA8I), n === l.SHORT && (s = l.RGBA16I), n === l.INT && (s = l.RGBA32I)), t === l.RGB && (n === l.UNSIGNED_SHORT && o && (s = o.RGB16_EXT), n === l.SHORT && o && (s = o.RGB16_SNORM_EXT), n === l.UNSIGNED_INT_5_9_9_9_REV && (s = l.RGB9_E5), n === l.UNSIGNED_INT_10F_11F_11F_REV && (s = l.R11F_G11F_B10F)), t === l.RGBA) {
			let e = a ? Pe : X.getTransfer(i);
			n === l.FLOAT && (s = l.RGBA32F), n === l.HALF_FLOAT && (s = l.RGBA16F), n === l.UNSIGNED_BYTE && (s = e === "srgb" ? l.SRGB8_ALPHA8 : l.RGBA8), n === l.UNSIGNED_SHORT && o && (s = o.RGBA16_EXT), n === l.SHORT && o && (s = o.RGBA16_SNORM_EXT), n === l.UNSIGNED_SHORT_4_4_4_4 && (s = l.RGBA4), n === l.UNSIGNED_SHORT_5_5_5_1 && (s = l.RGB5_A1);
		}
		return (s === l.R16F || s === l.R32F || s === l.RG16F || s === l.RG32F || s === l.RGBA16F || s === l.RGBA32F) && u.get("EXT_color_buffer_float"), s;
	}
	function ee(e, t) {
		let n;
		return e ? t === null || t === 1014 || t === 1020 ? n = l.DEPTH24_STENCIL8 : t === 1015 ? n = l.DEPTH32F_STENCIL8 : t === 1012 && (n = l.DEPTH24_STENCIL8, W("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")) : t === null || t === 1014 || t === 1020 ? n = l.DEPTH_COMPONENT24 : t === 1015 ? n = l.DEPTH_COMPONENT32F : t === 1012 && (n = l.DEPTH_COMPONENT16), n;
	}
	function j(e, t) {
		return D(e) === !0 || e.isFramebufferTexture && e.minFilter !== 1003 && e.minFilter !== 1006 ? Math.log2(Math.max(t.width, t.height)) + 1 : e.mipmaps !== void 0 && e.mipmaps.length > 0 ? e.mipmaps.length : e.isCompressedTexture && Array.isArray(e.image) ? t.mipmaps.length : 1;
	}
	function M(e) {
		let t = e.target;
	...
	function te(e) {
		let t = f.get(e);
		if (e.depthTexture && (e.depthTexture.dispose(), f.remove(e.depthTexture)), e.isWebGLCubeRenderTarget) for (let e = 0; e < 6; e++) {
			if (Array.isArray(t.__webglFramebuffer[e])) for (let n = 0; n < t.__webglFramebuffer[e].length; n++) l.deleteFramebuffer(t.__webglFramebuffer[e][n]);
			else l.deleteFramebuffer(t.__webglFramebuffer[e]);
			t.__webglDepthbuffer && l.deleteRenderbuffer(t.__webglDepthbuffer[e]);
		}
		else {
			if (Array.isArray(t.__webglFramebuffer)) for (let e = 0; e < t.__webglFramebuffer.length; e++) l.deleteFramebuffer(t.__webglFramebuffer[e]);
			else l.deleteFramebuffer(t.__webglFramebuffer);
			if (t.__webglDepthbuffer && l.deleteRenderbuffer(t.__webglDepthbuffer), t.__webglMultisampledFramebuffer && l.deleteFramebuffer(t.__webglMultisampledFramebuffer), t.__webglColorRenderbuffer) for (let e = 0; e < t.__webglColorRenderbuffer.length; e++) t.__webglColorRenderbuffer[e] && l.deleteRenderbuffer(t.__webglColorRenderbuffer[e]);
			t.__webglDepthRenderbuffer && l.deleteRenderbuffer(t.__webglDepthRenderbuffer);
		}
		let n = e.textures;
		for (let e = 0, t = n.length; e < t; e++) {
			let t = f.get(n[e]);
			t.__webglTexture && (l.deleteTexture(t.__webglTexture), h.memory.textures--), f.remove(n[e]);
		}
		f.remove(e);
	}
	let ne = 0;
	...
	function ae() {
		let e = ne;
		return e >= p.maxTextures && W("WebGLTextures: Trying to use " + e + " texture units while this GPU supports only " + p.maxTextures), ne += 1, e;
	}
	function oe(e) {
		let t = [];
	...
	function L(e, t) {
		...
		if (e.isVideoTexture && Oe(e), e.isRenderTargetTexture === !1 && e.isExternalTexture !== !0 && e.version > 0 && n.__version !== e.version) {
			let r = e.image;
			if (r === null) W("WebGLRenderer: Texture marked for update but no image data found.");
			else if (r.complete === !1) W("WebGLRenderer: Texture marked for update but image is incomplete");
			else {
				ge(n, e, t);
				return;
			}
	...
	function fe(e, t) {
		if (t.type === 1015 && u.has("OES_texture_float_linear") === !1 && (t.magFilter === 1006 || t.magFilter === 1007 || t.magFilter === 1005 || t.magFilter === 1008 || t.minFilter === 1006 || t.minFilter === 1007 || t.minFilter === 1005 || t.minFilter === 1008) && W("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."), l.texParameteri(e, l.TEXTURE_WRAP_S, le[t.wrapS]), l.texParameteri(e, l.TEXTURE_WRAP_T, le[t.wrapT]), (e === l.TEXTURE_3D || e === l.TEXTURE_2D_ARRAY) && l.texParameteri(e, l.TEXTURE_WRAP_R, le[t.wrapR]), l.texParameteri(e, l.TEXTURE_MAG_FILTER, ue[t.magFilter]), l.texParameteri(e, l.TEXTURE_MIN_FILTER, ue[t.minFilter]), t.compareFunction && (l.texParameteri(e, l.TEXTURE_COMPARE_MODE, l.COMPARE_REF_TO_TEXTURE), l.texParameteri(e, l.TEXTURE_COMPARE_FUNC, de[t.compareFunction])), u.has("EXT_texture_filter_anisotropic") === !0) {
			...
			if (t.anisotropy > 1 || f.get(t).__currentAnisotropy) {
				...
				l.texParameterf(e, n.TEXTURE_MAX_ANISOTROPY_EXT, Math.min(t.anisotropy, p.getMaxAnisotropy())), f.get(t).__currentAnisotropy = t.anisotropy;
			}
		}
	}
	function pe(e, t) {
		...
		if (a !== e.__cacheKey) {
			i[a] === void 0 && (i[a] = {
				...
				usedTimes: 0
			}, h.memory.textures++, n = !0), i[a].usedTimes++;
			let r = i[e.__cacheKey];
			r !== void 0 && (i[e.__cacheKey].usedTimes--, r.usedTimes === 0 && F(t)), e.__cacheKey = a, e.__webglTexture = i[a].texture;
		}
		return n;
	}
	function me(e, t, n) {
	...
	function he(e, t, n, r) {
		...
		if (i.length === 0) d.texSubImage2D(l.TEXTURE_2D, 0, 0, 0, t.width, t.height, n, r, t.data);
			...
			for (let e = 0, a = i.length; e < a; e++) {
				let a = i[e], o = Math.floor(a.start / 4), s = Math.ceil(a.count / 4), c = o % t.width, u = Math.floor(o / t.width), f = s;
				d.pixelStorei(l.UNPACK_SKIP_PIXELS, c), d.pixelStorei(l.UNPACK_SKIP_ROWS, u), d.texSubImage2D(l.TEXTURE_2D, 0, c, u, f, 1, n, r, t.data);
			}
	...
	function ge(e, t, n) {
		...
		let i = pe(e, t), a = t.source;
		d.bindTexture(r, e.__webglTexture, l.TEXTURE0 + n);
		let o = f.get(a);
		if (a.version !== o.__version || i === !0) {
			if (d.activeTexture(l.TEXTURE0 + n), !(typeof ImageBitmap < "u" && t.image instanceof ImageBitmap)) {
				let e = X.getPrimaries(X.workingColorSpace), n = t.colorSpace === "" ? null : X.getPrimaries(t.colorSpace), r = t.colorSpace === "" || e === n ? l.NONE : l.BROWSER_DEFAULT_WEBGL;
				d.pixelStorei(l.UNPACK_FLIP_Y_WEBGL, t.flipY), d.pixelStorei(l.UNPACK_PREMULTIPLY_ALPHA_WEBGL, t.premultiplyAlpha), d.pixelStorei(l.UNPACK_COLORSPACE_CONVERSION_WEBGL, r);
			}
			d.pixelStorei(l.UNPACK_ALIGNMENT, t.unpackAlignment);
			let e = T(t.image, !1, p.maxTextureSize);
			e = V(t, e);
			let s = m.convert(t.format, t.colorSpace), c = m.convert(t.type), u = A(t.internalFormat, s, c, t.normalized, t.colorSpace, t.isVideoTexture);
			fe(r, t);
			let f, h = t.mipmaps, g = t.isVideoTexture !== !0, _ = o.__version === void 0 || i === !0, v = a.dataReady, y = j(t, e);
			if (t.isDepthTexture) u = ee(t.format === E, t.type), _ && (g ? d.texStorage2D(l.TEXTURE_2D, 1, u, e.width, e.height) : d.texImage2D(l.TEXTURE_2D, 0, u, e.width, e.height, 0, s, c, null));
				...
				t.generateMipmaps = !1;
			} else g ? (_ && d.texStorage2D(l.TEXTURE_2D, y, u, e.width, e.height), v && he(t, e, s, c)) : d.texImage2D(l.TEXTURE_2D, 0, u, e.width, e.height, 0, s, c, e.data);
			else if (t.isCompressedTexture) if (t.isCompressedArrayTexture) {
				g && _ && d.texStorage3D(l.TEXTURE_2D_ARRAY, y, u, h[0].width, h[0].height, e.depth);
				for (let n = 0, r = h.length; n < r; n++) if (f = h[n], t.format !== 1023) if (s !== null) if (g) {
					if (v) if (t.layerUpdates.size > 0) {
						let e = hs(f.width, f.height, t.format, t.type);
						for (let r of t.layerUpdates) {
							let t = f.data.subarray(r * e / f.data.BYTES_PER_ELEMENT, (r + 1) * e / f.data.BYTES_PER_ELEMENT);
							d.compressedTexSubImage3D(l.TEXTURE_2D_ARRAY, n, 0, 0, r, f.width, f.height, 1, s, t);
						}
						t.clearLayerUpdates();
					} else d.compressedTexSubImage3D(l.TEXTURE_2D_ARRAY, n, 0, 0, 0, f.width, f.height, e.depth, s, f.data);
				} else d.compressedTexImage3D(l.TEXTURE_2D_ARRAY, n, u, f.width, f.height, e.depth, 0, f.data, 0, 0);
				else W("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");
				else g ? v && d.texSubImage3D(l.TEXTURE_2D_ARRAY, n, 0, 0, 0, f.width, f.height, e.depth, s, c, f.data) : d.texImage3D(l.TEXTURE_2D_ARRAY, n, u, f.width, f.height, e.depth, 0, s, c, f.data);
			} else {
				g && _ && d.texStorage2D(l.TEXTURE_2D, y, u, h[0].width, h[0].height);
				for (let e = 0, n = h.length; e < n; e++) f = h[e], t.format === 1023 ? g ? v && d.texSubImage2D(l.TEXTURE_2D, e, 0, 0, f.width, f.height, s, c, f.data) : d.texImage2D(l.TEXTURE_2D, e, u, f.width, f.height, 0, s, c, f.data) : s === null ? W("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()") : g ? v && d.compressedTexSubImage2D(l.TEXTURE_2D, e, 0, 0, f.width, f.height, s, f.data) : d.compressedTexImage2D(l.TEXTURE_2D, e, u, f.width, f.height, 0, f.data);
			}
			else if (t.isDataArrayTexture) if (g) {
				if (_ && d.texStorage3D(l.TEXTURE_2D_ARRAY, y, u, e.width, e.height, e.depth), v) if (t.layerUpdates.size > 0) {
					let n = hs(e.width, e.height, t.format, t.type);
					for (let r of t.layerUpdates) {
						let t = e.data.subarray(r * n / e.data.BYTES_PER_ELEMENT, (r + 1) * n / e.data.BYTES_PER_ELEMENT);
						d.texSubImage3D(l.TEXTURE_2D_ARRAY, 0, 0, 0, r, e.width, e.height, 1, s, c, t);
					}
					t.clearLayerUpdates();
				} else d.texSubImage3D(l.TEXTURE_2D_ARRAY, 0, 0, 0, 0, e.width, e.height, e.depth, s, c, e.data);
			} else d.texImage3D(l.TEXTURE_2D_ARRAY, 0, u, e.width, e.height, e.depth, 0, s, c, e.data);
			else if (t.isData3DTexture) g ? (_ && d.texStorage3D(l.TEXTURE_3D, y, u, e.width, e.height, e.depth), v && d.texSubImage3D(l.TEXTURE_3D, 0, 0, 0, 0, e.width, e.height, e.depth, s, c, e.data)) : d.texImage3D(l.TEXTURE_3D, 0, u, e.width, e.height, e.depth, 0, s, c, e.data);
			else if (t.isFramebufferTexture) {
				if (_) if (g) d.texStorage2D(l.TEXTURE_2D, y, u, e.width, e.height);
				else {
					let t = e.width, n = e.height;
					for (let e = 0; e < y; e++) d.texImage2D(l.TEXTURE_2D, e, u, t, n, 0, s, c, null), t >>= 1, n >>= 1;
				}
				...
				if ("texElementImage2D" in l) {
					...
					if (n.hasAttribute("layoutsubtree") || n.setAttribute("layoutsubtree", "true"), e.parentNode !== n) {
						n.appendChild(e), b.add(t), n.onpaint = (e) => {
							let t = e.changedElements;
							for (let e of b) t.includes(e.image) && (e.needsUpdate = !0);
						}, n.requestPaint();
						return;
					}
					let r = l.RGBA, i = l.RGBA, a = l.UNSIGNED_BYTE;
					l.texElementImage2D(l.TEXTURE_2D, 0, r, i, a, e), l.texParameteri(l.TEXTURE_2D, l.TEXTURE_MIN_FILTER, l.LINEAR), l.texParameteri(l.TEXTURE_2D, l.TEXTURE_WRAP_S, l.CLAMP_TO_EDGE), l.texParameteri(l.TEXTURE_2D, l.TEXTURE_WRAP_T, l.CLAMP_TO_EDGE);
				}
			} else if (h.length > 0) {
				if (g && _) {
					let e = ke(h[0]);
	...
	function _e(e, t, n) {
		...
		let r = pe(e, t), i = t.source;
		d.bindTexture(l.TEXTURE_CUBE_MAP, e.__webglTexture, l.TEXTURE0 + n);
		let a = f.get(i);
		if (i.version !== a.__version || r === !0) {
			d.activeTexture(l.TEXTURE0 + n);
			let e = X.getPrimaries(X.workingColorSpace), o = t.colorSpace === "" ? null : X.getPrimaries(t.colorSpace), s = t.colorSpace === "" || e === o ? l.NONE : l.BROWSER_DEFAULT_WEBGL;
			...
			for (let e = 0; e < 6; e++) !c && !u ? f[e] = T(t.image[e], !0, p.maxCubemapSize) : f[e] = u ? t.image[e].image : t.image[e], f[e] = V(t, f[e]);
			let h = f[0], g = m.convert(t.format, t.colorSpace), _ = m.convert(t.type), v = A(t.internalFormat, g, _, t.normalized, t.colorSpace), y = t.isVideoTexture !== !0, b = a.__version === void 0 || r === !0, x = i.dataReady, S = j(t, h);
			fe(l.TEXTURE_CUBE_MAP, t);
			let C;
			if (c) {
				...
				for (let e = 0; e < 6; e++) if (u) {
					y ? x && d.texSubImage2D(l.TEXTURE_CUBE_MAP_POSITIVE_X + e, 0, 0, 0, f[e].width, f[e].height, g, _, f[e].data) : d.texImage2D(l.TEXTURE_CUBE_MAP_POSITIVE_X + e, 0, v, f[e].width, f[e].height, 0, g, _, f[e].data);
					for (let t = 0; t < C.length; t++) {
						let n = C[t].image[e].image;
						y ? x && d.texSubImage2D(l.TEXTURE_CUBE_MAP_POSITIVE_X + e, t + 1, 0, 0, n.width, n.height, g, _, n.data) : d.texImage2D(l.TEXTURE_CUBE_MAP_POSITIVE_X + e, t + 1, v, n.width, n.height, 0, g, _, n.data);
					}
				} else {
					y ? x && d.texSubImage2D(l.TEXTURE_CUBE_MAP_POSITIVE_X + e, 0, 0, 0, g, _, f[e]) : d.texImage2D(l.TEXTURE_CUBE_MAP_POSITIVE_X + e, 0, v, g, _, f[e]);
					for (let t = 0; t < C.length; t++) {
						let n = C[t];
						y ? x && d.texSubImage2D(l.TEXTURE_CUBE_MAP_POSITIVE_X + e, t + 1, 0, 0, g, _, n.image[e]) : d.texImage2D(l.TEXTURE_CUBE_MAP_POSITIVE_X + e, t + 1, v, g, _, n.image[e]);
					}
				}
			}
			D(t) && O(l.TEXTURE_CUBE_MAP), a.__version = i.version, t.onUpdate && t.onUpdate(t);
		}
		e.__version = t.version;
	}
	function ve(e, t, n, r, i, a) {
		let o = m.convert(n.format, n.colorSpace), s = m.convert(n.type), c = A(n.internalFormat, o, s, n.normalized, n.colorSpace), u = f.get(t), p = f.get(n);
		...
		d.bindFramebuffer(l.FRAMEBUFFER, e), B(t) ? g.framebufferTexture2DMultisampleEXT(l.FRAMEBUFFER, r, i, p.__webglTexture, 0, De(t)) : (i === l.TEXTURE_2D || i >= l.TEXTURE_CUBE_MAP_POSITIVE_X && i <= l.TEXTURE_CUBE_MAP_NEGATIVE_Z) && l.framebufferTexture2D(l.FRAMEBUFFER, r, i, p.__webglTexture, a), d.bindFramebuffer(l.FRAMEBUFFER, null);
	}
	function ye(e, t, n) {
		if (l.bindRenderbuffer(l.RENDERBUFFER, e), t.depthBuffer) {
			let r = t.depthTexture, i = r && r.isDepthTexture ? r.type : null, a = ee(t.stencilBuffer, i), o = t.stencilBuffer ? l.DEPTH_STENCIL_ATTACHMENT : l.DEPTH_ATTACHMENT;
			B(t) ? g.renderbufferStorageMultisampleEXT(l.RENDERBUFFER, De(t), a, t.width, t.height) : n ? l.renderbufferStorageMultisample(l.RENDERBUFFER, De(t), a, t.width, t.height) : l.renderbufferStorage(l.RENDERBUFFER, a, t.width, t.height), l.framebufferRenderbuffer(l.FRAMEBUFFER, o, l.RENDERBUFFER, e);
		} else {
			let e = t.textures;
			for (let r = 0; r < e.length; r++) {
				let i = e[r], a = m.convert(i.format, i.colorSpace), o = m.convert(i.type), s = A(i.internalFormat, a, o, i.normalized, i.colorSpace);
				B(t) ? g.renderbufferStorageMultisampleEXT(l.RENDERBUFFER, De(t), s, t.width, t.height) : n ? l.renderbufferStorageMultisample(l.RENDERBUFFER, De(t), s, t.width, t.height) : l.renderbufferStorage(l.RENDERBUFFER, s, t.width, t.height);
			}
		}
	...
	function be(e, t, n) {
		...
		if (d.bindFramebuffer(l.FRAMEBUFFER, e), !(t.depthTexture && t.depthTexture.isDepthTexture)) throw Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");
		...
		if (i.__renderTarget = t, (!i.__webglTexture || t.depthTexture.image.width !== t.width || t.depthTexture.image.height !== t.height) && (t.depthTexture.image.width = t.width, t.depthTexture.image.height = t.height, t.depthTexture.needsUpdate = !0), r) {
			if (i.__webglInit === void 0 && (i.__webglInit = !0, t.depthTexture.addEventListener("dispose", M)), i.__webglTexture === void 0) {
				i.__webglTexture = l.createTexture(), d.bindTexture(l.TEXTURE_CUBE_MAP, i.__webglTexture), fe(l.TEXTURE_CUBE_MAP, t.depthTexture);
		...
		} else L(t.depthTexture, 0);
		let a = i.__webglTexture, o = De(t), s = r ? l.TEXTURE_CUBE_MAP_POSITIVE_X + n : l.TEXTURE_2D, c = t.depthTexture.format === 1027 ? l.DEPTH_STENCIL_ATTACHMENT : l.DEPTH_ATTACHMENT;
		if (t.depthTexture.format === 1026) B(t) ? g.framebufferTexture2DMultisampleEXT(l.FRAMEBUFFER, c, s, a, 0, o) : l.framebufferTexture2D(l.FRAMEBUFFER, c, s, a, 0);
		else if (t.depthTexture.format === 1027) B(t) ? g.framebufferTexture2DMultisampleEXT(l.FRAMEBUFFER, c, s, a, 0, o) : l.framebufferTexture2D(l.FRAMEBUFFER, c, s, a, 0);
	...
	function xe(e) {
		...
		if (e.depthTexture && !t.__autoAllocateDepthBuffer) if (n) for (let n = 0; n < 6; n++) be(t.__webglFramebuffer[n], e, n);
		else {
			...
			for (let n = 0; n < 6; n++) if (d.bindFramebuffer(l.FRAMEBUFFER, t.__webglFramebuffer[n]), t.__webglDepthbuffer[n] === void 0) t.__webglDepthbuffer[n] = l.createRenderbuffer(), ye(t.__webglDepthbuffer[n], e, !1);
			else {
			...
			let n = e.texture.mipmaps;
			if (n && n.length > 0 ? d.bindFramebuffer(l.FRAMEBUFFER, t.__webglFramebuffer[0]) : d.bindFramebuffer(l.FRAMEBUFFER, t.__webglFramebuffer), t.__webglDepthbuffer === void 0) t.__webglDepthbuffer = l.createRenderbuffer(), ye(t.__webglDepthbuffer, e, !1);
			else {
	...
	function Se(e, t, n) {
		let r = f.get(e);
		t !== void 0 && ve(r.__webglFramebuffer, e, e.texture, l.COLOR_ATTACHMENT0, l.TEXTURE_2D, 0), n !== void 0 && xe(e);
	}
	function Ce(e) {
		...
		if (o || (r.__webglTexture === void 0 && (r.__webglTexture = l.createTexture()), r.__version = t.version, h.memory.textures++), a) {
			n.__webglFramebuffer = [];
			for (let e = 0; e < 6; e++) if (t.mipmaps && t.mipmaps.length > 0) {
				n.__webglFramebuffer[e] = [];
				for (let r = 0; r < t.mipmaps.length; r++) n.__webglFramebuffer[e][r] = l.createFramebuffer();
			...
			if (e.samples > 0 && B(e) === !1) {
				...
				for (let t = 0; t < i.length; t++) {
					...
					let a = m.convert(r.format, r.colorSpace), o = m.convert(r.type), s = A(r.internalFormat, a, o, r.normalized, r.colorSpace, e.isXRRenderTarget === !0), c = De(e);
				...
				l.bindRenderbuffer(l.RENDERBUFFER, null), e.depthBuffer && (n.__webglDepthRenderbuffer = l.createRenderbuffer(), ye(n.__webglDepthRenderbuffer, e, !0)), d.bindFramebuffer(l.FRAMEBUFFER, null);
			}
		}
		if (a) {
			d.bindTexture(l.TEXTURE_CUBE_MAP, r.__webglTexture), fe(l.TEXTURE_CUBE_MAP, t);
			for (let r = 0; r < 6; r++) if (t.mipmaps && t.mipmaps.length > 0) for (let i = 0; i < t.mipmaps.length; i++) ve(n.__webglFramebuffer[r][i], e, t, l.COLOR_ATTACHMENT0, l.TEXTURE_CUBE_MAP_POSITIVE_X + r, i);
			else ve(n.__webglFramebuffer[r], e, t, l.COLOR_ATTACHMENT0, l.TEXTURE_CUBE_MAP_POSITIVE_X + r, 0);
			D(t) && O(l.TEXTURE_CUBE_MAP), d.unbindTexture();
		} else if (o) {
			for (let t = 0, r = i.length; t < r; t++) {
				let r = i[t], a = f.get(r), o = l.TEXTURE_2D;
				(e.isWebGL3DRenderTarget || e.isWebGLArrayRenderTarget) && (o = e.isWebGL3DRenderTarget ? l.TEXTURE_3D : l.TEXTURE_2D_ARRAY), d.bindTexture(o, a.__webglTexture), fe(o, r), ve(n.__webglFramebuffer, e, r, l.COLOR_ATTACHMENT0 + t, o, 0), D(r) && O(o);
			}
			d.unbindTexture();
		} else {
			let i = l.TEXTURE_2D;
			if ((e.isWebGL3DRenderTarget || e.isWebGLArrayRenderTarget) && (i = e.isWebGL3DRenderTarget ? l.TEXTURE_3D : l.TEXTURE_2D_ARRAY), d.bindTexture(i, r.__webglTexture), fe(i, t), t.mipmaps && t.mipmaps.length > 0) for (let r = 0; r < t.mipmaps.length; r++) ve(n.__webglFramebuffer[r], e, t, l.COLOR_ATTACHMENT0, i, r);
			else ve(n.__webglFramebuffer, e, t, l.COLOR_ATTACHMENT0, i, 0);
	...
	function z(e) {
		if (e.samples > 0) {
			if (B(e) === !1) {
				...
				c && c.length > 0 ? d.bindFramebuffer(l.DRAW_FRAMEBUFFER, o.__webglFramebuffer[0]) : d.bindFramebuffer(l.DRAW_FRAMEBUFFER, o.__webglFramebuffer);
				for (let c = 0; c < t.length; c++) {
					if (e.resolveDepthBuffer && (e.depthBuffer && (i |= l.DEPTH_BUFFER_BIT), e.stencilBuffer && e.resolveStencilBuffer && (i |= l.STENCIL_BUFFER_BIT)), s) {
						l.framebufferRenderbuffer(l.READ_FRAMEBUFFER, l.COLOR_ATTACHMENT0, l.RENDERBUFFER, o.__webglColorRenderbuffer[c]);
						let e = f.get(t[c]).__webglTexture;
						l.framebufferTexture2D(l.DRAW_FRAMEBUFFER, l.COLOR_ATTACHMENT0, l.TEXTURE_2D, e, 0);
					}
					l.blitFramebuffer(0, 0, n, r, 0, 0, n, r, i, l.NEAREST), _ === !0 && (Te.length = 0, Ee.length = 0, Te.push(l.COLOR_ATTACHMENT0 + c), e.depthBuffer && e.resolveDepthBuffer === !1 && (Te.push(a), Ee.push(a), l.invalidateFramebuffer(l.DRAW_FRAMEBUFFER, Ee)), l.invalidateFramebuffer(l.READ_FRAMEBUFFER, Te));
				}
				if (d.bindFramebuffer(l.READ_FRAMEBUFFER, null), d.bindFramebuffer(l.DRAW_FRAMEBUFFER, null), s) for (let e = 0; e < t.length; e++) {
					...
					d.bindFramebuffer(l.FRAMEBUFFER, o.__webglFramebuffer), l.framebufferTexture2D(l.DRAW_FRAMEBUFFER, l.COLOR_ATTACHMENT0 + e, l.TEXTURE_2D, n, 0);
				}
	...
	this.allocateTextureUnit = ae, this.resetTextureUnits = re, this.getTextureUnits = ie, this.setTextureUnits = I, this.setTexture2D = L, this.setTexture2DArray = R, this.setTexture3D = se, this.setTextureCube = ce, this.rebindTextures = Se, this.setupRenderTarget = Ce, this.updateRenderTargetMipmap = we, this.updateMultisampleRenderTarget = z, this.setupDepthRenderbuffer = xe, this.setupFrameBufferTexture = ve, this.useMultisampledRTT = B, this.isReversedDepthBuffer = function() {
...
var xu = "\nvoid main() {\n\n	gl_Position = vec4( position, 1.0 );\n\n}", Su = "\nuniform sampler2DArray depthColor;\nuniform float depthWidth;\nuniform float depthHeight;\n\nvoid main() {\n\n	vec2 coord = vec2( gl_FragCoord.x / depthWidth, gl_FragCoord.y / depthHeight );\n\n	if ( coord.x >= 1.0 ) {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x - 1.0, coord.y, 1 ) ).r;\n\n	} else {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;\n\n	}\n\n}", Cu = class {
	...
	getMesh(e) {
		if (this.texture !== null && this.mesh === null) {
			...
			this.mesh = new Kr(new La(20, 20), n);
		}
		return this.mesh;
	}
	reset() {
	...
	constructor(e, t) {
		super();
		let n = this, r = null, i = 1, a = null, o = "local-floor", s = 1, c = null, u = null, d = null, f = null, p = null, h = null, g = typeof XRWebGLBinding < "u", _ = new Cu(), v = {}, b = t.getContextAttributes(), x = null, S = null, C = [], D = [], O = new q(), k = null, A = new zo();
		A.viewport = new Bt();
		let ee = new zo();
		ee.viewport = new Bt();
		let j = [A, ee], M = new Yo(), N = null, P = null;
		this.cameraAutoUpdate = !0, this.enabled = !1, this.isPresenting = !1, this.getController = function(e) {
			let t = C[e];
			return t === void 0 && (t = new Sn(), C[e] = t), t.getTargetRaySpace();
		}, this.getControllerGrip = function(e) {
			let t = C[e];
			return t === void 0 && (t = new Sn(), C[e] = t), t.getGripSpace();
		}, this.getHand = function(e) {
			let t = C[e];
			return t === void 0 && (t = new Sn(), C[e] = t), t.getHandSpace();
		};
		function F(e) {
		...
		function te() {
			...
			e.setRenderTarget(x), p = null, f = null, d = null, r = null, S = null, se.stop(), n.isPresenting = !1, e.setPixelRatio(k), e.setSize(O.width, O.height, !1), n.dispatchEvent({ type: "sessionend" });
		}
		this.setFramebufferScaleFactor = function(e) {
			...
			if (r = u, r !== null) {
				if (x = e.getRenderTarget(), r.addEventListener("select", F), r.addEventListener("selectstart", F), r.addEventListener("selectend", F), r.addEventListener("squeeze", F), r.addEventListener("squeezestart", F), r.addEventListener("squeezeend", F), r.addEventListener("end", te), r.addEventListener("inputsourceschange", ne), b.xrCompatible !== !0 && await t.makeXRCompatible(), k = e.getPixelRatio(), e.getSize(O), g && "createProjectionLayer" in XRWebGLBinding.prototype) {
					let n = null, a = null, o = null;
					b.depth && (o = b.stencil ? t.DEPTH24_STENCIL8 : t.DEPTH_COMPONENT24, n = b.stencil ? E : T, a = b.stencil ? y : m);
					let s = {
						colorFormat: t.RGBA8,
						depthFormat: o,
						scaleFactor: i
					};
					d = this.getBinding(), f = d.createProjectionLayer(s), r.updateRenderState({ layers: [f] }), e.setPixelRatio(1), e.setSize(f.textureWidth, f.textureHeight, !1), S = new Ht(f.textureWidth, f.textureHeight, {
						format: w,
						type: l,
						depthTexture: new mi(f.textureWidth, f.textureHeight, a, void 0, void 0, void 0, void 0, void 0, void 0, n),
					...
					p = new XRWebGLLayer(r, t, n), r.updateRenderState({ baseLayer: p }), e.setPixelRatio(1), e.setSize(p.framebufferWidth, p.framebufferHeight, !1), S = new Ht(p.framebufferWidth, p.framebufferHeight, {
						format: w,
						type: l,
						colorSpace: e.outputColorSpace,
						stencilBuffer: b.stencil,
				...
				S.isXRRenderTarget = !0, this.setFoveation(s), c = null, a = await r.requestReferenceSpace(o), se.setContext(r), se.start(), n.isPresenting = !0, n.dispatchEvent({ type: "sessionstart" });
			}
		...
		function ne(e) {
			...
			for (let t = 0; t < e.added.length; t++) {
				...
				if (r === -1) {
					for (let e = 0; e < C.length; e++) if (e >= D.length) {
						D.push(n), r = e;
						break;
					} else if (D[e] === null) {
						D[e] = n, r = e;
		...
		this.updateCamera = function(e) {
			...
			_.texture !== null && (_.depthNear > 0 && (t = _.depthNear), _.depthFar > 0 && (n = _.depthFar)), M.near = ee.near = A.near = t, M.far = ee.far = A.far = n, (N !== M.near || P !== M.far) && (r.updateRenderState({
				depthNear: M.near,
				depthFar: M.far
			}), N = M.near, P = M.far), M.layers.mask = e.layers.mask | 6, A.layers.mask = M.layers.mask & -5, ee.layers.mask = M.layers.mask & -3;
			let i = e.parent, a = M.cameras;
			ae(M, i);
			for (let e = 0; e < a.length; e++) ae(a[e], i);
			a.length === 2 ? I(M, A, ee) : M.projectionMatrix.copy(A.projectionMatrix), oe(e, M, i);
		};
		function oe(e, t, n) {
			n === null ? e.matrix.copy(t.matrixWorld) : (e.matrix.copy(n.matrixWorld), e.matrix.invert(), e.matrix.multiply(t.matrixWorld)), e.matrix.decompose(e.position, e.quaternion, e.scale), e.updateMatrixWorld(!0), e.projectionMatrix.copy(t.projectionMatrix), e.projectionMatrixInverse.copy(t.projectionMatrixInverse), e.isPerspectiveCamera && (e.fov = et * 2 * Math.atan(1 / e.projectionMatrix.elements[5]), e.zoom = 1);
		}
		...
		let se = new _s();
		se.setAnimationLoop(R), this.setAnimationLoop = function(e) {
			L = e;
		}, this.dispose = function() {};
	}
}, Tu = /* @__PURE__ */ new Gt(), Eu = /* @__PURE__ */ new Y();
Eu.set(-1, 0, 0, 0, 1, 0, 0, 0, 1);
function Du(e, t) {
	function n(e, t) {
		e.matrixAutoUpdate === !0 && e.updateMatrix(), t.value.copy(e.matrix);
	}
	function r(t, n) {
		n.color.getRGB(t.fogColor.value, qa(e)), n.isFog ? (t.fogNear.value = n.near, t.fogFar.value = n.far) : n.isFogExp2 && (t.fogDensity.value = n.density);
	}
	...
	function a(e, r) {
		...
		a && (e.envMap.value = a, e.envMapRotation.value.setFromMatrix4(Tu.makeRotationFromEuler(o)).transpose(), a.isCubeTexture && a.isRenderTargetTexture === !1 && e.envMapRotation.value.premultiply(Eu), e.reflectivity.value = r.reflectivity, e.ior.value = r.ior, e.refractionRatio.value = r.refractionRatio), r.lightMap && (e.lightMap.value = r.lightMap, e.lightMapIntensity.value = r.lightMapIntensity, n(r.lightMap, e.lightMapTransform)), r.aoMap && (e.aoMap.value = r.aoMap, e.aoMapIntensity.value = r.aoMapIntensity, n(r.aoMap, e.aoMapTransform));
	}
	function o(e, t) {
...
function ju() {
	return Au === null && (Au = new Yr(ku, 16, 16, k, g), Au.name = "DFG_LUT", Au.minFilter = o, Au.magFilter = o, Au.wrapS = t, Au.wrapT = t, Au.generateMipmaps = !1, Au.needsUpdate = !0), Au;
}
var Mu = class {
	constructor(e = {}) {
		let { canvas: t = He(), context: n = null, depth: r = !0, stencil: i = !1, alpha: a = !1, antialias: o = !1, premultipliedAlpha: s = !0, preserveDrawingBuffer: u = !1, powerPreference: d = "default", failIfMajorPerformanceCaveat: p = !1, reversedDepthBuffer: h = !1, outputBufferType: b = l } = e;
		...
		let S = b, C = new Set([
			...
			_,
			v
		]), T = new Uint32Array(4), E = new Int32Array(4), D = new J(), k = null, j = null, M = [], N = [], P = null;
		this.domElement = t, this.debug = {
			checkShaderErrors: !0,
			onShaderError: null
		}, this.autoClear = !0, this.autoClearColor = !0, this.autoClearDepth = !0, this.autoClearStencil = !0, this.sortObjects = !0, this.clippingPlanes = [], this.localClippingEnabled = !1, this.toneMapping = 0, this.toneMappingExposure = 1, this.transmissionResolutionScale = 1;
		let F = this, te = !1, ne = null;
		this._outputColorSpace = Me;
		let re = 0, ie = 0, I = null, ae = -1, oe = null, L = new Bt(), R = new Bt(), se = null, ce = new Z(0), le = 0, ue = t.width, de = t.height, fe = 1, pe = null, me = null, he = new Bt(0, 0, ue, de), ge = new Bt(0, 0, ue, de), _e = !1, ve = new fi(), ye = !1, be = !1, xe = new Gt(), Se = new J(), Ce = new Bt(), we = {
			background: null,
			fog: null,
			environment: null,
		...
		try {
			...
			if ("setAttribute" in t && t.setAttribute("data-engine", "three.js r184"), t.addEventListener("webglcontextlost", et, !1), t.addEventListener("webglcontextrestored", tt, !1), t.addEventListener("webglcontextcreationerror", K, !1), z === null) {
				let t = "webgl2";
				if (z = De(t, e), z === null) throw De(t) ? Error("Error creating WebGL context with your selected attributes.") : Error("Error creating WebGL context.");
			}
		} catch (e) {
			throw G("WebGLRenderer: " + e.message), e;
		}
		let B, Oe, V, ke, H, U, Ae, je, Ne, Pe, Fe, Ie, Le, ze, Be, Ve, Ue, We, Ke, qe, Ye, Xe, Ze;
		function Qe() {
			B = new Xs(z), B.init(), Ye = new bu(z, B), Oe = new Es(z, B, e, Ye), V = new vu(z, B), Oe.reversedDepthBuffer && h && V.buffers.depth.setReversed(!0), ke = new $s(z), H = new Ql(), U = new yu(z, B, V, H, Oe, Ye, ke), Ae = new Ys(F), je = new vs(z), Xe = new ws(z, je), Ne = new Zs(z, je, ke, Xe), Pe = new tc(z, Ne, je, Xe, ke), We = new ec(z, Oe, U), Be = new Ds(H), Fe = new Zl(F, Ae, B, Oe, Xe, Be), Ie = new Du(F, H), Le = new nu(), ze = new lu(B), Ue = new Cs(F, Ae, V, Pe, x, s), Ve = new _u(F, Pe, Oe), Ze = new Ou(z, ke, Oe, V), Ke = new Ts(z, B, ke), qe = new Qs(z, B, ke), ke.programs = Fe.programs, F.capabilities = Oe, F.extensions = B, F.properties = H, F.renderLists = Le, F.shadowMap = Ve, F.state = V, F.info = ke;
		}
		Qe(), S !== 1009 && (P = new rc(S, t.width, t.height, r, i));
		let $e = new wu(F, z);
		this.xr = $e, this.getContext = function() {
			...
			ue = e, de = n, t.width = Math.floor(e * fe), t.height = Math.floor(n * fe), r === !0 && (t.style.width = e + "px", t.style.height = n + "px"), P !== null && P.setSize(t.width, t.height), this.setViewport(0, 0, e, n);
			...
			e.isVector4 ? he.set(e.x, e.y, e.z, e.w) : he.set(e, t, n, r), V.viewport(L.copy(he).multiplyScalar(fe).round());
		}, this.getScissor = function(e) {
			return e.copy(ge);
		}, this.setScissor = function(e, t, n, r) {
			e.isVector4 ? ge.set(e.x, e.y, e.z, e.w) : ge.set(e, t, n, r), V.scissor(R.copy(ge).multiplyScalar(fe).round());
		}, this.getScissorTest = function() {
			return _e;
		}, this.setScissorTest = function(e) {
			V.setScissorTest(_e = e);
			...
			if (e) {
				...
				if (e) {
					let e = I.texture.type, t = w.has(e), n = Ue.getClearColor(), r = Ue.getClearAlpha(), i = n.r, a = n.g, o = n.b;
					t ? (T[0] = i, T[1] = a, T[2] = o, T[3] = r, z.clearBufferuiv(z.COLOR, 0, T)) : (E[0] = i, E[1] = a, E[2] = o, E[3] = r, z.clearBufferiv(z.COLOR, 0, E));
		...
		function tt() {
			...
			let e = ke.autoReset, t = Ve.enabled, n = Ve.autoUpdate, r = Ve.needsUpdate, i = Ve.type;
			Qe(), ke.autoReset = e, Ve.enabled = t, Ve.autoUpdate = n, Ve.needsUpdate = r, Ve.type = i;
		}
		function K(e) {
		...
		function nt(e) {
			let t = e.target;
			t.removeEventListener("dispose", nt), rt(t);
		}
		function rt(e) {
			it(e), H.remove(e);
		}
		...
		this.renderBufferDirect = function(e, t, n, r, i, a) {
			t === null && (t = we);
			let o = i.isMesh && i.matrixWorld.determinant() < 0, s = bt(e, t, n, r, i);
			V.setMaterial(r, o);
			let c = n.index, l = 1;
			if (r.wireframe === !0) {
			...
			Xe.setup(i, r, s, n, c);
			let h, g = Ke;
			if (c !== null && (h = je.get(c), g = qe, g.setIndex(h)), i.isMesh) r.wireframe === !0 ? (V.setLineWidth(r.wireframeLinewidth * Ee()), g.setMode(z.LINES)) : g.setMode(z.TRIANGLES);
			else if (i.isLine) {
				let e = r.linewidth;
				e === void 0 && (e = 1), V.setLineWidth(e * Ee()), i.isLineSegments ? g.setMode(z.LINES) : i.isLineLoop ? g.setMode(z.LINE_LOOP) : g.setMode(z.LINE_STRIP);
			...
			if (i.isBatchedMesh) if (B.get("WEBGL_multi_draw")) g.renderMultiDraw(i._multiDrawStarts, i._multiDrawCounts, i._multiDrawCount);
				...
				let e = i._multiDrawStarts, t = i._multiDrawCounts, n = i._multiDrawCount, a = c ? je.get(c).bytesPerElement : 1, o = H.get(r).currentProgram.getUniforms();
		...
		function at(e, t, n) {
			e.transparent === !0 && e.side === 2 && e.forceSinglePass === !1 ? (e.side = 1, e.needsUpdate = !0, gt(e, t, n), e.side = 0, e.needsUpdate = !0, gt(e, t, n), e.side = 2) : gt(e, t, n);
		}
		this.compile = function(e, t, n = null) {
			n === null && (n = e), j = ze.get(n), j.init(t), N.push(j), n.traverseVisible(function(e) {
		...
		ut.setAnimationLoop(st), typeof self < "u" && ut.setContext(self), this.setAnimationLoop = function(e) {
		...
		}, $e.addEventListener("sessionstart", ct), $e.addEventListener("sessionend", lt), this.render = function(e, t) {
			...
			let n = $e.enabled === !0 && $e.isPresenting === !0, r = P !== null && (I === null || n) && P.begin(F, I);
			if (e.matrixWorldAutoUpdate === !0 && e.updateMatrixWorld(), t.parent === null && t.matrixWorldAutoUpdate === !0 && t.updateMatrixWorld(), $e.enabled === !0 && $e.isPresenting === !0 && (P === null || P.isCompositing() === !1) && ($e.cameraAutoUpdate === !0 && $e.updateCamera(t), t = $e.getCamera()), e.isScene === !0 && e.onBeforeRender(F, e, t, I), j = ze.get(e, N.length), j.init(t), j.state.textureUnits = U.getTextureUnits(), N.push(j), xe.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse), ve.setFromProjectionMatrix(xe, Re, t.reversedDepth), be = this.localClippingEnabled, ye = Be.init(this.clippingPlanes, be), k = Le.get(e, M.length), k.init(), M.push(k), $e.enabled === !0 && $e.isPresenting === !0) {
				let e = F.xr.getDepthSensingMesh();
				e !== null && dt(e, t, -Infinity, F.sortObjects);
			}
			dt(e, t, 0, F.sortObjects), k.finish(), F.sortObjects === !0 && k.sort(pe, me), Te = $e.enabled === !1 || $e.isPresenting === !1 || $e.hasDepthSensing() === !1, Te && Ue.addToRenderList(k, e), this.info.render.frame++, ye === !0 && Be.beginShadows();
			let i = j.state.shadowsArray;
			if (Ve.render(i, e, t), ye === !0 && Be.endShadows(), this.info.autoReset === !0 && this.info.reset(), (r && P.hasRenderPass()) === !1) {
				...
				} else r.length > 0 && pt(n, r, e, t), Te && Ue.render(e), ft(k, e, t);
			}
			I !== null && ie === 0 && (U.updateMultisampleRenderTarget(I), U.updateRenderTargetMipmap(I)), r && P.end(F), e.isScene === !0 && e.onAfterRender(F, e, t), Xe.resetDefaultState(), ae = -1, oe = null, N.pop(), N.length > 0 ? (j = N[N.length - 1], U.setTextureUnits(j.state.textureUnits), ye === !0 && Be.setGlobalState(F.clippingPlanes, j.state.camera)) : j = null, M.pop(), k = M.length > 0 ? M[M.length - 1] : null, ne !== null && ne.renderEnd();
		};
		function dt(e, t, n, r) {
			...
			if (e.layers.test(t.layers)) {
				if (e.isGroup) n = e.renderOrder;
					...
					if (!e.frustumCulled || ve.intersectsSprite(e)) {
						...
						i.visible && k.push(e, t, i, n, Ce.z, null);
					}
					...
					if (r && (e.boundingSphere === void 0 ? (t.boundingSphere === null && t.computeBoundingSphere(), Ce.copy(t.boundingSphere.center)) : (e.boundingSphere === null && e.computeBoundingSphere(), Ce.copy(e.boundingSphere.center)), Ce.applyMatrix4(e.matrixWorld).applyMatrix4(xe)), Array.isArray(i)) {
						...
						for (let a = 0, o = r.length; a < o; a++) {
							...
							s && s.visible && k.push(e, t, s, n, Ce.z, o);
						}
					} else i.visible && k.push(e, t, i, n, Ce.z, null);
				}
			}
			let i = e.children;
		...
		function ft(e, t, n, r) {
			...
			j.setupLightsView(n), ye === !0 && Be.setGlobalState(F.clippingPlanes, n), r && V.viewport(L.copy(r)), i.length > 0 && mt(i, t, n), a.length > 0 && mt(a, t, n), o.length > 0 && mt(o, t, n), V.buffers.depth.setTest(!0), V.buffers.depth.setMask(!0), V.buffers.color.setMask(!0), V.setPolygonOffset(!1);
		}
		function pt(e, t, n, r) {
			...
			if (j.state.transmissionRenderTarget[r.id] === void 0) {
				...
				j.state.transmissionRenderTarget[r.id] = new Ht(1, 1, {
					generateMipmaps: !0,
					type: e ? g : l,
					minFilter: c,
			...
			let a = j.state.transmissionRenderTarget[r.id], o = r.viewport || L;
			a.setSize(o.z * F.transmissionResolutionScale, o.w * F.transmissionResolutionScale);
			let s = F.getRenderTarget(), u = F.getActiveCubeFace(), d = F.getActiveMipmapLevel();
			F.setRenderTarget(a), F.getClearColor(ce), le = F.getClearAlpha(), le < 1 && F.setClearColor(16777215, .5), F.clear(), Te && Ue.render(n);
			let f = F.toneMapping;
			F.toneMapping = 0;
			let p = r.viewport;
			if (r.viewport !== void 0 && (r.viewport = void 0), j.setupLightsView(r), ye === !0 && Be.setGlobalState(F.clippingPlanes, r), mt(e, n, r), U.updateMultisampleRenderTarget(a), U.updateRenderTargetMipmap(a), B.has("WEBGL_multisampled_render_to_texture") === !1) {
				let e = !1;
				for (let i = 0, a = t.length; i < a; i++) {
					let { object: a, geometry: o, material: s, group: c } = t[i];
					if (s.side === 2 && a.layers.test(r.layers)) {
						let t = s.side;
						s.side = 1, s.needsUpdate = !0, ht(a, n, r, o, s, c), s.side = t, s.needsUpdate = !0, e = !0;
					}
				}
				e === !0 && (U.updateMultisampleRenderTarget(a), U.updateRenderTargetMipmap(a));
			}
			F.setRenderTarget(s, u, d), F.setClearColor(ce, le), p !== void 0 && (r.viewport = p), F.toneMapping = f;
		}
		function mt(e, t, n) {
			let r = t.isScene === !0 ? t.overrideMaterial : null;
			for (let i = 0, a = e.length; i < a; i++) {
				let a = e[i], { object: o, geometry: s, group: c } = a, l = a.material;
				l.allowOverride === !0 && r !== null && (l = r), o.layers.test(n.layers) && ht(o, t, n, s, l, c);
			}
		}
		...
		function gt(e, t, n) {
			t.isScene !== !0 && (t = we);
			let r = H.get(e), i = j.state.lights, a = j.state.shadowsArray, o = i.state.version, s = Fe.getParameters(e, i.state, a, t, n, j.state.lightProbeGridArray), c = Fe.getProgramCacheKey(s), l = r.programs;
		...
		function bt(e, t, n, r, i) {
			t.isScene !== !0 && (t = we), U.resetTextureUnits();
			let a = t.fog, o = r.isMeshStandardMaterial || r.isMeshLambertMaterial || r.isMeshPhongMaterial ? t.environment : null, s = I === null ? F.outputColorSpace : I.isXRRenderTarget === !0 ? I.texture.colorSpace : X.workingColorSpace, c = r.isMeshStandardMaterial || r.isMeshLambertMaterial && !r.envMap || r.isMeshPhongMaterial && !r.envMap, l = Ae.get(r.envMap || o, c), u = r.vertexColors === !0 && !!n.attributes.color && n.attributes.color.itemSize === 4, d = !!n.attributes.tangent && (!!r.normalMap || r.anisotropy > 0), f = !!n.morphAttributes.position, p = !!n.morphAttributes.normal, m = !!n.morphAttributes.color, h = 0;
			r.toneMapped && (I === null || I.isXRRenderTarget === !0) && (h = F.toneMapping);
			let g = n.morphAttributes.position || n.morphAttributes.normal || n.morphAttributes.color, _ = g === void 0 ? 0 : g.length, v = H.get(r), y = j.state.lights;
			if (ye === !0 && (be === !0 || e !== oe)) {
				let t = e === oe && r.id === ae;
				Be.setState(r, e, t);
			}
			...
			b === !0 && (x = gt(r, t, i), ne && r.isNodeMaterial && ne.onUpdateProgram(r, x, v));
			let S = !1, C = !1, w = !1, T = x.getUniforms(), E = v.uniforms;
			if (V.useProgram(x.program) && (S = !0, C = !0, w = !0), r.id !== ae && (ae = r.id, C = !0), v.needsLights) {
				let e = yt(j.state.lightProbeGridArray, i);
				v.lightProbeGrid !== e && (v.lightProbeGrid = e, C = !0);
			}
			if (S || oe !== e) {
				V.buffers.depth.getReversed() && e.reversedDepth !== !0 && (e._reversedDepth = !0, e.updateProjectionMatrix()), T.setValue(z, "projectionMatrix", e.projectionMatrix), T.setValue(z, "viewMatrix", e.matrixWorldInverse);
				let t = T.map.cameraPosition;
				t !== void 0 && t.setValue(z, Se.setFromMatrixPosition(e.matrixWorld)), Oe.logarithmicDepthBuffer && T.setValue(z, "logDepthBufFC", 2 / (Math.log(e.far + 1) / Math.LN2)), (r.isMeshPhongMaterial || r.isMeshToonMaterial || r.isMeshLambertMaterial || r.isMeshBasicMaterial || r.isMeshStandardMaterial || r.isShaderMaterial) && T.setValue(z, "isOrthographic", e.isOrthographicCamera === !0), oe !== e && (oe = e, C = !0, w = !0);
			}
			if (v.needsLights && (y.state.directionalShadowMap.length > 0 && T.setValue(z, "directionalShadowMap", y.state.directionalShadowMap, U), y.state.spotShadowMap.length > 0 && T.setValue(z, "spotShadowMap", y.state.spotShadowMap, U), y.state.pointShadowMap.length > 0 && T.setValue(z, "pointShadowMap", y.state.pointShadowMap, U)), i.isSkinnedMesh) {
				T.setOptional(z, i, "bindMatrix"), T.setOptional(z, i, "bindMatrixInverse");
				let e = i.skeleton;
				e && (e.boneTexture === null && e.computeBoneTexture(), T.setValue(z, "boneTexture", e.boneTexture, U));
			}
			i.isBatchedMesh && (T.setOptional(z, i, "batchingTexture"), T.setValue(z, "batchingTexture", i._matricesTexture, U), T.setOptional(z, i, "batchingIdTexture"), T.setValue(z, "batchingIdTexture", i._indirectTexture, U), T.setOptional(z, i, "batchingColorTexture"), i._colorsTexture !== null && T.setValue(z, "batchingColorTexture", i._colorsTexture, U));
			...
			if ((D.position !== void 0 || D.normal !== void 0 || D.color !== void 0) && We.update(i, n, x), (C || v.receiveShadow !== i.receiveShadow) && (v.receiveShadow = i.receiveShadow, T.setValue(z, "receiveShadow", i.receiveShadow)), (r.isMeshStandardMaterial || r.isMeshLambertMaterial || r.isMeshPhongMaterial) && r.envMap === null && t.environment !== null && (E.envMapIntensity.value = t.environmentIntensity), E.dfgLUT !== void 0 && (E.dfgLUT.value = ju()), C) {
				if (T.setValue(z, "toneMappingExposure", F.toneMappingExposure), v.needsLights && xt(E, w), a && r.fog === !0 && Ie.refreshFogUniforms(E, a), Ie.refreshMaterialUniforms(E, r, fe, de, j.state.transmissionRenderTarget[e.id]), v.needsLights && v.lightProbeGrid) {
				...
				ul.upload(z, _t(v), E, U);
			}
			if (r.isShaderMaterial && r.uniformsNeedUpdate === !0 && (ul.upload(z, _t(v), E, U), r.uniformsNeedUpdate = !1), r.isSpriteMaterial && T.setValue(z, "center", i.center), T.setValue(z, "modelViewMatrix", i.modelViewMatrix), T.setValue(z, "normalMatrix", i.normalMatrix), T.setValue(z, "modelMatrix", i.matrixWorld), r.uniformsGroups !== void 0) {
		...
		this.getActiveCubeFace = function() {
			...
			let r = H.get(e);
			r.__autoAllocateDepthBuffer = e.resolveDepthBuffer === !1, r.__autoAllocateDepthBuffer === !1 && (r.__useRenderToTexture = !1), H.get(e.texture).__webglTexture = t, H.get(e.depthTexture).__webglTexture = r.__autoAllocateDepthBuffer ? void 0 : n, r.__hasExternalTextures = !0;
		}, this.setRenderTargetFramebuffer = function(e, t) {
			let n = H.get(e);
			n.__webglFramebuffer = t, n.__useDefaultFramebuffer = t === void 0;
		};
		let q = z.createFramebuffer();
		this.setRenderTarget = function(e, t = 0, n = 0) {
			...
			if (e) {
				...
				if (o.__useDefaultFramebuffer !== void 0) {
					V.bindFramebuffer(z.FRAMEBUFFER, o.__webglFramebuffer), L.copy(e.viewport), R.copy(e.scissor), se = e.scissorTest, V.viewport(L), V.scissor(R), V.setScissorTest(se), ae = -1;
					return;
					...
					if (o.__boundDepthTexture !== t) {
						if (t !== null && H.has(t) && (e.width !== t.image.width || e.height !== t.image.height)) throw Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");
				...
				e.isWebGLCubeRenderTarget ? (r = Array.isArray(c[t]) ? c[t][n] : c[t], i = !0) : r = e.samples > 0 && U.useMultisampledRTT(e) === !1 ? H.get(e).__webglMultisampledFramebuffer : Array.isArray(c) ? c[n] : c, L.copy(e.viewport), R.copy(e.scissor), se = e.scissorTest;
			} else L.copy(he).multiplyScalar(fe).floor(), R.copy(ge).multiplyScalar(fe).floor(), se = _e;
			if (n !== 0 && (r = q), V.bindFramebuffer(z.FRAMEBUFFER, r) && V.drawBuffers(e, r), V.viewport(L), V.scissor(R), V.setScissorTest(se), i) {
			...
			if (e.isWebGLCubeRenderTarget && o !== void 0 && (c = c[o]), c) {
				...
				try {
					...
					if (e.textures.length > 1 && z.readBuffer(z.COLOR_ATTACHMENT0 + s), !Oe.textureFormatReadable(c)) {
					...
					t >= 0 && t <= e.width - r && n >= 0 && n <= e.height - i && z.readPixels(t, n, r, i, Ye.convert(c), Ye.convert(l), a);
				} finally {
					let e = I === null ? null : H.get(I).__webglFramebuffer;
			...
			if (e.isWebGLCubeRenderTarget && o !== void 0 && (c = c[o]), c) if (t >= 0 && t <= e.width - r && n >= 0 && n <= e.height - i) {
				...
				if (e.textures.length > 1 && z.readBuffer(z.COLOR_ATTACHMENT0 + s), !Oe.textureFormatReadable(l)) throw Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");
				...
				z.bindBuffer(z.PIXEL_PACK_BUFFER, d), z.bufferData(z.PIXEL_PACK_BUFFER, a.byteLength, z.STREAM_READ), z.readPixels(t, n, r, i, Ye.convert(l), Ye.convert(u), 0);
				let f = I === null ? null : H.get(I).__webglFramebuffer;
				V.bindFramebuffer(z.FRAMEBUFFER, f);
				let p = z.fenceSync(z.SYNC_GPU_COMMANDS_COMPLETE, 0);
				return z.flush(), await Je(z, p, 4), z.bindBuffer(z.PIXEL_PACK_BUFFER, d), z.getBufferSubData(z.PIXEL_PACK_BUFFER, 0, a), z.deleteBuffer(d), z.deleteSync(p), a;
		...
		let Ct = z.createFramebuffer(), wt = z.createFramebuffer();
		this.copyTextureToTexture = function(e, t, n = null, r = null, i = 0, a = 0) {
			...
			if (e.isDepthTexture) {
				...
				V.bindFramebuffer(z.READ_FRAMEBUFFER, Ct), V.bindFramebuffer(z.DRAW_FRAMEBUFFER, wt);
			...
			e.isCubeTexture ? U.setTextureCube(e, 0) : e.isData3DTexture ? U.setTexture3D(e, 0) : e.isDataArrayTexture || e.isCompressedArrayTexture ? U.setTexture2DArray(e, 0) : U.setTexture2D(e, 0), V.unbindTexture();
		}, this.resetState = function() {
			re = 0, ie = 0, I = null, V.reset(), Xe.reset();
...
//#endregion
export { y as $, eo as A, Ra as B, Ne as C, Kr as D, Gt as E, La as F, za as G, kn as H, Vo as I, To as J, Va as K, w as L, yn as M, Ho as N, Pr as O, zo as P, l as Q, fs as R, o as S, St as T, Za as U, Me as V, Xi as W, Ha as X, Xo as Y, us as Z, h as _, _i as a, Do as b, vi as c, Yr as d, q as et, E as f, Pa as g, Xe as h, je as i, $a as j, to as k, Z as l, Wo as m, Mu as n, Bt as nt, cr as o, mi as p, zt as q, Go as r, Ht as rt, Cr as s, zs as t, J as tt, yi as u, On as v, Tr as w, ii as x, bn as y, e as z };
