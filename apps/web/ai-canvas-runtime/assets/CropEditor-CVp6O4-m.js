...
import { Kt as i, ht as a, mt as o, st as s } from "./useTooltipAutoPlacement-D1FArkVS.js";
import { l as c } from "./assetFormat-UuOoHpLo.js";
import { t as l } from "./FullscreenOverlay-BTKONk6M.js";
...
function W({ isOpen: e, imageUrl: t, onClose: n, onStart: p, onSave: m, operationKey: h }) {
	...
	let X = B?.sourceUrl === t ? B : null, Z = (0, f.useCallback)(() => {
		...
		let n = Z();
		if (!n) return;
		let { natW: r, natH: i } = P, s = null, c = !1, l = !1;
		try {
			...
			o(_, v, "钢笔裁切输出"), p?.(), c = !0, $(), s = document.createElement("canvas"), s.width = _, s.height = v;
			let y = s.getContext("2d");
		...
		let t = Z();
		if (!t) return;
		let { x: n, y: r, width: i, height: s } = D, c = e.clientWidth * G, l = e.clientHeight * G, u = e.naturalWidth / c, d = e.naturalHeight / l, f = null, h = !1, _ = !1;
		try {
			let c = Math.round(i * u), l = Math.round(s * d);
			...
			g.drawImage(e, n * u, r * d, i * u, s * d, 0, 0, c, l);
			let v = await a(f);
