...
import { a as t, t as n } from "./core-CoHQ9AE0.js";
import { N as r, b as i } from "./directorSceneSchema-BcP-NXqL.js";
import "./fileService-zQLozbOU.js";
import { t as a } from "./ViewportImage-Dsz9jsTU.js";
...
async function d() {
	if (!u) try {
		let { appDataDir: e } = await import("./path-C7M6ZesM.js").then((e) => e.a), t = r(r(await e(), ".cache"), "drag-icon.png"), n = atob(l), a = new Uint8Array(n.length);
