...
function v({ isOpen: e, imageUrl: t, onClose: n, onGenerate: g }) {
	...
	let G = (0, f.useMemo)(() => {
		...
		x,
		C
	]), K = (0, f.useMemo)(() => G ? i(G.tw, G.th, "扩图输出") : null, [G]), q = (0, f.useMemo)(() => {
