...
function le(e, { preferredFontFormat: t }) {
...
async function fe(e, t) {
	let r = n(e.childNodes).map((e) => K(e, t));
	await Promise.all(r).then(() => e);
}
async function K(e, t) {
	p(e, Element) && (await ue(e, t), await de(e, t), await fe(e, t));
}
//#endregion
		...
		if ("cssRules" in r) try {
			n(r.cssRules || []).forEach((e, n) => {
				if (e.type === CSSRule.IMPORT_RULE) {
					let a = n + 1, o = e.href, s = J(o).then((e) => Y(e, t)).then((e) => X(e).forEach((e) => {
						try {
			...
			r.href != null && i.push(J(r.href).then((e) => Y(e, t)).then((e) => X(e).forEach((e) => {
...
function he(e) {
	return e.filter((e) => e.type === CSSRule.FONT_FACE_RULE).filter((e) => U(e.style.getPropertyValue("src")));
}
async function ge(e, t) {
	if (e.ownerDocument == null) throw Error("Provided element is not within a Document");
	return he(await me(n(e.ownerDocument.styleSheets), t));
}
function Z(e) {
...
async function Q(e, t) {
	let n = await ge(e, t), r = _e(e);
	return (await Promise.all(n.filter((e) => r.has(Z(e.style.fontFamily))).map((e) => {
		let n = e.parentStyleSheet ? e.parentStyleSheet.href : null;
		return W(e.cssText, n, t);
	}))).join("\n");
}
async function ve(e, t) {
	let n = t.fontEmbedCSS == null ? t.skipFonts ? null : await Q(e, t) : t.fontEmbedCSS;
	if (n) {
...
async function ye(e, t = {}) {
	...
	return await ve(i, t), await K(i, t), pe(i, t), await te(i, n, r);
}
async function $(e, t = {}) {
	let { width: n, height: r } = c(e, t), i = await d(await ye(e, t)), a = document.createElement("canvas"), o = a.getContext("2d"), s = t.pixelRatio || l(), u = t.canvasWidth || n, f = t.canvasHeight || r;
...
async function be(e, t = {}) {
	return (await $(e, t)).toDataURL("image/jpeg", t.quality || 1);
}
//#endregion
export { be as n, $ as t };
