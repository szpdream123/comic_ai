...
import { t as n } from "./ModalOverlay-DopvjrY3.js";
import { Rt as r, Tt as i } from "./useTooltipAutoPlacement-BSvTkR9V.js";
import { n as a } from "./rasterImageDimensions-CX1VK2cM.js";
//#region src/components/OnboardingDialog.tsx
var o = e(), s = [
	{
...
function c({ onClose: e, onOpenHelp: c }) {
	let l = t();
	return /* @__PURE__ */ (0, o.jsxs)(n, {
		isOpen: !0,
		onClose: e,
		closeOnBackdrop: !1,
		ariaLabel: l("AI Canvas 新手引导"),
		className: "h-[min(660px,calc(100vh-24px))] w-[min(620px,calc(100vw-24px))]",
		children: [
			/* @__PURE__ */ (0, o.jsxs)("header", {
				className: "flex shrink-0 items-center justify-between gap-3 border-b border-canvas-border px-4 py-3",
			...
			/* @__PURE__ */ (0, o.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, o.jsxs)("section", {
						"data-tooltip": l("像现在这样——把鼠标停在元素上不动，说明就会自己浮出来。"),
						...
						children: [/* @__PURE__ */ (0, o.jsx)(a, {
							...
							children: [/* @__PURE__ */ (0, o.jsx)("h3", {
								...
								children: l("先养成一个习惯：多悬停")
							}), /* @__PURE__ */ (0, o.jsxs)("p", {
								className: "mt-1.5 text-xs leading-5 text-canvas-text-secondary",
								children: [l("界面上几乎每个按钮、图标和开关都写了说明。把鼠标停在上面约 1 秒，说明就会浮出来。"), l("遇到不认识的图标，先悬停看一眼再点，比点开试错快得多——这段文字本身也可以悬停试试。")]
							})]
						})]
					}),
					/* @__PURE__ */ (0, o.jsxs)("section", {
						className: "mt-3 flex gap-3 rounded-xl border border-amber-400/30 bg-amber-500/10 p-3",
						children: [/* @__PURE__ */ (0, o.jsx)(a, {
							...
							children: [/* @__PURE__ */ (0, o.jsx)("h3", {
								...
								children: l("界面卡顿或显示不全？开启性能模式")
							}), /* @__PURE__ */ (0, o.jsx)("p", {
								className: "mt-1.5 text-xs leading-5 text-amber-200/80",
								children: l("前往“设置 > 常规 > 图形与性能”开启。它会关闭毛玻璃、装饰动画和动态背景，同时保留加载与进度提示。")
							})]
						})]
					}),
					/* @__PURE__ */ (0, o.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, o.jsx)(a, {
							...
							className: "text-sm font-semibold text-canvas-text",
							children: l("这些操作藏在界面里，不说很难发现")
						})]
					}),
					/* @__PURE__ */ (0, o.jsx)("p", {
						className: "mb-3 text-xs leading-5 text-canvas-text-muted",
						children: l("下面每一条都可以悬停查看适用条件和限制。")
					}),
					/* @__PURE__ */ (0, o.jsx)("ul", {
						className: "space-y-1",
						children: s.map((e) => /* @__PURE__ */ (0, o.jsxs)("li", {
							"data-tooltip": l(e.tooltip),
							...
							children: [/* @__PURE__ */ (0, o.jsx)("span", {
								className: "flex h-7 w-7 shrink-0 items-center justify-center rounded-md bg-canvas-hover text-canvas-text-secondary",
								children: /* @__PURE__ */ (0, o.jsx)(a, {
									icon: e.icon,
									width: "16",
									height: "16",
					...
					/* @__PURE__ */ (0, o.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, o.jsx)(a, {
							...
							"aria-hidden": "true"
						}), /* @__PURE__ */ (0, o.jsxs)("p", { children: [l("开始生成前，记得先在“设置 > API Key”配置好模型服务，否则节点里的模型会是不可用状态。"), l("本引导只在首次启动时出现，之后可从侧边栏头像菜单的「帮助」再次查看完整说明。")] })]
					})
				]
			}),
			/* @__PURE__ */ (0, o.jsxs)("footer", {
				className: "flex shrink-0 flex-wrap items-center justify-end gap-2 border-t border-canvas-border px-4 py-3",
				children: [/* @__PURE__ */ (0, o.jsx)(r, {
					...
					type: "button",
					"data-tooltip": l("按场景整理的完整说明：画布导航、节点连线、AI 生成、快捷指令、资产与设置"),
					onClick: c,
