...
import { t as i } from "./ModalOverlay-B0YAfIbK.js";
import { Nt as a, S as o, p as s } from "./useTooltipAutoPlacement-D1FArkVS.js";
...
function g() {
	let e = (0, u.useRef)(null), t = (0, u.useRef)(null), [n, r] = (0, u.useState)(0), [i, a] = (0, u.useState)(() => h() ? "wf:6" : void 0), [l, g] = (0, u.useState)(() => h() ? m.length - 1 : 0), _ = (0, u.useCallback)(() => r((e) => e + 1), []);
	return (0, u.useEffect)(() => {
		...
		let n = e.current;
		if (!n) return;
		let r = n.querySelector("[data-demo-query]"), i = n.querySelector("[data-demo-picker]"), o = t.current, s = n.querySelector("[data-demo-caret]"), c = n.querySelector("[data-demo-result]");
		if (!r || !i || !o || !s || !c) return;
		if (h()) {
		...
		return import("./gsap-C1ZKf3Iq.js").then((e) => e.n).then(({ gsap: t }) => {
			l || !e.current || (u = t.context(() => {
				...
				t.set(s, { opacity: 1 }), t.to(s, {
					...
					duration: .22,
					ease: "power2.in"
				}).set(r, { display: "none" }).set(o, { display: "inline" }).fromTo(o, {
					opacity: 0,
					scale: .86
				}, {
					opacity: 1,
