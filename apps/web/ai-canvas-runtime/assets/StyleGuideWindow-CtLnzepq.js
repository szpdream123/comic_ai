...
import { t as r } from "./LazyLoadBoundary-nRnF0yH-.js";
import { a as i, i as a } from "./i18n-on3r1DCI.js";
import { W as o } from "./fileService-BawXHbsK.js";
import { t as s } from "./use-reduced-motion-BNk9FtxG.js";
import { t as c } from "./mascotClips-Czs9Mb5c.js";
//#region src/components/styleGuide/StyleGuideMascot.tsx
var l = /* @__PURE__ */ e(t(), 1), u = n(), d = (0, l.lazy)(() => import("./Mascot-BnqYrm8l.js")), f = [
	{
		kind: "status",
		id: "idle",
		label: "待机"
...
function h({ choice: e, theme: t, reduceMotion: n }) {
	let r = (0, l.useRef)(null), [i, a] = (0, l.useState)("idle");
	return (0, l.useEffect)(() => {
		if (e.kind === "clip") {
			r.current?.playClip(e.id);
			return;
		}
		let t = requestAnimationFrame(() => a(e.id));
		return () => cancelAnimationFrame(t);
	}, [e]), /* @__PURE__ */ (0, u.jsx)(d, {
		handleRef: r,
		theme: t,
		status: i,
		loading: i === "thinking",
...
function g({ theme: e }) {
	let t = (0, l.useRef)(null), [n, i] = (0, l.useState)(!1), [a, o] = (0, l.useState)(() => !document.hidden), [d, g] = (0, l.useState)(f[0]), [_, v] = (0, l.useState)(0), [y, b] = (0, l.useState)(!1), [x, S] = (0, l.useState)(!1), [C, w] = (0, l.useState)(!1), T = s(), E = !!T || C, D = n && a;
	(0, l.useEffect)(() => {
		let e = t.current;
		if (!e) return;
		let n = new IntersectionObserver(([e]) => i(e.isIntersecting), { rootMargin: "48px" });
		n.observe(e);
		let r = () => o(!document.hidden);
		return document.addEventListener("visibilitychange", r), () => {
			n.disconnect(), document.removeEventListener("visibilitychange", r);
		};
	}, []), (0, l.useEffect)(() => {
		if (!x || !D || E) return;
		let e = d.kind === "clip" ? c[d.id].duration : 2.2, t = Number.isFinite(e) ? e + .9 : d.id === "sleepy" ? 6.2 : 3.6, n = window.setTimeout(() => {
			g(m[(m.findIndex((e) => e.kind === d.kind && e.id === d.id) + 1) % m.length]), v((e) => e + 1);
		}, t * 1e3);
	...
	let O = (e) => {
		S(!1), g(e), v((e) => e + 1);
	}, k = (e) => e.kind === d.kind && e.id === d.id;
	return /* @__PURE__ */ (0, u.jsxs)("div", {
		className: "ui-card",
		children: [
			/* @__PURE__ */ (0, u.jsxs)("div", {
				className: "flex flex-wrap items-center justify-between gap-3 border-b border-canvas-border px-4 py-3",
				children: [/* @__PURE__ */ (0, u.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, u.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, u.jsx)("button", {
							type: "button",
							className: `ui-segmented__item${y ? " is-active" : ""}`,
							"aria-pressed": y,
							onClick: () => b(!0),
							children: "实际 100px"
			...
			/* @__PURE__ */ (0, u.jsx)("div", {
				ref: t,
				className: "flex h-72 items-center justify-center bg-canvas-surface",
				children: /* @__PURE__ */ (0, u.jsx)("div", {
					className: y ? "h-[100px] w-[100px]" : "h-60 w-60",
					role: "img",
					"aria-label": `吉祥物预览：${d.label}`,
					children: D ? /* @__PURE__ */ (0, u.jsx)(r, {
						label: "吉祥物预览",
						children: /* @__PURE__ */ (0, u.jsx)(l.Suspense, {
							fallback: /* @__PURE__ */ (0, u.jsx)("p", {
								className: "text-center text-xs text-canvas-text-muted",
								children: "正在加载吉祥物…"
							}),
			...
			/* @__PURE__ */ (0, u.jsxs)("div", {
				className: "ui-card__body ui-stack",
				children: [
					[{
						label: "助手状态",
						choices: f
						...
						"aria-label": e.label,
						children: [/* @__PURE__ */ (0, u.jsx)("span", {
							className: "w-16 shrink-0 text-xs text-canvas-text-muted",
							children: e.label
						}), e.choices.map((e) => /* @__PURE__ */ (0, u.jsx)("button", {
							type: "button",
							className: `ui-btn ui-btn--sm${k(e) ? " is-active" : ""}`,
							"aria-pressed": k(e),
							onClick: () => O(e),
							children: e.label
						}, e.id))]
					...
					/* @__PURE__ */ (0, u.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, u.jsx)("button", {
								type: "button",
								className: `ui-btn ui-btn--sm${x && !E ? " is-active" : ""}`,
								"aria-pressed": x && !E,
								disabled: E,
								onClick: () => S((e) => !e),
								children: "循环演示"
					...
					/* @__PURE__ */ (0, u.jsxs)("p", {
						className: "m-0 text-xs leading-relaxed text-canvas-text-muted",
						children: [
							T ? "系统已开启减少动态，预览保留静态表情。" : E ? "已开启减少动态，预览保留静态表情。" : "移动鼠标查看眼神与身体跟随；思考状态可查看加载彩带。",
							" ",
							"明暗主题跟随窗口右上角切换。"
						]
					})
...
function _({ id: e, title: t, desc: n, children: r }) {
...
function v({ label: e, code: t, children: n }) {
...
function b({ items: e }) {
	return /* @__PURE__ */ (0, u.jsx)("div", {
		...
		children: e.map((e) => /* @__PURE__ */ (0, u.jsx)(y, { ...e }, e.cssVar))
	});
}
function x() {
	return /* @__PURE__ */ (0, u.jsxs)(_, {
		id: "sg-colors",
		title: "颜色令牌",
				...
				children: [/* @__PURE__ */ (0, u.jsx)("p", {
					...
					children: [
						/* @__PURE__ */ (0, u.jsxs)("span", {
							...
							children: [/* @__PURE__ */ (0, u.jsx)("i", { className: "ui-badge__dot" }), "成功"]
						}),
						/* @__PURE__ */ (0, u.jsxs)("span", {
							className: "ui-badge ui-badge--info",
							children: [/* @__PURE__ */ (0, u.jsx)("i", { className: "ui-badge__dot" }), "信息"]
						}),
						/* @__PURE__ */ (0, u.jsxs)("span", {
							className: "ui-badge ui-badge--warning",
							children: [/* @__PURE__ */ (0, u.jsx)("i", { className: "ui-badge__dot" }), "警告"]
						}),
						/* @__PURE__ */ (0, u.jsxs)("span", {
							className: "ui-badge ui-badge--danger",
							children: [/* @__PURE__ */ (0, u.jsx)("i", { className: "ui-badge__dot" }), "危险"]
						})
					]
				})]
			}),
		...
		children: [/* @__PURE__ */ (0, u.jsx)(v, {
			...
			children: /* @__PURE__ */ (0, u.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, u.jsxs)("span", {
						className: "text-xs text-canvas-text-secondary",
						children: ["内联代码 ", /* @__PURE__ */ (0, u.jsx)("code", {
							className: "ui-code",
				...
				children: /* @__PURE__ */ (0, u.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, u.jsxs)("button", {
							...
							children: [/* @__PURE__ */ (0, u.jsx)("span", { className: "ui-spinner" }), "处理中"]
						}),
						/* @__PURE__ */ (0, u.jsx)("button", {
							type: "button",
					...
					children: [
						/* @__PURE__ */ (0, u.jsx)("button", {
							...
							children: /* @__PURE__ */ (0, u.jsxs)("svg", {
								...
								strokeWidth: "2",
								"aria-hidden": "true",
								children: [/* @__PURE__ */ (0, u.jsx)("circle", {
									cx: "12",
									cy: "12",
									r: "3"
								}), /* @__PURE__ */ (0, u.jsx)("path", { d: "M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z" })]
							})
						}),
						/* @__PURE__ */ (0, u.jsx)("button", {
							type: "button",
			...
			/* @__PURE__ */ (0, u.jsx)(v, {
				...
				children: /* @__PURE__ */ (0, u.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, u.jsxs)("div", {
							className: "ui-field",
							children: [/* @__PURE__ */ (0, u.jsx)("label", {
								className: "ui-label",
								htmlFor: "sg-input-sm",
...
function E() {
	let [e, t] = (0, l.useState)("flux"), [n, r] = (0, l.useState)(!1), i = (0, l.useRef)(null), a = [
		{
			value: "flux",
			label: "FLUX.1 [dev]"
		},
			...
			/* @__PURE__ */ (0, u.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, u.jsx)("select", {
						...
						tabIndex: -1,
						"aria-hidden": "true",
						children: a.map((e) => /* @__PURE__ */ (0, u.jsx)("option", {
							value: e.value,
							disabled: e.disabled,
							children: e.label
						}, e.value))
					...
					n ? /* @__PURE__ */ (0, u.jsx)("div", {
						className: "ui-menu",
						role: "listbox",
						children: a.map((n) => /* @__PURE__ */ (0, u.jsx)("button", {
							type: "button",
							role: "option",
...
function D() {
	let [e, t] = (0, l.useState)(!1), [n, r] = (0, l.useState)("最近修改"), i = (0, l.useRef)(null);
	return (0, l.useEffect)(() => {
		if (!e) return;
		let n = (e) => {
		...
		children: [/* @__PURE__ */ (0, u.jsxs)("button", {
			...
			"aria-expanded": e,
			onClick: () => t((e) => !e),
			children: [n, /* @__PURE__ */ (0, u.jsx)("svg", {
				width: "12",
				height: "12",
				viewBox: "0 0 24 24",
				fill: "none",
			...
			children: [
				...
				/* @__PURE__ */ (0, u.jsx)("div", { className: "ui-menu__sep" }),
				/* @__PURE__ */ (0, u.jsx)("span", {
					className: "ui-menu__label",
					children: "操作"
				}),
				/* @__PURE__ */ (0, u.jsxs)("button", {
					...
					children: ["导出为 JSON", /* @__PURE__ */ (0, u.jsx)("span", {
...
function O() {
	return /* @__PURE__ */ (0, u.jsxs)(_, {
		...
		children: [/* @__PURE__ */ (0, u.jsx)(v, {
			...
			children: /* @__PURE__ */ (0, u.jsxs)("div", {
				className: "pb-32",
				children: [/* @__PURE__ */ (0, u.jsx)(D, {}), /* @__PURE__ */ (0, u.jsx)("p", {
				...
				children: [
					...
					/* @__PURE__ */ (0, u.jsx)("span", {
						...
						children: /* @__PURE__ */ (0, u.jsxs)("svg", {
							...
							strokeLinejoin: "round",
							children: [
								/* @__PURE__ */ (0, u.jsx)("path", { d: "M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" }),
								/* @__PURE__ */ (0, u.jsx)("polyline", { points: "17 8 12 3 7 8" }),
								/* @__PURE__ */ (0, u.jsx)("line", {
									x1: "12",
									y1: "3",
									x2: "12",
...
function A() {
	let [e, t] = (0, l.useState)(!0), [n, r] = (0, l.useState)(!1), [i, a] = (0, l.useState)(65), [o, s] = (0, l.useState)("grid");
	return /* @__PURE__ */ (0, u.jsxs)(_, {
		id: "sg-selection",
		title: "选择控件",
		...
		children: [
			...
			/* @__PURE__ */ (0, u.jsx)(v, {
				...
				children: /* @__PURE__ */ (0, u.jsxs)("div", {
					className: "ui-field",
					style: { maxWidth: 320 },
					children: [/* @__PURE__ */ (0, u.jsxs)("label", {
						className: "ui-label",
						htmlFor: "sg-slider",
						children: [
							"画质权重 · ",
			...
			/* @__PURE__ */ (0, u.jsx)(v, {
				...
				children: /* @__PURE__ */ (0, u.jsx)("div", {
					...
					children: [
						...
						type: "button",
						role: "tab",
						"aria-selected": o === e.key,
						className: `ui-segmented__item${o === e.key ? " is-active" : ""}`,
						onClick: () => s(e.key),
						children: e.label
					}, e.key))
				})
		...
		children: [
			...
			/* @__PURE__ */ (0, u.jsx)(v, {
				...
				children: /* @__PURE__ */ (0, u.jsx)("div", {
					...
					].map((n) => /* @__PURE__ */ (0, u.jsxs)("button", {
						type: "button",
						"aria-pressed": e === n.id,
	...
	return /* @__PURE__ */ (0, u.jsxs)(_, {
		...
		children: [
			/* @__PURE__ */ (0, u.jsx)(v, {
				...
				children: /* @__PURE__ */ (0, u.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, u.jsxs)("span", {
							className: "ui-badge ui-badge--success",
							children: [/* @__PURE__ */ (0, u.jsx)("i", { className: "ui-badge__dot" }), "运行中"]
						})
					]
				})
			}),
			/* @__PURE__ */ (0, u.jsx)(v, {
				...
				children: /* @__PURE__ */ (0, u.jsxs)("div", {
					className: "ui-row",
					children: [e.map((e) => /* @__PURE__ */ (0, u.jsxs)("span", {
						className: "ui-tag",
						children: [e, /* @__PURE__ */ (0, u.jsx)("button", {
							type: "button",
							...
							children: /* @__PURE__ */ (0, u.jsxs)("svg", {
								...
								strokeWidth: "3",
								"aria-hidden": "true",
								children: [/* @__PURE__ */ (0, u.jsx)("line", {
									x1: "18",
									y1: "6",
									x2: "6",
									y2: "18"
					...
					}, e)), e.length === 0 ? /* @__PURE__ */ (0, u.jsx)("button", {
						type: "button",
						className: "ui-btn ui-btn--ghost ui-btn--sm",
						onClick: () => t([
							"角色",
			...
			/* @__PURE__ */ (0, u.jsx)(v, {
				...
				children: /* @__PURE__ */ (0, u.jsxs)("table", {
					className: "ui-table",
					children: [/* @__PURE__ */ (0, u.jsx)("thead", { children: /* @__PURE__ */ (0, u.jsxs)("tr", { children: [
						/* @__PURE__ */ (0, u.jsx)("th", { children: "连接" }),
						/* @__PURE__ */ (0, u.jsx)("th", { children: "厂商" }),
						/* @__PURE__ */ (0, u.jsx)("th", { children: "状态" }),
						/* @__PURE__ */ (0, u.jsx)("th", { children: "模型数" })
					] }) }), /* @__PURE__ */ (0, u.jsxs)("tbody", { children: [
						/* @__PURE__ */ (0, u.jsxs)("tr", { children: [
							/* @__PURE__ */ (0, u.jsx)("td", {
								className: "text-canvas-text",
								children: "主账号"
							}),
							/* @__PURE__ */ (0, u.jsx)("td", { children: "OpenAI" }),
							/* @__PURE__ */ (0, u.jsx)("td", { children: /* @__PURE__ */ (0, u.jsxs)("span", {
								className: "ui-badge ui-badge--success",
								children: [/* @__PURE__ */ (0, u.jsx)("i", { className: "ui-badge__dot" }), "可用"]
							}) }),
							/* @__PURE__ */ (0, u.jsx)("td", { children: "24" })
						] }),
						/* @__PURE__ */ (0, u.jsxs)("tr", { children: [
							/* @__PURE__ */ (0, u.jsx)("td", {
								className: "text-canvas-text",
							...
							/* @__PURE__ */ (0, u.jsx)("td", { children: "火山方舟" }),
							/* @__PURE__ */ (0, u.jsx)("td", { children: /* @__PURE__ */ (0, u.jsxs)("span", {
								className: "ui-badge ui-badge--warning",
								children: [/* @__PURE__ */ (0, u.jsx)("i", { className: "ui-badge__dot" }), "限流"]
							}) }),
							/* @__PURE__ */ (0, u.jsx)("td", { children: "11" })
						] }),
						/* @__PURE__ */ (0, u.jsxs)("tr", { children: [
							/* @__PURE__ */ (0, u.jsx)("td", {
								className: "text-canvas-text",
							...
							/* @__PURE__ */ (0, u.jsx)("td", { children: "ComfyUI" }),
							/* @__PURE__ */ (0, u.jsx)("td", { children: /* @__PURE__ */ (0, u.jsx)("span", {
								className: "ui-badge ui-badge--outline",
								children: "未连接"
							}) }),
							/* @__PURE__ */ (0, u.jsx)("td", { children: "0" })
						] })
					] })]
				})
			}),
				...
				children: /* @__PURE__ */ (0, u.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, u.jsxs)("div", {
							...
							children: ["最近使用", /* @__PURE__ */ (0, u.jsx)("span", {
						...
						/* @__PURE__ */ (0, u.jsxs)("div", {
							...
							children: ["我的收藏", /* @__PURE__ */ (0, u.jsx)("span", {
								className: "ui-list__trailing",
								children: "48"
							})]
						}),
						/* @__PURE__ */ (0, u.jsxs)("div", {
							...
							children: ["回收站", /* @__PURE__ */ (0, u.jsx)("span", {
								className: "ui-list__trailing",
								children: "3"
							})]
						})
						...
						/* @__PURE__ */ (0, u.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, u.jsx)("span", {
								...
								children: /* @__PURE__ */ (0, u.jsxs)("svg", {
									...
									strokeWidth: "2",
									children: [
										/* @__PURE__ */ (0, u.jsx)("path", { d: "M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z" }),
										/* @__PURE__ */ (0, u.jsx)("line", {
											x1: "12",
											y1: "9",
											x2: "12",
				...
				children: /* @__PURE__ */ (0, u.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, u.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, u.jsx)("div", { className: "ui-progress__bar" })
						}),
						/* @__PURE__ */ (0, u.jsxs)("div", {
							className: "ui-row ui-row--loose",
							children: [/* @__PURE__ */ (0, u.jsxs)("span", {
								className: "ui-row ui-row--tight text-xs text-canvas-text-secondary",
								children: [/* @__PURE__ */ (0, u.jsx)("span", { className: "ui-spinner" }), " 加载中"]
							}), /* @__PURE__ */ (0, u.jsxs)("div", {
								className: "ui-stack ui-stack--tight",
								style: { width: 220 },
								children: [/* @__PURE__ */ (0, u.jsx)("div", {
			...
			/* @__PURE__ */ (0, u.jsxs)(v, {
				...
				children: [/* @__PURE__ */ (0, u.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, u.jsx)("hr", { className: "ui-divider" }),
						/* @__PURE__ */ (0, u.jsx)("span", {
							className: "text-xs text-canvas-text-secondary",
							children: "下方内容"
						})
					...
					children: [
						...
						/* @__PURE__ */ (0, u.jsx)("span", { className: "ui-divider ui-divider--vertical" }),
						/* @__PURE__ */ (0, u.jsx)("span", {
							className: "text-xs text-canvas-text-secondary",
							children: "右"
						})
...
function F({ theme: e }) {
	return /* @__PURE__ */ (0, u.jsxs)(u.Fragment, { children: [
		...
		/* @__PURE__ */ (0, u.jsx)(_, {
			id: "sg-mascot",
			title: "吉祥物",
			desc: "预览真实吉祥物的状态、表情与身体动作，支持循环演示和不同尺寸查看。",
			children: /* @__PURE__ */ (0, u.jsx)(g, { theme: e })
		}),
		/* @__PURE__ */ (0, u.jsx)(P, {})
	] });
}
...
function R() {
	let e = i(), [t, n] = (0, l.useState)("dark"), [r, s] = (0, l.useState)(I[0]?.id ?? ""), c = (0, l.useRef)(null);
	(0, l.useEffect)(() => {
		...
		return (async () => {
			try {
				...
				if (e) return;
				let r = L(t);
				n(r), document.documentElement.setAttribute("data-theme", r), document.documentElement.toggleAttribute("data-native-cursor", t?.customCursor === !1), a(t?.language);
			} catch (e) {
	...
	let d = (0, l.useCallback)((e) => {
		...
		let t = c.current, n = document.getElementById(e);
		!t || !n || (t.scrollTo({
			top: n.offsetTop - 12,
			behavior: "smooth"
		}), s(e));
		...
		import("./window-Mv3S1g6R.js").then((e) => e.getCurrentWindow().minimize()).catch(() => {});
	}, []), h = (0, l.useCallback)(() => {
		import("./window-Mv3S1g6R.js").then((e) => e.getCurrentWindow().close()).catch(() => {});
	}, []);
	return /* @__PURE__ */ (0, u.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, u.jsxs)("header", {
			...
			children: [/* @__PURE__ */ (0, u.jsx)("nav", {
				...
				"aria-label": e("样式分区目录"),
				children: I.map((e) => /* @__PURE__ */ (0, u.jsx)("button", {
					type: "button",
					onClick: () => f(e.id),
					className: `w-full rounded-md px-2.5 py-1.5 text-left text-xs transition-colors ${r === e.id ? "bg-brand/15 text-brand-light" : "text-canvas-text-secondary hover:bg-canvas-hover hover:text-canvas-text"}`,
					children: e.title
				}, e.id))
				...
				children: /* @__PURE__ */ (0, u.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, u.jsx)(F, { theme: t })
				})
			})]
		})]
	});
