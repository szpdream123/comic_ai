...
import { ri as o, t as s } from "./useAppStore-CcUL4Jo0.js";
import { i as c } from "./core-CoHQ9AE0.js";
import { C as l, S as u, l as d } from "./fileService-zQLozbOU.js";
import { t as f } from "./num-vBm-9Bix.js";
import { Rt as p, ct as m, dt as h, ft as g, ht as _, lt as v, mt as y, nt as b, ot as x, pt as ee, rt as S, st as te, ut as ne } from "./useTooltipAutoPlacement-BSvTkR9V.js";
import { t as C } from "./QualityRatioSelector-DwYxbR6P.js";
import { n as w } from "./dropCapture-BvcIf7tG.js";
import { t as T } from "./FullscreenOverlay-Dpw1A125.js";
import { a as re, l as E, r as ie } from "./onnxService-BVMRtTc4.js";
...
function ls(e) {
	...
	for (let r of e) for (let e of r) e.type !== "image" || !e.image || t.has(e.image) || (t.add(e.image), n += v(e.width, e.height)?.bytes ?? 0);
	return n;
}
function us(e, t, n, r = S, i = 0) {
...
function vs() {
	let [e, t] = (0, D.useState)([]), [n, r] = (0, D.useState)(null), [i, a] = (0, D.useState)(gs), [o, s] = (0, D.useState)("select"), [c, l] = (0, D.useState)({
		...
		past: 0,
		future: 0
	}), [f, p] = (0, D.useState)(0), m = (0, D.useRef)([]), h = (0, D.useRef)(gs), g = (0, D.useRef)(null), _ = (0, D.useRef)([]), x = (0, D.useRef)([]), te = (0, D.useRef)(null), ne = (0, D.useRef)(Promise.resolve()), C = (0, D.useRef)(/* @__PURE__ */ new Set()), w = (0, D.useRef)(/* @__PURE__ */ new Set()), T = (0, D.useCallback)((e = m.current) => {
		cs(C.current, w.current, [
			e,
			..._.current.map((e) => e.layers),
	...
	let E = (0, D.useCallback)((e) => {
		let n = us(e, _.current, x.current);
		(n.past !== _.current || n.future !== x.current) && (_.current = n.past, x.current = n.future, d({
			past: n.past.length,
			future: n.future.length
		}));
		let r = ee(n.totalBytes);
		...
		d({
			past: _.current.length,
			future: x.current.length
		});
	}, []), oe = (0, D.useCallback)(() => ({
		layers: m.current,
		canvas: h.current,
		selectedId: g.current
	}), []), k = (0, D.useCallback)((e) => {
		let t = Date.now();
		if (e && te.current?.tag === e && t - te.current.at < hs) {
			te.current.at = t;
			return;
		}
		te.current = e ? {
			tag: e,
			at: t
		} : null, _.current = [..._.current, oe()].slice(-80), x.current = [], O(), T();
	}, [
		T,
		oe,
		O
		...
		let e = _.current.pop();
		e && (x.current = [...x.current, oe()].slice(-80), te.current = null, A(e), O());
	}, [
		A,
		oe,
		O
		...
		let e = x.current.pop();
		e && (_.current = [..._.current, oe()].slice(-80), te.current = null, A(e), O());
	}, [
		A,
		oe,
		O
	]), le = (0, D.useCallback)(() => {
		_.current = [], x.current = [], te.current = null, p(us(m.current, [], []).totalBytes), O(), T();
		...
		k(), E(m.current.filter((t) => t.id !== e)), g.current === e && ie(null);
	}, [
		E,
		k,
		ie
	...
	}, []), _e = (0, D.useCallback)((e) => b(e, {
		label: "合成器源图",
		beforeDecode: ({ width: e, height: t }) => {
			let n = v(e, t);
			if (!n) throw RangeError("图片图层尺寸无效，请重新添加图片");
			let r = us(m.current, _.current, x.current, S, n.bytes);
			(r.past !== _.current || r.future !== x.current) && (_.current = r.past, x.current = r.future, O()), T(), p(r.totalBytes - n.bytes);
			let i = ee(r.totalBytes);
			if (i) throw RangeError(i);
		}
	}), [T, O]), ve = (0, D.useCallback)(async (e, t = "图片", n) => j(async () => {
		let r = await _e(e), i = r.naturalWidth, a = r.naturalHeight, o = /* @__PURE__ */ new Set(), s = y(m.current.reduce((e, t) => t.type !== "image" || !t.image || o.has(t.image) ? e : (o.add(t.image), e + (v(t.width, t.height)?.bytes ?? 0)), 0), i, a);
		if (s) throw RangeError(s);
		n?.(r);
		let c = h.current, l = Math.min(1, c.width * .9 / i, c.height * .9 / a);
		ge({
		...
		let t = h.current, n = t.width / 2, r = t.height / 2, i = Math.min(t.width, t.height) * .3, a = ms();
		ge(e === "rect" || e === "ellipse" ? {
...
function Es({ composer: e, canExport: t, onFit: n, onExport: r, onClose: i }) {
	let { canvas: a, updateCanvas: o, addImageLayer: c, addImageFileLayer: l, addText: u, addShape: d, tool: f, setTool: m, brush: h, setBrush: g, undo: _, redo: v, canUndo: y, canRedo: b } = e, x = (0, D.useRef)(null), [ee, S] = (0, D.useState)(null), te = (e) => S((t) => t === e ? null : e), [ne, w] = (0, D.useState)("1K"), T = Cs(a.width, a.height), re = (e) => {
		let { w: t, h: n } = xs(e, ne);
		o({
			width: t,
			height: n
				...
				children: [
					...
					/* @__PURE__ */ (0, W.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, W.jsx)(p, {
							...
							"aria-label": "画笔",
							onClick: () => f === "brush" ? te("brush") : m("brush"),
							children: /* @__PURE__ */ (0, W.jsxs)("svg", {
								viewBox: "0 0 24 24",
								fill: "none",
								stroke: "currentColor",
...
function Ps({ composer: e, nodeId: t, collapsed: n, onToggleCollapsed: r, animateIn: i, onMatteSubject: a, mattingLayerId: o, onAlign: c, onFitLayer: l }) {
	let { layers: u, selectedId: d, setSelectedId: f, selectedLayer: m, canvas: h, updateCanvas: g, updateLayer: _, removeLayer: v, duplicateLayer: y, reorderLayer: b, moveLayerToIndex: x, addImageLayer: ee, addText: S, flipLayer: te, resetTransform: ne, setAdjustments: C, resetAdjustments: w } = e, [T, re] = (0, D.useState)(null), [E, ie] = (0, D.useState)(null), ae = s((e) => e.nodes), O = s((e) => e.edges), oe = (0, D.useMemo)(() => {
		...
		O,
		t
	]), k = (e, t) => m && _(m.id, e, t), A = m && (m.type === "rect" || m.type === "ellipse") ? m : null, se = m && As(m) ? m : null, ce = m && ks(m) ? m : null, le = (e, t) => {
		if (!ce || t <= 0) return;
	...
	}, fe = m?.type === "text" ? m.fontStyle : "", pe = (e) => {
	...
	return /* @__PURE__ */ (0, W.jsxs)(W.Fragment, { children: [n && /* @__PURE__ */ (0, W.jsx)("button", {
		...
		children: [
			...
			m && /* @__PURE__ */ (0, W.jsxs)(W.Fragment, { children: [
				/* @__PURE__ */ (0, W.jsxs)("div", {
					className: "composer-side-section",
					children: [
				...
				/* @__PURE__ */ (0, W.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, W.jsx)(Ds, {
							...
							max: 1,
							step: .01,
							display: `${Math.round(m.opacity * 100)}%`,
							onChange: (e) => k({ opacity: e }, `opacity:${m.id}`)
						}),
						...
						m.type === "text" && /* @__PURE__ */ (0, W.jsxs)(W.Fragment, { children: [
							/* @__PURE__ */ (0, W.jsxs)("label", {
								className: "composer-field",
							...
							/* @__PURE__ */ (0, W.jsxs)("label", {
								...
								children: [/* @__PURE__ */ (0, W.jsx)("span", { children: "颜色" }), /* @__PURE__ */ (0, W.jsx)("input", {
									type: "color",
									value: m.fill,
									onChange: (e) => k({ fill: e.target.value }, `fill:${m.id}`)
								})]
							}),
							/* @__PURE__ */ (0, W.jsxs)("div", {
								className: "composer-field",
								children: [/* @__PURE__ */ (0, W.jsx)("span", { children: "样式" }), /* @__PURE__ */ (0, W.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, W.jsx)("button", {
											type: "button",
											className: m.shadow ? "active" : "",
											"data-tooltip": "投影",
											onClick: () => k({ shadow: !m.shadow }),
											children: "◍"
										})
									]
								})]
						...
						m.type === "rect" && /* @__PURE__ */ (0, W.jsx)(Ds, {
							label: "圆角",
							value: m.cornerRadius,
							min: 0,
							max: 400,
							onChange: (e) => k({ cornerRadius: e }, `radius:${m.id}`)
						}),
						/* @__PURE__ */ (0, W.jsxs)("div", {
							className: "composer-field",
				...
				m.type === "image" && /* @__PURE__ */ (0, W.jsxs)("div", {
					className: "composer-side-section",
					children: [
						/* @__PURE__ */ (0, W.jsxs)("div", {
							className: "composer-side-title",
							children: ["调整", !ps(m.adjustments) && /* @__PURE__ */ (0, W.jsx)("button", {
								type: "button",
						...
						Ns.map((e) => /* @__PURE__ */ (0, W.jsx)(Ds, {
							label: e.label,
							value: m.adjustments[e.key],
							min: e.min,
							max: e.max,
							step: e.step,
							onChange: (t) => C(m.id, { [e.key]: t }, `adj:${e.key}:${m.id}`)
						}, e.key)),
						/* @__PURE__ */ (0, W.jsxs)("div", {
							className: "composer-field",
							children: [/* @__PURE__ */ (0, W.jsx)("span", { children: "效果" }), /* @__PURE__ */ (0, W.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, W.jsx)("button", {
										type: "button",
										className: m.adjustments.grayscale ? "active" : "",
										onClick: () => C(m.id, { grayscale: !m.adjustments.grayscale }),
										children: "黑白"
									}),
									/* @__PURE__ */ (0, W.jsx)("button", {
										type: "button",
										className: m.adjustments.sepia ? "active" : "",
										onClick: () => C(m.id, { sepia: !m.adjustments.sepia }),
										children: "怀旧"
									}),
									/* @__PURE__ */ (0, W.jsx)("button", {
										type: "button",
										className: m.adjustments.invert ? "active" : "",
										onClick: () => C(m.id, { invert: !m.adjustments.invert }),
										children: "反相"
									})
								]
							})]
	...
	return (0, D.useEffect)(() => {
		...
		if (!(!t || !e.image)) {
			if (ps(o)) t.filters([]), t.clearCache(), r(e.id, null);
				...
				let n = Math.ceil(o.blur) * 2 + 1, a = i ?? h(e.width, e.height, n);
...
function Qs({ isOpen: e, nodeId: t, imageUrl: n, onClose: r, onStart: i, onSave: a }) {
	let o = vs(), { layers: l, selectedId: u, setSelectedId: d, selectedLayer: p, canvas: h, updateCanvas: v, updateLayer: y, removeLayer: b, duplicateLayer: ee, reorderLayer: S, addImageLayer: C, addImageFileLayer: O, replaceImageLayer: oe, addBrushStroke: k, tool: A, setTool: se, brush: ce, undo: le, redo: ue, clearHistory: de, reset: fe, retainedImageBytes: pe } = o, me = (0, D.useRef)(null), he = (0, D.useRef)(null), ge = (0, D.useRef)(null), j = (0, D.useRef)(/* @__PURE__ */ new Map()), [_e, ve] = (0, D.useState)({
		...
		for (let n of l) {
			...
			let r = Math.ceil(n.adjustments.blur) * 2 + 1, i = ne(t, n.width, n.height, r, pe);
			if (i) {
				e.set(n.id, i);
				continue;
			}
			t += m(n.width, n.height, r) ?? 0;
		}
		return {
			errors: e,
			workingBytes: t
	...
	let Ze = (0, D.useCallback)((e) => {
		...
		Ce && y(Ce.id, { text: e }), we(null);
	}, [Ce, y]), ot = (0, D.useCallback)((e) => {
		if (!p) return;
		let t = j.current.get(p.id);
		if (!t) return;
	...
	(0, D.useEffect)(() => {
		...
		let t = !1, n = null;
		return (async () => {
			let { listen: e } = await import("./event-h5Ir25pQ.js").then((e) => e.i), r = await e("tauri://drag-drop", async (e) => {
	...
	let [ft, pt] = (0, D.useState)(null), mt = (0, D.useCallback)(async () => {
		...
		let n = _(h.width, h.height, "合成导出");
		if (n) {
			s.getState().showToast(n, "error");
			return;
		}
		let r = g(pe, Ue.workingBytes, h.width, h.height);
		if (r) {
				...
				children: [/* @__PURE__ */ (0, W.jsxs)("div", {
					...
					children: [
						...
						Ce && /* @__PURE__ */ (0, W.jsx)("textarea", {
							...
							autoFocus: !0,
							defaultValue: (p?.type === "text" ? p.text : "") || "",
							style: {
								left: Ce.left,
								top: Ce.top,
								width: Ce.width,
