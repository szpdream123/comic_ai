...
import { Lt as i, t as a, zt as o } from "./useAppStore-BH-MdRLu.js";
import { r as s } from "./dist-js-Cjy7VdJu.js";
import { t as c } from "./ModalOverlay-B0YAfIbK.js";
import { n as l } from "./rasterImageDimensions-CX1VK2cM.js";
import { a as u, i as d, r as f, s as p, t as m } from "./directorDeskRuntimeService-B4LM4Z12.js";
...
function x() {
	let e = a((e) => e.directorDeskRuntimeRequest);
	return e ? /* @__PURE__ */ (0, _.jsx)(S, { request: e }, e.instanceId) : null;
}
function S({ request: e }) {
	let t = a((e) => e.clearDirectorDeskRuntimeRequest), n = a((e) => e.config.theme), r = a((e) => e.showToast), c = u(), [l, g] = (0, h.useState)(c ? "checking" : "error"), [x, S] = (0, h.useState)(y), [C, w] = (0, h.useState)(0), [T, E] = (0, h.useState)("正在准备下载..."), [D, O] = (0, h.useState)(c ? null : "3D 导演台运行资源仅支持 Tauri 桌面端下载"), [k, A] = (0, h.useState)(!1), j = (0, h.useRef)(!1), M = (0, h.useRef)(!1);
	(0, h.useEffect)(() => {
		if (!c) return;
		let e = !0;
		return f().then((n) => {
	...
	let N = (0, h.useCallback)(async (r) => {
		...
		try {
			...
			S(c.version), w(100), t();
			let l = a.getState().nodes.find((t) => t.type === "ai-director" ? (typeof t.data.directorInstanceId == "string" ? t.data.directorInstanceId : t.id) === e.instanceId : !1), u = l ? o(l.data.directorRuntimeKind) : null;
			e.openAfterInstall && l && u?.supported && u.kind === "lightweight-web" && await i(l.data.directorRuntimeKind, {
