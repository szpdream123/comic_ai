...
import { Tt as r, ft as i, ri as a, t as o, ut as s } from "./useAppStore-CcUL4Jo0.js";
import { a as c, r as l } from "./ViewportImage-Dsz9jsTU.js";
import { Tt as ee, zt as te } from "./useTooltipAutoPlacement-BSvTkR9V.js";
...
function S() {
	let { workflows: e, workflowPanelOpen: t, setWorkflowPanelOpen: n, addWorkflow: h, deleteWorkflow: S, updateWorkflow: C, resetBuiltIns: w, comfyServers: T, showToast: E } = o(te((e) => ({
	...
	let Y = (0, d.useCallback)(() => {
		...
		try {
			...
			M(e.name), P(t), I(s(t)), O((t) => t || e.name.replace(/\.json$/i, ""));
		} catch {
			V("JSON 解析失败，请检查文件格式");
		}
