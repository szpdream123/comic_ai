...
import { t as i } from "./useAppStore-BH-MdRLu.js";
...
async function _(e, t) {
	let { listen: n } = await import("./event-BlmvLUFr.js").then((e) => e.i), r = await n(s, (t) => {
		e(t.payload);
	}), i = await n(c, () => {
		t();
	});
...
async function v(e) {
	let { emit: t } = await import("./event-BlmvLUFr.js").then((e) => e.i);
	await t(o, e);
}
async function y() {
	try {
		let { emit: e } = await import("./event-BlmvLUFr.js").then((e) => e.i);
		await e(l, {});
	} catch {}
}
async function b(e, t) {
	let { listen: n } = await import("./event-BlmvLUFr.js").then((e) => e.i), r = await n(o, (t) => {
		e(t.payload);
	}), i = await n(l, () => {
		t();
	});
