...
async function y({ instanceId: e, theme: n = "dark" }) {
	...
	await _();
	let { WebviewWindow: a } = await import("./webviewWindow-B_qR0hzx.js"), o = await a.getByLabel(r);
	if (g(i), o) {
...
async function S() {
	try {
		let { WebviewWindow: e } = await import("./webviewWindow-B_qR0hzx.js"), t = await e.getByLabel(r);
		t && await t.close();
	} catch {}
}
//#endregion
