...
const migrations = [
  ...
  ["20260904-create-skill-plaza.sql", "packages/db/migrations/20260904-create-skill-plaza.sql"],
  ...
  ["20261001-align-seedance25-special-resolution.sql", "packages/db/migrations/20261001-align-seedance25-special-resolution.sql"],
  ["20261001-replace-minimax-h3-c4-with-768p.sql", "packages/db/migrations/20261001-replace-minimax-h3-c4-with-768p.sql"],
  ["20261002-replace-globalaiopc-banana-with-seedream5.sql", "packages/db/migrations/20261002-replace-globalaiopc-banana-with-seedream5.sql"],
  ["20261003-fix-minimax-h3-model-center-endpoints.sql", "packages/db/migrations/20261003-fix-minimax-h3-model-center-endpoints.sql"],
  ["20261004-align-globalaiopc-sd25-discount-model.sql", "packages/db/migrations/20261004-align-globalaiopc-sd25-discount-model.sql"],
  ["20261005-correct-globalaiopc-sd25-special-model.sql", "packages/db/migrations/20261005-correct-globalaiopc-sd25-special-model.sql"],
  ["20261006-fix-globalaiopc-happyhorse11-model-center.sql", "packages/db/migrations/20261006-fix-globalaiopc-happyhorse11-model-center.sql"],
  ["20261007-enable-globalaiopc-sd25-special.sql", "packages/db/migrations/20261007-enable-globalaiopc-sd25-special.sql"],
  ["20261008-enable-globalaiopc-seedream5.sql", "packages/db/migrations/20261008-enable-globalaiopc-seedream5.sql"],
  ["20261009-correct-globalaiopc-sd25-discount-model.sql", "packages/db/migrations/20261009-correct-globalaiopc-sd25-discount-model.sql"],
  ["20261010-fix-globalaiopc-sd25-discount-duration.sql", "packages/db/migrations/20261010-fix-globalaiopc-sd25-discount-duration.sql"],
  ["20261011-normalize-globalaiopc-sd25-duration-options.sql", "packages/db/migrations/20261011-normalize-globalaiopc-sd25-duration-options.sql"],
  ["20261012-restore-globalaiopc-sd25-special-model.sql", "packages/db/migrations/20261012-restore-globalaiopc-sd25-special-model.sql"],
  ["20261013-add-globalaiopc-klingo3-wan27-r2v.sql", "packages/db/migrations/20261013-add-globalaiopc-klingo3-wan27-r2v.sql"],
  ["20261014-fix-globalaiopc-klingo3-wan27-parameters.sql", "packages/db/migrations/20261014-fix-globalaiopc-klingo3-wan27-parameters.sql"],
...
const runtimeSafeMigrationNames = new Set([
  ...
  "20260827-generation-queue-worker-readiness.sql",
  ...
  "20260904-create-skill-plaza.sql",
  "20260904-create-skill-favorites.sql",
  "20261001-replace-minimax-h3-c4-with-768p.sql",
  ...
  "20261002-replace-globalaiopc-banana-with-seedream5.sql",
  "20261003-fix-minimax-h3-model-center-endpoints.sql",
  "20261004-align-globalaiopc-sd25-discount-model.sql",
  "20261005-correct-globalaiopc-sd25-special-model.sql",
  "20261006-fix-globalaiopc-happyhorse11-model-center.sql",
  "20261013-add-globalaiopc-klingo3-wan27-r2v.sql",
  "20261014-fix-globalaiopc-klingo3-wan27-parameters.sql",
...
async function assertCleanSchema(db) {
  ...
  const result = await db.query(`
    ...
    WHERE (object_type, object_name) NOT IN (
      ...
      ('column', 'production_agent_conversations.workspace_json'),
